...
public class MagpulCTRStock extends ModelBase {
	...
	public MagpulCTRStock() {
		...
		gun365.cubeList.add(new ModelBox(gun365, 10, 25, 0.0F, 0.0F, 0.0F, 1, 3, 4, 0.0F, false));

		gun366 = new ModelRenderer(this);
		gun366.setRotationPoint(-3.0F, -10.5F, 3.5F);
		gun366.cubeList.add(new ModelBox(gun366, 26, 32, 0.0F, 0.0F, 0.0F, 3, 1, 4, 0.0F, false));

		gun367 = new ModelRenderer(this);
		gun367.setRotationPoint(-2.0F, -11.7F, 8.0F);
		gun367.cubeList.add(new ModelBox(gun367, 0, 21, 0.0F, 0.0F, 0.0F, 1, 3, 20, 0.0F, false));

		gun368 = new ModelRenderer(this);
		gun368.setRotationPoint(-2.0F, -9.3F, 7.5F);
		...
		gun372.cubeList.add(new ModelBox(gun372, 24, 1, 0.0F, 0.0F, 0.0F, 1, 2, 20, 0.0F, false));
		...
		gun374.cubeList.add(new ModelBox(gun374, 44, 44, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));
		...
		gun395.cubeList.add(new ModelBox(gun395, 12, 4, 0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F, false));

		gun396 = new ModelRenderer(this);
		gun396.setRotationPoint(-2.5F, -6.8F, 23.5F);
		setRotationAngle(gun396, 2.082F, 0.0F, 0.0F);
		gun396.cubeList.add(new ModelBox(gun396, 9, 21, -0.001F, 0.0F, 0.0F, 2, 1, 2, 0.0F, false));

		gun397 = new ModelRenderer(this);
		gun397.setRotationPoint(-3.0F, -8.5F, 13.0F);
		setRotationAngle(gun397, -0.1115F, 0.0F, 0.0F);
		gun397.cubeList.add(new ModelBox(gun397, 0, 0, 0.0F, 0.0F, 0.0F, 3, 1, 6, 0.0F, false));

		gun398 = new ModelRenderer(this);
		gun398.setRotationPoint(-3.0F, -7.9F, 18.95F);
		setRotationAngle(gun398, -0.2603F, 0.0F, 0.0F);
		gun398.cubeList.add(new ModelBox(gun398, 8, 34, -0.001F, 0.0F, 0.0F, 3, 1, 3, 0.0F, false));

		gun399 = new ModelRenderer(this);
		gun399.setRotationPoint(-3.0F, -7.0F, 17.5F);
		gun399.cubeList.add(new ModelBox(gun399, 0, 29, 0.001F, 0.0F, 0.0F, 3, 1, 4, 0.0F, false));

		gun400 = new ModelRenderer(this);
		gun400.setRotationPoint(-3.0F, -6.0F, 17.5F);
		setRotationAngle(gun400, 2.8256F, 0.0F, 0.0F);
		gun400.cubeList.add(new ModelBox(gun400, 0, 14, -0.001F, 0.0F, 0.0F, 3, 1, 5, 0.0F, false));

		gun402 = new ModelRenderer(this);
		gun402.setRotationPoint(-2.5F, -2.8F, 24.6F);
		setRotationAngle(gun402, -0.7854F, 0.0F, 0.0F);
		gun402.cubeList.add(new ModelBox(gun402, 28, 23, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

		gun403 = new ModelRenderer(this);
		gun403.setRotationPoint(-2.0F, -0.9F, 21.5F);
		gun403.cubeList.add(new ModelBox(gun403, 30, 23, 0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));

		gun404 = new ModelRenderer(this);
		gun404.setRotationPoint(-2.0F, 0.7F, 24.0F);
		gun404.cubeList.add(new ModelBox(gun404, 12, 0, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

		gun405 = new ModelRenderer(this);
		gun405.setRotationPoint(-2.0F, 0.1F, 22.5F);
		setRotationAngle(gun405, 0.7808F, 0.0F, 0.0F);
		gun405.cubeList.add(new ModelBox(gun405, 11, 7, -0.001F, 0.0F, 0.0F, 1, 2, 1, 0.0F, false));
		...
		setRotationAngle(gun415, 1.0647F, 0.0F, 0.0F);
		gun415.cubeList.add(new ModelBox(gun415, 22, 23, 0.0F, 2.0F, 0.0F, 2, 11, 2, 0.0F, false));

		gun416 = new ModelRenderer(this);
		gun416.setRotationPoint(-2.5F, -2.5F, 20.6F);
		gun416.cubeList.add(new ModelBox(gun416, 32, 5, 0.001F, 0.0F, 0.0F, 2, 1, 4, 0.0F, false));

		gun417 = new ModelRenderer(this);
		gun417.setRotationPoint(-0.6F, -10.3F, 7.5F);
		gun417.cubeList.add(new ModelBox(gun417, 0, 44, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

		gun418 = new ModelRenderer(this);
		gun418.setRotationPoint(-3.4F, -10.3F, 7.5F);
		gun418.cubeList.add(new ModelBox(gun418, 22, 24, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

		gun419 = new ModelRenderer(this);
		gun419.setRotationPoint(-3.0F, -8.0F, 7.8F);
		gun419.cubeList.add(new ModelBox(gun419, 32, 0, 0.0F, 0.0F, 0.0F, 3, 2, 3, 0.0F, false));

		gun420 = new ModelRenderer(this);
		gun420.setRotationPoint(-3.0F, -8.0F, 10.8F);
		setRotationAngle(gun420, -0.5205F, 0.0F, 0.0F);
		gun420.cubeList.add(new ModelBox(gun420, 0, 7, -0.001F, 0.0F, 0.0F, 3, 2, 5, 0.0F, false));
	}
