...
public class turretsilenced extends ModelBiped {
	...
	public turretsilenced() {
		...
		cube_r25.cubeList.add(new ModelBox(cube_r25, 6, 6, -1.0F, 0.0F, 0.0F, 1, 2, 1, -0.001F, false));
		...
		cube_r28.cubeList.add(new ModelBox(cube_r28, 31, 13, -1.0F, 0.0F, 0.0F, 1, 1, 6, 0.001F, false));

		cube_r29 = new ModelRenderer(this);
		cube_r29.setRotationPoint(1.0F, -4.25F, 2.5F);
		...
		cube_r30.setRotationPoint(1.0F, -4.25F, 2.5F);
		...
		cube_r32.setRotationPoint(2.0F, 0.0F, 1.0F);
		magazine.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.0F, 0.4538F, 0.0F);
		cube_r32.cubeList.add(new ModelBox(cube_r32, 22, 33, -1.0F, 0.0F, -2.0F, 1, 1, 2, 0.005F, false));

		cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(-0.4F, 0.0F, 4.05F);
		magazine.addChild(cube_r33);
		setRotationAngle(cube_r33, 0.0F, 0.6807F, 0.0F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 29, 6, 0.0F, 0.0F, -1.0F, 2, 1, 1, 0.0F, false));
		...
		cube_r35.setRotationPoint(2.0F, 0.0F, 1.0F);
		magazine.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.0F, -0.4538F, 0.0F);
		cube_r35.cubeList.add(new ModelBox(cube_r35, 21, 40, -1.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
}
