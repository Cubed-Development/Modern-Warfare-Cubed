...
public class EntityConfiguration {
    ...
    public static class Builder {
        ...
        public void register() {
            ...
            EntityRegistry.registerModEntity(new ResourceLocation(ID, entityName), entityClass, ID + "_" + entityName, modEntityId, MWC.class, trackingRange, updateFrequency, sendVelocityUpdates);
