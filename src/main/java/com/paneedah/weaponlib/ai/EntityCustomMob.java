...
public class EntityCustomMob extends EntityMob implements IRangedAttackMob, Contextual, Configurable<EntityConfiguration> {
    ...
    protected void initEntityAI() {
        ...
        setSize(getConfiguration().getSizeWidth(), getConfiguration().getSizeHeight());
        getConfiguration().addAiTasks(this, tasks);
        getConfiguration().addAiTargetTasks(this, targetTasks);
    }
    ...
    private void setArmorEquipment() {
        ...
        Arrays.fill(inventoryArmorDropChances, configuration.getArmorDropChance());
    ...
    private void setPrimaryEquipment() {
        ...
        Arrays.fill(inventoryHandsDropChances, configuration.getPrimaryEquipmentDropChance());
        if (equipment != null) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        int variant = 0;
        if (!variants.isEmpty()) {
            variant = rand.nextInt(variants.size());
        }
        setVariant(variant);
