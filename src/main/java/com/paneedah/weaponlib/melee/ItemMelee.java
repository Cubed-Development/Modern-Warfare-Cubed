    ...
    public static class Builder {
        ...
        public ItemMelee build() {
            ...
            if (craftingRecipe != null && craftingRecipe.length >= 2) {
                ...
                ForgeRegistries.RECIPES.register(new ShapedOreRecipe(null, new ItemStack(itemMelee), shape.toArray()).setMirrored(false).setRegistryName(ID, new ItemStack(itemMelee).getItem().getTranslationKey() + "_recipe")); // ! TODO: Temporary hack because we should use the registry event instead - Luna Mira Lage (Desoroxxx) 2025-09-19
            } else {
