...
public class CompatibleWorldRenderer extends EntityRenderer {
    ...
    public void loadEntityShader(@Nullable Entity entityIn) {
        if (OpenGlHelper.shadersSupported) {
            ...
            } else if (null instanceof EntitySpider) {
                loadShader(new ResourceLocation("shaders/post/spider.json"));
            } else if (null instanceof EntityEnderman) {
                loadShader(new ResourceLocation("shaders/post/invert.json"));
            } else {
                net.minecraftforge.client.ForgeHooksClient.loadEntityShader(null, this);
            }
        }
    }
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null) {
            if (MC.world != null) {
                ...
                if (pointedEntity != null && flag && eyePosition.distanceTo(vec3d3) > 3.0D) {
                    pointedEntity = null;
                ...
                if (pointedEntity != null && (d2 < d1 || MC.objectMouseOver == null)) {
                    ...
                    if (pointedEntity instanceof EntityLivingBase || null instanceof EntityItemFrame) {
