...
public class ModernConfigManager {
	...
	public static final String CATEGORY_ENTITIES = CATEGORY_SERVER + ".entities";
	public static final String CATEGORY_ORES = CATEGORY_SERVER + ".ores";
	public static final String CATEGORY_RENDERING = CATEGORY_CLIENT + ".rendering";
	public static final String CATEGORY_RENDERING_SCREENSHADERS = CATEGORY_RENDERING + ".screenshaders";
	public static final String CATEGORY_AMMO_COUNTER = CATEGORY_CLIENT + ".ammocounter";
