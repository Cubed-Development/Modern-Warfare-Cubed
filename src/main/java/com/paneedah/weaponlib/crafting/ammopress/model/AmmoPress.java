...
public class AmmoPress extends ModelBase {
    ...
    public AmmoPress() {
        ...
        bone13.setRotationPoint(0, 24, -6.75F);
        bone13.cubeList.add(new ModelBox(bone13, 40, 48, -1, -9.25F, -0.15F, 2, 7, 2, 0, false));
        bone13.cubeList.add(new ModelBox(bone13, 48, 5, -1, -2, -3.15F, 2, 2, 4, 0, false));
        bone13.cubeList.add(new ModelBox(bone13, 20, 49, -2, -4, -2.9F, 1, 4, 1, 0, false));
        bone13.cubeList.add(new ModelBox(bone13, 0, 49, -1, -3.25F, -2.15F, 2, 2, 3, -0.2F, false));
        bone13.cubeList.add(new ModelBox(bone13, 10, 49, 2, -8.75F, 0.35F, 1, 7, 2, 0, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(-5.1F, -0.1F, -1.1F);
        bone13.addChild(cube_r1);
        setRotationAngle(cube_r1, 0, 0.6021F, 0);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 28, 47, -2, -3, 0, 2, 3, 4, 0, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(13, 0, 5.95F);
        bone13.addChild(cube_r2);
        setRotationAngle(cube_r2, 0, -0.2094F, 0);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 0, -8, -6, 0, 8, 6, 7, 0, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(3.15F, -1, 5.35F);
        bone13.addChild(cube_r3);
        setRotationAngle(cube_r3, 0, -0.3665F, 0);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 13, -5, -6.25F, 0, 5, 6, 5, -0.2F, false));

        BottomRotor = new ModelRenderer(this);
        BottomRotor.setRotationPoint(0, 0, 6.75F);
        bone13.addChild(BottomRotor);


        bone = new ModelRenderer(this);
        bone.setRotationPoint(0, 0, -6.75F);
        ...
        setRotationAngle(cube_r4, 0, -0.4189F, 0);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 32, 30, 0, -3, 0, 5, 3, 4, 0.001F, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(0, 0, 0);
        bone.addChild(cube_r5);
        setRotationAngle(cube_r5, 0, 0.4189F, 0);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 34, 7, -5, -3, 0, 5, 3, 4, 0, false));

        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0, 0, 6.75F);
        ...
        setRotationAngle(cube_r6, 0, 0.4189F, 0);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 18, 27, 0, -3, -4, 5, 3, 4, 0.001F, false));

        cube_r7 = new ModelRenderer(this);
        cube_r7.setRotationPoint(0, 0, 0);
        bone2.addChild(cube_r7);
        setRotationAngle(cube_r7, 0, -0.4189F, 0);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 32, -5, -3, -4, 5, 3, 4, -0.001F, false));

        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(6.75F, 0, 0);
        ...
        setRotationAngle(cube_r8, 0, -0.4189F, 0);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 23, 0, 0, -3, 0, 5, 3, 4, 0.002F, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(0, 0, 0);
        bone3.addChild(cube_r9);
        setRotationAngle(cube_r9, 0, 0.4189F, 0);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 25, -5, -3, 0, 5, 3, 4, 0, false));

        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(-6.75F, 0, 0);
        BottomRotor.addChild(bone4);
        setRotationAngle(bone4, 0, 1.5708F, 0);


        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(0, 0, 0);
        bone4.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, -0.4189F, 0);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 20, 13, 0, -3, 0, 5, 3, 4, 0.001F, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(0, 0, 0);
        bone4.addChild(cube_r11);
        setRotationAngle(cube_r11, 0, 0.4189F, 0);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 20, 20, -5, -3, 0, 5, 3, 4, 0, false));

        Presser = new ModelRenderer(this);
        Presser.setRotationPoint(2, -5.75F, 1.15F);
        ...
        setRotationAngle(cube_r12, -0.2443F, 0, 0);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 48, 48, -1, -2.5756F, -1.4567F, 1, 5, 3, 0, false));

        TopRotor = new ModelRenderer(this);
        TopRotor.setRotationPoint(0, 0, 6.75F);
        bone13.addChild(TopRotor);
        TopRotor.cubeList.add(new ModelBox(TopRotor, 0, 0, -3, -11.75F, -3.65F, 1, 4, 1, 0, false));
        TopRotor.cubeList.add(new ModelBox(TopRotor, 0, 13, -4.1F, -11.75F, 0.95F, 1, 4, 1, 0, false));
        TopRotor.cubeList.add(new ModelBox(TopRotor, 15, 13, -1.4F, -11.75F, 3.45F, 1, 4, 1, 0, false));
        TopRotor.cubeList.add(new ModelBox(TopRotor, 30, 7, 2.5F, -11.75F, -3.15F, 1, 4, 1, 0, false));

        bone12 = new ModelRenderer(this);
        bone12.setRotationPoint(0, -11, -5.25F);
        ...
        setRotationAngle(cube_r13, 0, -0.4189F, 0);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 34, 16, 0, -1, 0, 4, 1, 4, 0.001F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(0, 0, 0);
        bone12.addChild(cube_r14);
        setRotationAngle(cube_r14, 0, 0.4189F, 0);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 18, 34, -4, -1, 0, 4, 1, 4, 0, false));

        bone11 = new ModelRenderer(this);
        bone11.setRotationPoint(0, -11, 5.25F);
        TopRotor.addChild(bone11);
        setRotationAngle(bone11, 0, 3.1416F, 0);


        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(0, 0, 0);
        bone11.addChild(cube_r15);
        setRotationAngle(cube_r15, 0, -0.4189F, 0);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 34, 23, 0, -1, 0, 4, 1, 4, 0.001F, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(0, 0, 0);
        bone11.addChild(cube_r16);
        setRotationAngle(cube_r16, 0, 0.4189F, 0);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 30, 37, -4, -1, 0, 4, 1, 4, 0, false));

        bone10 = new ModelRenderer(this);
        bone10.setRotationPoint(-5.25F, -11, 0);
        ...
        setRotationAngle(cube_r17, 0, -0.4189F, 0);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 39, 0, -1, 0, 4, 1, 4, 0.002F, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(0, 0, 0);
        bone10.addChild(cube_r18);
        setRotationAngle(cube_r18, 0, 0.4189F, 0);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 16, 39, -4, -1, 0, 4, 1, 4, 0, false));

        bone9 = new ModelRenderer(this);
        bone9.setRotationPoint(5.25F, -11, 0);
        ...
        setRotationAngle(cube_r19, 0, -0.4189F, 0);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 41, 0, 0, -1, 0, 4, 1, 4, 0.002F, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(0, 0, 0);
        bone9.addChild(cube_r20);
        setRotationAngle(cube_r20, 0, 0.4189F, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 28, 42, -4, -1, 0, 4, 1, 4, 0, false));

        bone8 = new ModelRenderer(this);
        bone8.setRotationPoint(-5.25F, -7, 0);
        TopRotor.addChild(bone8);
        setRotationAngle(bone8, 0, 1.5708F, 0);


        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(0, 0, 0);
        bone8.addChild(cube_r21);
        setRotationAngle(cube_r21, 0, -0.4189F, 0);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 42, 38, 0, -1, 0, 4, 1, 4, 0.002F, false));

        cube_r22 = new ModelRenderer(this);
        cube_r22.setRotationPoint(0, 0, 0);
        bone8.addChild(cube_r22);
        setRotationAngle(cube_r22, 0, 0.4189F, 0);
        cube_r22.cubeList.add(new ModelBox(cube_r22, 40, 43, -4, -1, 0, 4, 1, 4, 0, false));

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(5.25F, -7, 0);
        ...
        setRotationAngle(cube_r23, 0, -0.4189F, 0);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 0, 44, 0, -1, 0, 4, 1, 4, 0.002F, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(0, 0, 0);
        bone7.addChild(cube_r24);
        setRotationAngle(cube_r24, 0, 0.4189F, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 16, 44, -4, -1, 0, 4, 1, 4, 0, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(0, -7, 5.25F);
        TopRotor.addChild(bone6);
        setRotationAngle(bone6, 0, 3.1416F, 0);


        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(0, 0, 0);
        bone6.addChild(cube_r25);
        setRotationAngle(cube_r25, 0, -0.4189F, 0);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 46, 14, 0, -1, 0, 4, 1, 4, 0.001F, false));

        cube_r26 = new ModelRenderer(this);
        cube_r26.setRotationPoint(0, 0, 0);
        bone6.addChild(cube_r26);
        setRotationAngle(cube_r26, 0, 0.4189F, 0);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 46, 19, -4, -1, 0, 4, 1, 4, 0, false));

        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(0, -7, -5.25F);
        ...
        setRotationAngle(cube_r27, 0, -0.4189F, 0);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 46, 24, 0, -1, 0, 4, 1, 4, 0.001F, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(0, 0, 0);
        bone5.addChild(cube_r28);
        setRotationAngle(cube_r28, 0, 0.4189F, 0);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 46, 29, -4, -1, 0, 4, 1, 4, 0, false));

        MainPiston = new ModelRenderer(this);
        MainPiston.setRotationPoint(3.8F, -7.75F, 1.05F);
        TopRotor.addChild(MainPiston);
        MainPiston.cubeList.add(new ModelBox(MainPiston, 16, 49, -1, -4, 0, 1, 7, 1, 0, false));
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        for (float i = 0; i < 2 * Math.PI; i += Math.PI / 6) {
            ...
            int bulletID = (int) Math.round(i / (Math.PI / 6));
            ...
            if (outOfBoolets && bulletStatus[bulletID] == 0) {
                continue;
            }
        ...
        //if(BottomRotor.rotateAngleY >= 2*Math.PI) BottomRotor.rotateAngleY = 0;


        //MainPiston.offsetY = (1-proximity)/100;
