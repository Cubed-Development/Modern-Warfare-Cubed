...
public class DepthTexture {
    ...
    protected void createDepthTexture() {
        ...
        GlStateManager.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GLCompatible.GL_DEPTH_COMPONENT24, this.width, this.height, 0, GL11.GL_DEPTH_COMPONENT, GL11.GL_FLOAT, null);
    ...
    public void blitOn(int srcBuf, int srcW, int srcH, boolean rebind) {
        ...
        GLCompatible.glBlitFramebuffer(0, 0, srcW, srcH, 0, 0, getWidth(), getHeight(), GL11.GL_DEPTH_BUFFER_BIT,
                GL11.GL_NEAREST);
