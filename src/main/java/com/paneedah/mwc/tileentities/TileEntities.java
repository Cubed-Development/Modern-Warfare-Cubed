...
public final class TileEntities {
    ...
    public static void init() {
        new TurretBaseFactory().createTileEntity();
        ...
        for (final CustomTileEntityConfiguration customTileEntityConfiguration : props) {
            ...
            if (!customTileEntityConfiguration.isModern())
                LOGGER.debug("Non modern loot box configuration found: " + customTileEntityConfiguration.getName() + ". This may impact performance and should be modernized.");

            customTileEntityConfiguration.build(modContext);
        }

        LOGGER.debug("Built " + props.size() + " props");
