...
public class BanditNew4 extends ModelBiped {
    ...
    public BanditNew4() {
        ...
        chestharness.cubeList.add(new ModelBox(chestharness, 0, 32, -3.4F, 3.25F, -2.65F, 1, 3, 1, 0, false));
        chestharness.cubeList.add(new ModelBox(chestharness, 0, 16, 2.4F, 3.25F, -2.65F, 1, 3, 1, 0, false));
        chestharness.cubeList.add(new ModelBox(chestharness, 0, 48, -4, -0.25F, -2, 2, 1, 4, 0.1F, false));
        chestharness.cubeList.add(new ModelBox(chestharness, 0, 53, 2, -0.25F, -2, 2, 1, 4, 0.1F, true));
        chestharness.cubeList.add(new ModelBox(chestharness, 32, 32, -4, 7.9791F, -1.6516F, 8, 3, 4, 0.2F, false));

        body_r1 = new ModelRenderer(this);
        body_r1.setRotationPoint(-2.9F, 3.05F, 2.35F);
        chestharness.addChild(body_r1);
        setRotation(body_r1, 0, 0, -0.8727F);
        body_r1.cubeList.add(new ModelBox(body_r1, 48, 5, 0, -0.4F, -1, 1, 9, 1, -0.1F, false));

        body_r2 = new ModelRenderer(this);
        body_r2.setRotationPoint(2.9F, 3.05F, 2.35F);
        chestharness.addChild(body_r2);
        setRotation(body_r2, 0, 0, 0.8727F);
        ...
        body_r3.cubeList.add(new ModelBox(body_r3, 0, 0, 0, -6, 0, 2, 6, 2, 0, false));

        body_r4 = new ModelRenderer(this);
        body_r4.setRotationPoint(-3, 11.5F, -4.15F);
        chestharness.addChild(body_r4);
        setRotation(body_r4, 0, 0.3316F, 0.0524F);
        body_r4.cubeList.add(new ModelBox(body_r4, 24, 0, -2, -6, 0, 2, 6, 2, 0, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(3.9F, 0.45F, 2.55F);
        chestharness.addChild(bone6);
        setRotation(bone6, -0.0524F, 0, 0.2793F);
        bone6.cubeList.add(new ModelBox(bone6, 36, 16, -2, 0, -1, 2, 3, 1, 0, false));

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(-3.9F, 0.45F, 2.55F);
        chestharness.addChild(bone7);
        setRotation(bone7, -0.0524F, 0, -0.2793F);
        bone7.cubeList.add(new ModelBox(bone7, 28, 32, 0, 0, -1, 2, 3, 1, 0, false));

        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(3.9F, 3.25F, -2.75F);
        chestharness.addChild(bone5);
        setRotation(bone5, -0.1047F, 0, 0);
        bone5.cubeList.add(new ModelBox(bone5, 12, 32, -2, -3, 0, 2, 3, 1, 0, false));
        bone5.cubeList.add(new ModelBox(bone5, 20, 16, -7.8F, -3, 0, 2, 3, 1, 0, false));

        rightarm = new ModelRenderer(this);
        rightarm.setRotationPoint(0, 0, 0);
        rightarm.cubeList.add(new ModelBox(rightarm, 16, 32, -3, -2, -2, 4, 12, 4, 0, false));
        rightarm.cubeList.add(new ModelBox(rightarm, 32, 39, -3, -2, -2, 4, 10, 4, 0.12F, false));

        leftarm = new ModelRenderer(this);
        leftarm.setRotationPoint(0, 0, 0);
        leftarm.cubeList.add(new ModelBox(leftarm, 32, 0, -1, -2, -2, 4, 12, 4, 0, false));
        leftarm.cubeList.add(new ModelBox(leftarm, 40, 16, -1, -2, -2, 4, 10, 4, 0.12F, false));
