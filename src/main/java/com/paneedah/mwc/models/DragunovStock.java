...
public class DragunovStock extends ModelWithAttachments {
    ...
    public DragunovStock() {
        ...
        gripstock.cubeList.add(new ModelBox(gripstock, 0, 47, -3.8F, -24.05F, 31, 4, 5, 6, 0.0F, false));
        ...
        grip5_r2.cubeList.add(new ModelBox(grip5_r2, 43, 143, 0.0F, -1, 0.0F, 1, 1, 6, 0.002F, false));
        grip5_r2.cubeList.add(new ModelBox(grip5_r2, 27, 144, -3.6F, -1, 0.0F, 1, 1, 6, 0.002F, false));
        ...
        grip9_r1.cubeList.add(new ModelBox(grip9_r1, 93, 19, -1, 13.0F, -9.1F, 1, 2, 7, 0.003F, false));
        ...
        grip6_r1.cubeList.add(new ModelBox(grip6_r1, 180, 0, 0.0F, -1, -1, 1, 1, 39, 0.002F, false));
        grip6_r1.cubeList.add(new ModelBox(grip6_r1, 93, 38, -2.8F, -1, 25.0F, 3, 2, 2, 0.001F, false));
        grip6_r1.cubeList.add(new ModelBox(grip6_r1, 22, 24, -2.8F, -1, 17.0F, 3, 12, 8, 0.001F, false));
        ...
        grip9_r4.cubeList.add(new ModelBox(grip9_r4, 46, 77, 1, -4.0F, -5.0F, 3, 4, 5, -0.001F, false));
        ...
        grip8_r1.cubeList.add(new ModelBox(grip8_r1, 187, 209, -1, 0.0F, 0.0F, 1, 2, 35, 0.001F, false));
        ...
        grip13_r1.cubeList.add(new ModelBox(grip13_r1, 79, 122, -1, 0.0F, 0.0F, 1, 1, 4, -0.001F, false));
        ...
        grip10_r2.cubeList.add(new ModelBox(grip10_r2, 32, 129, -1, 0.0F, -4.0F, 1, 1, 4, -0.001F, false));
        ...
        grip10_r3.cubeList.add(new ModelBox(grip10_r3, 27, 123, -1, 0.0F, 0.0F, 1, 1, 4, -0.001F, false));
        grip10_r3.cubeList.add(new ModelBox(grip10_r3, 19, 87, -1, 0.4F, 0.0F, 1, 1, 2, -0.002F, false));
        ...
        grip9_r5.cubeList.add(new ModelBox(grip9_r5, 136, 43, -1, 0.0F, 0.0F, 1, 2, 17, 0.0F, false));
        ...
        grip9_r6.cubeList.add(new ModelBox(grip9_r6, 43, 136, -1, 1.7F, 0.0F, 1, 2, 17, 0.001F, false));
        grip9_r6.cubeList.add(new ModelBox(grip9_r6, 181, 130, 0.0F, 1, 2.0F, 3, 2, 13, 0.001F, false));
        ...
        grip6_r2.cubeList.add(new ModelBox(grip6_r2, 181, 172, -1, 0.0F, 0.0F, 3, 2, 35, 0.001F, false));
        ...
        grip3_r1.cubeList.add(new ModelBox(grip3_r1, 76, 39, -4.0F, -1, -3.0F, 4, 1, 3, -0.001F, false));
