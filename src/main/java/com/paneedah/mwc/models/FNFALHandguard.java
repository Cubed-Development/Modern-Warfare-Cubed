...
public class FNFALHandguard extends ModelWithAttachments {
	...
	public FNFALHandguard() {
		...
		action.cubeList.add(new ModelBox(action, 176, 16, 0.5347F, -37.6046F, -30.4436F, 1, 1, 15, 0.0F, false));
		action.cubeList.add(new ModelBox(action, 63, 75, 1.0347F, -37.6046F, -30.6436F, 1, 1, 1, 0.0F, false));
		action.cubeList.add(new ModelBox(action, 74, 14, 1.035F, -37.0046F, -30.6436F, 1, 1, 1, 0.0F, false));
		action.cubeList.add(new ModelBox(action, 176, 0, 0.535F, -37.0046F, -30.444F, 1, 1, 15, 0.0F, false));
