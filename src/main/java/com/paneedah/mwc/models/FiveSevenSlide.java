...
public class FiveSevenSlide extends ModelWithAttachments {
    ...
    public FiveSevenSlide() {
        ...
        slide.setRotationPoint(-4.1F, -11, 0.0F);
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 70, 26, -1, 0.0F, -1, 1, 2, 1, -0.001F, false));
        ...
        cube_r2.cubeList.add(new ModelBox(cube_r2, 67, 77, 0.0F, 0.0F, -1, 1, 1, 1, -0.002F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 70, 29, 0.0F, -1.5F, -1, 1, 2, 1, -0.001F, false));
        ...
        cube_r3.cubeList.add(new ModelBox(cube_r3, 69, 0, -1, -1.8F, -12.0F, 1, 1, 12, -0.002F, false));
        ...
        cube_r5.cubeList.add(new ModelBox(cube_r5, 16, 57, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r5.cubeList.add(new ModelBox(cube_r5, 78, 66, -5.93F, 1.4F, -1, 1, 1, 1, -0.3F, false));
        cube_r5.cubeList.add(new ModelBox(cube_r5, 73, 9, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r6.cubeList.add(new ModelBox(cube_r6, 63, 8, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r6.cubeList.add(new ModelBox(cube_r6, 73, 6, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r7.cubeList.add(new ModelBox(cube_r7, 63, 24, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r7.cubeList.add(new ModelBox(cube_r7, 14, 72, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 17, 65, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 8, 72, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r9.cubeList.add(new ModelBox(cube_r9, 69, 6, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 54, 71, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r10.cubeList.add(new ModelBox(cube_r10, 8, 69, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r10.cubeList.add(new ModelBox(cube_r10, 50, 71, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 69, 9, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 21, 71, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r12.cubeList.add(new ModelBox(cube_r12, 14, 69, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r12.cubeList.add(new ModelBox(cube_r12, 71, 18, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 18, 69, -1.01F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        cube_r13.cubeList.add(new ModelBox(cube_r13, 71, 15, -5.93F, 0.0F, -1, 1, 2, 1, -0.3F, false));
        ...
        cube_r15.cubeList.add(new ModelBox(cube_r15, 7, 77, -1.01F, 0.0F, -1, 1, 1, 1, -0.002F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 78, 71, -5.23F, 0.0F, -1.5F, 1, 1, 1, -0.003F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 78, 76, -5.23F, 0.0F, -1, 1, 1, 1, -0.002F, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 10, 57, -1, 0.0F, -1, 1, 2, 1, -0.001F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 76, 5, -5.2F, 1.5F, -1, 1, 1, 1, -0.002F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 17, 47, -5.2F, 0.0F, -1, 1, 2, 1, -0.001F, false));

        cube_r17 = new ModelRenderer(this);
        cube_r17.setRotationPoint(5.2F, -1.5F, 3.5F);
        slide.addChild(cube_r17);
        setRotationAngle(cube_r17, 0.0F, 0.0F, -0.7854F);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 48, 24, -1, -2.0F, -20.0F, 1, 2, 20, -0.001F, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 30, 76, -1, -1, -21.85F, 1, 1, 1, -0.001F, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 31, 55, -1, -2.0F, -21.25F, 1, 2, 2, 0.0F, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(5.2F, -1.5F, -19.25F);
        slide.addChild(cube_r18);
        setRotationAngle(cube_r18, -0.6458F, 0.0F, -0.7854F);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 50, 56, -1, -2.5F, 0.0F, 1, 2, 1, 0.001F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(5.2F, -0.5F, -19.25F);
        slide.addChild(cube_r19);
        setRotationAngle(cube_r19, 0.3316F, 0.0F, 0.0F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 76, 51, -1, 0.6F, 0.0F, 1, 1, 1, -0.003F, false));
        cube_r19.cubeList.add(new ModelBox(cube_r19, 76, 48, -1, 0.0F, 0.0F, 1, 1, 1, -0.002F, false));
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 36, 24, -1, 0.0F, -1, 1, 3, 1, 0.001F, false));
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 54, 15, -2.36F, 0.0F, -1, 2, 3, 1, 0.0F, false));
        ...
        cube_r25.cubeList.add(new ModelBox(cube_r25, 75, 77, 0.0F, -1, -21.85F, 1, 1, 1, -0.001F, false));
        ...
        cube_r26.cubeList.add(new ModelBox(cube_r26, 70, 26, 0.0F, -1, -11, 1, 1, 11, -0.001F, false));
        ...
        cube_r28.cubeList.add(new ModelBox(cube_r28, 17, 76, 0.0F, -1, -1, 1, 1, 1, -0.003F, false));
