...
public class ReflexScreen extends ModelBase implements CustomRenderer<RenderableState> {
    ...
    private final ModelRenderer reflexScreen;
    ...
    public ReflexScreen(Runnable pos, float radius, CyclicList<Reticle> reticles) {
        ...
        reflexScreen = new ModelRenderer(this);
        reflexScreen.setRotationPoint(0.0F, 24.0F, 0.0F);
        reflexScreen.cubeList.add(new ModelBox(reflexScreen, 0, 0, -3.0F, -2.0F, 0.0F, 5, 4, 0, 0.0F, false));
    }
