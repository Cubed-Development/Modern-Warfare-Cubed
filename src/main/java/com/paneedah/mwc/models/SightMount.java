...
public class SightMount extends ModelBase {
    ...
    public SightMount() {
        ...
        mount.cubeList.add(new ModelBox(mount, 0, 0, -1, -1, -4.0F, 8, 2, 14, 0.0F, false));
        mount.cubeList.add(new ModelBox(mount, 0, 0, -1, 4.0F, -4.0F, 8, 2, 14, 0.0F, false));
        mount.cubeList.add(new ModelBox(mount, 0, 0, 7.0F, 4.0F, -4.5F, 1, 3, 15, 0.0F, false));
        mount.cubeList.add(new ModelBox(mount, 0, 0, 0.0F, 1, -4.0F, 6, 3, 14, 0.0F, false));
        ...
        mount2.cubeList.add(new ModelBox(mount2, 0, 0, -1, -1, 0.0F, 1, 1, 15, 0.0F, false));
        ...
        mount3.setRotationPoint(7.0F, 1, -4.0F);
        mount.addChild(mount3);
        setRotationAngle(mount3, 0.0F, 0.0F, 0.7854F);
        mount3.cubeList.add(new ModelBox(mount3, 0, 0, -1, 0.0F, -0.01F, 1, 2, 14, 0.0F, false));
        ...
        mount4.cubeList.add(new ModelBox(mount4, 0, 0, -1, -3.0F, 0.0F, 1, 3, 3, 0.0F, false));
        mount4.cubeList.add(new ModelBox(mount4, 0, 0, -1, -7.221F, 6.4997F, 1, 3, 3, 0.0F, false));
    }
