...
public class SoldierSniper extends ModelBiped {
    ...
    public SoldierSniper() {
        ...
        body.cubeList.add(new ModelBox(body, 0, 26, -4, 0, -2, 8, 12, 4, 0.1F, false));
        body.cubeList.add(new ModelBox(body, 26, 10, -3.5F, 2, -3, 7, 7, 6, 0, false));
        body.cubeList.add(new ModelBox(body, 46, 27, -4, 9.25F, -2, 8, 1, 4, 0.3F, false));
        ...
        setRotation(body_r2, 0.1222F, 0.1222F, 0);
        body_r2.cubeList.add(new ModelBox(body_r2, 64, 45, -7, -2, 0, 7, 13, 0, 0, false));

        body_r3 = new ModelRenderer(this);
        body_r3.setRotationPoint(-3.5F, 2, -3);
        body.addChild(body_r3);
        setRotation(body_r3, -0.2443F, 0, 0);
        body_r3.cubeList.add(new ModelBox(body_r3, 34, 23, 0, -2, 0, 2, 2, 1, -0.01F, false));
        body_r3.cubeList.add(new ModelBox(body_r3, 40, 23, 5, -2, 0, 2, 2, 1, -0.01F, false));

        body_r4 = new ModelRenderer(this);
        body_r4.setRotationPoint(-0.2F, 9.1F, -4.3F);
        body.addChild(body_r4);
        setRotation(body_r4, 0.0658F, 0.2441F, -0.0218F);
        body_r4.cubeList.add(new ModelBox(body_r4, 64, 2, -4, -3, 0, 4, 3, 2, 0, false));

        body_r5 = new ModelRenderer(this);
        body_r5.setRotationPoint(4.4F, 9.5F, -3.9F);
        body.addChild(body_r5);
        setRotation(body_r5, -0.0524F, -0.2443F, 0);
        body_r5.cubeList.add(new ModelBox(body_r5, 32, 65, -3, -4, 0, 3, 4, 2, 0, false));

        leftarm = new ModelRenderer(this);
        leftarm.setRotationPoint(0, 0, 0);
        leftarm.cubeList.add(new ModelBox(leftarm, 48, 49, -1, -2, -2, 4, 12, 4, 0, false));
        leftarm.cubeList.add(new ModelBox(leftarm, 60, 8, -1, -2, -2, 4, 9, 4, 0.1F, false));
        ...
        rightarm.cubeList.add(new ModelBox(rightarm, 0, 45, -3, -2, -2, 4, 12, 4, 0, false));
        rightarm.cubeList.add(new ModelBox(rightarm, 55, 32, -3, -2, -2, 4, 9, 4, 0.1F, false));
        ...
        leftleg.cubeList.add(new ModelBox(leftleg, 32, 49, -2, 0, -2, 4, 12, 4, 0, false));
        ...
        setRotation(leftleg_r6, 0.1745F, -0.576F, 0);
