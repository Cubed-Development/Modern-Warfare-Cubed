...
public class K2C1Action extends ModelWithAttachments {
    ...
    public K2C1Action() {
        ...
        setRotationAngle(bulletejection_r1, 0, 0, -0.7854F);


        lever_r1 = new ModelRenderer(this);
        lever_r1.setRotationPoint(-3.9549F, -39.5237F, -19.0644F);
        Action.addChild(lever_r1);
        setRotationAngle(lever_r1, 0, 0, -0.7854F);


        lever = new ModelRenderer(this);
        lever.setRotationPoint(-3.9549F, -39.5237F, -19.0644F);
        Action.addChild(lever);
        setRotationAngle(lever, 0, 0, -0.7854F);
        lever.cubeList.add(new ModelBox(lever, 54, 48, -0.5F, -2.1464F, -0.25F, 1, 2, 1, 0, false));
        lever.cubeList.add(new ModelBox(lever, 54, 21, -0.5F, -2.1464F, -0.75F, 1, 2, 1, 0, false));
        lever.cubeList.add(new ModelBox(lever, 54, 8, -0.3839F, -1.9697F, -0.5F, 1, 2, 1, 0, false));
        lever.cubeList.add(new ModelBox(lever, 53, 36, -0.6768F, -1.9697F, -0.5F, 1, 2, 1, 0, false));
        lever.cubeList.add(new ModelBox(lever, 21, 72, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));
        ...
        setRotationAngle(bulletejection, 0, 0, -0.7854F);
        bulletejection.cubeList.add(new ModelBox(bulletejection, 60, 72, 0, 0, 0, 1, 1, 9, 0, false));
        ...
        bulletejection2.cubeList.add(new ModelBox(bulletejection2, 60, 25, 0, 0, -1, 1, 1, 10, 0, false));
    }
