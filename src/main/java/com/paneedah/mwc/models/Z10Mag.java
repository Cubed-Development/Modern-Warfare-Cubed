...
public class Z10Mag extends ModelWithAttachments {
    ...
    public Z10Mag() {
        ...
        mag.cubeList.add(new ModelBox(mag, 22, 66, -1.75F, -5.8028F, -2.4607F, 3, 5, 7, 0, false));
        ...
        setRotationAngle(gun48_r10_r1, 0, 0.2967F, 0);
        gun48_r10_r1.cubeList.add(new ModelBox(gun48_r10_r1, 14, 13, 0, -32, -20.45F, 1, 4, 2, -0.002F, false));

        gun49_r15_r1 = new ModelRenderer(this);
        gun49_r15_r1.setRotationPoint(-3.3313F, 26.1972F, 16.4167F);
        mag.addChild(gun49_r15_r1);
        setRotationAngle(gun49_r15_r1, 0, -0.2967F, 0);
        gun49_r15_r1.cubeList.add(new ModelBox(gun49_r15_r1, 0, 13, -4, -32, -20.45F, 1, 4, 2, -0.001F, false));
        ...
        gun50_r17_r1.cubeList.add(new ModelBox(gun50_r17_r1, 48, 48, -0.4F, -19.7055F, -19.8252F, 1, 2, 6, 0, false));
        ...
        gun51_r19_r1.cubeList.add(new ModelBox(gun51_r19_r1, 56, 0, -0.17F, -19.8055F, -21.2252F, 1, 2, 2, 0, false));
        ...
        gun52_r17_r1.cubeList.add(new ModelBox(gun52_r17_r1, 12, 37, -3.83F, -19.8055F, -21.2252F, 1, 2, 2, 0, false));
        ...
        gun51_r18_r1.cubeList.add(new ModelBox(gun51_r18_r1, 32, 38, -3.6F, -19.7055F, -19.8252F, 1, 2, 6, 0, false));

        gun50_r16_r1 = new ModelRenderer(this);
        gun50_r16_r1.setRotationPoint(1.5F, 27.6282F, 15.1006F);
        mag.addChild(gun50_r16_r1);
        setRotationAngle(gun50_r16_r1, -0.0873F, 0, 0);
        gun50_r16_r1.cubeList.add(new ModelBox(gun50_r16_r1, 12, 66, -3.5F, -23.4055F, -16.8252F, 4, 3, 4, 0, false));
        gun50_r16_r1.cubeList.add(new ModelBox(gun50_r16_r1, 33, 59, -3.5F, -23.4055F, -19.8252F, 4, 3, 2, 0, false));
        gun50_r16_r1.cubeList.add(new ModelBox(gun50_r16_r1, 0, 13, -3.5F, -20.4055F, -19.8252F, 4, 1, 6, 0, false));
        gun50_r16_r1.cubeList.add(new ModelBox(gun50_r16_r1, 65, 52, -3.5F, -20.4055F, -13.8252F, 4, 3, 1, 0, false));

        gun50_r15_r1 = new ModelRenderer(this);
        gun50_r15_r1.setRotationPoint(1.5F, 28.2986F, 14.4157F);
        mag.addChild(gun50_r15_r1);
        setRotationAngle(gun50_r15_r1, -0.1309F, 0, 0);
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 65, 75, -3.5F, -16.59F, -22.2172F, 4, 1, 2, 0, false));
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 65, 48, -3, -17.583F, -22.3172F, 3, 2, 2, 0, false));
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 78, 0, -3.5499F, -17.5823F, -20.3169F, 1, 2, 7, 0, false));
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 72, 5, -3.55F, -17.5823F, -13.8099F, 1, 2, 1, 0, false));
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 23, 7, -3.4501F, -17.5823F, -13.8172F, 4, 2, 1, 0.001F, false));
        gun50_r15_r1.cubeList.add(new ModelBox(gun50_r15_r1, 23, 12, -3.45F, -17.583F, -20.3172F, 4, 2, 7, 0, false));
        ...
        setRotationAngle(gun49_r14_r1, -0.0436F, 0, 0);
        ...
        setRotationAngle(gun47_r6_r1, -0.0873F, 0, 0);
        gun47_r6_r1.cubeList.add(new ModelBox(gun47_r6_r1, 48, 95, -2.5F, -23.4055F, -21.8002F, 2, 2, 1, 0, false));

        gun49_r13_r1 = new ModelRenderer(this);
        gun49_r13_r1.setRotationPoint(1.5F, 26.9174F, 15.9183F);
        mag.addChild(gun49_r13_r1);
        setRotationAngle(gun49_r13_r1, -0.0436F, 0, 0);
        gun49_r13_r1.cubeList.add(new ModelBox(gun49_r13_r1, 11, 77, -2.5F, -26.4491F, -21.5515F, 2, 3, 1, 0, false));

        gun51_r16_r1 = new ModelRenderer(this);
        gun51_r16_r1.setRotationPoint(1.5F, 26.9157F, 15.8399F);
        mag.addChild(gun51_r16_r1);
        setRotationAngle(gun51_r16_r1, -0.0436F, 0, 0);
        gun51_r16_r1.cubeList.add(new ModelBox(gun51_r16_r1, 24, 66, -2.85F, -28.2F, -21.5515F, 1, 2, 1, 0.001F, false));
        gun51_r16_r1.cubeList.add(new ModelBox(gun51_r16_r1, 35, 94, -2.15F, -28.2F, -21.5515F, 2, 2, 1, 0, false));

        gun52_r16_r1 = new ModelRenderer(this);
        gun52_r16_r1.setRotationPoint(1.5F, 27.9597F, 13.9378F);
        mag.addChild(gun52_r16_r1);
        setRotationAngle(gun52_r16_r1, -0.1134F, 0, 0);
        gun52_r16_r1.cubeList.add(new ModelBox(gun52_r16_r1, 12, 66, -2.85F, -21.4F, -21.3515F, 1, 2, 1, 0.001F, false));
        gun52_r16_r1.cubeList.add(new ModelBox(gun52_r16_r1, 15, 94, -2.5F, -19.4F, -21.3515F, 2, 2, 1, 0, false));
        gun52_r16_r1.cubeList.add(new ModelBox(gun52_r16_r1, 24, 94, -2.15F, -21.4F, -21.3515F, 2, 2, 1, 0, false));

        gun50_r13_r1 = new ModelRenderer(this);
        gun50_r13_r1.setRotationPoint(1.5F, 26.9171F, 15.8966F);
        mag.addChild(gun50_r13_r1);
        setRotationAngle(gun50_r13_r1, -0.0436F, 0, 0);
        gun50_r13_r1.cubeList.add(new ModelBox(gun50_r13_r1, 34, 54, -3.5F, -27.6986F, -19.5547F, 4, 2, 2, 0, false));
        gun50_r13_r1.cubeList.add(new ModelBox(gun50_r13_r1, 0, 37, -3.5F, -27.1986F, -16.5547F, 4, 2, 4, 0, false));

        gun52_r15_r1 = new ModelRenderer(this);
        gun52_r15_r1.setRotationPoint(1.5F, 26.9167F, 15.8791F);
        mag.addChild(gun52_r15_r1);
        setRotationAngle(gun52_r15_r1, -0.0436F, 0, 0);
        ...
        setRotationAngle(gun50_r12_r1, -0.1745F, 0, 0);
        gun50_r12_r1.cubeList.add(new ModelBox(gun50_r12_r1, 0, 94, -3.499F, -27.9472F, -19.6643F, 4, 1, 7, 0, false));
    }
