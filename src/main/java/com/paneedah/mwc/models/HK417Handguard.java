...
public class HK417Handguard extends ModelWithAttachments {
    ...
    public HK417Handguard() {
        ...
        handguard.setRotationPoint(0, -15.1F, -19.5F);
        handguard.cubeList.add(new ModelBox(handguard, 35, 89, -2.5F, -1, -36, 2, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 0, 88, -2.5F, 3.8F, -36.001F, 2, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 0, 120, -1.4F, 3.45F, -36, 1, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 75, 45, -0.4F, 2.4F, -16, 1, 2, 5, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 75, 18, -3.6F, 2.4F, -16, 1, 2, 5, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 103, 78, -1.401F, 3.15F, -36, 1, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 103, 110, -2.6F, 3.45F, -36, 1, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 70, 90, -2.601F, 3.15F, -36, 1, 1, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 54, 0, 0, 1.15F, -8, 1, 2, 3, 0, false));
        ...
        handguard.cubeList.add(new ModelBox(handguard, 9, 44, -3.9F, 1.15F, -8, 1, 2, 3, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 45, -1.3F, -0.7F, -36, 1, 2, 31, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 0, -2.7F, -0.7F, -36, 1, 2, 31, 0, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(1, 3.15F, -8);
        handguard.addChild(cube_r8);
        setRotationAngle(cube_r8, 0, 0, -0.5061F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 75, 77, -2, -1, 0, 2, 1, 3, 0, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(1, 1.15F, -8);
        handguard.addChild(cube_r9);
        setRotationAngle(cube_r9, 0, 0, 0.5061F);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 52, 83, -2, 0, 0, 2, 1, 3, 0, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(-3.9F, 3.15F, -8);
        handguard.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, 0, 0.5061F);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 76, 6, 0, -1, 0, 2, 1, 3, 0, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-3.9F, 1.15F, -8);
        handguard.addChild(cube_r11);
        setRotationAngle(cube_r11, 0, 0, -0.5061F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 21, 0, 0, 0, 2, 1, 3, 0, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(0.9F, 3.05F, -23.25F);
        handguard.addChild(cube_r12);
        setRotationAngle(cube_r12, 0, 0, 1.0647F);
        ...
        setRotationAngle(cube_r13, 0, 0, -1.0647F);
        ...
        cube_r14.setRotationPoint(-3.8F, 1.25F, -36);
        handguard.addChild(cube_r14);
        setRotationAngle(cube_r14, 0, 0, 1.0647F);
        ...
        cube_r15.setRotationPoint(0.9F, 1.25F, -18);
        handguard.addChild(cube_r15);
        setRotationAngle(cube_r15, 0, 0, -1.0647F);
        ...
        setRotationAngle(cube_r16, 0, 0, 1.0647F);
        ...
        cube_r17.setRotationPoint(-2.6F, 4.4F, -11);
        handguard.addChild(cube_r17);
        setRotationAngle(cube_r17, -0.9163F, 0, 0);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 56, 36, -0.999F, -2, -1, 1, 2, 1, 0, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 19, 56, 2.201F, -2, -1, 1, 2, 1, 0, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(-2.6F, 4.4F, -16);
        handguard.addChild(cube_r18);
        setRotationAngle(cube_r18, 0.9163F, 0, 0);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 45, 57, -0.999F, -2, 0, 1, 2, 1, 0, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 57, 57, 2.201F, -2, 0, 1, 2, 1, 0, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(-2.9F, 4.1F, -12);
        handguard.addChild(cube_r19);
        setRotationAngle(cube_r19, -0.3142F, 0, 0);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 69, 45, -1, -1, 0, 1, 1, 1, -0.2F, false));
        cube_r19.cubeList.add(new ModelBox(cube_r19, 69, 63, 2.8F, -1, 0, 1, 1, 1, -0.2F, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(-2.9F, 4.1F, -16.3F);
        handguard.addChild(cube_r20);
        setRotationAngle(cube_r20, -0.3142F, 0, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 9, 64, -1, -1, 0, 1, 1, 1, -0.2F, false));
        cube_r20.cubeList.add(new ModelBox(cube_r20, 39, 74, 2.8F, -1, 0, 1, 1, 1, -0.2F, false));
    }
