...
public class MakarovPBBody extends ModelBase {
	...
	public MakarovPBBody() {
		...
		pb_body.cubeList.add(new ModelBox(pb_body, 0, 76, -2.5F, -37.4F, -23.7F, 2, 1, 13, 0.0F, false));
		pb_body.cubeList.add(new ModelBox(pb_body, 38, 62, -2.5F, -33.6F, -23.7F, 2, 1, 13, 0.0F, false));
		pb_body.cubeList.add(new ModelBox(pb_body, 78, 78, -0.1F, -36.0F, -23.7F, 1, 2, 13, 0.0F, false));
		pb_body.cubeList.add(new ModelBox(pb_body, 77, 52, -3.9F, -36.0F, -23.7F, 1, 2, 13, 0.0F, false));
		...
		gun144_r3.cubeList.add(new ModelBox(gun144_r3, 32, 79, 0.0F, 0.0F, 0.0F, 1, 2, 13, 0.0F, false));
		...
		gun143_r5.cubeList.add(new ModelBox(gun143_r5, 60, 80, -1.0F, 0.0F, 0.0F, 1, 2, 13, 0.0F, false));
		...
		gun147_r1.cubeList.add(new ModelBox(gun147_r1, 63, 38, -2.0F, -1.0F, 0.0F, 2, 1, 13, 0.0F, false));
		...
		gun145_r2.cubeList.add(new ModelBox(gun145_r2, 17, 77, 0.0F, 0.0F, 0.0F, 1, 2, 13, 0.0F, false));
		...
		gun4.cubeList.add(new ModelBox(gun4, 52, 0, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		gun5 = new ModelRenderer(this);
		gun5.setRotationPoint(-3.5F, -20.0F, -4.0F);
		pb_body.addChild(gun5);
		gun5.cubeList.add(new ModelBox(gun5, 0, 90, 0.0F, 0.0F, 0.0F, 4, 2, 6, 0.0F, false));
		...
		gun7.cubeList.add(new ModelBox(gun7, 22, 65, 0.0F, 0.0F, 0.0F, 4, 2, 1, 0.0F, false));

		gun8 = new ModelRenderer(this);
		gun8.setRotationPoint(-3.5F, -30.5F, -7.0F);
		pb_body.addChild(gun8);
		gun8.cubeList.add(new ModelBox(gun8, 30, 42, 0.0F, 0.0F, 0.0F, 4, 5, 2, 0.0F, false));
		...
		gun9.cubeList.add(new ModelBox(gun9, 44, 50, 0.0F, 0.0F, 0.0F, 5, 2, 2, 0.0F, false));
		...
		gun10.cubeList.add(new ModelBox(gun10, 62, 23, 0.0F, 0.0F, 0.0F, 5, 2, 1, 0.0F, false));
		...
		gun11.cubeList.add(new ModelBox(gun11, 22, 7, 0.0F, 0.0F, 0.0F, 5, 2, 3, 0.0F, false));
		...
		gun16.cubeList.add(new ModelBox(gun16, 62, 0, 0.0F, 0.0F, 0.0F, 4, 5, 1, 0.0F, false));

		gun17 = new ModelRenderer(this);
		gun17.setRotationPoint(-3.5F, -33.2F, -22.5F);
		pb_body.addChild(gun17);
		gun17.cubeList.add(new ModelBox(gun17, 55, 38, 0.0F, 0.0F, 1.0F, 4, 1, 5, 0.0F, false));

		gun18 = new ModelRenderer(this);
		gun18.setRotationPoint(-0.2F, -31.8F, -8.0F);
		pb_body.addChild(gun18);
		gun18.cubeList.add(new ModelBox(gun18, 30, 30, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

		gun19 = new ModelRenderer(this);
		gun19.setRotationPoint(-0.35F, -34.0F, -8.0F);
		pb_body.addChild(gun19);
		gun19.cubeList.add(new ModelBox(gun19, 12, 0, 0.0F, 0.0F, 0.0F, 1, 3, 3, 0.0F, false));

		gun20 = new ModelRenderer(this);
		gun20.setRotationPoint(-4.0F, -30.5F, -3.2F);
		pb_body.addChild(gun20);
		gun20.cubeList.add(new ModelBox(gun20, 19, 53, 0.0F, 0.0F, 0.0F, 5, 1, 4, 0.0F, false));

		gun21 = new ModelRenderer(this);
		gun21.setRotationPoint(-3.5F, -33.0F, -15.5F);
		pb_body.addChild(gun21);
		gun21.cubeList.add(new ModelBox(gun21, 62, 20, 0.0F, 0.0F, 0.0F, 4, 1, 2, 0.0F, false));
		...
		gun22.cubeList.add(new ModelBox(gun22, 0, 49, 0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));
		...
		gun23.cubeList.add(new ModelBox(gun23, 22, 29, 0.0F, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));

		gun24 = new ModelRenderer(this);
		gun24.setRotationPoint(-2.3F, -36.8F, -9.7F);
		pb_body.addChild(gun24);
		gun24.cubeList.add(new ModelBox(gun24, 12, 29, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));
		...
		gun25.cubeList.add(new ModelBox(gun25, 12, 25, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

		gun26 = new ModelRenderer(this);
		gun26.setRotationPoint(-1.3F, -35.35F, -23.0F);
		pb_body.addChild(gun26);
		gun26.cubeList.add(new ModelBox(gun26, 43, 2, 0.0F, 0.0F, 0.0F, 1, 1, 17, 0.0F, false));
		...
		gun27.cubeList.add(new ModelBox(gun27, 12, 21, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

		gun28 = new ModelRenderer(this);
		gun28.setRotationPoint(-2.0F, -34.6F, -23.0F);
		pb_body.addChild(gun28);
		gun28.cubeList.add(new ModelBox(gun28, 0, 0, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

		gun29 = new ModelRenderer(this);
		gun29.setRotationPoint(-2.7F, -35.35F, -23.0F);
		pb_body.addChild(gun29);
		gun29.cubeList.add(new ModelBox(gun29, 0, 42, 0.0F, 0.0F, 0.0F, 1, 1, 17, 0.0F, false));

		gun30 = new ModelRenderer(this);
		gun30.setRotationPoint(-2.0F, -36.1F, -23.0F);
		pb_body.addChild(gun30);
		gun30.cubeList.add(new ModelBox(gun30, 25, 41, 0.0F, 0.0F, 0.0F, 1, 1, 17, 0.0F, false));

		gun31 = new ModelRenderer(this);
		gun31.setRotationPoint(-2.5F, -35.85F, -23.0F);
		pb_body.addChild(gun31);
		gun31.cubeList.add(new ModelBox(gun31, 22, 22, 0.0F, 0.0F, 0.0F, 2, 2, 17, 0.0F, false));
		...
		gun32.cubeList.add(new ModelBox(gun32, 44, 44, 0.0F, 0.0F, 1.0F, 1, 1, 5, 0.0F, false));
		...
		gun33.cubeList.add(new ModelBox(gun33, 7, 35, 0.0F, 0.0F, 1.0F, 1, 1, 5, 0.0F, false));

		gun34 = new ModelRenderer(this);
		gun34.setRotationPoint(-3.5F, -33.0F, -16.5F);
		pb_body.addChild(gun34);
		gun34.cubeList.add(new ModelBox(gun34, 63, 47, 0.0F, 0.0F, 0.0F, 4, 2, 1, 0.0F, false));

		gun35 = new ModelRenderer(this);
		gun35.setRotationPoint(-3.0F, -33.3F, -22.3F);
		pb_body.addChild(gun35);
		gun35.cubeList.add(new ModelBox(gun35, 22, 22, 0.0F, 0.0F, 1.0F, 3, 2, 5, 0.0F, false));
		...
		gun36.cubeList.add(new ModelBox(gun36, 14, 12, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));
		...
		gun37.cubeList.add(new ModelBox(gun37, 14, 14, 0.0F, 0.0F, 0.0F, 2, 3, 1, 0.0F, false));
		...
		gun38.cubeList.add(new ModelBox(gun38, 22, 36, 0.0F, 0.0F, 0.0F, 5, 1, 2, 0.0F, false));
		...
		gun39.cubeList.add(new ModelBox(gun39, 0, 0, 0.0F, 0.0F, 0.0F, 4, 17, 2, 0.0F, false));

		gun41 = new ModelRenderer(this);
		gun41.setRotationPoint(-4.0F, -19.6F, 2.2F);
		pb_body.addChild(gun41);
		gun41.cubeList.add(new ModelBox(gun41, 44, 41, 0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun42.cubeList.add(new ModelBox(gun42, 62, 0, 0.0F, 0.0F, 0.0F, 4, 3, 12, 0.0F, false));
		...
		gun43.cubeList.add(new ModelBox(gun43, 22, 0, 0.0F, 0.0F, 0.0F, 5, 5, 2, 0.0F, false));

		gun44 = new ModelRenderer(this);
		gun44.setRotationPoint(-4.0F, -20.5F, -3.3F);
		pb_body.addChild(gun44);
		gun44.cubeList.add(new ModelBox(gun44, 77, 67, 0.0F, 0.0F, 0.0F, 5, 2, 6, 0.0F, false));
		...
		gun45.cubeList.add(new ModelBox(gun45, 63, 52, 0.0F, 0.0F, 0.0F, 5, 2, 6, 0.0F, false));
		...
		gun46.cubeList.add(new ModelBox(gun46, 43, 12, 0.0F, 0.0F, 0.0F, 4, 2, 3, 0.0F, false));

		gun47 = new ModelRenderer(this);
		gun47.setRotationPoint(-3.5F, -32.5F, 0.5F);
		pb_body.addChild(gun47);
		gun47.cubeList.add(new ModelBox(gun47, 43, 32, 0.0F, 0.0F, 0.0F, 4, 1, 3, 0.0F, false));
		...
		gun48.cubeList.add(new ModelBox(gun48, 62, 15, 0.0F, 0.0F, 0.0F, 4, 1, 2, 0.0F, false));
		...
		gun49.cubeList.add(new ModelBox(gun49, 14, 37, 0.0F, 0.0F, 0.0F, 2, 2, 1, 0.0F, false));
		...
		gun50.cubeList.add(new ModelBox(gun50, 22, 60, 0.0F, 0.0F, 0.0F, 4, 3, 2, 0.0F, false));
		...
		gun51.cubeList.add(new ModelBox(gun51, 43, 0, 0.0F, 0.0F, 0.0F, 2, 1, 5, 0.0F, false));
		...
		gun52.cubeList.add(new ModelBox(gun52, 7, 49, 0.0F, 0.0F, 0.0F, 2, 1, 3, 0.0F, false));
		...
		gun53.cubeList.add(new ModelBox(gun53, 82, 15, 0.0F, 0.0F, 0.0F, 5, 11, 6, 0.0F, false));

		gun54 = new ModelRenderer(this);
		gun54.setRotationPoint(-3.5F, -35.0F, -13.5F);
		pb_body.addChild(gun54);
		gun54.cubeList.add(new ModelBox(gun54, 0, 60, 0.0F, 2.0F, 0.0F, 4, 2, 14, 0.0F, false));
		...
		gun55.cubeList.add(new ModelBox(gun55, 22, 22, 0.0F, 0.0F, 0.0F, 1, 4, 1, 0.0F, false));

		pbs_silencer = new ModelRenderer(this);
		pbs_silencer.setRotationPoint(0.0F, 24.0F, -13.0F);
		pbs_silencer.cubeList.add(new ModelBox(pbs_silencer, 24, 24, -2.5F, -37.4F, -30.7F, 2, 1, 20, 0.0F, false));
		pbs_silencer.cubeList.add(new ModelBox(pbs_silencer, 44, 47, -0.1F, -36.0F, -30.7F, 1, 2, 20, 0.0F, false));
		pbs_silencer.cubeList.add(new ModelBox(pbs_silencer, 0, 0, -2.5F, -33.6F, -30.7F, 2, 1, 20, 0.0F, false));
		pbs_silencer.cubeList.add(new ModelBox(pbs_silencer, 24, 1, -3.9F, -36.0F, -30.7F, 1, 2, 20, 0.0F, false));
		...
		gun145_r3.cubeList.add(new ModelBox(gun145_r3, 0, 42, 0.0F, 0.0F, -7.0F, 1, 2, 20, 0.0F, false));
		...
		gun146_r1.cubeList.add(new ModelBox(gun146_r1, 22, 45, 0.0F, 0.0F, -7.0F, 1, 2, 20, 0.0F, false));
		...
		gun148_r1.cubeList.add(new ModelBox(gun148_r1, 0, 21, -2.0F, -1.0F, -7.0F, 2, 1, 20, 0.0F, false));
		...
		gun144_r4.cubeList.add(new ModelBox(gun144_r4, 48, 3, -1.0F, 0.0F, -7.0F, 1, 2, 20, 0.0F, false));
	}
