...
public class MPXHandguard extends ModelWithAttachments {
    ...
    public MPXHandguard() {
        ...
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 40, 11, 1, -40.0F, -28.5F, 1, 3, 3, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 0, 24, -5.0F, -40.0F, -28.5F, 1, 3, 3, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 57, 74, 1, -40.0F, -46.5F, 1, 3, 1, 0.0F, false));
        ...
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 140, 18, 1, -40.0F, -45.5F, 1, 1, 17, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 100, 20, -5.0F, -40.0F, -45.5F, 1, 1, 17, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 140, 0, 1, -38.0F, -45.5F, 1, 1, 17, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 48, 120, -5.0F, -38.0F, -45.5F, 1, 1, 17, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 117, 42, 1, -39.0F, -43.0F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 52, 115, -5.0F, -39.0F, -43.0F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 23, 116, 1, -39.0F, -39.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 58, 115, -5.0F, -39.0F, -39.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 4, 116, 1, -39.0F, -36.0F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 115, 67, -5.0F, -39.0F, -36.0F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 0, 116, 1, -39.0F, -32.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 83, 115, -5.0F, -39.0F, -32.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard.cubeList.add(new ModelBox(mpx_handguard, 115, 113, 1, -39.0F, -29.0F, 1, 1, 1, 0.001F, false));
        ...
        mpx_handguard_left_r3.cubeList.add(new ModelBox(mpx_handguard_left_r3, 120, 12, -1.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        mpx_handguard_left_r3.cubeList.add(new ModelBox(mpx_handguard_left_r3, 110, 120, 4.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r5.cubeList.add(new ModelBox(mpx_handguard_left_r5, 120, 40, -1.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        mpx_handguard_left_r5.cubeList.add(new ModelBox(mpx_handguard_left_r5, 37, 121, 4.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r7.cubeList.add(new ModelBox(mpx_handguard_left_r7, 120, 9, -1.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        mpx_handguard_left_r7.cubeList.add(new ModelBox(mpx_handguard_left_r7, 98, 120, 4.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r9.cubeList.add(new ModelBox(mpx_handguard_left_r9, 21, 120, -1.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        mpx_handguard_left_r9.cubeList.add(new ModelBox(mpx_handguard_left_r9, 104, 120, 4.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r11.cubeList.add(new ModelBox(mpx_handguard_left_r11, 33, 120, -1.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        mpx_handguard_left_r11.cubeList.add(new ModelBox(mpx_handguard_left_r11, 58, 121, 4.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r12.cubeList.add(new ModelBox(mpx_handguard_left_r12, 99, 85, -3.0F, 0.0F, -1, 3, 2, 1, 0.0F, false));
        ...
        mpx_handguard_left_r13.cubeList.add(new ModelBox(mpx_handguard_left_r13, 36, 50, -3.001F, -4.0F, -1, 3, 4, 1, 0.0F, false));
        ...
        mpx_handguard_left_r14.cubeList.add(new ModelBox(mpx_handguard_left_r14, 30, 87, -1, 0.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        mpx_handguard_left_r15.cubeList.add(new ModelBox(mpx_handguard_left_r15, 82, 0, 0.0F, 0.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        mpx_handguard_left_r17.cubeList.add(new ModelBox(mpx_handguard_left_r17, 88, 74, -1, -2.0F, 0.0F, 1, 2, 1, 0.0F, false));
        ...
        mpx_handguard_left_r19.cubeList.add(new ModelBox(mpx_handguard_left_r19, 68, 0, -1, -3.0F, 0.0F, 1, 3, 1, 0.0F, false));
        ...
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 163, 72, 2.0F, -1, 15.0F, 1, 1, 13, 0.0F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 164, 122, 0.0F, -1, 15.0F, 1, 1, 13, 0.0F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 36, 55, 0.0F, -1, 14.0F, 3, 1, 1, 0.001F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 114, 98, 1, -1, 17.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 114, 105, 1, -1, 21, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 114, 111, 1, -1, 24.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r21.cubeList.add(new ModelBox(mpx_handguard_left_r21, 0, 50, 0.0F, -1, 28.0F, 3, 1, 7, 0.0F, false));
        ...
        mpx_handguard_left_r22.cubeList.add(new ModelBox(mpx_handguard_left_r22, 120, 3, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r23.cubeList.add(new ModelBox(mpx_handguard_left_r23, 6, 120, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r24.cubeList.add(new ModelBox(mpx_handguard_left_r24, 0, 120, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r25.cubeList.add(new ModelBox(mpx_handguard_left_r25, 120, 0, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r26.cubeList.add(new ModelBox(mpx_handguard_left_r26, 119, 29, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r27.cubeList.add(new ModelBox(mpx_handguard_left_r27, 119, 32, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r28.cubeList.add(new ModelBox(mpx_handguard_left_r28, 119, 23, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r29.cubeList.add(new ModelBox(mpx_handguard_left_r29, 119, 26, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 146, 90, -3.0F, -1, 15.0F, 1, 1, 13, 0.0F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 146, 104, -1, -1, 15.0F, 1, 1, 13, 0.0F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 64, 13, -3.0F, -1, 14.0F, 3, 1, 1, 0.001F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 114, 102, -2.0F, -1, 17.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 114, 108, -2.0F, -1, 21, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 112, 114, -2.0F, -1, 24.5F, 1, 1, 1, 0.0F, false));
        mpx_handguard_left_r30.cubeList.add(new ModelBox(mpx_handguard_left_r30, 23, 50, -3.0F, -1, 28.0F, 3, 1, 7, 0.0F, false));
        ...
        mpx_handguard_left_r31.cubeList.add(new ModelBox(mpx_handguard_left_r31, 85, 115, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r32.cubeList.add(new ModelBox(mpx_handguard_left_r32, 117, 90, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r33.cubeList.add(new ModelBox(mpx_handguard_left_r33, 104, 117, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r34.cubeList.add(new ModelBox(mpx_handguard_left_r34, 110, 117, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r35.cubeList.add(new ModelBox(mpx_handguard_left_r35, 79, 115, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r36.cubeList.add(new ModelBox(mpx_handguard_left_r36, 116, 39, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r37.cubeList.add(new ModelBox(mpx_handguard_left_r37, 98, 117, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        mpx_handguard_left_r38.cubeList.add(new ModelBox(mpx_handguard_left_r38, 119, 20, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));

        barrel = new ModelRenderer(this);
        barrel.setRotationPoint(-1, -40.0F, -51);
        mpx_handguard.addChild(barrel);
        barrel.cubeList.add(new ModelBox(barrel, 56, 86, -1, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 178, 40, -1.5F, 0.5F, 5.0F, 2, 2, 21, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 23, 86, -1, 2.0F, 0.0F, 1, 1, 5, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 65, 114, -2.0F, 1, 4.0F, 1, 1, 1, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 114, 3, -2.0F, 1, 0.0F, 1, 1, 1, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 31, 114, 0.0F, 1, 0.0F, 1, 1, 1, 0.0F, false));
        barrel.cubeList.add(new ModelBox(barrel, 114, 6, 0.0F, 1, 4.0F, 1, 1, 1, 0.0F, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(-1.7F, 1, -0.8F);
        barrel.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, 0.0F, 0.7854F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 221, 30, 0.0F, -1, 1, 1, 1, 5, 0.204F, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-1.7F, 2.0F, -0.8F);
        barrel.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, 0.7854F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 235, 39, 0.0F, -1, 1, 1, 1, 5, 0.203F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-0.7F, 2.0F, -0.8F);
        barrel.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.0F, 0.7854F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 235, 21, 0.0F, -1, 1, 1, 1, 5, 0.202F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-0.7F, 1, -0.8F);
        barrel.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.0F, 0.0F, 0.7854F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 236, 6, 0.0F, -1, 1, 1, 1, 5, 0.201F, false));
    }
