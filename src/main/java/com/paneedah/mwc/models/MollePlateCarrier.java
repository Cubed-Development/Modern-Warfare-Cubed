...
public class MollePlateCarrier extends ModelBiped {
    ...
    public MollePlateCarrier() {
        ...
        platecarrier.cubeList.add(new ModelBox(platecarrier, 16, 40, -3.5F, 1.75F, -2.77F, 7, 9, 1, 0, false));
        ...
        platecarrier.cubeList.add(new ModelBox(platecarrier, 36, 16, -3.5F, 1.75F, 1.38F, 7, 9, 1, 0, false));
        ...
        cube_r2.cubeList.add(new ModelBox(cube_r2, 24, 24, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(3.5F, 1.75F, -2.5F);
        platecarrier.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.192F, 0, -0.1571F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 24, 3, -2, -2, 0, 2, 2, 1, 0, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(3.3F, -0.15F, -2.7F);
        platecarrier.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.2094F, 0, 0.2094F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 0, -2, 0, 0, 2, 3, 1, -0.3F, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-3.3F, -0.15F, -2.7F);
        platecarrier.addChild(cube_r5);
        setRotationAngle(cube_r5, -0.2094F, 0, -0.2094F);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 4, 0, 0, 0, 2, 3, 1, -0.3F, false));

        cube_r6 = new ModelRenderer(this);
        cube_r6.setRotationPoint(-3.5F, 1.75F, -2.5F);
        platecarrier.addChild(cube_r6);
        setRotationAngle(cube_r6, -0.192F, 0, 0.1571F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 24, 21, 0, -2, 0, 2, 2, 1, 0, false));

        cube_r7 = new ModelRenderer(this);
        cube_r7.setRotationPoint(-3, 0.05F, 2.1F);
        platecarrier.addChild(cube_r7);
        setRotationAngle(cube_r7, 0.1396F, 0, -0.1222F);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 20, 16, 0, 0, -1, 2, 2, 1, 0, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(3, 0.05F, 2.1F);
        platecarrier.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.1396F, 0, 0.1222F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 24, 0, -2, 0, -1, 2, 2, 1, 0, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(3.2F, -0.25F, -1.9F);
        platecarrier.addChild(cube_r9);
        setRotationAngle(cube_r9, 0, -0.0698F, 0);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 24, 16, -2, 0, -0.05F, 2, 1, 4, 0, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(-3.2F, -0.25F, -1.9F);
        platecarrier.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, 0.0698F, 0);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 47, 26, 0, 0, -0.05F, 2, 1, 4, 0, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-3, 5.65F, 1.65F);
        platecarrier.addChild(cube_r11);
        setRotationAngle(cube_r11, 0.0175F, 0, 0);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 48, 0, 0, -0.02F, 6, 5, 1, 0, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-3, 5.45F, -3.1F);
        platecarrier.addChild(cube_r12);
        setRotationAngle(cube_r12, -0.0349F, 0, 0);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 48, 0, 0, -0.02F, 6, 5, 1, 0, false));
