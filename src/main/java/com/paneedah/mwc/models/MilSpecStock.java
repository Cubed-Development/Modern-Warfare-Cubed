...
public class MilSpecStock extends ModelBase {
    ...
    public MilSpecStock() {
        ...
        gun365.cubeList.add(new ModelBox(gun365, 10, 0, 0.0F, 0.0F, 0.0F, 1, 3, 4, 0.0F, false));

        gun366 = new ModelRenderer(this);
        gun366.setRotationPoint(-3.0F, -10.5F, 3.5F);
        gun366.cubeList.add(new ModelBox(gun366, 22, 24, 0.0F, 0.0F, 0.0F, 3, 1, 4, 0.0F, false));

        gun367 = new ModelRenderer(this);
        gun367.setRotationPoint(-2.0F, -11.7F, 8.0F);
        gun367.cubeList.add(new ModelBox(gun367, 0, 0, 0.0F, 0.0F, 0.0F, 1, 3, 20, 0.0F, false));

        gun368 = new ModelRenderer(this);
        gun368.setRotationPoint(-2.0F, -9.0F, 8.5F);
        gun368.cubeList.add(new ModelBox(gun368, 45, 63, 0.0F, 0.0F, 0.0F, 1, 1, 19, 0.0F, false));

        gun369 = new ModelRenderer(this);
        gun369.setRotationPoint(-3.2F, -10.5F, 7.5F);
        gun369.cubeList.add(new ModelBox(gun369, 34, 39, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));
        ...
        gun372.cubeList.add(new ModelBox(gun372, 44, 42, -0.001F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

        gun373 = new ModelRenderer(this);
        gun373.setRotationPoint(-3.2F, -10.5F, 7.5F);
        setRotationAngle(gun373, 0.0F, 0.0F, -0.7854F);
        gun373.cubeList.add(new ModelBox(gun373, 44, 21, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

        gun375 = new ModelRenderer(this);
        gun375.setRotationPoint(0.2F, -10.5F, 7.5F);
        setRotationAngle(gun375, 0.0F, 0.0F, 2.3562F);
        gun375.cubeList.add(new ModelBox(gun375, 44, 0, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

        gun376 = new ModelRenderer(this);
        gun376.setRotationPoint(0.2F, -9.5F, 7.5F);
        setRotationAngle(gun376, 0.0F, 0.0F, 2.0216F);
        gun376.cubeList.add(new ModelBox(gun376, 0, 44, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));

        gun378 = new ModelRenderer(this);
        gun378.setRotationPoint(-2.5F, -9.0F, 7.5F);
        gun378.cubeList.add(new ModelBox(gun378, 33, 0, 0.0F, 0.0F, 0.0F, 2, 1, 2, 0.0F, false));

        gun381 = new ModelRenderer(this);
        gun381.setRotationPoint(-3.3F, -10.9F, 27.5F);
        setRotationAngle(gun381, -0.0372F, 0.0F, 0.0F);
        gun381.cubeList.add(new ModelBox(gun381, 0, 23, 0.0F, 0.0F, 0.001F, 3, 13, 1, 0.0F, false));

        gun382 = new ModelRenderer(this);
        gun382.setRotationPoint(-0.7F, -10.9F, 27.5F);
        setRotationAngle(gun382, -0.0372F, 0.0F, 0.0F);
        gun382.cubeList.add(new ModelBox(gun382, 22, 29, 0.0F, 0.0F, 0.0F, 1, 13, 1, 0.0F, false));

        gun383 = new ModelRenderer(this);
        gun383.setRotationPoint(-2.5F, -11.8F, 27.6F);
        setRotationAngle(gun383, -0.0372F, 0.0F, 0.0F);
        gun383.cubeList.add(new ModelBox(gun383, 34, 36, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun384 = new ModelRenderer(this);
        gun384.setRotationPoint(-3.0F, -11.4F, 27.55F);
        setRotationAngle(gun384, -0.0372F, 0.0F, 0.0F);
        gun384.cubeList.add(new ModelBox(gun384, 11, 14, 0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F, false));

        gun385 = new ModelRenderer(this);
        gun385.setRotationPoint(-2.0F, -11.7F, 7.5F);
        gun385.cubeList.add(new ModelBox(gun385, 10, 0, 0.0F, -0.001F, 0.0F, 1, 3, 1, 0.0F, false));

        gun386 = new ModelRenderer(this);
        gun386.setRotationPoint(-2.0F, -7.3F, 10.5F);
        ...
        setRotationAngle(gun415, -0.0372F, 0.0F, 0.0F);


        gun417 = new ModelRenderer(this);
        gun417.setRotationPoint(-2.5F, -5.3F, 10.5F);
        setRotationAngle(gun417, 2.0076F, 0.0F, 0.0F);
        gun417.cubeList.add(new ModelBox(gun417, 26, 34, -0.001F, 0.0F, 0.0F, 2, 1, 4, 0.0F, false));

        gun418 = new ModelRenderer(this);
        gun418.setRotationPoint(-2.5F, -5.3F, 10.5F);
        setRotationAngle(gun418, 1.4128F, 0.0F, 0.0F);
        gun418.cubeList.add(new ModelBox(gun418, 0, 9, 0.0F, 0.0F, 0.0F, 2, 5, 1, 0.0F, false));

        gun419 = new ModelRenderer(this);
        gun419.setRotationPoint(-2.5F, -5.45F, 15.6F);
        setRotationAngle(gun419, -0.4461F, 0.0F, 0.0F);
        gun419.cubeList.add(new ModelBox(gun419, 66, 21, 0.0F, 0.0F, 0.0F, 2, 1, 11, 0.0F, false));

        gun420 = new ModelRenderer(this);
        gun420.setRotationPoint(-2.5F, -2.0F, 20.6F);
        setRotationAngle(gun420, 0.8179F, 0.0F, 0.0F);
        gun420.cubeList.add(new ModelBox(gun420, 36, 24, 0.001F, 0.0F, 0.0F, 2, 7, 1, 0.0F, false));

        gun421 = new ModelRenderer(this);
        gun421.setRotationPoint(-2.5F, -2.0F, 20.6F);
        setRotationAngle(gun421, 0.8179F, 0.0F, 0.0F);
        gun421.cubeList.add(new ModelBox(gun421, 14, 35, -0.001F, 6.3F, 0.001F, 2, 1, 1, 0.0F, false));

        gun422 = new ModelRenderer(this);
        gun422.setRotationPoint(-2.5F, -3.0F, 20.6F);
        setRotationAngle(gun422, -0.2974F, 0.0F, 0.0F);
        gun422.cubeList.add(new ModelBox(gun422, 0, 9, -0.001F, 0.0F, 0.5F, 2, 1, 7, 0.0F, false));

        gun423 = new ModelRenderer(this);
        gun423.setRotationPoint(-3.0F, -1.5F, 23.0F);
        setRotationAngle(gun423, -0.1487F, 0.0F, 0.0F);
        gun423.cubeList.add(new ModelBox(gun423, 22, 14, 0.001F, 0.0F, 0.0F, 3, 1, 5, 0.0F, false));

        gun424 = new ModelRenderer(this);
        gun424.setRotationPoint(-3.0F, -0.5F, 22.8F);
        setRotationAngle(gun424, 0.8179F, 0.0F, 0.0F);
        gun424.cubeList.add(new ModelBox(gun424, 11, 9, 0.0F, 0.0F, 0.0F, 3, 4, 1, 0.0F, false));

        gun425 = new ModelRenderer(this);
        gun425.setRotationPoint(-3.0F, 0.3F, 24.0F);
        setRotationAngle(gun425, 1.3013F, 0.0F, 0.0F);


        gun426 = new ModelRenderer(this);
        gun426.setRotationPoint(-2.0F, -5.3F, 15.9F);
        gun426.cubeList.add(new ModelBox(gun426, 19, 66, 0.0F, 0.0F, 0.0F, 1, 1, 12, 0.0F, false));

        gun427 = new ModelRenderer(this);
        gun427.setRotationPoint(-2.0F, -4.3F, 17.9F);
        gun427.cubeList.add(new ModelBox(gun427, 66, 42, 0.0F, 0.0F, 0.0F, 1, 1, 10, 0.0F, false));

        gun428 = new ModelRenderer(this);
        gun428.setRotationPoint(-2.0F, -3.3F, 19.9F);
        gun428.cubeList.add(new ModelBox(gun428, 0, 0, 0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F, false));

        gun429 = new ModelRenderer(this);
        gun429.setRotationPoint(-2.0F, -2.3F, 22.9F);
        gun429.cubeList.add(new ModelBox(gun429, 8, 23, 0.0F, 0.0F, 0.0F, 1, 2, 5, 0.0F, false));
        ...
        setRotationAngle(gun431, 0.0F, 0.0F, 2.7652F);
        gun431.cubeList.add(new ModelBox(gun431, 0, 23, 0.0F, 0.0F, 0.0F, 1, 1, 20, 0.0F, false));
        ...
        gun433.cubeList.add(new ModelBox(gun433, 34, 34, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun434 = new ModelRenderer(this);
        gun434.setRotationPoint(-1.8F, -10.5F, 15.5F);
        gun434.cubeList.add(new ModelBox(gun434, 33, 16, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun435 = new ModelRenderer(this);
        gun435.setRotationPoint(-1.8F, -10.5F, 19.5F);
        gun435.cubeList.add(new ModelBox(gun435, 33, 14, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun436 = new ModelRenderer(this);
        gun436.setRotationPoint(-1.8F, -10.5F, 23.5F);
        gun436.cubeList.add(new ModelBox(gun436, 8, 30, 0.0F, 0.0F, 0.0F, 2, 1, 4, 0.0F, false));

        gun437 = new ModelRenderer(this);
        gun437.setRotationPoint(-3.2F, -10.5F, 11.5F);
        gun437.cubeList.add(new ModelBox(gun437, 33, 10, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun438 = new ModelRenderer(this);
        gun438.setRotationPoint(-3.2F, -10.5F, 15.5F);
        gun438.cubeList.add(new ModelBox(gun438, 33, 3, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun439 = new ModelRenderer(this);
        gun439.setRotationPoint(-3.2F, -10.5F, 19.5F);
        gun439.cubeList.add(new ModelBox(gun439, 14, 17, 0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        gun440 = new ModelRenderer(this);
        gun440.setRotationPoint(-3.2F, -10.5F, 23.5F);
        gun440.cubeList.add(new ModelBox(gun440, 26, 29, 0.0F, 0.0F, 0.0F, 2, 1, 4, 0.0F, false));

        gun441 = new ModelRenderer(this);
        gun441.setRotationPoint(-3.0F, -10.5F, 8.5F);
        gun441.cubeList.add(new ModelBox(gun441, 66, 0, 0.0F, 0.0F, 0.0F, 3, 1, 15, 0.0F, false));

        gun442 = new ModelRenderer(this);
        gun442.setRotationPoint(-2.0F, -8.3F, 10.0F);
        gun442.cubeList.add(new ModelBox(gun442, 33, 66, -0.001F, 0.0F, 0.0F, 1, 1, 11, 0.0F, false));

        gun443 = new ModelRenderer(this);
        gun443.setRotationPoint(-2.0F, -8.3F, 26.0F);
        gun443.cubeList.add(new ModelBox(gun443, 33, 7, -0.001F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

        gun4433 = new ModelRenderer(this);
        gun4433.setRotationPoint(-2.5F, -9.3F, 12.5F);
        gun4433.cubeList.add(new ModelBox(gun4433, 0, 0, 0.0F, 0.0F, 0.0F, 2, 4, 2, 0.0F, false));

        gun444 = new ModelRenderer(this);
        gun444.setRotationPoint(-2.0F, -5.4F, 13.0F);
        gun444.cubeList.add(new ModelBox(gun444, 16, 0, 0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F, false));

        gun445 = new ModelRenderer(this);
        gun445.setRotationPoint(-3.0F, -6.6F, 11.3F);
        setRotationAngle(gun445, -0.0372F, 0.0F, 0.0F);
        gun445.cubeList.add(new ModelBox(gun445, 22, 7, 0.001F, 0.0F, 0.0F, 3, 2, 5, 0.0F, false));

        gun446 = new ModelRenderer(this);
        gun446.setRotationPoint(-3.0F, -6.4F, 16.3F);
        setRotationAngle(gun446, -0.8551F, 0.0F, 0.0F);
        gun446.cubeList.add(new ModelBox(gun446, 22, 0, 0.0F, 0.0F, 0.0F, 3, 2, 5, 0.0F, false));

        gun447 = new ModelRenderer(this);
        gun447.setRotationPoint(-3.0F, -2.6F, 18.6F);
        gun447.cubeList.add(new ModelBox(gun447, 0, 17, 0.001F, 0.0F, 0.0F, 3, 2, 1, 0.0F, false));
        ...
        gun449.cubeList.add(new ModelBox(gun449, 6, 35, -0.001F, 0.1F, -0.2F, 3, 3, 2, 0.0F, false));
    }
