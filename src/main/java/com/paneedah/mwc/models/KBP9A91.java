...
public class KBP9A91 extends ModelWithAttachments {
    ...
    public KBP9A91() {
        ...
        MainGUN.setRotationPoint(0, 24, 0);
        MainGUN.cubeList.add(new ModelBox(MainGUN, 123, 170, -2, -39.6F, -48.51F, 1, 1, 19, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 46, 6, -2, -39.6F, -43.21F, 1, 1, 5, 0.05F, false));
        ...
        MainGUN.cubeList.add(new ModelBox(MainGUN, 114, 31, -2.5F, -37.8F, -48.26F, 2, 2, 1, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 7, 0, -2, -36.85F, -50.51F, 1, 3, 2, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 101, 45, -3, -35.85F, -50.51F, 3, 1, 2, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 88, 77, -2, -39.6F, -48.41F, 1, 1, 2, 0.05F, false));
        ...
        MainGUN.cubeList.add(new ModelBox(MainGUN, 112, 144, -2, -38.2F, -48.51F, 1, 1, 19, 0, false));
        ...
        MainGUN.cubeList.add(new ModelBox(MainGUN, 0, 120, -0.7F, -37, -34.5F, 1, 1, 2, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 57, 45, -0.8F, -36.9F, -34.5F, 1, 1, 5, -0.001F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 0, 23, -2, -37.4F, -37.5F, 1, 1, 5, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 0, 7, -2, -36.4F, -37.5F, 1, 1, 5, 0.3F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 0, 99, -0.7F, -36.5F, -34.5F, 1, 1, 4, -0.001F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 21, 120, -0.7F, -37, -30.5F, 1, 1, 2, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 40, 54, -3.2F, -36.9F, -34.5F, 1, 1, 5, -0.001F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 118, 0, -3.3F, -37, -34.5F, 1, 1, 2, 0, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 107, 81, -3.3F, -36.5F, -33.5F, 1, 1, 3, -0.001F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 123, 104, -3.3F, -37, -30.5F, 1, 1, 1, 0, false));
        ...
        MainGUN.cubeList.add(new ModelBox(MainGUN, 79, 39, -2, -41, -48.1F, 1, 2, 1, -0.4F, false));
        ...
        MainGUN.cubeList.add(new ModelBox(MainGUN, 88, 96, -2, -40.4F, -48.6F, 1, 1, 2, -0.301F, false));
        MainGUN.cubeList.add(new ModelBox(MainGUN, 24, 110, -2, -40.1F, -48.1F, 1, 1, 1, -0.1F, false));
        ...
        gun94_r1.setRotationPoint(-0.8F, -40, -27.7F);
        MainGUN.addChild(gun94_r1);
        setRotationAngle(gun94_r1, -1.0297F, 0, 0);
        ...
        gun93_r1.setRotationPoint(-2.2F, -40, -27.7F);
        ...
        gun92_r1.setRotationPoint(-0.8F, -40, -27.7F);
        ...
        gun92_r2.setRotationPoint(-2.6F, -40, -27.5F);
        MainGUN.addChild(gun92_r2);
        setRotationAngle(gun92_r2, -0.8901F, 0, 0);
        ...
        setRotationAngle(gun94_r2, 0.2094F, 0, 0);
        ...
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 101, 113, -0.3F, -1, -0.5F, 1, 1, 1, -0.302F, false));
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 112, 108, -0.3F, -1, -0.3F, 1, 1, 1, -0.301F, false));
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 57, 120, 1.1F, -0.7F, -0.5F, 1, 1, 1, -0.301F, false));
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 42, 120, 1.1F, -1, -0.5F, 1, 1, 1, -0.302F, false));
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 120, 93, 1.1F, -1, -0.3F, 1, 1, 1, -0.301F, false));
        gun94_r2.cubeList.add(new ModelBox(gun94_r2, 120, 95, 1.1F, -0.7F, -0.3F, 1, 1, 1, -0.3F, false));

        gun93_r2 = new ModelRenderer(this);
        gun93_r2.setRotationPoint(-2, -39.7F, -48.3F);
        MainGUN.addChild(gun93_r2);
        setRotationAngle(gun93_r2, 0, 0, -2.0944F);
        ...
        gun93_r3.setRotationPoint(-1, -39.7F, -48.3F);
        MainGUN.addChild(gun93_r3);
        setRotationAngle(gun93_r3, 0, 0, 2.0944F);
        ...
        setRotationAngle(cube_r1, 0, -0.192F, 0);
        ...
        setRotationAngle(cube_r2, 0, 0.2618F, 0);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 107, 77, -0.2F, -0.8F, -2.8F, 1, 1, 3, -0.201F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-3.3F, -37, -34.5F);
        MainGUN.addChild(cube_r3);
        setRotationAngle(cube_r3, 0, 0, 0.3665F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 118, 3, 0, -1, 0, 1, 1, 2, 0.002F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 123, 96, 0, -1, 4, 1, 1, 1, 0.001F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-2.94F, -37.93F, -34.5F);
        MainGUN.addChild(cube_r4);
        setRotationAngle(cube_r4, 0, 0, 0.8901F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 117, 65, 0, -1, 0, 1, 1, 2, 0, false));
        cube_r4.cubeList.add(new ModelBox(cube_r4, 123, 94, 0, -1, 4, 1, 1, 1, 0, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-3.2F, -36.9F, -37.5F);
        MainGUN.addChild(cube_r5);
        setRotationAngle(cube_r5, 0, 0, 0.3665F);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 97, 91, 0, -1, 3, 1, 1, 4, 0.001F, false));

        cube_r6 = new ModelRenderer(this);
        cube_r6.setRotationPoint(-2.84F, -37.83F, -38.5F);
        MainGUN.addChild(cube_r6);
        setRotationAngle(cube_r6, 0, 0, 0.8901F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 54, 0, -1, 4, 1, 1, 5, 0, false));

        cube_r7 = new ModelRenderer(this);
        cube_r7.setRotationPoint(-3.2F, -35.9F, -37.5F);
        MainGUN.addChild(cube_r7);
        setRotationAngle(cube_r7, 0, 0, -0.3665F);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 94, 0, 0, 3, 1, 1, 4, 0.001F, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(0.2F, -35.9F, -37.5F);
        MainGUN.addChild(cube_r8);
        setRotationAngle(cube_r8, 0, 0, 0.3665F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 15, 94, -1, 0, 3, 1, 1, 4, 0.001F, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(0.2F, -36.9F, -37.5F);
        MainGUN.addChild(cube_r9);
        setRotationAngle(cube_r9, 0, 0, -0.3665F);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 97, 96, -1, -1, 3, 1, 1, 4, 0.001F, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(0.3F, -37, -34.5F);
        MainGUN.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, 0, -0.3665F);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 6, 120, -1, -1, 0, 1, 1, 2, 0.002F, false));
        cube_r10.cubeList.add(new ModelBox(cube_r10, 15, 120, -1, -1, 4, 1, 1, 2, 0.001F, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-0.06F, -37.93F, -30.5F);
        MainGUN.addChild(cube_r11);
        setRotationAngle(cube_r11, 0, 0, -0.8901F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 118, 24, -1, -1, 0, 1, 1, 2, 0, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 120, 31, -1, -1, -4, 1, 1, 2, 0, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-0.16F, -37.83F, -38.5F);
        MainGUN.addChild(cube_r12);
        setRotationAngle(cube_r12, 0, 0, -0.8901F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 57, 39, -1, -1, 4, 1, 1, 5, 0, false));

        gun343_r1 = new ModelRenderer(this);
        gun343_r1.setRotationPoint(-2, -37.2F, -48.51F);
        MainGUN.addChild(gun343_r1);
        setRotationAngle(gun343_r1, 0, 0, 0.7854F);
        gun343_r1.cubeList.add(new ModelBox(gun343_r1, 76, 113, -1, -1, 0, 1, 1, 19, -0.001F, false));

        gun342_r1 = new ModelRenderer(this);
        gun342_r1.setRotationPoint(-1, -37.2F, -48.51F);
        MainGUN.addChild(gun342_r1);
        setRotationAngle(gun342_r1, 0, 0, 0.7854F);
        gun342_r1.cubeList.add(new ModelBox(gun342_r1, 38, 80, -1, -1, 0, 1, 1, 19, -0.001F, false));

        gun342_r2 = new ModelRenderer(this);
        gun342_r2.setRotationPoint(-2, -39.6F, -48.51F);
        MainGUN.addChild(gun342_r2);
        setRotationAngle(gun342_r2, 0, 0, -0.7854F);
        gun342_r2.cubeList.add(new ModelBox(gun342_r2, 152, 103, -1, 0, 0, 1, 1, 19, -0.001F, false));

        gun343_r2 = new ModelRenderer(this);
        gun343_r2.setRotationPoint(-1, -39.6F, -53.41F);
        MainGUN.addChild(gun343_r2);
        setRotationAngle(gun343_r2, 0, 0, -0.7854F);
        gun343_r2.cubeList.add(new ModelBox(gun343_r2, 6, 94, -1, 0, 5, 1, 1, 2, 0.052F, false));
        gun343_r2.cubeList.add(new ModelBox(gun343_r2, 46, 0, -1, 0, 10.2F, 1, 1, 5, 0.052F, false));
        gun343_r2.cubeList.add(new ModelBox(gun343_r2, 156, 139, -1, 0, 4.9F, 1, 1, 19, -0.001F, false));

        gun344_r1 = new ModelRenderer(this);
        gun344_r1.setRotationPoint(-2, -39.6F, -53.41F);
        MainGUN.addChild(gun344_r1);
        setRotationAngle(gun344_r1, 0, 0, -0.7854F);
        gun344_r1.cubeList.add(new ModelBox(gun344_r1, 7, 89, -1, 0, 5, 1, 1, 2, 0.051F, false));
        gun344_r1.cubeList.add(new ModelBox(gun344_r1, 40, 45, -1, 0, 10.2F, 1, 1, 5, 0.051F, false));

        gun342_r3 = new ModelRenderer(this);
        gun342_r3.setRotationPoint(-1, -39.4F, -48.31F);
        MainGUN.addChild(gun342_r3);
        setRotationAngle(gun342_r3, 0.1745F, 0, 0);
        gun342_r3.cubeList.add(new ModelBox(gun342_r3, 79, 44, -1, 0.2F, -2.2F, 1, 2, 1, -0.301F, false));

        gun342_r4 = new ModelRenderer(this);
        gun342_r4.setRotationPoint(-1, -39.2F, -48.31F);
        MainGUN.addChild(gun342_r4);
        setRotationAngle(gun342_r4, 0.1745F, 0, 0);
        gun342_r4.cubeList.add(new ModelBox(gun342_r4, 104, 52, -1, 1.4F, -2.1F, 1, 1, 3, -0.3F, false));
        gun342_r4.cubeList.add(new ModelBox(gun342_r4, 55, 104, -1, 0, -2.1F, 1, 1, 3, -0.3F, false));

        gun343_r3 = new ModelRenderer(this);
        gun343_r3.setRotationPoint(-1, -33.85F, -50.51F);
        MainGUN.addChild(gun343_r3);
        setRotationAngle(gun343_r3, 0, 0, -0.7854F);
        gun343_r3.cubeList.add(new ModelBox(gun343_r3, 22, 116, 0.2F, -1.2F, 0.2F, 1, 1, 2, 0.201F, false));

        gun344_r2 = new ModelRenderer(this);
        gun344_r2.setRotationPoint(-2, -33.85F, -50.51F);
        MainGUN.addChild(gun344_r2);
        setRotationAngle(gun344_r2, 0, 0, -0.7854F);
        gun344_r2.cubeList.add(new ModelBox(gun344_r2, 7, 116, 0.2F, -1.2F, 0.2F, 1, 1, 2, 0.201F, false));

        gun343_r4 = new ModelRenderer(this);
        gun343_r4.setRotationPoint(-2, -36.85F, -50.51F);
        MainGUN.addChild(gun343_r4);
        setRotationAngle(gun343_r4, 0, 0, 0.7854F);
        gun343_r4.cubeList.add(new ModelBox(gun343_r4, 45, 116, 0.2F, 0.2F, 0.2F, 1, 1, 2, 0.201F, false));

        gun342_r5 = new ModelRenderer(this);
        gun342_r5.setRotationPoint(-1, -36.85F, -50.51F);
        MainGUN.addChild(gun342_r5);
        setRotationAngle(gun342_r5, 0, 0, 0.7854F);
        ...
        MainGunBARREL.setRotationPoint(0, -0.2F, 0);
        MainGUN.addChild(MainGunBARREL);


        gun285 = new ModelRenderer(this);
        gun285.setRotationPoint(-1.7F, -35.7F, -55);
        MainGunBARREL.addChild(gun285);
        gun285.cubeList.add(new ModelBox(gun285, 167, 123, 0, 0, 0, 1, 1, 10, 0, false));

        gun287 = new ModelRenderer(this);
        gun287.setRotationPoint(-2, -36, -55);
        MainGunBARREL.addChild(gun287);
        gun287.cubeList.add(new ModelBox(gun287, 74, 162, 0, 0, -0.01F, 1, 1, 10, 0, false));

        gun286 = new ModelRenderer(this);
        gun286.setRotationPoint(-1.8F, -35.9F, -55);
        MainGunBARREL.addChild(gun286);
        gun286.cubeList.add(new ModelBox(gun286, 86, 163, 0, 0, 0.01F, 1, 1, 10, 0, false));

        gun284 = new ModelRenderer(this);
        gun284.setRotationPoint(-2.3F, -35.7F, -55);
        MainGunBARREL.addChild(gun284);
        gun284.cubeList.add(new ModelBox(gun284, 175, 0, 0, 0, 0, 1, 1, 10, 0, false));

        gun283 = new ModelRenderer(this);
        gun283.setRotationPoint(-2.2F, -35.5F, -55);
        MainGunBARREL.addChild(gun283);
        gun283.cubeList.add(new ModelBox(gun283, 175, 11, 0, 0, -0.02F, 1, 1, 10, 0, false));

        gun281 = new ModelRenderer(this);
        gun281.setRotationPoint(-2, -35.4F, -55);
        MainGunBARREL.addChild(gun281);
        gun281.cubeList.add(new ModelBox(gun281, 111, 175, 0, 0, 0.01F, 1, 1, 10, 0, false));

        gun282 = new ModelRenderer(this);
        gun282.setRotationPoint(-1.8F, -35.5F, -55);
        MainGunBARREL.addChild(gun282);
        gun282.cubeList.add(new ModelBox(gun282, 89, 175, 0, 0, -0.03F, 1, 1, 10, 0, false));

        gun288 = new ModelRenderer(this);
        gun288.setRotationPoint(-2.2F, -35.9F, -55);
        MainGunBARREL.addChild(gun288);
        gun288.cubeList.add(new ModelBox(gun288, 88, 149, 0, 0, 0.01F, 1, 1, 10, 0, false));

        gun129HAMMER = new ModelRenderer(this);
        gun129HAMMER.setRotationPoint(-2, -38.2F, 1);
        MainGUN.addChild(gun129HAMMER);
        gun129HAMMER.cubeList.add(new ModelBox(gun129HAMMER, 120, 81, 0, 0, 0, 1, 1, 2, 0, false));
        gun129HAMMER.cubeList.add(new ModelBox(gun129HAMMER, 88, 72, 0, -0.3F, 0.2F, 1, 1, 2, -0.201F, false));
        gun129HAMMER.cubeList.add(new ModelBox(gun129HAMMER, 21, 87, 0, 0.3F, 0.2F, 1, 1, 2, -0.201F, false));
        gun129HAMMER.cubeList.add(new ModelBox(gun129HAMMER, 73, 25, -0.3F, 0, 0.2F, 1, 1, 2, -0.201F, false));
        gun129HAMMER.cubeList.add(new ModelBox(gun129HAMMER, 73, 3, 0.3F, 0, 0.2F, 1, 1, 2, -0.201F, false));

        gun113trigger = new ModelRenderer(this);
        gun113trigger.setRotationPoint(-2, -29, -9.7F);
        MainGUN.addChild(gun113trigger);
        setRotationAngle(gun113trigger, -2.6397F, 0, 0);
        gun113trigger.cubeList.add(new ModelBox(gun113trigger, 23, 125, 0, 0, 0, 1, 1, 1, 0, false));

        gun112TRIGGER = new ModelRenderer(this);
        gun112TRIGGER.setRotationPoint(-2, -29.7F, -9.1F);
        MainGUN.addChild(gun112TRIGGER);
        setRotationAngle(gun112TRIGGER, -2.3051F, 0, 0);
        gun112TRIGGER.cubeList.add(new ModelBox(gun112TRIGGER, 125, 25, 0, 0, 0, 1, 1, 1, 0.001F, false));

        gun111TRIGGER = new ModelRenderer(this);
        gun111TRIGGER.setRotationPoint(-2, -32.8F, -9);
        MainGUN.addChild(gun111TRIGGER);
        setRotationAngle(gun111TRIGGER, -0.3718F, 0, 0);
        gun111TRIGGER.cubeList.add(new ModelBox(gun111TRIGGER, 27, 45, 0, 0, 0, 1, 3, 1, 0, false));

        gun110TRIGGER = new ModelRenderer(this);
        gun110TRIGGER.setRotationPoint(-2, -32.2F, -10.5F);
        MainGUN.addChild(gun110TRIGGER);
        setRotationAngle(gun110TRIGGER, 0.4461F, 0, 0);
        gun110TRIGGER.cubeList.add(new ModelBox(gun110TRIGGER, 15, 87, 0, 0, 0, 1, 2, 1, 0.001F, false));

        gun392 = new ModelRenderer(this);
        gun392.setRotationPoint(-3.5F, -34, -20.5F);
        MainGUN.addChild(gun392);
        gun392.cubeList.add(new ModelBox(gun392, 124, 66, 0, 0, 0, 1, 1, 1, 0, false));

        gun391 = new ModelRenderer(this);
        gun391.setRotationPoint(-3.7F, -34, -34.5F);
        MainGUN.addChild(gun391);
        gun391.cubeList.add(new ModelBox(gun391, 46, 15, 0, 0, 0, 1, 1, 14, 0, false));

        gun390 = new ModelRenderer(this);
        gun390.setRotationPoint(-3.7F, -34, -19.5F);
        MainGUN.addChild(gun390);
        gun390.cubeList.add(new ModelBox(gun390, 54, 100, 0, 0, 0, 1, 1, 10, 0, false));

        gun389 = new ModelRenderer(this);
        gun389.setRotationPoint(-4, -33, -7.5F);
        MainGUN.addChild(gun389);
        setRotationAngle(gun389, 0, 0, -0.7854F);
        gun389.cubeList.add(new ModelBox(gun389, 68, 124, 0, 0, 0, 1, 1, 1, 0, false));

        gun388 = new ModelRenderer(this);
        gun388.setRotationPoint(-4, -34, -7.5F);
        MainGUN.addChild(gun388);
        setRotationAngle(gun388, 0, 0, -0.7854F);
        gun388.cubeList.add(new ModelBox(gun388, 124, 72, 0, 0, 0, 1, 1, 1, 0, false));

        gun387 = new ModelRenderer(this);
        gun387.setRotationPoint(-4.2F, -34, -6.5F);
        MainGUN.addChild(gun387);
        setRotationAngle(gun387, 0, 0, -0.7854F);
        gun387.cubeList.add(new ModelBox(gun387, 124, 75, 0, 0, 0, 1, 1, 1, 0, false));

        gun386 = new ModelRenderer(this);
        gun386.setRotationPoint(-4.2F, -33, -6.5F);
        MainGUN.addChild(gun386);
        setRotationAngle(gun386, 0, 0, -0.7854F);
        gun386.cubeList.add(new ModelBox(gun386, 124, 78, 0, 0, 0, 1, 1, 1, 0, false));

        gun385 = new ModelRenderer(this);
        gun385.setRotationPoint(-4.2F, -33, -9.5F);
        MainGUN.addChild(gun385);
        setRotationAngle(gun385, 0, 0, -0.7854F);
        gun385.cubeList.add(new ModelBox(gun385, 65, 120, 0, 0, 0, 1, 1, 2, 0, false));

        gun384 = new ModelRenderer(this);
        gun384.setRotationPoint(-4.2F, -34, -9.5F);
        MainGUN.addChild(gun384);
        setRotationAngle(gun384, 0, 0, -0.7854F);
        gun384.cubeList.add(new ModelBox(gun384, 120, 72, 0, 0, 0, 1, 1, 2, 0, false));

        gun383 = new ModelRenderer(this);
        gun383.setRotationPoint(-4.2F, -34, -9.5F);
        MainGUN.addChild(gun383);
        gun383.cubeList.add(new ModelBox(gun383, 15, 99, 0, 0, 0, 1, 1, 4, -0.001F, false));
        gun383.cubeList.add(new ModelBox(gun383, 19, 123, 0.2F, 0, 4.5F, 1, 1, 1, -0.3F, false));
        gun383.cubeList.add(new ModelBox(gun383, 15, 123, 0.199F, 0, -3.1F, 1, 1, 1, -0.3F, false));
        gun383.cubeList.add(new ModelBox(gun383, 8, 123, 0.199F, 0, -3.85F, 1, 1, 1, -0.3F, false));
        gun383.cubeList.add(new ModelBox(gun383, 4, 123, 0.199F, 0, -4.6F, 1, 1, 1, -0.3F, false));

        gun376 = new ModelRenderer(this);
        gun376.setRotationPoint(-3, -37, 1.7F);
        MainGUN.addChild(gun376);
        setRotationAngle(gun376, -0.2231F, 0, 0);
        gun376.cubeList.add(new ModelBox(gun376, 0, 39, 0, 0, 0, 3, 4, 3, 0, false));

        gun375 = new ModelRenderer(this);
        gun375.setRotationPoint(-3, -32.4F, -14);
        MainGUN.addChild(gun375);
        gun375.cubeList.add(new ModelBox(gun375, 15, 30, 0, 0, 0, 3, 1, 6, 0, false));

        gun370 = new ModelRenderer(this);
        gun370.setRotationPoint(1.1F, -35.5F, -34.2F);
        MainGUN.addChild(gun370);
        setRotationAngle(gun370, 0, 0, 2.9371F);
        gun370.cubeList.add(new ModelBox(gun370, 120, 124, 0, 0, 0, 1, 1, 1, 0, false));

        gun369 = new ModelRenderer(this);
        gun369.setRotationPoint(0, -35.1F, -34.2F);
        MainGUN.addChild(gun369);
        gun369.cubeList.add(new ModelBox(gun369, 0, 125, 0, 0, 0, 1, 1, 1, 0, false));

        gun357 = new ModelRenderer(this);
        gun357.setRotationPoint(-0.5F, -37.3F, 5);
        MainGUN.addChild(gun357);
        gun357.cubeList.add(new ModelBox(gun357, 34, 12, -0.001F, 0.801F, 0, 1, 4, 1, -0.001F, false));
        gun357.cubeList.add(new ModelBox(gun357, 0, 123, -0.01F, 0.01F, -0.75F, 1, 1, 1, 0, false));
        gun357.cubeList.add(new ModelBox(gun357, 121, 62, -2.99F, 0.01F, -0.75F, 1, 1, 1, 0, false));
        gun357.cubeList.add(new ModelBox(gun357, 33, 29, -2.999F, 0.801F, 0, 1, 4, 1, -0.001F, false));

        gun361_r1 = new ModelRenderer(this);
        gun361_r1.setRotationPoint(-2.99F, 0.01F, -0.75F);
        gun357.addChild(gun361_r1);
        setRotationAngle(gun361_r1, -0.7854F, 0, 0);
        gun361_r1.cubeList.add(new ModelBox(gun361_r1, 121, 65, -0.009F, 0.1F, 0, 1, 1, 1, -0.001F, false));
        gun361_r1.cubeList.add(new ModelBox(gun361_r1, 121, 59, -0.009F, 0, 0, 1, 1, 1, 0, false));
        gun361_r1.cubeList.add(new ModelBox(gun361_r1, 122, 38, 2.989F, 0.1F, 0, 1, 1, 1, -0.001F, false));
        gun361_r1.cubeList.add(new ModelBox(gun361_r1, 120, 122, 2.989F, 0, 0, 1, 1, 1, 0, false));

        gun361_r2 = new ModelRenderer(this);
        gun361_r2.setRotationPoint(-2.99F, 0.01F, 0.25F);
        gun357.addChild(gun361_r2);
        setRotationAngle(gun361_r2, 0.7854F, 0, 0);
        gun361_r2.cubeList.add(new ModelBox(gun361_r2, 121, 56, -0.009F, 0, -1, 1, 1, 1, 0, false));
        gun361_r2.cubeList.add(new ModelBox(gun361_r2, 121, 53, -0.009F, 0.1F, -1, 1, 1, 1, -0.002F, false));
        gun361_r2.cubeList.add(new ModelBox(gun361_r2, 122, 24, 2.989F, 0, -1, 1, 1, 1, 0, false));
        gun361_r2.cubeList.add(new ModelBox(gun361_r2, 121, 68, 2.989F, 0.1F, -1, 1, 1, 1, -0.002F, false));

        gun356 = new ModelRenderer(this);
        gun356.setRotationPoint(-3.5F, -37.3F, 5);
        ...
        gun355.cubeList.add(new ModelBox(gun355, 21, 16, 0, 0.8F, 0, 1, 4, 2, 0.001F, false));
        gun355.cubeList.add(new ModelBox(gun355, 21, 0, -3, 0.8F, 0, 1, 4, 2, 0.001F, false));
        ...
        gun353.setRotationPoint(-3.5F, -33.3F, 3);
        MainGUN.addChild(gun353);
        gun353.cubeList.add(new ModelBox(gun353, 46, 30, 0, 0, 0, 4, 1, 3, 0, false));

        gun339 = new ModelRenderer(this);
        gun339.setRotationPoint(-3.8F, -34, -30.5F);
        MainGUN.addChild(gun339);
        gun339.cubeList.add(new ModelBox(gun339, 4, 125, 0, 0, 0, 1, 1, 1, 0, false));

        gun338 = new ModelRenderer(this);
        gun338.setRotationPoint(-3.8F, -34.5F, -34);
        MainGUN.addChild(gun338);
        gun338.cubeList.add(new ModelBox(gun338, 8, 125, 0, 0, 0, 1, 1, 1, 0, false));

        gun337 = new ModelRenderer(this);
        gun337.setRotationPoint(0.4F, -33.8F, -33);
        MainGUN.addChild(gun337);


        gun336 = new ModelRenderer(this);
        gun336.setRotationPoint(0.4F, -35.5F, -33);
        ...
        gun335.setRotationPoint(0, -34.5F, -33);
        MainGUN.addChild(gun335);
        gun335.cubeList.add(new ModelBox(gun335, 120, 72, -0.2F, 0.8F, 0, 1, 1, 30, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 79, 64, -0.2F, -1.2F, 0, 1, 2, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 57, 123, -0.2F, 0, 1, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 53, 123, -0.2F, -1, 3, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 123, 49, -0.2F, -1.3F, 7, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 123, 45, -0.201F, -1.5F, 19, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 42, 123, -0.201F, 0.5F, 19, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 46, 123, -0.201F, 0.7F, 7, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 23, 123, -0.2F, -1.3F, 28, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 38, 123, -0.201F, 0.7F, 28, 1, 1, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 79, 55, -0.2F, -1.2F, 2, 1, 2, 1, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 59, 80, -0.2F, -1.2F, 4, 1, 2, 3, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 167, 87, -0.2F, -1.2F, 8, 1, 2, 11, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 62, 15, -0.2F, -1.2F, 20, 1, 2, 8, 0, false));
        gun335.cubeList.add(new ModelBox(gun335, 79, 50, -0.2F, -1.2F, 29, 1, 2, 1, 0, false));

        gun314 = new ModelRenderer(this);
        gun314.setRotationPoint(-3.7F, -36, -34.5F);
        MainGUN.addChild(gun314);
        gun314.cubeList.add(new ModelBox(gun314, 57, 54, 0, 0, 0.01F, 1, 1, 5, 0, false));

        gun312 = new ModelRenderer(this);
        gun312.setRotationPoint(-2, -38.5F, -34.5F);
        MainGUN.addChild(gun312);
        gun312.cubeList.add(new ModelBox(gun312, 120, 75, 0, 0, 0, 1, 1, 2, 0, false));

        gun311 = new ModelRenderer(this);
        gun311.setRotationPoint(-3.5F, -29, -20);
        MainGUN.addChild(gun311);
        gun311.cubeList.add(new ModelBox(gun311, 46, 36, 0, 0, 0, 4, 1, 1, -0.002F, false));

        gun310 = new ModelRenderer(this);
        gun310.setRotationPoint(-3.5F, -29.5F, -20.9F);
        MainGUN.addChild(gun310);
        gun310.cubeList.add(new ModelBox(gun310, 79, 60, 0, 0, 0, 4, 1, 2, 0.001F, false));

        gun309 = new ModelRenderer(this);
        gun309.setRotationPoint(-0.7F, -30, -29);
        MainGUN.addChild(gun309);
        setRotationAngle(gun309, 1.4573F, 0, 0);
        gun309.cubeList.add(new ModelBox(gun309, 31, 16, 0.01F, 0, 0, 1, 5, 1, 0, false));

        gun308 = new ModelRenderer(this);
        gun308.setRotationPoint(-3.3F, -30, -29);
        MainGUN.addChild(gun308);
        setRotationAngle(gun308, 1.4573F, 0, 0);
        gun308.cubeList.add(new ModelBox(gun308, 38, 80, 0, -0.01F, 0, 3, 5, 1, -0.001F, false));

        gun307 = new ModelRenderer(this);
        gun307.setRotationPoint(-0.7F, -32, -29);
        MainGUN.addChild(gun307);
        gun307.cubeList.add(new ModelBox(gun307, 84, 0, 0, 0, 0.01F, 1, 2, 4, 0, false));

        gun306 = new ModelRenderer(this);
        gun306.setRotationPoint(-3.3F, -32, -29);
        MainGUN.addChild(gun306);
        gun306.cubeList.add(new ModelBox(gun306, 0, 108, 0, 0, 0, 3, 2, 4, 0, false));

        gun305 = new ModelRenderer(this);
        gun305.setRotationPoint(-3.5F, -27, -19);
        MainGUN.addChild(gun305);
        setRotationAngle(gun305, 2.491F, 0, 0);
        gun305.cubeList.add(new ModelBox(gun305, 60, 30, 0, 0, 0, 4, 1, 3, -0.001F, false));

        gun304 = new ModelRenderer(this);
        gun304.setRotationPoint(-3.5F, -29.5F, -25);
        MainGUN.addChild(gun304);
        setRotationAngle(gun304, 1.3384F, 0, 0);
        gun304.cubeList.add(new ModelBox(gun304, 84, 6, 0, 0, 0, 4, 5, 1, -0.002F, false));

        gun303 = new ModelRenderer(this);
        gun303.setRotationPoint(-3.5F, -32.5F, -25);
        MainGUN.addChild(gun303);
        gun303.cubeList.add(new ModelBox(gun303, 76, 133, 0, 0, 0, 4, 3, 6, 0, false));

        gun302 = new ModelRenderer(this);
        gun302.setRotationPoint(-3.5F, -32, -19);
        MainGUN.addChild(gun302);
        gun302.cubeList.add(new ModelBox(gun302, 84, 14, 0, 0, 0, 4, 5, 1, 0, false));

        gun301 = new ModelRenderer(this);
        gun301.setRotationPoint(-0.3F, -33, 4.2F);
        MainGUN.addChild(gun301);
        setRotationAngle(gun301, -2.3562F, 0, 0);
        gun301.cubeList.add(new ModelBox(gun301, 19, 125, 0.01F, 0, 0, 1, 1, 1, 0, false));

        gun300 = new ModelRenderer(this);
        gun300.setRotationPoint(-3.7F, -33, 4.2F);
        MainGUN.addChild(gun300);
        setRotationAngle(gun300, -2.3562F, 0, 0);
        gun300.cubeList.add(new ModelBox(gun300, 56, 36, -0.01F, 0, 0, 4, 1, 1, 0, false));

        gun299 = new ModelRenderer(this);
        gun299.setRotationPoint(-3.7F, -33, 3.5F);
        MainGUN.addChild(gun299);
        gun299.cubeList.add(new ModelBox(gun299, 84, 24, 0, -0.01F, 0, 4, 1, 2, 0, false));

        gun298 = new ModelRenderer(this);
        gun298.setRotationPoint(-0.3F, -33, 3.5F);
        MainGUN.addChild(gun298);
        gun298.cubeList.add(new ModelBox(gun298, 120, 78, 0, 0, 0, 1, 1, 2, 0, false));

        gun297 = new ModelRenderer(this);
        gun297.setRotationPoint(-3, -27.9F, -14.5F);
        MainGUN.addChild(gun297);
        setRotationAngle(gun297, -2.3562F, 0, 0);
        gun297.cubeList.add(new ModelBox(gun297, 82, 108, 0, 0, 0, 3, 2, 1, -0.002F, false));

        gun296 = new ModelRenderer(this);
        gun296.setRotationPoint(-3, -27.9F, -15.5F);
        MainGUN.addChild(gun296);
        gun296.cubeList.add(new ModelBox(gun296, 48, 86, 0, 0, 0, 3, 1, 1, -0.001F, false));

        gun295 = new ModelRenderer(this);
        gun295.setRotationPoint(-3, -27.9F, -18);
        MainGUN.addChild(gun295);
        gun295.cubeList.add(new ModelBox(gun295, 84, 20, 0, 0, 0, 3, 1, 3, 0.001F, false));

        gun933 = new ModelRenderer(this);
        gun933.setRotationPoint(-3.8F, -37.5F, 2.2F);
        MainGUN.addChild(gun933);
        setRotationAngle(gun933, -0.9295F, 0, 0);
        gun933.cubeList.add(new ModelBox(gun933, 117, 45, -0.01F, 0, 0, 2, 2, 2, 0, false));

        gun922 = new ModelRenderer(this);
        gun922.setRotationPoint(-1.2F, -37.5F, 2.2F);
        MainGUN.addChild(gun922);
        setRotationAngle(gun922, -0.9295F, 0, 0);
        gun922.cubeList.add(new ModelBox(gun922, 117, 49, 0.01F, 0, 0, 2, 2, 2, 0, false));

        gun911 = new ModelRenderer(this);
        gun911.setRotationPoint(-1.2F, -39.3F, 0.88F);
        MainGUN.addChild(gun911);
        setRotationAngle(gun911, -0.9295F, 0, 0);
        gun911.cubeList.add(new ModelBox(gun911, 66, 100, 0, 0, 0, 1, 1, 4, 0, false));

        gun900 = new ModelRenderer(this);
        gun900.setRotationPoint(-2.8F, -39.3F, 0.88F);
        MainGUN.addChild(gun900);
        setRotationAngle(gun900, -0.9295F, 0, 0);
        gun900.cubeList.add(new ModelBox(gun900, 102, 64, 0, 0, 0, 1, 1, 4, 0, false));

        gun899 = new ModelRenderer(this);
        gun899.setRotationPoint(-2, -39.8F, 0.5F);
        MainGUN.addChild(gun899);
        setRotationAngle(gun899, -0.9295F, 0, 0);
        gun899.cubeList.add(new ModelBox(gun899, 0, 60, 0, 0, 0, 1, 1, 5, 0, false));

        gun96 = new ModelRenderer(this);
        gun96.setRotationPoint(-3.8F, -37.5F, -20.5F);
        MainGUN.addChild(gun96);
        setRotationAngle(gun96, 0, 0, -0.7436F);
        gun96.cubeList.add(new ModelBox(gun96, 52, 130, 0, -0.01F, -0.01F, 1, 1, 9, 0, false));

        gun95 = new ModelRenderer(this);
        gun95.setRotationPoint(-3.8F, -37.5F, -12);
        MainGUN.addChild(gun95);
        setRotationAngle(gun95, 0, 0, -0.7436F);
        gun95.cubeList.add(new ModelBox(gun95, 120, 122, 0, 0, 0, 1, 1, 13, 0, false));

        gun94 = new ModelRenderer(this);
        gun94.setRotationPoint(-2.8F, -39.2F, -20.5F);
        MainGUN.addChild(gun94);
        setRotationAngle(gun94, 0, 0, 0.3346F);
        gun94.cubeList.add(new ModelBox(gun94, 0, 152, 0, 0, 0, 1, 2, 21, 0, false));

        gun93 = new ModelRenderer(this);
        gun93.setRotationPoint(0.8F, -37.5F, -29.5F);
        MainGUN.addChild(gun93);
        setRotationAngle(gun93, 0, 0, 2.3051F);
        gun93.cubeList.add(new ModelBox(gun93, 40, 60, 0, 0, -0.01F, 1, 1, 5, -0.001F, false));

        gun91 = new ModelRenderer(this);
        gun91.setRotationPoint(-0.17F, -39.25F, -29.5F);
        MainGUN.addChild(gun91);
        setRotationAngle(gun91, 0, 0, 1.3013F);
        gun91.cubeList.add(new ModelBox(gun91, 84, 0, 0, 0, 0.01F, 2, 1, 30, 0, false));

        gun92 = new ModelRenderer(this);
        gun92.setRotationPoint(0.8F, -37.5F, -25);
        MainGUN.addChild(gun92);
        setRotationAngle(gun92, 0, 0, 2.3051F);
        gun92.cubeList.add(new ModelBox(gun92, 147, 0, 0, 0, 0, 1, 1, 26, 0, false));

        gun90 = new ModelRenderer(this);
        gun90.setRotationPoint(-2, -39.8F, -29.5F);
        MainGUN.addChild(gun90);
        setRotationAngle(gun90, 0, 0, 0.9295F);
        gun90.cubeList.add(new ModelBox(gun90, 120, 108, 0, 0, 0.001F, 1, 1, 30, 0, false));

        gun89 = new ModelRenderer(this);
        gun89.setRotationPoint(-1, -39.8F, -29.5F);
        MainGUN.addChild(gun89);
        setRotationAngle(gun89, 0, 0, 0.5949F);
        gun89.cubeList.add(new ModelBox(gun89, 124, 139, 0, 0, 0.001F, 1, 1, 30, 0, false));

        gun88 = new ModelRenderer(this);
        gun88.setRotationPoint(-2, -39.8F, -29.5F);
        MainGUN.addChild(gun88);
        gun88.cubeList.add(new ModelBox(gun88, 80, 144, 0, 0, 0, 1, 1, 30, 0, false));

        gun74 = new ModelRenderer(this);
        gun74.setRotationPoint(-3.8F, -36.5F, -4.5F);
        MainGUN.addChild(gun74);
        gun74.cubeList.add(new ModelBox(gun74, 46, 22, 0.01F, 0, 0.01F, 1, 1, 6, 0, false));

        gun73 = new ModelRenderer(this);
        gun73.setRotationPoint(-3.8F, -37.5F, -11.1F);
        MainGUN.addChild(gun73);
        gun73.cubeList.add(new ModelBox(gun73, 0, 130, 0, 0, 0, 1, 1, 13, 0, false));

        gun69 = new ModelRenderer(this);
        gun69.setRotationPoint(-3.8F, -37.5F, -20.5F);
        MainGUN.addChild(gun69);
        gun69.cubeList.add(new ModelBox(gun69, 176, 27, -0.01F, -0.01F, 0, 1, 1, 10, 0, false));

        gun67 = new ModelRenderer(this);
        gun67.setRotationPoint(-0.2F, -37.5F, -25);
        MainGUN.addChild(gun67);
        gun67.cubeList.add(new ModelBox(gun67, 118, 0, 0, 0, 0, 1, 2, 27, 0, false));

        gun66 = new ModelRenderer(this);
        gun66.setRotationPoint(-0.2F, -37.5F, -29.5F);
        MainGUN.addChild(gun66);
        gun66.cubeList.add(new ModelBox(gun66, 57, 60, 0.01F, 0, -0.02F, 1, 1, 5, 0, false));

        gun65 = new ModelRenderer(this);
        gun65.setRotationPoint(-0.2F, -37, -29.5F);
        MainGUN.addChild(gun65);
        gun65.cubeList.add(new ModelBox(gun65, 24, 70, 0, 0, -0.01F, 1, 1, 5, -0.001F, false));

        gun61 = new ModelRenderer(this);
        gun61.setRotationPoint(-3.8F, -36, 2.5F);
        MainGUN.addChild(gun61);
        gun61.cubeList.add(new ModelBox(gun61, 76, 36, 0, 0, 0, 4, 1, 1, 0, false));

        gun60 = new ModelRenderer(this);
        gun60.setRotationPoint(-3.8F, -36, -4.5F);
        MainGUN.addChild(gun60);
        gun60.cubeList.add(new ModelBox(gun60, 21, 0, 0, 0, 0, 1, 1, 7, 0, false));

        gun61_r1 = new ModelRenderer(this);
        gun61_r1.setRotationPoint(0, 1, 0);
        gun60.addChild(gun61_r1);
        setRotationAngle(gun61_r1, -0.9076F, 0, 0);
        gun61_r1.cubeList.add(new ModelBox(gun61_r1, 117, 62, 0, -1, -2, 1, 1, 2, -0.001F, false));

        gun58 = new ModelRenderer(this);
        gun58.setRotationPoint(-0.2F, -36, 2.5F);
        MainGUN.addChild(gun58);
        gun58.cubeList.add(new ModelBox(gun58, 125, 33, 0, 0, 0, 1, 1, 1, 0, false));

        gun56 = new ModelRenderer(this);
        gun56.setRotationPoint(-3.7F, -35, -34.5F);
        MainGUN.addChild(gun56);
        gun56.cubeList.add(new ModelBox(gun56, 47, 150, 0, 0, 0, 1, 1, 25, 0, false));
        gun56.cubeList.add(new ModelBox(gun56, 149, 27, 0.002F, -0.4F, 5, 1, 1, 25, 0, false));

        gun47 = new ModelRenderer(this);
        gun47.setRotationPoint(-0.3F, -36, -34.5F);
        MainGUN.addChild(gun47);
        gun47.cubeList.add(new ModelBox(gun47, 40, 39, 0, 0, 0, 1, 1, 37, 0, false));

        gun44 = new ModelRenderer(this);
        gun44.setRotationPoint(-3.7F, -35, -9.5F);
        MainGUN.addChild(gun44);
        gun44.cubeList.add(new ModelBox(gun44, 0, 0, 0.001F, -0.02F, 0, 4, 3, 13, 0, false));

        gun41 = new ModelRenderer(this);
        gun41.setRotationPoint(-0.3F, -35, -34.5F);
        MainGUN.addChild(gun41);
        gun41.cubeList.add(new ModelBox(gun41, 0, 39, 0, -0.01F, 0.001F, 1, 3, 38, 0, false));

        gun39 = new ModelRenderer(this);
        gun39.setRotationPoint(-3.7F, -33, -34.5F);
        MainGUN.addChild(gun39);
        gun39.cubeList.add(new ModelBox(gun39, 0, 0, 0, 0, 0, 4, 1, 38, 0, false));

        gun28 = new ModelRenderer(this);
        gun28.setRotationPoint(-2.5F, -27, -17.8F);
        MainGUN.addChild(gun28);
        setRotationAngle(gun28, 0.2603F, 0, 0);
        gun28.cubeList.add(new ModelBox(gun28, 120, 86, 0, 0, 0, 2, 2, 1, 0, false));

        gun25 = new ModelRenderer(this);
        gun25.setRotationPoint(-3, -32.5F, -18);
        MainGUN.addChild(gun25);
        gun25.cubeList.add(new ModelBox(gun25, 48, 80, 0, 0, 0, 3, 5, 1, -0.001F, false));

        gun24 = new ModelRenderer(this);
        gun24.setRotationPoint(-3, -32.5F, -17.5F);
        MainGUN.addChild(gun24);
        gun24.cubeList.add(new ModelBox(gun24, 15, 80, 0, 0, 0, 3, 5, 2, 0, false));

        gun23 = new ModelRenderer(this);
        gun23.setRotationPoint(-2.5F, -26.8F, -14.5F);
        MainGUN.addChild(gun23);
        setRotationAngle(gun23, 2.4538F, 0, 0);
        gun23.cubeList.add(new ModelBox(gun23, 64, 57, 0, 0, 0, 2, 1, 1, -0.002F, false));

        gun20 = new ModelRenderer(this);
        gun20.setRotationPoint(-2.5F, -27.8F, -15.5F);
        MainGUN.addChild(gun20);
        setRotationAngle(gun20, 0.7436F, 0, 0);
        gun20.cubeList.add(new ModelBox(gun20, 64, 63, 0, 0, 0, 2, 1, 1, -0.001F, false));

        gun18 = new ModelRenderer(this);
        gun18.setRotationPoint(-2.5F, -32.8F, -15.5F);
        MainGUN.addChild(gun18);
        gun18.cubeList.add(new ModelBox(gun18, 0, 30, 0, 0, 0, 2, 5, 1, 0, false));

        gun17 = new ModelRenderer(this);
        gun17.setRotationPoint(-2.5F, -27.8F, -14.5F);
        MainGUN.addChild(gun17);
        gun17.cubeList.add(new ModelBox(gun17, 40, 68, 0, 0, 0, 2, 1, 7, 0.001F, false));

        gun14 = new ModelRenderer(this);
        gun14.setRotationPoint(-2.5F, -27.5F, -6.7F);
        MainGUN.addChild(gun14);
        setRotationAngle(gun14, -2.3423F, 0, 0);
        gun14.cubeList.add(new ModelBox(gun14, 58, 74, 0, 0, 0, 2, 1, 1, -0.001F, false));

        gun12 = new ModelRenderer(this);
        gun12.setRotationPoint(-2.5F, -32.5F, -7.5F);
        MainGUN.addChild(gun12);
        gun12.cubeList.add(new ModelBox(gun12, 15, 30, 0, 0, 0, 2, 5, 1, 0, false));

        gun1 = new ModelRenderer(this);
        gun1.setRotationPoint(-3.5F, -32.5F, -7);
        MainGUN.addChild(gun1);
        gun1.cubeList.add(new ModelBox(gun1, 38, 100, 0, 0, 0, 4, 1, 9, 0, false));
        ...
        gun378.setRotationPoint(-3.7F, -37, 4.3F);
        ...
        setRotationAngle(gun378_r1, -0.1745F, 0, 0);
        gun378_r1.cubeList.add(new ModelBox(gun378_r1, 124, 81, -3.7F, -37, 4.3F, 1, 1, 1, 0, false));

        gun377 = new ModelRenderer(this);
        gun377.setRotationPoint(-0.3F, -37, 4.3F);
        ...
        setRotationAngle(gun377_r1, -0.1745F, 0, 0);
        gun377_r1.cubeList.add(new ModelBox(gun377_r1, 124, 100, -0.3F, -37, 4.3F, 1, 1, 1, 0, false));

        gun368 = new ModelRenderer(this);
        gun368.setRotationPoint(-0.8F, -30.5F, 36.5F);
        Stock.addChild(gun368);
        setRotationAngle(gun368, -1.2641F, 0, 0);
        gun368.cubeList.add(new ModelBox(gun368, 31, 8, 0, 0.01F, 0, 1, 2, 2, 0, false));
        ...
        gun367.cubeList.add(new ModelBox(gun367, 117, 34, 0, 0, 0, 3, 2, 2, 0, false));

        gun366 = new ModelRenderer(this);
        gun366.setRotationPoint(-0.8F, -30.5F, 36.5F);
        Stock.addChild(gun366);
        gun366.cubeList.add(new ModelBox(gun366, 69, 80, 0, 0.01F, 0, 1, 2, 3, 0, false));

        gun365 = new ModelRenderer(this);
        gun365.setRotationPoint(-3.2F, -30.5F, 36.5F);
        Stock.addChild(gun365);
        gun365.cubeList.add(new ModelBox(gun365, 0, 80, 0, 0, 0, 3, 2, 3, 0, false));

        gun364 = new ModelRenderer(this);
        gun364.setRotationPoint(-3.2F, -30.5F, 39.5F);
        Stock.addChild(gun364);
        gun364.cubeList.add(new ModelBox(gun364, 76, 113, 0, 0, 0, 3, 14, 1, 0, false));

        gun363 = new ModelRenderer(this);
        gun363.setRotationPoint(-0.8F, -30.5F, 39.5F);
        Stock.addChild(gun363);
        gun363.cubeList.add(new ModelBox(gun363, 90, 113, 0, 0.01F, -0.01F, 1, 14, 1, 0, false));

        gun362 = new ModelRenderer(this);
        gun362.setRotationPoint(-3.2F, -33, 5.5F);
        Stock.addChild(gun362);
        setRotationAngle(gun362, 1.4128F, 0, 0);
        gun362.cubeList.add(new ModelBox(gun362, 74, 13, -0.01F, 28, -0.5F, 1, 7, 2, 0, false));

        gun361 = new ModelRenderer(this);
        gun361.setRotationPoint(-0.8F, -33, 5.5F);
        Stock.addChild(gun361);
        setRotationAngle(gun361, 1.4128F, 0, 0);
        gun361.cubeList.add(new ModelBox(gun361, 38, 100, 0.01F, 28, -0.5F, 1, 7, 2, 0, false));

        gun360 = new ModelRenderer(this);
        gun360.setRotationPoint(-2.5F, -32.6F, 5.5F);
        Stock.addChild(gun360);
        setRotationAngle(gun360, 1.4128F, 0, 0);
        gun360.cubeList.add(new ModelBox(gun360, 32, 39, 0, 0, 0, 2, 35, 1, 0, false));

        gun359 = new ModelRenderer(this);
        gun359.setRotationPoint(-3.2F, -33, 5.5F);
        Stock.addChild(gun359);
        setRotationAngle(gun359, 1.4128F, 0, 0);
        gun359.cubeList.add(new ModelBox(gun359, 70, 39, 0, 0, 0, 1, 30, 2, 0, false));

        gun358 = new ModelRenderer(this);
        gun358.setRotationPoint(-0.8F, -33, 5.5F);
        Stock.addChild(gun358);
        setRotationAngle(gun358, 1.4128F, 0, 0);
        gun358.cubeList.add(new ModelBox(gun358, 28, 80, 0, 0, 0, 1, 30, 2, 0, false));

        GripArea = new ModelRenderer(this);
        GripArea.setRotationPoint(0, 24, 0);


        gun294 = new ModelRenderer(this);
        gun294.setRotationPoint(-3.5F, -21.3F, 4.4F);
        GripArea.addChild(gun294);
        setRotationAngle(gun294, -1.673F, 0, 0);
        gun294.cubeList.add(new ModelBox(gun294, 66, 36, 0, 0, 1.7F, 4, 1, 1, -0.001F, false));

        gun293 = new ModelRenderer(this);
        gun293.setRotationPoint(-3.5F, -21.3F, 4.4F);
        GripArea.addChild(gun293);
        setRotationAngle(gun293, -1.673F, 0, 0);
        gun293.cubeList.add(new ModelBox(gun293, 0, 85, 0, 0, 0, 4, 2, 2, 0.001F, false));

        gun292 = new ModelRenderer(this);
        gun292.setRotationPoint(-3.5F, -17.5F, -3);
        GripArea.addChild(gun292);
        setRotationAngle(gun292, 0.8528F, 0, 0);
        gun292.cubeList.add(new ModelBox(gun292, 84, 31, 0, 0, 0, 4, 1, 2, -0.001F, false));

        gun291 = new ModelRenderer(this);
        gun291.setRotationPoint(-3.5F, -17.5F, -3);
        GripArea.addChild(gun291);
        setRotationAngle(gun291, 0.3695F, 0, 0);
        gun291.cubeList.add(new ModelBox(gun291, 0, 30, 0, 0.5F, 0, 4, 1, 7, 0, false));

        gun290 = new ModelRenderer(this);
        gun290.setRotationPoint(-3.5F, -17.5F, -3);
        GripArea.addChild(gun290);
        setRotationAngle(gun290, 0.3695F, 0, 0);
        gun290.cubeList.add(new ModelBox(gun290, 0, 68, 0, 0, 0, 4, 1, 7, 0.001F, false));

        gun289 = new ModelRenderer(this);
        gun289.setRotationPoint(-3.5F, -28, 0);
        GripArea.addChild(gun289);
        setRotationAngle(gun289, -1.0038F, 0, 0);
        gun289.cubeList.add(new ModelBox(gun289, 149, 42, 0, 0, 0, 4, 2, 8, 0, false));

        gun11 = new ModelRenderer(this);
        gun11.setRotationPoint(-3.5F, -30.7F, 0.67F);
        GripArea.addChild(gun11);
        setRotationAngle(gun11, -2.1564F, 0, 0);
        gun11.cubeList.add(new ModelBox(gun11, 82, 87, 0, 0, 0, 4, 1, 2, -0.002F, false));

        gun10 = new ModelRenderer(this);
        gun10.setRotationPoint(-3.5F, -31.5F, -0.4F);
        GripArea.addChild(gun10);
        gun10.cubeList.add(new ModelBox(gun10, 84, 28, 0, 0, 0, 4, 1, 1, 0, false));

        gun9 = new ModelRenderer(this);
        gun9.setRotationPoint(-3.5F, -27.5F, -7);
        GripArea.addChild(gun9);
        setRotationAngle(gun9, 1.2269F, 0, 0);
        gun9.cubeList.add(new ModelBox(gun9, 101, 59, 0, 0, 0, 4, 2, 1, 0, false));

        gun8 = new ModelRenderer(this);
        gun8.setRotationPoint(-3.5F, -31.5F, -7);
        GripArea.addChild(gun8);
        gun8.cubeList.add(new ModelBox(gun8, 176, 38, 0, 0, 0, 4, 4, 7, 0.001F, false));

        gun3 = new ModelRenderer(this);
        gun3.setRotationPoint(-3.5F, -31.5F, 2);
        GripArea.addChild(gun3);
        setRotationAngle(gun3, -2.5281F, 0, 0);
        gun3.cubeList.add(new ModelBox(gun3, 62, 25, 0, 0, 0, 4, 1, 3, -0.001F, false));

        gun2 = new ModelRenderer(this);
        gun2.setRotationPoint(-3.5F, -27.5F, -6);
        GripArea.addChild(gun2);
        setRotationAngle(gun2, 0.3695F, 0, 0);
        gun2.cubeList.add(new ModelBox(gun2, 133, 144, 0, 0, 0, 4, 11, 6, 0.002F, false));

        Handguard = new ModelRenderer(this);
        Handguard.setRotationPoint(0, -13, -49);
        Handguard.cubeList.add(new ModelBox(Handguard, 84, 0, -0.5F, 2, 13, 1, 2, 1, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 53, 120, -0.5F, 1.5F, 12, 1, 1, 2, 0.001F, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 173, 100, -0.5F, -1.5F, 1, 1, 4, 10, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 20, 45, -0.5F, -0.5F, 0, 1, 3, 1, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 40, 39, -0.5F, -0.5F, 11, 1, 3, 1, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 117, 53, -1.3F, 3.8F, 13, 1, 1, 2, -0.001F, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 108, 72, -2.7F, 3.8F, 13, 2, 1, 2, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 9, 80, -3.5F, 2, 13, 1, 2, 1, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 44, 120, -3.5F, 1.5F, 12, 1, 1, 2, 0.001F, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 144, 170, -3.5F, -1.5F, 1, 1, 4, 10, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 20, 39, -3.5F, -0.5F, 0, 1, 3, 1, 0, false));
        Handguard.cubeList.add(new ModelBox(Handguard, 27, 39, -3.5F, -0.5F, 11, 1, 3, 1, 0, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(-3.5F, 4, 13);
        Handguard.addChild(cube_r13);
        setRotationAngle(cube_r13, 1.4661F, 0, 0);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 109, 113, 0, -13, 0, 1, 13, 2, -0.001F, false));
        cube_r13.cubeList.add(new ModelBox(cube_r13, 28, 116, 3, -13, 0, 1, 13, 2, -0.001F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(-3.5F, -0.5F, 12);
        Handguard.addChild(cube_r14);
        setRotationAngle(cube_r14, 0.7854F, 0, 0);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 123, 119, 0, -1.4F, -0.999F, 1, 1, 1, -0.003F, false));
        cube_r14.cubeList.add(new ModelBox(cube_r14, 123, 117, 0, -1, -1, 1, 1, 1, -0.001F, false));
        cube_r14.cubeList.add(new ModelBox(cube_r14, 124, 52, 3, -1.4F, -0.999F, 1, 1, 1, -0.003F, false));
        cube_r14.cubeList.add(new ModelBox(cube_r14, 124, 41, 3, -1, -1, 1, 1, 1, -0.001F, false));

        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(-3.5F, -0.5F, 0);
        Handguard.addChild(cube_r15);
        setRotationAngle(cube_r15, -0.7854F, 0, 0);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 123, 115, 0, -1.4F, -0.001F, 1, 1, 1, -0.003F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 123, 113, 0, -1, 0, 1, 1, 1, -0.001F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 124, 54, 3, -1.4F, -0.001F, 1, 1, 1, -0.003F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 124, 63, 3, -1, 0, 1, 1, 1, -0.001F, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(-3.6F, 1.1F, 10);
        Handguard.addChild(cube_r16);
        setRotationAngle(cube_r16, -0.7069F, 0, 0);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 123, 111, 0, -1, 2.7F, 1, 1, 1, -0.002F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 38, 110, 0, -1, 0, 1, 1, 3, -0.001F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 123, 123, 3.2F, -1, 2.7F, 1, 1, 1, -0.002F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 63, 116, 3.2F, -1, 0, 1, 1, 3, -0.001F, false));

        cube_r17 = new ModelRenderer(this);
        cube_r17.setRotationPoint(-3.6F, 0.5F, 2.6F);
        Handguard.addChild(cube_r17);
        setRotationAngle(cube_r17, -0.7069F, 0, 0);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 123, 109, 0, -1, 2.7F, 1, 1, 1, -0.002F, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 10, 108, 0, -1, 0, 1, 1, 3, -0.001F, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 124, 31, 3.2F, -1, 2.7F, 1, 1, 1, -0.002F, false));
        cube_r17.cubeList.add(new ModelBox(cube_r17, 117, 38, 3.2F, -1, 0, 1, 1, 3, -0.001F, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(-3.6F, 0.5F, 2.6F);
        Handguard.addChild(cube_r18);
        setRotationAngle(cube_r18, -0.1047F, 0, 0);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 38, 89, -0.1F, -0.3F, 1, 1, 1, 8, -0.1F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 59, 80, -0.1F, 0.5F, 2.1F, 1, 1, 8, -0.1F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 38, 80, 0, -1, 0, 1, 1, 8, 0.001F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 59, 89, 3.3F, 0.5F, 2.1F, 1, 1, 8, -0.1F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 94, 36, 3.3F, -0.3F, 1, 1, 1, 8, -0.1F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 94, 50, 3.2F, -1, 0, 1, 1, 8, 0.001F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(-3.6F, 2.9F, 5.4F);
        Handguard.addChild(cube_r19);
        setRotationAngle(cube_r19, -0.1047F, 0, 0);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 14, 68, 0, -1, 0, 1, 1, 8, 0.001F, false));
        cube_r19.cubeList.add(new ModelBox(cube_r19, 97, 77, 3.2F, -1, 0, 1, 1, 8, 0.001F, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(-3.5F, 4, 14);
        Handguard.addChild(cube_r20);
        setRotationAngle(cube_r20, 0, 0.5585F, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 74, 80, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-3.5F, 1.5F, 14);
        Handguard.addChild(cube_r21);
        setRotationAngle(cube_r21, 0.1745F, 0, 0);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 38, 120, 0, -1, -2, 1, 1, 2, -0.002F, false));
        cube_r21.cubeList.add(new ModelBox(cube_r21, 59, 120, 3, -1, -2, 1, 1, 2, -0.002F, false));

        cube_r22 = new ModelRenderer(this);
        cube_r22.setRotationPoint(-2.5F, 4.8F, 13);
        Handguard.addChild(cube_r22);
        setRotationAngle(cube_r22, 0, 0, 0.7854F);
        cube_r22.cubeList.add(new ModelBox(cube_r22, 123, 90, -1.2F, -0.9F, 0.1F, 1, 1, 1, 0.05F, false));

        cube_r23 = new ModelRenderer(this);
        cube_r23.setRotationPoint(-2.5F, 4.8F, 13);
        Handguard.addChild(cube_r23);
        setRotationAngle(cube_r23, 1.4979F, 0.0753F, 0.8001F);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 84, 113, -1.2F, -13, -0.1F, 1, 13, 2, 0.05F, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(-2.5F, 4.8F, 13);
        Handguard.addChild(cube_r24);
        setRotationAngle(cube_r24, 1.4661F, 0, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 108, 89, -0.2F, -13, 0, 2, 13, 2, 0, false));
        cube_r24.cubeList.add(new ModelBox(cube_r24, 103, 113, 1.2F, -13, 0, 1, 13, 2, -0.001F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(-0.5F, 4.8F, 13);
        Handguard.addChild(cube_r25);
        setRotationAngle(cube_r25, 0, 0, -0.7854F);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 123, 92, 0.2F, -0.9F, 0.1F, 1, 1, 1, 0.05F, false));

        cube_r26 = new ModelRenderer(this);
        cube_r26.setRotationPoint(-0.5F, 4.8F, 13);
        Handguard.addChild(cube_r26);
        setRotationAngle(cube_r26, 1.4979F, -0.0753F, -0.8001F);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 97, 113, 0.2F, -13, -0.1F, 1, 13, 2, 0.05F, false));

        cube_r27 = new ModelRenderer(this);
        cube_r27.setRotationPoint(0.5F, 4, 14);
        Handguard.addChild(cube_r27);
        setRotationAngle(cube_r27, 0, -0.5585F, 0);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 82, 77, -1, -2, 0, 1, 2, 1, 0, false));

        Handguard_COMPACT = new ModelRenderer(this);
        Handguard_COMPACT.setRotationPoint(1, -11.8F, -34.5F);
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 27, 30, -0.8F, -0.5F, -1, 1, 3, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 62, 15, -1.95F, -3.5F, -4.35F, 1, 4, 3, 0.05F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 23, -1.95F, -3, -1.25F, 1, 4, 1, 0.05F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 109, 52, -1.8F, -2.9F, -1, 1, 1, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 44, 152, -1.8F, -3.9F, -13, 1, 1, 12, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 23, -1.8F, -2.9F, -14, 1, 4, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 104, -1.8F, 0.7F, -14, 1, 1, 1, -0.002F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 109, 48, -3, 1.7F, -14, 1, 1, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 7, -4.2F, -2.9F, -14, 1, 4, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 91, 82, -4.2F, 0.7F, -14, 1, 1, 1, -0.002F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 74, 149, -4.2F, -3.9F, -13, 1, 1, 12, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 93, 21, -4.2F, -2.9F, -1, 1, 1, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 8, -5.2F, -0.5F, -1, 1, 3, 1, 0, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 30, 0, -4.05F, -3.5F, -4.35F, 1, 4, 3, 0.05F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 16, -4.05F, -3, -1.25F, 1, 4, 1, 0.05F, false));
        Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 110, -3, 2.7F, -1, 1, 1, 1, 0, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(-5.2F, 2.5F, -1);
        Handguard_COMPACT.addChild(cube_r28);
        setRotationAngle(cube_r28, 0, 0, 0.5061F);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 46, 3, 1.5F, -1, 0, 1, 1, 1, -0.001F, false));
        cube_r28.cubeList.add(new ModelBox(cube_r28, 32, 36, 0, -1, 0, 2, 1, 1, 0, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(0.2F, 2.5F, -1);
        Handguard_COMPACT.addChild(cube_r29);
        setRotationAngle(cube_r29, 0, 0, -0.5061F);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 109, 104, -2.5F, -1, 0, 1, 1, 1, -0.001F, false));
        cube_r29.cubeList.add(new ModelBox(cube_r29, 7, 57, -2, -1, 0, 2, 1, 1, 0, false));

        cube_r30 = new ModelRenderer(this);
        cube_r30.setRotationPoint(-5.2F, 2.5F, -1);
        Handguard_COMPACT.addChild(cube_r30);
        setRotationAngle(cube_r30, 0, -0.0175F, 0);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 0, 152, 1.28F, -6, -12.05F, 1, 4, 9, 0.05F, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(-5.2F, -0.5F, -1);
        Handguard_COMPACT.addChild(cube_r31);
        setRotationAngle(cube_r31, 0, 0, 0.5236F);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 0, 54, 0, -2, 0, 1, 2, 1, -0.001F, false));

        cube_r32 = new ModelRenderer(this);
        cube_r32.setRotationPoint(-4.2F, -3.9F, -1);
        Handguard_COMPACT.addChild(cube_r32);
        setRotationAngle(cube_r32, 0.7854F, 0, 0);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 93, 19, 0, 0.4F, -1, 1, 1, 1, 0.002F, false));
        cube_r32.cubeList.add(new ModelBox(cube_r32, 93, 11, 0, 0, -1, 1, 1, 1, 0.001F, false));
        cube_r32.cubeList.add(new ModelBox(cube_r32, 100, 108, 2.4F, 0, -1, 1, 1, 1, 0.001F, false));
        cube_r32.cubeList.add(new ModelBox(cube_r32, 94, 108, 2.4F, 0.4F, -1, 1, 1, 1, 0.002F, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(-4.2F, -3.9F, -13);
        Handguard_COMPACT.addChild(cube_r33);
        setRotationAngle(cube_r33, -0.7854F, 0, 0);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 93, 5, 0, 0, 0, 1, 1, 1, 0.001F, false));
        cube_r33.cubeList.add(new ModelBox(cube_r33, 91, 84, 0, 0.4F, 0, 1, 1, 1, 0.002F, false));
        cube_r33.cubeList.add(new ModelBox(cube_r33, 106, 108, 2.4F, 0.4F, 0, 1, 1, 1, 0.002F, false));
        cube_r33.cubeList.add(new ModelBox(cube_r33, 109, 36, 2.4F, 0, 0, 1, 1, 1, 0.001F, false));

        cube_r34 = new ModelRenderer(this);
        cube_r34.setRotationPoint(-4.2F, 1.7F, -13);
        Handguard_COMPACT.addChild(cube_r34);
        setRotationAngle(cube_r34, 0, 0, -0.8727F);
        cube_r34.cubeList.add(new ModelBox(cube_r34, 24, 91, 0, 0.55F, -1, 1, 1, 1, -0.002F, false));
        cube_r34.cubeList.add(new ModelBox(cube_r34, 74, 89, 0, 0, -1, 1, 1, 1, -0.001F, false));

        cube_r35 = new ModelRenderer(this);
        cube_r35.setRotationPoint(0.2F, -0.5F, -1);
        Handguard_COMPACT.addChild(cube_r35);
        setRotationAngle(cube_r35, 0, 0, -0.5236F);
        cube_r35.cubeList.add(new ModelBox(cube_r35, 73, 71, -1, -2, 0, 1, 2, 1, -0.001F, false));

        cube_r36 = new ModelRenderer(this);
        cube_r36.setRotationPoint(-0.8F, 1.7F, -13);
        Handguard_COMPACT.addChild(cube_r36);
        setRotationAngle(cube_r36, 0, 0, 0.8727F);
        cube_r36.cubeList.add(new ModelBox(cube_r36, 109, 40, -1, 0.55F, -1, 1, 1, 1, -0.002F, false));
        cube_r36.cubeList.add(new ModelBox(cube_r36, 109, 45, -1, 0, -1, 1, 1, 1, -0.001F, false));

        cube_r37 = new ModelRenderer(this);
        cube_r37.setRotationPoint(0.2F, 2.5F, -1);
        Handguard_COMPACT.addChild(cube_r37);
        setRotationAngle(cube_r37, 0, 0.0175F, 0);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 0, 175, -2.28F, -6, -12.05F, 1, 4, 9, 0.05F, false));

        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(0.05F, 1.5F, -3);
        Handguard_COMPACT.addChild(bone5);


        cube_r38 = new ModelRenderer(this);
        cube_r38.setRotationPoint(-0.8F, -1, -9.5F);
        bone5.addChild(cube_r38);
        setRotationAngle(cube_r38, -0.045F, 0.0748F, -0.5427F);
        cube_r38.cubeList.add(new ModelBox(cube_r38, 17, 60, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r39 = new ModelRenderer(this);
        cube_r39.setRotationPoint(-0.8F, 0, -9.5F);
        bone5.addChild(cube_r39);
        setRotationAngle(cube_r39, 0, 0.0873F, 0);
        cube_r39.cubeList.add(new ModelBox(cube_r39, 60, 104, -1, -1, 0, 1, 1, 1, 0, false));

        cube_r40 = new ModelRenderer(this);
        cube_r40.setRotationPoint(-0.8F, 0, -9.5F);
        bone5.addChild(cube_r40);
        setRotationAngle(cube_r40, 0.045F, 0.0748F, 0.5427F);
        cube_r40.cubeList.add(new ModelBox(cube_r40, 104, 56, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r41 = new ModelRenderer(this);
        cube_r41.setRotationPoint(-0.6F, -1, -7.5F);
        bone5.addChild(cube_r41);
        setRotationAngle(cube_r41, -0.045F, 0.0748F, -0.5427F);
        cube_r41.cubeList.add(new ModelBox(cube_r41, 40, 60, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r42 = new ModelRenderer(this);
        cube_r42.setRotationPoint(-0.6F, 0, -7.5F);
        bone5.addChild(cube_r42);
        setRotationAngle(cube_r42, 0, 0.0873F, 0);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 24, 105, -1, -1, 0, 1, 1, 1, 0, false));

        cube_r43 = new ModelRenderer(this);
        cube_r43.setRotationPoint(-0.6F, 0, -7.5F);
        bone5.addChild(cube_r43);
        setRotationAngle(cube_r43, 0.045F, 0.0748F, 0.5427F);
        cube_r43.cubeList.add(new ModelBox(cube_r43, 97, 93, -1, 0.15F, 0, 1, 1, 1, -0.001F, false));
        cube_r43.cubeList.add(new ModelBox(cube_r43, 9, 105, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r44 = new ModelRenderer(this);
        cube_r44.setRotationPoint(-0.45F, 0, -5.5F);
        bone5.addChild(cube_r44);
        setRotationAngle(cube_r44, 0.045F, 0.0748F, 0.5427F);
        cube_r44.cubeList.add(new ModelBox(cube_r44, 107, 62, -1, 0, 0, 1, 1, 1, 0, false));
        cube_r44.cubeList.add(new ModelBox(cube_r44, 73, 105, -1, 0.25F, 0, 1, 1, 1, -0.001F, false));

        cube_r45 = new ModelRenderer(this);
        cube_r45.setRotationPoint(-0.45F, 0, -5.5F);
        bone5.addChild(cube_r45);
        setRotationAngle(cube_r45, 0, 0.0873F, 0);
        cube_r45.cubeList.add(new ModelBox(cube_r45, 106, 28, -1, -1, 0, 1, 1, 1, 0, false));

        cube_r46 = new ModelRenderer(this);
        cube_r46.setRotationPoint(-0.45F, -1, -5.5F);
        bone5.addChild(cube_r46);
        setRotationAngle(cube_r46, -0.045F, 0.0748F, -0.5427F);
        cube_r46.cubeList.add(new ModelBox(cube_r46, 57, 60, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r47 = new ModelRenderer(this);
        cube_r47.setRotationPoint(-0.25F, -1, -3.5F);
        bone5.addChild(cube_r47);
        setRotationAngle(cube_r47, -0.045F, 0.0748F, -0.5427F);
        cube_r47.cubeList.add(new ModelBox(cube_r47, 63, 7, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r48 = new ModelRenderer(this);
        cube_r48.setRotationPoint(-0.25F, 0, -3.5F);
        bone5.addChild(cube_r48);
        setRotationAngle(cube_r48, 0.045F, 0.0748F, 0.5427F);
        cube_r48.cubeList.add(new ModelBox(cube_r48, 108, 9, -1, 0, 0, 1, 1, 1, 0, false));
        cube_r48.cubeList.add(new ModelBox(cube_r48, 0, 108, -1, 0.4F, 0, 1, 1, 1, -0.001F, false));

        cube_r49 = new ModelRenderer(this);
        cube_r49.setRotationPoint(-0.25F, 0, -3.5F);
        bone5.addChild(cube_r49);
        setRotationAngle(cube_r49, 0, 0.0873F, 0);
        cube_r49.cubeList.add(new ModelBox(cube_r49, 108, 3, -1, -1, 0, 1, 1, 1, 0, false));

        cube_r50 = new ModelRenderer(this);
        cube_r50.setRotationPoint(-0.1F, 0, -1.5F);
        bone5.addChild(cube_r50);
        setRotationAngle(cube_r50, 0.045F, 0.0748F, 0.5427F);
        cube_r50.cubeList.add(new ModelBox(cube_r50, 24, 108, -1, 0.5F, 0, 1, 1, 1, -0.001F, false));
        cube_r50.cubeList.add(new ModelBox(cube_r50, 108, 23, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r51 = new ModelRenderer(this);
        cube_r51.setRotationPoint(-0.1F, -1, -1.5F);
        bone5.addChild(cube_r51);
        setRotationAngle(cube_r51, -0.045F, 0.0748F, -0.5427F);
        cube_r51.cubeList.add(new ModelBox(cube_r51, 51, 68, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r52 = new ModelRenderer(this);
        cube_r52.setRotationPoint(-0.1F, 0, -1.5F);
        bone5.addChild(cube_r52);
        setRotationAngle(cube_r52, 0, 0.0873F, 0);
        cube_r52.cubeList.add(new ModelBox(cube_r52, 108, 17, -1, -1, 0, 1, 1, 1, 0, false));

        cube_r53 = new ModelRenderer(this);
        cube_r53.setRotationPoint(0.1F, 0, 0.5F);
        bone5.addChild(cube_r53);
        setRotationAngle(cube_r53, 0.045F, 0.0748F, 0.5427F);
        cube_r53.cubeList.add(new ModelBox(cube_r53, 108, 56, -1, 0.7F, 0, 1, 1, 1, -0.001F, false));
        cube_r53.cubeList.add(new ModelBox(cube_r53, 108, 64, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r54 = new ModelRenderer(this);
        cube_r54.setRotationPoint(0.1F, -1, 0.5F);
        bone5.addChild(cube_r54);
        setRotationAngle(cube_r54, -0.045F, 0.0748F, -0.5427F);
        cube_r54.cubeList.add(new ModelBox(cube_r54, 24, 70, -1, -2, 0, 1, 2, 1, 0, false));

        cube_r55 = new ModelRenderer(this);
        cube_r55.setRotationPoint(0.1F, 0, 0.5F);
        bone5.addChild(cube_r55);
        setRotationAngle(cube_r55, 0, 0.0873F, 0);
        cube_r55.cubeList.add(new ModelBox(cube_r55, 108, 66, -1, -1, 0, 1, 1, 1, 0, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(-5.05F, 1.5F, -3);
        Handguard_COMPACT.addChild(bone6);


        cube_r56 = new ModelRenderer(this);
        cube_r56.setRotationPoint(0.8F, -1, -9.5F);
        bone6.addChild(cube_r56);
        setRotationAngle(cube_r56, -0.045F, -0.0748F, 0.5427F);
        cube_r56.cubeList.add(new ModelBox(cube_r56, 17, 54, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r57 = new ModelRenderer(this);
        cube_r57.setRotationPoint(0.8F, 0, -9.5F);
        bone6.addChild(cube_r57);
        setRotationAngle(cube_r57, 0, -0.0873F, 0);
        cube_r57.cubeList.add(new ModelBox(cube_r57, 0, 101, 0, -1, 0, 1, 1, 1, 0, false));

        cube_r58 = new ModelRenderer(this);
        cube_r58.setRotationPoint(0.8F, 0, -9.5F);
        bone6.addChild(cube_r58);
        setRotationAngle(cube_r58, 0.045F, -0.0748F, -0.5427F);
        cube_r58.cubeList.add(new ModelBox(cube_r58, 15, 101, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r59 = new ModelRenderer(this);
        cube_r59.setRotationPoint(0.6F, -1, -7.5F);
        bone6.addChild(cube_r59);
        setRotationAngle(cube_r59, -0.045F, -0.0748F, 0.5427F);
        cube_r59.cubeList.add(new ModelBox(cube_r59, 40, 54, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r60 = new ModelRenderer(this);
        cube_r60.setRotationPoint(0.6F, 0, -7.5F);
        bone6.addChild(cube_r60);
        setRotationAngle(cube_r60, 0, -0.0873F, 0);
        cube_r60.cubeList.add(new ModelBox(cube_r60, 88, 101, 0, -1, 0, 1, 1, 1, 0, false));

        cube_r61 = new ModelRenderer(this);
        cube_r61.setRotationPoint(0.6F, 0, -7.5F);
        bone6.addChild(cube_r61);
        setRotationAngle(cube_r61, 0.045F, -0.0748F, -0.5427F);
        cube_r61.cubeList.add(new ModelBox(cube_r61, 102, 28, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r62 = new ModelRenderer(this);
        cube_r62.setRotationPoint(0.45F, 0, -5.5F);
        bone6.addChild(cube_r62);
        setRotationAngle(cube_r62, 0.045F, -0.0748F, -0.5427F);
        cube_r62.cubeList.add(new ModelBox(cube_r62, 102, 64, 0, 0, 0, 1, 1, 1, 0, false));
        cube_r62.cubeList.add(new ModelBox(cube_r62, 102, 66, 0, 0.1F, 0, 1, 1, 1, -0.001F, false));

        cube_r63 = new ModelRenderer(this);
        cube_r63.setRotationPoint(0.45F, 0, -5.5F);
        bone6.addChild(cube_r63);
        setRotationAngle(cube_r63, 0, -0.0873F, 0);
        cube_r63.cubeList.add(new ModelBox(cube_r63, 66, 102, 0, -1, 0, 1, 1, 1, 0, false));

        cube_r64 = new ModelRenderer(this);
        cube_r64.setRotationPoint(0.45F, -1, -5.5F);
        bone6.addChild(cube_r64);
        setRotationAngle(cube_r64, -0.045F, -0.0748F, 0.5427F);
        cube_r64.cubeList.add(new ModelBox(cube_r64, 57, 39, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r65 = new ModelRenderer(this);
        cube_r65.setRotationPoint(0.25F, -1, -3.5F);
        bone6.addChild(cube_r65);
        setRotationAngle(cube_r65, -0.045F, -0.0748F, 0.5427F);
        cube_r65.cubeList.add(new ModelBox(cube_r65, 57, 45, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r66 = new ModelRenderer(this);
        cube_r66.setRotationPoint(0.25F, 0, -3.5F);
        bone6.addChild(cube_r66);
        setRotationAngle(cube_r66, 0.045F, -0.0748F, -0.5427F);
        cube_r66.cubeList.add(new ModelBox(cube_r66, 91, 102, 0, 0, 0, 1, 1, 1, 0, false));
        cube_r66.cubeList.add(new ModelBox(cube_r66, 24, 103, 0, 0.3F, 0, 1, 1, 1, -0.001F, false));

        cube_r67 = new ModelRenderer(this);
        cube_r67.setRotationPoint(0.25F, 0, -3.5F);
        bone6.addChild(cube_r67);
        setRotationAngle(cube_r67, 0, -0.0873F, 0);
        cube_r67.cubeList.add(new ModelBox(cube_r67, 9, 103, 0, -1, 0, 1, 1, 1, 0, false));

        cube_r68 = new ModelRenderer(this);
        cube_r68.setRotationPoint(0.1F, 0, -1.5F);
        bone6.addChild(cube_r68);
        setRotationAngle(cube_r68, 0.045F, -0.0748F, -0.5427F);
        cube_r68.cubeList.add(new ModelBox(cube_r68, 103, 91, 0, 0.4F, 0, 1, 1, 1, -0.001F, false));
        cube_r68.cubeList.add(new ModelBox(cube_r68, 103, 93, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r69 = new ModelRenderer(this);
        cube_r69.setRotationPoint(0.1F, -1, -1.5F);
        bone6.addChild(cube_r69);
        setRotationAngle(cube_r69, -0.045F, -0.0748F, 0.5427F);
        cube_r69.cubeList.add(new ModelBox(cube_r69, 57, 54, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r70 = new ModelRenderer(this);
        cube_r70.setRotationPoint(0.1F, 0, -1.5F);
        bone6.addChild(cube_r70);
        setRotationAngle(cube_r70, 0, -0.0873F, 0);
        cube_r70.cubeList.add(new ModelBox(cube_r70, 103, 96, 0, -1, 0, 1, 1, 1, 0, false));

        cube_r71 = new ModelRenderer(this);
        cube_r71.setRotationPoint(-0.1F, 0, 0.5F);
        bone6.addChild(cube_r71);
        setRotationAngle(cube_r71, 0.045F, -0.0748F, -0.5427F);
        cube_r71.cubeList.add(new ModelBox(cube_r71, 103, 98, 0, 0.5F, 0, 1, 1, 1, -0.001F, false));
        cube_r71.cubeList.add(new ModelBox(cube_r71, 103, 101, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r72 = new ModelRenderer(this);
        cube_r72.setRotationPoint(-0.1F, -1, 0.5F);
        bone6.addChild(cube_r72);
        setRotationAngle(cube_r72, -0.045F, -0.0748F, 0.5427F);
        cube_r72.cubeList.add(new ModelBox(cube_r72, 0, 60, 0, -2, 0, 1, 2, 1, 0, false));

        cube_r73 = new ModelRenderer(this);
        cube_r73.setRotationPoint(-0.1F, 0, 0.5F);
        bone6.addChild(cube_r73);
        setRotationAngle(cube_r73, 0, -0.0873F, 0);
        cube_r73.cubeList.add(new ModelBox(cube_r73, 6, 104, 0, -1, 0, 1, 1, 1, 0, false));

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(-2.05F, 3.6F, -3);
        Handguard_COMPACT.addChild(bone7);
        setRotationAngle(bone7, 0, 0, -1.5708F);


        cube_r74 = new ModelRenderer(this);
        cube_r74.setRotationPoint(0.8F, 0, -9.5F);
        bone7.addChild(cube_r74);
        setRotationAngle(cube_r74, 0, -0.0873F, 0);
        cube_r74.cubeList.add(new ModelBox(cube_r74, 98, 28, 0, -0.95F, 0, 1, 1, 1, 0, false));

        cube_r75 = new ModelRenderer(this);
        cube_r75.setRotationPoint(0.8F, 0, -9.5F);
        bone7.addChild(cube_r75);
        setRotationAngle(cube_r75, 0.045F, -0.0748F, -0.5427F);
        cube_r75.cubeList.add(new ModelBox(cube_r75, 82, 98, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r76 = new ModelRenderer(this);
        cube_r76.setRotationPoint(0.6F, 0, -7.5F);
        bone7.addChild(cube_r76);
        setRotationAngle(cube_r76, 0, -0.0873F, 0);
        cube_r76.cubeList.add(new ModelBox(cube_r76, 97, 98, 0, -0.95F, 0, 1, 1, 1, 0, false));

        cube_r77 = new ModelRenderer(this);
        cube_r77.setRotationPoint(0.6F, 0, -7.5F);
        bone7.addChild(cube_r77);
        setRotationAngle(cube_r77, 0.045F, -0.0748F, -0.5427F);
        cube_r77.cubeList.add(new ModelBox(cube_r77, 97, 96, 0, 0.15F, 0, 1, 1, 1, -0.001F, false));
        cube_r77.cubeList.add(new ModelBox(cube_r77, 0, 99, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r78 = new ModelRenderer(this);
        cube_r78.setRotationPoint(0.45F, 0, -5.5F);
        bone7.addChild(cube_r78);
        setRotationAngle(cube_r78, 0.045F, -0.0748F, -0.5427F);
        cube_r78.cubeList.add(new ModelBox(cube_r78, 99, 0, 0, 0, 0, 1, 1, 1, 0, false));
        cube_r78.cubeList.add(new ModelBox(cube_r78, 99, 6, 0, 0.25F, 0, 1, 1, 1, -0.001F, false));

        cube_r79 = new ModelRenderer(this);
        cube_r79.setRotationPoint(0.45F, 0, -5.5F);
        bone7.addChild(cube_r79);
        setRotationAngle(cube_r79, 0, -0.0873F, 0);
        cube_r79.cubeList.add(new ModelBox(cube_r79, 99, 2, 0, -0.95F, 0, 1, 1, 1, 0, false));

        cube_r80 = new ModelRenderer(this);
        cube_r80.setRotationPoint(0.25F, 0, -3.5F);
        bone7.addChild(cube_r80);
        setRotationAngle(cube_r80, 0.045F, -0.0748F, -0.5427F);
        cube_r80.cubeList.add(new ModelBox(cube_r80, 99, 8, 0, 0, 0, 1, 1, 1, 0, false));
        cube_r80.cubeList.add(new ModelBox(cube_r80, 15, 99, 0, 0.4F, 0, 1, 1, 1, -0.001F, false));

        cube_r81 = new ModelRenderer(this);
        cube_r81.setRotationPoint(0.25F, 0, -3.5F);
        bone7.addChild(cube_r81);
        setRotationAngle(cube_r81, 0, -0.0873F, 0);
        cube_r81.cubeList.add(new ModelBox(cube_r81, 99, 14, 0, -0.95F, 0, 1, 1, 1, 0, false));

        cube_r82 = new ModelRenderer(this);
        cube_r82.setRotationPoint(0.1F, 0, -1.5F);
        bone7.addChild(cube_r82);
        setRotationAngle(cube_r82, 0.045F, -0.0748F, -0.5427F);
        cube_r82.cubeList.add(new ModelBox(cube_r82, 99, 16, 0, 0.5F, 0, 1, 1, 1, -0.001F, false));
        cube_r82.cubeList.add(new ModelBox(cube_r82, 99, 20, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r83 = new ModelRenderer(this);
        cube_r83.setRotationPoint(0.1F, 0, -1.5F);
        bone7.addChild(cube_r83);
        setRotationAngle(cube_r83, 0, -0.0873F, 0);
        cube_r83.cubeList.add(new ModelBox(cube_r83, 99, 22, 0, -0.95F, 0, 1, 1, 1, 0, false));

        cube_r84 = new ModelRenderer(this);
        cube_r84.setRotationPoint(-0.1F, 0, 0.5F);
        bone7.addChild(cube_r84);
        setRotationAngle(cube_r84, 0.045F, -0.0748F, -0.5427F);
        cube_r84.cubeList.add(new ModelBox(cube_r84, 42, 100, 0, 0.6F, 0, 1, 1, 1, -0.001F, false));
        cube_r84.cubeList.add(new ModelBox(cube_r84, 66, 100, 0, 0, 0, 1, 1, 1, 0, false));

        cube_r85 = new ModelRenderer(this);
        cube_r85.setRotationPoint(-0.1F, 0, 0.5F);
        bone7.addChild(cube_r85);
        setRotationAngle(cube_r85, 0, -0.0873F, 0);
        cube_r85.cubeList.add(new ModelBox(cube_r85, 91, 100, 0, -0.95F, 0, 1, 1, 1, 0, false));

        bone11 = new ModelRenderer(this);
        bone11.setRotationPoint(-2.95F, 3.6F, -3);
        Handguard_COMPACT.addChild(bone11);
        setRotationAngle(bone11, 0, 0, 1.5708F);


        cube_r86 = new ModelRenderer(this);
        cube_r86.setRotationPoint(-0.8F, 0, -9.5F);
        bone11.addChild(cube_r86);
        setRotationAngle(cube_r86, 0.045F, 0.0748F, 0.5427F);
        cube_r86.cubeList.add(new ModelBox(cube_r86, 53, 93, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r87 = new ModelRenderer(this);
        cube_r87.setRotationPoint(-0.6F, 0, -7.5F);
        bone11.addChild(cube_r87);
        setRotationAngle(cube_r87, 0.045F, 0.0748F, 0.5427F);
        cube_r87.cubeList.add(new ModelBox(cube_r87, 74, 93, -1, 0.15F, 0, 1, 1, 1, -0.001F, false));
        cube_r87.cubeList.add(new ModelBox(cube_r87, 0, 94, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r88 = new ModelRenderer(this);
        cube_r88.setRotationPoint(-0.45F, 0, -5.5F);
        bone11.addChild(cube_r88);
        setRotationAngle(cube_r88, 0.045F, 0.0748F, 0.5427F);
        cube_r88.cubeList.add(new ModelBox(cube_r88, 15, 94, -1, 0, 0, 1, 1, 1, 0, false));
        cube_r88.cubeList.add(new ModelBox(cube_r88, 94, 28, -1, 0.25F, 0, 1, 1, 1, -0.001F, false));

        cube_r89 = new ModelRenderer(this);
        cube_r89.setRotationPoint(-0.25F, 0, -3.5F);
        bone11.addChild(cube_r89);
        setRotationAngle(cube_r89, 0.045F, 0.0748F, 0.5427F);
        cube_r89.cubeList.add(new ModelBox(cube_r89, 94, 64, -1, 0, 0, 1, 1, 1, 0, false));
        cube_r89.cubeList.add(new ModelBox(cube_r89, 94, 66, -1, 0.4F, 0, 1, 1, 1, -0.001F, false));

        cube_r90 = new ModelRenderer(this);
        cube_r90.setRotationPoint(-0.1F, 0, -1.5F);
        bone11.addChild(cube_r90);
        setRotationAngle(cube_r90, 0.045F, 0.0748F, 0.5427F);
        cube_r90.cubeList.add(new ModelBox(cube_r90, 0, 96, -1, 0.5F, 0, 1, 1, 1, -0.001F, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 15, 96, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r91 = new ModelRenderer(this);
        cube_r91.setRotationPoint(0.1F, 0, 0.5F);
        bone11.addChild(cube_r91);
        setRotationAngle(cube_r91, 0.045F, 0.0748F, 0.5427F);
        cube_r91.cubeList.add(new ModelBox(cube_r91, 82, 96, -1, 0.6F, 0, 1, 1, 1, -0.001F, false));
        cube_r91.cubeList.add(new ModelBox(cube_r91, 97, 91, -1, 0, 0, 1, 1, 1, 0, false));

        bone8 = new ModelRenderer(this);
        bone8.setRotationPoint(0.2F, 1, -1);
        Handguard_COMPACT.addChild(bone8);
        setRotationAngle(bone8, 0, 0.0873F, 0);


        cube_r92 = new ModelRenderer(this);
        cube_r92.setRotationPoint(0, 68.8F, 0);
        bone8.addChild(cube_r92);
        setRotationAngle(cube_r92, 0, -0.0628F, 1.0821F);
        ...
        setRotationAngle(cube_r93, 0, -0.0628F, -1.0821F);
        cube_r93.cubeList.add(new ModelBox(cube_r93, 120, 72, -2, -1, -12.9F, 1, 1, 13, 0.001F, false));

        cube_r94 = new ModelRenderer(this);
        cube_r94.setRotationPoint(0, 0, 0);
        bone8.addChild(cube_r94);
        setRotationAngle(cube_r94, 0, 0, -1.0821F);
        cube_r94.cubeList.add(new ModelBox(cube_r94, 120, 86, -1, -1, -13, 1, 1, 13, 0, false));

        cube_r95 = new ModelRenderer(this);
        cube_r95.setRotationPoint(0, 0, 0);
        bone8.addChild(cube_r95);
        setRotationAngle(cube_r95, 0, 0, 1.0821F);
        cube_r95.cubeList.add(new ModelBox(cube_r95, 120, 108, -1, 0, -13, 1, 1, 13, 0, false));

        bone10 = new ModelRenderer(this);
        bone10.setRotationPoint(-5.2F, 1, -1);
        Handguard_COMPACT.addChild(bone10);
        setRotationAngle(bone10, 0, -0.0873F, 0);


        cube_r96 = new ModelRenderer(this);
        cube_r96.setRotationPoint(0, 68.8F, 0);
        bone10.addChild(cube_r96);
        setRotationAngle(cube_r96, 0, 0.0628F, -1.0821F);
        ...
        setRotationAngle(cube_r97, 0, 0.0628F, 1.0821F);
        cube_r97.cubeList.add(new ModelBox(cube_r97, 84, 14, 1, -1, -12.9F, 1, 1, 13, 0, false));

        cube_r98 = new ModelRenderer(this);
        cube_r98.setRotationPoint(0, 0, 0);
        bone10.addChild(cube_r98);
        setRotationAngle(cube_r98, 0, 0, 1.0821F);
        cube_r98.cubeList.add(new ModelBox(cube_r98, 82, 91, 0, -1, -13, 1, 1, 13, 0, false));

        cube_r99 = new ModelRenderer(this);
        cube_r99.setRotationPoint(0, 0, 0);
        bone10.addChild(cube_r99);
        setRotationAngle(cube_r99, 0, 0, -1.0821F);
        cube_r99.cubeList.add(new ModelBox(cube_r99, 0, 94, 0, 0, -13, 1, 1, 13, 0, false));

        bone9 = new ModelRenderer(this);
        bone9.setRotationPoint(-2.5F, 3.7F, -1);
        Handguard_COMPACT.addChild(bone9);
        setRotationAngle(bone9, 0, 0.0873F, 1.5708F);


        cube_r100 = new ModelRenderer(this);
        cube_r100.setRotationPoint(0, 68.8F, 0);
        bone9.addChild(cube_r100);
        setRotationAngle(cube_r100, 0, -0.0628F, 1.0821F);
        cube_r100.cubeList.add(new ModelBox(cube_r100, 0, 116, -62.6269F, -32.2996F, -9.0857F, 1, 1, 13, 0, false));

        cube_r101 = new ModelRenderer(this);
        cube_r101.setRotationPoint(0, 0, 0);
        bone9.addChild(cube_r101);
        setRotationAngle(cube_r101, 0, -0.0628F, -1.0821F);
        cube_r101.cubeList.add(new ModelBox(cube_r101, 38, 116, -2, -1, -12.9F, 1, 1, 13, 0, false));

        cube_r102 = new ModelRenderer(this);
        cube_r102.setRotationPoint(0, 0, 0);
        bone9.addChild(cube_r102);
        setRotationAngle(cube_r102, 0, 0, -1.0821F);
        cube_r102.cubeList.add(new ModelBox(cube_r102, 117, 31, -1, -1, -13, 1, 1, 13, -0.001F, false));

        cube_r103 = new ModelRenderer(this);
        cube_r103.setRotationPoint(0, 0, 0);
        bone9.addChild(cube_r103);
        setRotationAngle(cube_r103, 0, 0, 1.0821F);
        cube_r103.cubeList.add(new ModelBox(cube_r103, 117, 45, -1, 0, -13, 1, 1, 13, -0.001F, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 82, 91, 0, -4.001F, 0, 4, 4, 1, 0, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 64, 39, 0.75F, -1.08F, -0.8F, 3, 1, 1, 0, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 7, 16, 0, -3, -2, 1, 2, 2, 0, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 15, 104, 0, -4, -2, 2, 1, 2, -0.001F, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 0, 39, 0, -4.8F, -13.102F, 4, 3, 12, -0.05F, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 88, 64, -0.55F, -4.1F, -12.3F, 1, 1, 1, 0, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 76, 28, -0.55F, -4.1F, -9.8F, 1, 1, 1, 0, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 93, 64, 0, -5.35F, -13.1F, 2, 1, 5, -0.051F, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 51, 68, 0, -2.1F, -13.102F, 4, 1, 5, -0.051F, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 0, 0, 3.5F, -4, 0, 1, 4, 1, 0, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 0, 54, 1.25F, -1.3F, -13, 2, 1, 13, 0, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 7, 7, 3.5F, -3, -2, 1, 2, 2, 0, false));
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 7, 54, 3.5F, -4, -2, 1, 1, 2, -0.001F, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 17, 57, 4.05F, -4.1F, -12.3F, 1, 1, 1, 0, false));
        ...
        Handguard_KulaTactical_railmount.cubeList.add(new ModelBox(Handguard_KulaTactical_railmount, 63, 10, 4.05F, -4.1F, -9.8F, 1, 1, 1, 0, false));
        ...
        setRotationAngle(cube_r104, 0, 0, 1.1694F);
        ...
        setRotationAngle(cube_r105, 0, 0, -0.1222F);
        ...
        setRotationAngle(cube_r106, 0, 0, 0.6807F);
        ...
        setRotationAngle(cube_r107, 0, 0, -0.6807F);
        ...
        setRotationAngle(cube_r108, -0.4887F, 0, 0);
        ...
        setRotationAngle(cube_r109, -0.4887F, 0, 0);
        ...
        cube_r110.setRotationPoint(5, -1.25F, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r110);
        setRotationAngle(cube_r110, 0, -0.6283F, 0);
        ...
        setRotationAngle(cube_r111, 0.7854F, 0, 0);
        ...
        cube_r112.setRotationPoint(5, -2.8F, -4);
        ...
        cube_r113.setRotationPoint(5, -2.8F, -4);
        ...
        cube_r114.setRotationPoint(5, -2.8F, -4);
        ...
        cube_r115.setRotationPoint(5, -2, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r115);
        setRotationAngle(cube_r115, 0, 0, 0.576F);
        ...
        cube_r116.setRotationPoint(5, -2, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r116);
        setRotationAngle(cube_r116, 0.9425F, 0, 0.576F);
        cube_r116.cubeList.add(new ModelBox(cube_r116, 0, 46, -0.9F, 3.8F, 1.9F, 1, 2, 1, -0.101F, false));

        cube_r117 = new ModelRenderer(this);
        cube_r117.setRotationPoint(5, -4.8F, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r117);
        setRotationAngle(cube_r117, 0, -0.4712F, 0.7505F);
        cube_r117.cubeList.add(new ModelBox(cube_r117, 79, 72, -1.1F, -0.3F, 3, 3, 1, 3, -0.302F, false));

        cube_r118 = new ModelRenderer(this);
        cube_r118.setRotationPoint(5, -4.8F, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r118);
        setRotationAngle(cube_r118, 0, 0, 0.7505F);
        cube_r118.cubeList.add(new ModelBox(cube_r118, 24, 68, -2.7F, -0.3F, 3, 3, 1, 1, -0.301F, false));
        ...
        cube_r119.setRotationPoint(4.5F, 0, 0);
        Handguard_KulaTactical_railmount.addChild(cube_r119);
        setRotationAngle(cube_r119, 0.4538F, 0, 0);
        cube_r119.cubeList.add(new ModelBox(cube_r119, 40, 45, -1, -2, 0, 1, 2, 1, -0.001F, false));
        cube_r119.cubeList.add(new ModelBox(cube_r119, 96, 31, -4.5F, -2, -0.001F, 4, 2, 1, -0.001F, false));
        ...
        setRotationAngle(cube_r120, 0, 0, -1.2043F);
        ...
        cube_r120.cubeList.add(new ModelBox(cube_r120, 46, 18, -0.2F, -0.8F, 5, 1, 1, 2, -0.201F, false));
        ...
        setRotationAngle(cube_r121, 0, 0, 1.2043F);
        ...
        cube_r121.cubeList.add(new ModelBox(cube_r121, 46, 15, -0.8F, -0.8F, 5, 1, 1, 2, -0.201F, false));
        ...
        setRotationAngle(cube_r122, 0, 0, -1.1694F);
        ...
        setRotationAngle(cube_r123, 0, 0, 0.1222F);
        ...
        setRotationAngle(cube_r124, 0, 0, -0.6807F);
        ...
        setRotationAngle(cube_r125, 0, 0, 0.6807F);
        ...
        setRotationAngle(cube_r126, 0, 0.6283F, 0);
        ...
        cube_r127.setRotationPoint(-0.5F, -2.8F, -4);
        ...
        cube_r128.setRotationPoint(-0.5F, -2.8F, -4);
        ...
        cube_r129.setRotationPoint(-0.5F, -2.8F, -4);
        ...
        cube_r130.setRotationPoint(-0.5F, -2, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r130);
        setRotationAngle(cube_r130, 0, 0, -0.576F);
        ...
        cube_r131.setRotationPoint(-0.5F, -2, -8.4F);
        Handguard_KulaTactical_railmount.addChild(cube_r131);
        setRotationAngle(cube_r131, 0.9425F, 0, -0.576F);
        ...
        setRotationAngle(cube_r132, 0, 0.4712F, -0.7505F);
        cube_r132.cubeList.add(new ModelBox(cube_r132, 82, 83, -1.9F, -0.3F, 3, 3, 1, 3, -0.302F, false));
        ...
        setRotationAngle(cube_r133, 0, 0, -0.7505F);
        cube_r133.cubeList.add(new ModelBox(cube_r133, 38, 86, -0.3F, -0.3F, 3, 3, 1, 1, -0.301F, false));
        ...
        bone.setRotationPoint(0, 0.2F, 0);
        Suppressor.addChild(bone);


        cube_r134 = new ModelRenderer(this);
        cube_r134.setRotationPoint(0, 0, 0);
        ...
        cube_r135.setRotationPoint(0, 0, 0);
        ...
        bone4.setRotationPoint(0, 4.4F, 0);
        ...
        setRotationAngle(cube_r140, 0, 0, 0.4363F);
        ...
        setRotationAngle(cube_r141, 0, 0, -0.4363F);
        ...
        Action.cubeList.add(new ModelBox(Action, 149, 29, -1, -2.1F, 0, 1, 2, 11, 0, false));
        Action.cubeList.add(new ModelBox(Action, 26, 63, -1.8F, -1.2F, -0.001F, 2, 1, 1, 0, false));
        Action.cubeList.add(new ModelBox(Action, 7, 63, -1.8F, -1.2F, 3.5F, 2, 1, 1, 0, false));
        Action.cubeList.add(new ModelBox(Action, 47, 57, -3.7F, -1.2F, 1, 2, 1, 1, 0, false));
        Action.cubeList.add(new ModelBox(Action, 7, 23, -1, -2, 12, 1, 2, 2, 0, false));

        cube_r142 = new ModelRenderer(this);
        cube_r142.setRotationPoint(-0.6F, -2.1F, 0);
        Action.addChild(cube_r142);
        setRotationAngle(cube_r142, 0, 0, -1.2392F);
        cube_r142.cubeList.add(new ModelBox(cube_r142, 152, 86, 0, 0, 0, 2, 1, 11, 0, false));

        cube_r143 = new ModelRenderer(this);
        cube_r143.setRotationPoint(-1, -2.1F, 0);
        Action.addChild(cube_r143);
        setRotationAngle(cube_r143, 0, 0, -0.7505F);
        cube_r143.cubeList.add(new ModelBox(cube_r143, 152, 123, 0, 0, 0, 2, 1, 11, 0, false));

        cube_r144 = new ModelRenderer(this);
        cube_r144.setRotationPoint(0.2F, 0.8F, 2.7F);
        Action.addChild(cube_r144);
        setRotationAngle(cube_r144, 0, 0, -0.1745F);
        cube_r144.cubeList.add(new ModelBox(cube_r144, 104, 48, -1.6F, -2.4F, -2, 1, 1, 3, 0, false));

        cube_r145 = new ModelRenderer(this);
        cube_r145.setRotationPoint(-1.8F, -1.2F, 0);
        Action.addChild(cube_r145);
        setRotationAngle(cube_r145, 0, -0.7592F, 0);
        ...
        setRotationAngle(cube_r146, 0, 0.2007F, 0);
        ...
        cube_r147.setRotationPoint(-3.7F, -1.2F, 2);
        Action.addChild(cube_r147);
        setRotationAngle(cube_r147, 0, 0.8552F, 0);
        cube_r147.cubeList.add(new ModelBox(cube_r147, 121, 42, 0, 0, -1, 1, 1, 1, 0.001F, false));
