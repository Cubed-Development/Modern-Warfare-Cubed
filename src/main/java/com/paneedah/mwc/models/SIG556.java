...
public class SIG556 extends ModelWithAttachments {
    ...
    public SIG556() {
        ...
        gun.cubeList.add(new ModelBox(gun, 0, 76, -3.0F, -41, -15.25F, 1, 1, 8, 0.001F, false));
        ...
        grip12_r1.cubeList.add(new ModelBox(grip12_r1, 32, 42, 0.0F, -1, 8.3F, 4, 1, 1, 0.0F, false));
        grip12_r1.cubeList.add(new ModelBox(grip12_r1, 94, 131, 3.4F, -1, 8.3F, 1, 1, 1, -0.001F, false));
        grip12_r1.cubeList.add(new ModelBox(grip12_r1, 92, 84, 0.0F, -1, 0.0F, 4, 1, 9, 0.0F, false));
        grip12_r1.cubeList.add(new ModelBox(grip12_r1, 103, 105, 3.4F, -1, 0.0F, 1, 1, 9, 0.001F, false));
        ...
        grip6_r2.cubeList.add(new ModelBox(grip6_r2, 21, 54, -3.0F, -1, 0.0F, 3, 1, 1, -0.001F, false));
        ...
        grip6_r3.cubeList.add(new ModelBox(grip6_r3, 59, 31, -3.0F, -1, 0.0F, 3, 1, 1, -0.001F, false));
        ...
        grip7_r1.cubeList.add(new ModelBox(grip7_r1, 129, 91, -1, 0.0F, -1, 1, 1, 1, -0.001F, false));
        ...
        grip6_r4.cubeList.add(new ModelBox(grip6_r4, 97, 88, -1, 0.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        grip12_r2.cubeList.add(new ModelBox(grip12_r2, 71, 113, 0.0F, -1, 0.0F, 1, 1, 2, 0.001F, false));
        ...
        grip11_r1.cubeList.add(new ModelBox(grip11_r1, 114, 100, -1, -1, 0.0F, 1, 1, 2, 0.001F, false));
        ...
        grip12_r4.cubeList.add(new ModelBox(grip12_r4, 41, 102, -1, 2.0F, -1, 1, 2, 1, 0.001F, false));
        ...
        grip11_r3.cubeList.add(new ModelBox(grip11_r3, 118, 105, -1, 0.0F, -1, 1, 4, 1, 0.003F, false));
        ...
        grip12_r5.cubeList.add(new ModelBox(grip12_r5, 46, 57, 0.0F, -1, 0.0F, 4, 1, 3, 0.001F, false));
        grip12_r5.cubeList.add(new ModelBox(grip12_r5, 46, 112, 4.0F, -1, 0.0F, 1, 1, 4, 0.002F, false));
        ...
        grip12_r6.cubeList.add(new ModelBox(grip12_r6, 103, 16, 0.0F, -1, 0.0F, 1, 1, 7, 0.0F, false));
        ...
        grip12_r7.cubeList.add(new ModelBox(grip12_r7, 63, 129, 0.0F, -1, 0.0F, 1, 1, 1, 0.001F, false));
        ...
        grip11_r4.cubeList.add(new ModelBox(grip11_r4, 129, 101, 0.0F, -1, 0.0F, 1, 1, 1, 0.001F, false));
        grip11_r4.cubeList.add(new ModelBox(grip11_r4, 129, 103, 4.2F, -1, 0.0F, 1, 1, 1, 0.001F, false));
        ...
        grip12_r9.cubeList.add(new ModelBox(grip12_r9, 23, 33, -1, 0.0F, 0.0F, 1, 1, 6, 0.0F, false));
        ...
        grip11_r5.cubeList.add(new ModelBox(grip11_r5, 49, 0, -1, -1, 0.0F, 1, 1, 6, 0.0F, false));
        ...
        grip13_r4.cubeList.add(new ModelBox(grip13_r4, 129, 87, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip12_r10.cubeList.add(new ModelBox(grip12_r10, 129, 89, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip11_r6.cubeList.add(new ModelBox(grip11_r6, 90, 129, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip15_r3.cubeList.add(new ModelBox(grip15_r3, 56, 207, -1, 0.0F, 2.0F, 1, 1, 26, 0.002F, false));
        ...
        grip17_r1.cubeList.add(new ModelBox(grip17_r1, 86, 131, 0.0F, -1, 9.0F, 1, 1, 1, 0.001F, false));
        ...
        grip15_r4.cubeList.add(new ModelBox(grip15_r4, 180, 199, -1, -1, 0.0F, 1, 1, 26, 0.001F, false));
        ...
        grip14_r4.cubeList.add(new ModelBox(grip14_r4, 92, 104, 0.0F, -1, 0.0F, 1, 1, 9, 0.001F, false));
        ...
        grip14_r5.cubeList.add(new ModelBox(grip14_r5, 92, 177, -1, -3.0F, 0.0F, 1, 3, 26, 0.001F, false));
        ...
        grip14_r6.cubeList.add(new ModelBox(grip14_r6, 148, 200, -1, 0.0F, 2.0F, 1, 1, 26, 0.001F, false));
        ...
        grip13_r6.cubeList.add(new ModelBox(grip13_r6, 0, 92, 0.0F, -3.0F, 1, 1, 3, 16, 0.001F, false));
        ...
        grip16_r1.cubeList.add(new ModelBox(grip16_r1, 0, 67, 0.0F, -3.0F, -1, 1, 1, 8, 0.002F, false));
        grip16_r1.cubeList.add(new ModelBox(grip16_r1, 36, 118, 0.0F, -1, 0.0F, 1, 1, 7, 0.001F, false));
        ...
        grip13_r8.cubeList.add(new ModelBox(grip13_r8, 36, 92, 0.0F, -1, 0.0F, 1, 1, 3, 0.001F, false));
        ...
        grip12_r12.cubeList.add(new ModelBox(grip12_r12, 52, 92, -1, -1, 0.0F, 1, 1, 3, 0.001F, false));
        ...
        grip14_r8.cubeList.add(new ModelBox(grip14_r8, 94, 129, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip14_r9.cubeList.add(new ModelBox(grip14_r9, 86, 129, 0.0F, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip13_r9.cubeList.add(new ModelBox(grip13_r9, 129, 99, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip14_r10.cubeList.add(new ModelBox(grip14_r10, 129, 85, 0.0F, -1, 0.0F, 1, 1, 1, -0.2F, false));
        ...
        grip13_r10.cubeList.add(new ModelBox(grip13_r10, 129, 93, -1, -1, 0.0F, 1, 1, 1, -0.2F, false));
        ...
        grip12_r13.cubeList.add(new ModelBox(grip12_r13, 100, 129, -1, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        grip11_r7.cubeList.add(new ModelBox(grip11_r7, 62, 83, -1, -2.0F, 0.0F, 1, 2, 2, 0.001F, false));
        ...
        grip10_r2.cubeList.add(new ModelBox(grip10_r2, 23, 0, -1, -6.0F, 1.8F, 1, 6, 4, -0.001F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 103, 94, -0.1F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 82, 100, -3.9F, -1, 0.0F, 1, 1, 3, 0.0F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-3.9F, -1.65F, 0.0F);
        stock.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.0F, 0.8727F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 76, 97, 0.0F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        cube_r4.cubeList.add(new ModelBox(cube_r4, 118, 49, 0.0F, -0.8F, 1, 1, 1, 2, 0.0F, false));
        ...
        cube_r7.cubeList.add(new ModelBox(cube_r7, 51, 118, -1, -0.8F, 1, 1, 1, 2, 0.0F, false));
        cube_r7.cubeList.add(new ModelBox(cube_r7, 74, 131, -1, -1.4F, 0.7F, 1, 1, 1, -0.001F, false));
        cube_r7.cubeList.add(new ModelBox(cube_r7, 97, 98, -1, -2.2F, 0.0F, 1, 2, 1, 0.001F, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(0.9F, -1.65F, 0.0F);
        stock.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.0F, 0.0F, -0.8727F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 53, 102, -1, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        cube_r10.cubeList.add(new ModelBox(cube_r10, 69, 36, -1, -1, 0.0F, 2, 2, 7, 0.0F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 97, 37, -1, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 82, 92, 0.5F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        cube_r13.cubeList.add(new ModelBox(cube_r13, 92, 84, 0.0F, -1, 0.0F, 1, 1, 3, 0.001F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(0.0F, 0.0F, 0.0F);
        bone4.addChild(cube_r14);
        setRotationAngle(cube_r14, 0.0F, 0.0F, 0.4014F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 92, 88, -1, -1, 0.0F, 1, 1, 3, -0.001F, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 52, 96, -1, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));
    }
