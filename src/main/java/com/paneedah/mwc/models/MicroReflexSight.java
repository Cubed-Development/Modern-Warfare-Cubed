...
public class MicroReflexSight extends ModelBase {
    ...
    public MicroReflexSight() {
        ...
        bone4.setRotationPoint(-1, -14.25F, -4.0F);
        bone.addChild(bone4);
        ...
        bone5.cubeList.add(new ModelBox(bone5, 0, 0, -1, -2.0F, 0.0F, 1, 2, 3, 0.0F, false));

        bone11 = new ModelRenderer(this);
        bone11.setRotationPoint(7.0F, -14.25F, -1);
        bone.addChild(bone11);
        setRotationAngle(bone11, 0.2618F, 0.0F, -0.5236F);
        bone11.cubeList.add(new ModelBox(bone11, 0, 0, -1, -2.0F, 0.0F, 1, 2, 1, 0.0F, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(0.0F, -16.0F, -4.0F);
        bone.addChild(bone6);
        setRotationAngle(bone6, 0.0F, 0.0F, 2.7576F);
        bone6.cubeList.add(new ModelBox(bone6, 0, 0, -2.0F, -1, 0.0F, 2, 1, 3, 0.0F, false));

        bone14 = new ModelRenderer(this);
        bone14.setRotationPoint(-0.1F, -16.0F, -1.4F);
        bone.addChild(bone14);
        setRotationAngle(bone14, 0.0F, -0.3491F, 2.7576F);
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, -2.0F, -1, 0.0F, 2, 1, 1, 0.0F, false));

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(6.0F, -16.0F, -4.0F);
        bone.addChild(bone7);
        setRotationAngle(bone7, 0.0F, 0.0F, -2.7576F);
        bone7.cubeList.add(new ModelBox(bone7, 0, 0, 0.0F, -1, 0.0F, 2, 1, 3, 0.0F, false));

        bone13 = new ModelRenderer(this);
        bone13.setRotationPoint(6.1F, -16.0F, -1.4F);
        bone.addChild(bone13);
        setRotationAngle(bone13, 0.0F, 0.3491F, -2.7576F);
        bone13.cubeList.add(new ModelBox(bone13, 0, 0, 0.0F, -1, 0.0F, 2, 1, 1, 0.0F, false));
        ...
        bone8.cubeList.add(new ModelBox(bone8, 0, 0, 0.25F, -11, -1, 1, 1, 9, 0.0F, false));
        bone8.cubeList.add(new ModelBox(bone8, 0, 0, 4.75F, -11, -1, 1, 1, 9, 0.0F, false));
        ...
        bone8.cubeList.add(new ModelBox(bone8, 0, 0, -1, -14.25F, -4.0F, 1, 4, 4, 0.0F, false));
        ...
        bone9.setRotationPoint(-1, -14.25F, 0.0F);
        bone.addChild(bone9);
        ...
        bone10.cubeList.add(new ModelBox(bone10, 0, 0, -1, 0.0F, 0.0F, 1, 3, 8, 0.0F, false));

        bone15 = new ModelRenderer(this);
        bone15.setRotationPoint(7.8F, -10.75F, -4.5F);
        bone.addChild(bone15);
        setRotationAngle(bone15, 0.0F, 0.0F, 0.6981F);
        bone15.cubeList.add(new ModelBox(bone15, 0, 0, -1, -1, 0.0F, 2, 2, 11, 0.0F, false));

        bone16 = new ModelRenderer(this);
        bone16.setRotationPoint(0.0F, 0.0F, 0.0F);
        bone15.addChild(bone16);
        setRotationAngle(bone16, 0.0F, 0.0F, -0.4363F);
        bone16.cubeList.add(new ModelBox(bone16, 0, 0, -1, -1, -2.0F, 2, 2, 2, 0.0F, false));
    }
