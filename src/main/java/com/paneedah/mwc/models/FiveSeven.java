...
public class FiveSeven extends ModelWithAttachments {
    ...
    public FiveSeven() {
        ...
        gun22_r1.cubeList.add(new ModelBox(gun22_r1, 11, 47, -1, -1, 0.0F, 1, 1, 4, -0.002F, false));
        ...
        gun21_r1.cubeList.add(new ModelBox(gun21_r1, 10, 57, 0.0F, -1, 0.0F, 1, 1, 4, -0.002F, false));
        ...
        gun23_r1.cubeList.add(new ModelBox(gun23_r1, 69, 0, 0.0F, 0.0F, -1, 3, 1, 1, -0.002F, false));
        ...
        gun23_r2.cubeList.add(new ModelBox(gun23_r2, 58, 48, 0.0F, -2.0F, -1, 5, 2, 1, -0.001F, false));
        ...
        gun24_r1.cubeList.add(new ModelBox(gun24_r1, 73, 34, -1, -2.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        gun23_r3.cubeList.add(new ModelBox(gun23_r3, 73, 46, 0.0F, -2.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        gun23_r4.cubeList.add(new ModelBox(gun23_r4, 48, 38, 0.0F, -2.0F, -1, 3, 2, 1, 0.0F, false));
        ...
        gun21_r2.cubeList.add(new ModelBox(gun21_r2, 37, 88, -1, -1, 0.0F, 5, 1, 3, -0.001F, false));
        ...
        gun20_r1.cubeList.add(new ModelBox(gun20_r1, 23, 64, 0.0F, -1, -3.0F, 5, 1, 3, -0.001F, false));
        ...
        gun22_r3.cubeList.add(new ModelBox(gun22_r3, 42, 24, -1, 0.0F, 0.0F, 1, 3, 1, 0.0F, false));
        ...
        gun21_r4.cubeList.add(new ModelBox(gun21_r4, 12, 23, 0.0F, -1, 0.0F, 3, 6, 2, -0.002F, false));
        ...
        gun22_r4.cubeList.add(new ModelBox(gun22_r4, 0, 35, -1, 0.0F, -2.0F, 1, 4, 2, 0.0F, false));
        ...
        gun25_r1.cubeList.add(new ModelBox(gun25_r1, 4, 74, -1, 0.0F, -1.5F, 1, 1, 1, -0.001F, false));
        gun25_r1.cubeList.add(new ModelBox(gun25_r1, 0, 74, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun24_r3.cubeList.add(new ModelBox(gun24_r3, 79, 52, 0.0F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun21_r6.cubeList.add(new ModelBox(gun21_r6, 87, 79, -1, 0.0F, -6.0F, 1, 1, 6, -0.001F, false));
        ...
        gun22_r5.cubeList.add(new ModelBox(gun22_r5, 67, 79, -1, 0.0F, 0.0F, 1, 1, 1, -0.001F, false));
        ...
        gun19_r1.cubeList.add(new ModelBox(gun19_r1, 0, 18, 0.0F, -1, -2.0F, 5, 1, 2, -0.002F, false));
        ...
        gun20_r3.cubeList.add(new ModelBox(gun20_r3, 50, 75, -1, 0.0F, -11, 1, 1, 11, 0.0F, false));
        ...
        gun20_r4.cubeList.add(new ModelBox(gun20_r4, 75, 58, 0.0F, 0.75F, -11, 1, 1, 11, -0.001F, false));
        gun20_r4.cubeList.add(new ModelBox(gun20_r4, 74, 75, 0.0F, 0.0F, -11, 1, 1, 11, 0.0F, false));
        ...
        gun21_r8.cubeList.add(new ModelBox(gun21_r8, 10, 62, 0.0F, -1, -2.0F, 3, 1, 2, -0.001F, false));
        ...
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 63, 75, -1, -1, -1, 1, 1, 1, 0.0F, false));
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 75, 65, -1, -1, -2.75F, 1, 1, 1, 0.0F, false));
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 75, 67, -1, -1, -4.5F, 1, 1, 1, 0.0F, false));
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 75, 75, -1, -1, -6.25F, 1, 1, 1, 0.0F, false));
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 28, 88, -1.2F, -1, -7.3F, 1, 1, 7, -0.201F, false));
        gun26_r1.cubeList.add(new ModelBox(gun26_r1, 76, 1, -1, -1, -8.0F, 1, 1, 1, 0.0F, false));
        ...
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 75, 61, 0.0F, -1, -1, 1, 1, 1, 0.0F, false));
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 75, 63, 0.0F, -1, -2.75F, 1, 1, 1, 0.0F, false));
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 67, 75, 0.0F, -1, -4.5F, 1, 1, 1, 0.0F, false));
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 75, 70, 0.0F, -1, -6.25F, 1, 1, 1, 0.0F, false));
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 0, 76, 0.0F, -1, -8.0F, 1, 1, 1, 0.0F, false));
        ...
        gun20_r5.cubeList.add(new ModelBox(gun20_r5, 14, 75, -1, 0.0F, -1, 1, 1, 1, -0.1F, false));
        gun20_r5.cubeList.add(new ModelBox(gun20_r5, 27, 75, -5.3F, 0.0F, -1, 1, 1, 1, -0.1F, false));
        ...
        gun21_r9.cubeList.add(new ModelBox(gun21_r9, 7, 75, -1, 0.0F, -1, 1, 1, 1, -0.1F, false));
        gun21_r9.cubeList.add(new ModelBox(gun21_r9, 75, 23, -5.3F, 0.0F, -1, 1, 1, 1, -0.1F, false));
        ...
        gun23_r6.cubeList.add(new ModelBox(gun23_r6, 74, 26, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        gun23_r6.cubeList.add(new ModelBox(gun23_r6, 75, 15, -5.1F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun22_r6.cubeList.add(new ModelBox(gun22_r6, 74, 20, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        gun22_r6.cubeList.add(new ModelBox(gun22_r6, 21, 75, -5.1F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun23_r7.cubeList.add(new ModelBox(gun23_r7, 67, 68, -1, 0.0F, -1.35F, 1, 1, 1, -0.201F, false));
        gun23_r7.cubeList.add(new ModelBox(gun23_r7, 67, 64, -1, 0.0F, -1, 1, 1, 1, -0.2F, false));
        ...
        gun22_r7.cubeList.add(new ModelBox(gun22_r7, 73, 28, 0.0F, -0.9F, -1, 1, 1, 1, -0.2F, false));
        ...
        gun22_r8.cubeList.add(new ModelBox(gun22_r8, 73, 55, 0.0F, 0.0F, -1, 1, 1, 1, -0.2F, false));
        ...
        gun22_r9.cubeList.add(new ModelBox(gun22_r9, 58, 71, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun22_r10.cubeList.add(new ModelBox(gun22_r10, 54, 19, -1, 0.0F, -2.0F, 1, 1, 2, 0.0F, false));
        ...
        gun21_r10.cubeList.add(new ModelBox(gun21_r10, 31, 59, -1, 0.0F, -2.0F, 1, 1, 2, 0.0F, false));
        ...
        gun23_r8.cubeList.add(new ModelBox(gun23_r8, 39, 66, -1, 0.7F, 0.0F, 1, 1, 1, -0.001F, false));
        gun23_r8.cubeList.add(new ModelBox(gun23_r8, 66, 54, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun24_r6.cubeList.add(new ModelBox(gun24_r6, 54, 3, -1, 0.7F, 0.0F, 1, 1, 1, -0.101F, false));
        gun24_r6.cubeList.add(new ModelBox(gun24_r6, 63, 27, -1, 0.0F, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        gun21_r11.cubeList.add(new ModelBox(gun21_r11, 45, 15, -1, 0.0F, -2.0F, 1, 1, 2, 0.0F, false));
        ...
        gun19_r2.cubeList.add(new ModelBox(gun19_r2, 11, 0, -1, 0.0F, -4.0F, 1, 1, 4, -0.002F, false));
        ...
        gun17_r2.setRotationPoint(1, -25.0F, 1.3F);
        gun_body.addChild(gun17_r2);
        setRotationAngle(gun17_r2, 0.2747F, -0.593F, -0.1562F);
        gun17_r2.cubeList.add(new ModelBox(gun17_r2, 24, 36, -1, 0.0F, 0.0F, 1, 6, 1, 0.0F, false));
        gun17_r2.cubeList.add(new ModelBox(gun17_r2, 16, 5, -1, 0.0F, 0.6F, 1, 6, 1, -0.001F, false));

        gun18_r2 = new ModelRenderer(this);
        gun18_r2.setRotationPoint(1, -25.0F, 1.3F);
        gun_body.addChild(gun18_r2);
        setRotationAngle(gun18_r2, 0.6371F, 0.8542F, 0.509F);
        gun18_r2.cubeList.add(new ModelBox(gun18_r2, 31, 0, -1, -4.0F, -1, 1, 4, 1, -0.001F, false));
        gun18_r2.cubeList.add(new ModelBox(gun18_r2, 0, 0, -1.6F, -4.0F, -1, 1, 4, 1, -0.002F, false));
        ...
        gun18_r3.cubeList.add(new ModelBox(gun18_r3, 48, 24, 0.6F, -4.0F, -1, 1, 4, 1, -0.002F, false));
        gun18_r3.cubeList.add(new ModelBox(gun18_r3, 41, 48, 0.0F, -4.0F, -1, 1, 4, 1, -0.001F, false));
        ...
        gun17_r3.cubeList.add(new ModelBox(gun17_r3, 0, 57, 1, -4.0F, -7.0F, 3, 4, 1, -0.001F, false));
        ...
        gun20_r8.cubeList.add(new ModelBox(gun20_r8, 69, 2, 0.0F, -1, -1.7F, 3, 1, 1, -0.002F, false));
        gun20_r8.cubeList.add(new ModelBox(gun20_r8, 69, 4, 0.0F, -1, -1, 3, 1, 1, -0.001F, false));
        ...
        gun20_r10.cubeList.add(new ModelBox(gun20_r10, 73, 49, 0.0F, 0.0F, -1, 1, 2, 1, -0.001F, false));
        ...
        gun18_r4.cubeList.add(new ModelBox(gun18_r4, 27, 69, 0.0F, -1, -5.0F, 3, 1, 5, 0.0F, false));
        ...
        gun16_r1.cubeList.add(new ModelBox(gun16_r1, 0, 47, 1, 0.0F, -7.0F, 3, 6, 1, 0.0F, false));
        ...
        gun91_r1.cubeList.add(new ModelBox(gun91_r1, 79, 55, 0.0F, -1, 0.0F, 1, 1, 1, -0.001F, false));
        gun91_r1.cubeList.add(new ModelBox(gun91_r1, 53, 79, 0.0F, -1, 0.7F, 1, 1, 1, -0.002F, false));
        ...
        gun91_r2.cubeList.add(new ModelBox(gun91_r2, 63, 79, -1, -1, 0.0F, 1, 1, 1, -0.001F, false));
