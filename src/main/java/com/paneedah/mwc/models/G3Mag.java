...
public class G3Mag extends ModelWithAttachments {
    ...
    public G3Mag() {
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 16, 55, -1, 0.0F, -4.0F, 1, 4, 3, 0.0F, false));
        cube_r18.cubeList.add(new ModelBox(cube_r18, 76, 27, -1, -1, -4.0F, 1, 1, 4, 0.0F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 16, 64, -0.7F, -1, -4.0F, 3, 1, 4, 0.0F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(-3.15F, -1.7F, 0.55F);
        mag.addChild(cube_r19);
        setRotationAngle(cube_r19, 0.0F, 0.0F, 0.5411F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 38, 62, 0.002F, -1, -4.0F, 1, 1, 4, 0.0F, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(0.15F, -1.7F, 0.55F);
        mag.addChild(cube_r20);
        setRotationAngle(cube_r20, 0.0F, 0.0F, -0.5411F);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 62, 64, -0.998F, -1, -4.0F, 1, 1, 4, 0.0F, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-2.15F, 3.1F, -0.9F);
        mag.addChild(cube_r21);
        setRotationAngle(cube_r21, -0.3142F, 0.0F, 0.0F);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 82, 56, -1, -1, -7.3F, 1, 1, 1, 0.0F, false));
        cube_r21.cubeList.add(new ModelBox(cube_r21, 40, 0, -1, -1, -7.0F, 1, 1, 7, 0.0F, false));
        cube_r21.cubeList.add(new ModelBox(cube_r21, 0, 14, -0.7F, -1, -7.3F, 3, 1, 1, 0.0F, false));
        cube_r21.cubeList.add(new ModelBox(cube_r21, 40, 8, 1.3F, -1, -7.0F, 1, 1, 7, 0.0F, false));
        ...
        cube_r22.cubeList.add(new ModelBox(cube_r22, 40, 17, -3.0F, 0.3F, -1, 3, 15, 1, 0.0F, false));
        ...
        cube_r23.cubeList.add(new ModelBox(cube_r23, 26, 64, -1, -1, 0.0F, 1, 1, 3, -0.2F, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(0.1F, 14.1F, -6.1F);
        mag.addChild(cube_r24);
        setRotationAngle(cube_r24, -0.0349F, -0.1047F, -1.1868F);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 67, 11, 0.0F, -1, -3.3F, 1, 1, 2, -0.2F, false));
        cube_r24.cubeList.add(new ModelBox(cube_r24, 88, 74, 0.0F, -1, 0.0F, 1, 1, 3, -0.2F, false));
        ...
        cube_r25.cubeList.add(new ModelBox(cube_r25, 67, 17, -1, 8.3F, -2.0F, 1, 1, 2, -0.3F, false));
        ...
        cube_r26.cubeList.add(new ModelBox(cube_r26, 67, 20, -1, 6.3F, -2.0F, 1, 1, 2, -0.3F, false));
        ...
        cube_r27.cubeList.add(new ModelBox(cube_r27, 67, 25, -1, 4.3F, -2.0F, 1, 1, 2, -0.3F, false));
        ...
        cube_r28.cubeList.add(new ModelBox(cube_r28, 67, 28, -1, 2.3F, -2.0F, 1, 1, 2, -0.3F, false));
        ...
        cube_r28.cubeList.add(new ModelBox(cube_r28, 76, 61, -1, 0.3F, -2.0F, 1, 1, 2, -0.3F, false));
        cube_r28.cubeList.add(new ModelBox(cube_r28, 54, 81, 1.8F, 0.3F, -2.0F, 1, 1, 2, -0.3F, false));

        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.35F, 1, -6.0F);
        mag.addChild(bone2);
        setRotationAngle(bone2, -0.3142F, 0.0F, 0.0F);
        bone2.cubeList.add(new ModelBox(bone2, 82, 54, -1, -1, -1, 1, 1, 1, 0.0F, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(0.0F, 0.0F, 0.0F);
        bone2.addChild(cube_r29);
        setRotationAngle(cube_r29, 0.0F, 0.0F, 0.6981F);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 82, 51, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r30 = new ModelRenderer(this);
        cube_r30.setRotationPoint(0.0F, -1, -1);
        bone2.addChild(cube_r30);
        setRotationAngle(cube_r30, 0.0F, -1.1519F, 0.0F);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 82, 45, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(0.0F, -1, 0.0F);
        bone2.addChild(cube_r31);
        setRotationAngle(cube_r31, 0.0F, 1.1519F, 0.0F);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 82, 49, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(-3.35F, 0.7F, -6.95F);
        mag.addChild(bone5);
        setRotationAngle(bone5, 0.3142F, 3.1416F, 0.0F);
        bone5.cubeList.add(new ModelBox(bone5, 76, 49, -1, -1, -1.05F, 1, 1, 1, 0.0F, false));

        cube_r32 = new ModelRenderer(this);
        cube_r32.setRotationPoint(0.0F, 0.0F, -0.05F);
        bone5.addChild(cube_r32);
        setRotationAngle(cube_r32, 0.0F, 0.0F, 0.6981F);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 76, 29, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(0.0F, -1, -1.05F);
        bone5.addChild(cube_r33);
        setRotationAngle(cube_r33, 0.0F, -1.1519F, 0.0F);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 76, 43, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r34 = new ModelRenderer(this);
        cube_r34.setRotationPoint(0.0F, -1, -0.05F);
        bone5.addChild(cube_r34);
        setRotationAngle(cube_r34, 0.0F, 1.1519F, 0.0F);
        cube_r34.cubeList.add(new ModelBox(cube_r34, 76, 45, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(-3.35F, 1.5F, -4.35F);
        mag.addChild(bone6);
        setRotationAngle(bone6, 0.3142F, 3.1416F, 0.0F);
        bone6.cubeList.add(new ModelBox(bone6, 76, 27, -1, -1, -0.95F, 1, 1, 1, 0.0F, false));

        cube_r35 = new ModelRenderer(this);
        cube_r35.setRotationPoint(0.0F, 0.0F, 0.05F);
        bone6.addChild(cube_r35);
        setRotationAngle(cube_r35, 0.0F, 0.0F, 0.6981F);
        cube_r35.cubeList.add(new ModelBox(cube_r35, 24, 72, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r36 = new ModelRenderer(this);
        cube_r36.setRotationPoint(0.0F, -1, -0.95F);
        bone6.addChild(cube_r36);
        setRotationAngle(cube_r36, 0.0F, -1.1519F, 0.0F);
        cube_r36.cubeList.add(new ModelBox(cube_r36, 0, 74, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r37 = new ModelRenderer(this);
        cube_r37.setRotationPoint(0.0F, -1, 0.05F);
        bone6.addChild(cube_r37);
        setRotationAngle(cube_r37, 0.0F, 1.1519F, 0.0F);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 11, 74, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(-3.35F, 2.3F, -1.88F);
        mag.addChild(bone7);
        setRotationAngle(bone7, 0.3142F, 3.1416F, 0.0F);
        bone7.cubeList.add(new ModelBox(bone7, 11, 72, -1, -1, -0.92F, 1, 1, 1, 0.0F, false));

        cube_r38 = new ModelRenderer(this);
        cube_r38.setRotationPoint(0.0F, 0.0F, 0.08F);
        bone7.addChild(cube_r38);
        setRotationAngle(cube_r38, 0.0F, 0.0F, 0.6981F);
        cube_r38.cubeList.add(new ModelBox(cube_r38, 68, 64, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r39 = new ModelRenderer(this);
        cube_r39.setRotationPoint(0.0F, -1, -0.92F);
        bone7.addChild(cube_r39);
        setRotationAngle(cube_r39, 0.0F, -1.1519F, 0.0F);
        cube_r39.cubeList.add(new ModelBox(cube_r39, 68, 66, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r40 = new ModelRenderer(this);
        cube_r40.setRotationPoint(0.0F, -1, 0.08F);
        bone7.addChild(cube_r40);
        setRotationAngle(cube_r40, 0.0F, 1.1519F, 0.0F);
        cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 72, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(0.35F, 1.8F, -3.4F);
        mag.addChild(bone3);
        setRotationAngle(bone3, -0.3142F, 0.0F, 0.0F);
        bone3.cubeList.add(new ModelBox(bone3, 82, 43, -1, -1, -1, 1, 1, 1, 0.0F, false));

        cube_r41 = new ModelRenderer(this);
        cube_r41.setRotationPoint(0.0F, 0.0F, 0.0F);
        bone3.addChild(cube_r41);
        setRotationAngle(cube_r41, 0.0F, 0.0F, 0.6981F);
        cube_r41.cubeList.add(new ModelBox(cube_r41, 80, 70, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r42 = new ModelRenderer(this);
        cube_r42.setRotationPoint(0.0F, -1, -1);
        bone3.addChild(cube_r42);
        setRotationAngle(cube_r42, 0.0F, -1.1519F, 0.0F);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 82, 27, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r43 = new ModelRenderer(this);
        cube_r43.setRotationPoint(0.0F, -1, 0.0F);
        bone3.addChild(cube_r43);
        setRotationAngle(cube_r43, 0.0F, 1.1519F, 0.0F);
        cube_r43.cubeList.add(new ModelBox(cube_r43, 82, 29, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(0.35F, 2.6F, -1);
        mag.addChild(bone4);
        setRotationAngle(bone4, -0.3142F, 0.0F, 0.0F);
        bone4.cubeList.add(new ModelBox(bone4, 76, 70, -1, -1, -1, 1, 1, 1, 0.0F, false));

        cube_r44 = new ModelRenderer(this);
        cube_r44.setRotationPoint(0.0F, 0.0F, 0.0F);
        bone4.addChild(cube_r44);
        setRotationAngle(cube_r44, 0.0F, 0.0F, 0.6981F);
        cube_r44.cubeList.add(new ModelBox(cube_r44, 76, 51, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));

        cube_r45 = new ModelRenderer(this);
        cube_r45.setRotationPoint(0.0F, -1, -1);
        bone4.addChild(cube_r45);
        setRotationAngle(cube_r45, 0.0F, -1.1519F, 0.0F);
        cube_r45.cubeList.add(new ModelBox(cube_r45, 76, 54, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        cube_r46 = new ModelRenderer(this);
        cube_r46.setRotationPoint(0.0F, -1, 0.0F);
        bone4.addChild(cube_r46);
        setRotationAngle(cube_r46, 0.0F, 1.1519F, 0.0F);
        cube_r46.cubeList.add(new ModelBox(cube_r46, 76, 56, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
    }
