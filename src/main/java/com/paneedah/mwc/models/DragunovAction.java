...
public class DragunovAction extends ModelWithAttachments {
    ...
    public DragunovAction() {
        ...
        action.cubeList.add(new ModelBox(action, 46, 47, 0.3F, -1, -20.0F, 1, 1, 20, 0.0F, false));
        action.cubeList.add(new ModelBox(action, 46, 68, 0.0F, -1, -19.5F, 1, 1, 3, 0.0F, false));
        ...
        cube_r98.cubeList.add(new ModelBox(cube_r98, 48, 44, 0.0F, -1, 0.0F, 3, 1, 1, -0.001F, false));
        ...
        cube_r99.cubeList.add(new ModelBox(cube_r99, 73, 39, 0.0F, -1, -2.0F, 1, 1, 2, 0.002F, false));
        ...
        cube_r100.cubeList.add(new ModelBox(cube_r100, 42, 44, 0.0F, -1, 0.0F, 1, 1, 1, 0.001F, false));
    }
