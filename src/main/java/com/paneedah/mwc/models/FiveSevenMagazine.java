...
public class FiveSevenMagazine extends ModelWithAttachments {
    ...
    public FiveSevenMagazine() {
        ...
        cube_r30.cubeList.add(new ModelBox(cube_r30, 50, 64, -4.0F, -1, -7.7F, 3, 1, 1, 0.001F, false));
        cube_r30.cubeList.add(new ModelBox(cube_r30, 86, 39, -4.5F, -1, -7.0F, 4, 1, 7, 0.0F, false));
        ...
        cube_r32.cubeList.add(new ModelBox(cube_r32, 0, 0, -1, -13.0F, -5.0F, 3, 13, 5, 0.0F, false));
