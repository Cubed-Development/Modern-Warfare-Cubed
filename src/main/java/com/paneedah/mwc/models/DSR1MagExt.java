...
public class DSR1MagExt extends ModelWithAttachments {
    ...
    public DSR1MagExt() {
        ...
        magazine_ext.setRotationPoint(0, -3, 7.1F);
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 66, 91, -1.2F, -5.4F, 0, 1, 5, 10, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 0, 0, -2.8F, -5.4F, 0, 2, 5, 10, -0.001F, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 26, 92, -3, -0.4F, -0.25F, 3, 7, 5, 0.1F, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 0, 69, -0.75F, -0.501F, -0.05F, 1, 1, 4, 0, false));
        ...
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 68, 46, -0.75F, -0.501F, 5.95F, 1, 1, 4, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 105, 28, -0.75F, 0.499F, 5.95F, 1, 6, 1, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 58, 69, -0.75F, 0.499F, 2.95F, 1, 6, 1, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 21, 77, -0.75F, 0.799F, 3.95F, 1, 1, 2, 0, false));
        ...
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 55, 63, -3.25F, 0.499F, 2.95F, 1, 6, 1, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 74, 18, -3.25F, 0.799F, 3.95F, 1, 1, 2, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 58, 14, -3.25F, 0.499F, 5.95F, 1, 6, 1, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 68, 41, -3.25F, -0.501F, 5.95F, 1, 1, 4, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 35, 21, -3.25F, -0.501F, -0.05F, 1, 1, 4, 0, false));
        magazine_ext.cubeList.add(new ModelBox(magazine_ext, 129, 82, -3, -0.4F, 4.15F, 3, 7, 6, 0.101F, false));

        cube_r142_r1 = new ModelRenderer(this);
        cube_r142_r1.setRotationPoint(3.3052F, 26.8284F, -7.1F);
        magazine_ext.addChild(cube_r142_r1);
        setRotationAngle(cube_r142_r1, 0, 0, -0.1222F);
        cube_r142_r1.cubeList.add(new ModelBox(cube_r142_r1, 39, 37, -0.75F, -30.101F, 11.05F, 1, 3, 2, 0, false));

        cube_r141_r1 = new ModelRenderer(this);
        cube_r141_r1.setRotationPoint(-3.3276F, 27.1941F, -7.1F);
        magazine_ext.addChild(cube_r141_r1);
        setRotationAngle(cube_r141_r1, 0, 0, 0.1222F);
        cube_r141_r1.cubeList.add(new ModelBox(cube_r141_r1, 22, 37, -3.25F, -30.101F, 11.05F, 1, 3, 2, 0, false));

        cube_r140_r1 = new ModelRenderer(this);
        cube_r140_r1.setRotationPoint(2.4855F, 26.9045F, -7.1F);
        magazine_ext.addChild(cube_r140_r1);
        setRotationAngle(cube_r140_r1, 0, 0, -0.0873F);
        cube_r140_r1.cubeList.add(new ModelBox(cube_r140_r1, 21, 82, -0.85F, -27.501F, 11.05F, 1, 1, 2, 0, false));

        cube_r139_r1 = new ModelRenderer(this);
        cube_r139_r1.setRotationPoint(2.4506F, 26.9061F, -7.1F);
        magazine_ext.addChild(cube_r139_r1);
        setRotationAngle(cube_r139_r1, 0, 0, -0.0873F);
        ...
        setRotationAngle(cube_r138_r1, 0, 0, 0.0873F);
        cube_r138_r1.cubeList.add(new ModelBox(cube_r138_r1, 6, 77, -3.15F, -27.501F, 11.05F, 1, 1, 2, 0, false));

        cube_r137_r1 = new ModelRenderer(this);
        cube_r137_r1.setRotationPoint(-2.462F, 27.1676F, -7.1F);
        magazine_ext.addChild(cube_r137_r1);
        setRotationAngle(cube_r137_r1, 0, 0, 0.0873F);
