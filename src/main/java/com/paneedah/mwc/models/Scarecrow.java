...
public class Scarecrow extends ModelBase {
    ...
    public Scarecrow() {
        ...
        bone2.setRotationPoint(-1, -5.0F, -2.0F);
        ...
        bone4.setRotationPoint(-18.0F, -9.5F, -1);
        bone2.addChild(bone4);
        setRotationAngle(bone4, -0.1047F, -0.1047F, 0.0349F);
        bone4.cubeList.add(new ModelBox(bone4, 0, 0, -6.0F, -1, 0.0F, 49, 3, 3, 0.0F, false));
        ...
        bone6.cubeList.add(new ModelBox(bone6, 60, 71, -7.0F, -1, 0.0F, 7, 1, 16, 0.1F, false));
        ...
        bone8.cubeList.add(new ModelBox(bone8, 80, 22, -7.0F, -1, -1, 7, 1, 7, 0.1F, false));

        bone9 = new ModelRenderer(this);
        bone9.setRotationPoint(0.0F, -1, -1);
        ...
        bone10.setRotationPoint(0.0F, -1, 6.0F);
        ...
        bone11.setRotationPoint(0.0F, -1, -1);
        ...
        bone12.setRotationPoint(-7.0F, -1, -1);
        ...
        bone15.cubeList.add(new ModelBox(bone15, 48, 37, -3.0F, -1, 0.0F, 9, 1, 13, 0.0F, false));

        bone16 = new ModelRenderer(this);
        bone16.setRotationPoint(9.25F, -8.05F, -2.8F);
        bone2.addChild(bone16);
        setRotationAngle(bone16, 0.6283F, -1.0996F, -0.5411F);
        bone16.cubeList.add(new ModelBox(bone16, 79, 37, -1, -1, 0.0F, 11, 1, 10, 0.0F, false));
        ...
        bone18.setRotationPoint(0.0F, 1, 0.0F);
        bone17.addChild(bone18);
        setRotationAngle(bone18, 0.0349F, 0.0F, -0.0175F);
        bone18.cubeList.add(new ModelBox(bone18, 0, 6, -40.0F, -1, 0.0F, 40, 25, 0, 0.0F, false));
        ...
        bone19.cubeList.add(new ModelBox(bone19, 0, 6, -40.0F, -1, 0.0F, 40, 25, 0, 0.0F, false));
    }
