...
public class Soldier extends ModelBiped {
    ...
    public Soldier() {
        ...
        head.cubeList.add(new ModelBox(head, 54, 29, -4, -0.9F, -4.1F, 8, 1, 1, 0.1F, false));
        ...
        head_r1.cubeList.add(new ModelBox(head_r1, 40, 54, 0, -1, 0, 1, 4, 4, 0, false));

        head_r2 = new ModelRenderer(this);
        head_r2.setRotationPoint(4.5F, -5.8F, 3.35F);
        head.addChild(head_r2);
        setRotation(head_r2, 0.3142F, 0, 0);
        head_r2.cubeList.add(new ModelBox(head_r2, 50, 20, -9, 0, 0, 9, 3, 1, 0, false));

        head_r3 = new ModelRenderer(this);
        head_r3.setRotationPoint(4.9F, -4.8F, -0.05F);
        head.addChild(head_r3);
        setRotation(head_r3, 0.2946F, 0.0356F, -0.1169F);
        head_r3.cubeList.add(new ModelBox(head_r3, 0, 55, -1, -1, 0, 1, 4, 4, 0, false));

        head_r4 = new ModelRenderer(this);
        head_r4.setRotationPoint(4, -5.2F, -4.5F);
        head.addChild(head_r4);
        setRotation(head_r4, -0.1745F, 0, 0);
        head_r4.cubeList.add(new ModelBox(head_r4, 0, 51, -8, -3, 0, 8, 3, 1, 0.31F, false));

        head_r5 = new ModelRenderer(this);
        head_r5.setRotationPoint(-3.1F, 0.1F, -3);
        head.addChild(head_r5);
        setRotation(head_r5, 0.5247F, -0.0604F, -0.0349F);
        head_r5.cubeList.add(new ModelBox(head_r5, 12, 51, -1, -1, 0, 1, 1, 6, 0.1F, false));

        head_r6 = new ModelRenderer(this);
        head_r6.setRotationPoint(3.1F, 0.1F, -3);
        head.addChild(head_r6);
        setRotation(head_r6, 0.5247F, 0.0604F, 0.0349F);
        head_r6.cubeList.add(new ModelBox(head_r6, 20, 52, 0, -1, 0, 1, 1, 6, 0.1F, false));

        body = new ModelRenderer(this);
        body.setRotationPoint(0, 0, 0);
        body.cubeList.add(new ModelBox(body, 30, 21, -4, 0, -2, 8, 12, 4, 0.1F, false));
        body.cubeList.add(new ModelBox(body, 48, 48, -4, 2.75F, -2.75F, 8, 7, 1, 0, false));
        ...
        body.cubeList.add(new ModelBox(body, 48, 0, -4, 1.75F, 1.55F, 8, 8, 1, 0, false));

        body_r1 = new ModelRenderer(this);
        body_r1.setRotationPoint(1.5F, 1.75F, 2.55F);
        body.addChild(body_r1);
        setRotation(body_r1, 0.1222F, 0, 0);
        body_r1.cubeList.add(new ModelBox(body_r1, 54, 31, -5, -2, -1, 7, 2, 1, 0, false));

        body_r2 = new ModelRenderer(this);
        body_r2.setRotationPoint(1.5F, 2.75F, -2.75F);
        body.addChild(body_r2);
        setRotation(body_r2, -0.1222F, 0, 0);
        body_r2.cubeList.add(new ModelBox(body_r2, 0, 16, 0, -3, 0, 2, 3, 1, 0, false));
        body_r2.cubeList.add(new ModelBox(body_r2, 0, 20, -5, -3, 0, 2, 3, 1, 0, false));

        body_r3 = new ModelRenderer(this);
        body_r3.setRotationPoint(4.1F, 11.15F, -3.35F);
        body.addChild(body_r3);
        setRotation(body_r3, 0.0336F, -0.1964F, 0.2175F);
        body_r3.cubeList.add(new ModelBox(body_r3, 32, 60, -3, -4, 0, 3, 4, 2, 0, false));

        body_r4 = new ModelRenderer(this);
        body_r4.setRotationPoint(-3.9F, 10.45F, -4.15F);
        body.addChild(body_r4);
        setRotation(body_r4, 0.0268F, 0.8894F, 0.0886F);
        body_r4.cubeList.add(new ModelBox(body_r4, 60, 34, -3, -4, 0, 3, 4, 2, 0, false));

        body_r5 = new ModelRenderer(this);
        body_r5.setRotationPoint(-2.8F, 8.85F, -2.95F);
        body.addChild(body_r5);
        setRotation(body_r5, -0.0175F, 0, 0.7679F);
        body_r5.cubeList.add(new ModelBox(body_r5, 50, 56, -2, -10, 0, 2, 10, 1, 0, false));

        body_r6 = new ModelRenderer(this);
        body_r6.setRotationPoint(0.4F, 5.65F, -3.35F);
        body.addChild(body_r6);
        setRotation(body_r6, -0.0339F, 0.061F, -0.9086F);
        body_r6.cubeList.add(new ModelBox(body_r6, 0, 5, -2, -4, 0, 2, 2, 1, 0, false));
        ...
        leftleg.cubeList.add(new ModelBox(leftleg, 54, 24, -2, 1.35F, -2, 4, 1, 4, 0.1F, false));
        leftleg.cubeList.add(new ModelBox(leftleg, 28, 53, -2, 3.45F, -2, 4, 1, 4, 0.1F, false));

        leftleg_r1 = new ModelRenderer(this);
        leftleg_r1.setRotationPoint(3, 5, -1.5F);
        leftleg.addChild(leftleg_r1);
        setRotation(leftleg_r1, -0.0073F, -0.1045F, 0.0702F);
        leftleg_r1.cubeList.add(new ModelBox(leftleg_r1, 22, 59, -2, -4, 0, 2, 4, 3, 0, false));
