...
public class AudiS4SteeringWheel extends ModelBase {
    ...
    public AudiS4SteeringWheel() {
        ...
        interior_wheel.setRotationPoint(-16, -5, 29);


        bone111 = new ModelRenderer(this);
        bone111.setRotationPoint(-52.5F, -2, 0.5F);
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 41, 37, 48.9542F, 15.3347F, -16.396F, 4, 2, 2, 0, false));

        bone110 = new ModelRenderer(this);
        bone110.setRotationPoint(-59.5F, -2, 0.5F);
        ...
        setRotationAngle(cube_r2, 0, 0.1745F, 0);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 101, 110, 49.7921F, -16.9764F, 14.3154F, 4, 2, 2, 0, false));

        bone112 = new ModelRenderer(this);
        bone112.setRotationPoint(-53.5F, 0, -1.7F);
        ...
        cube_r3.cubeList.add(new ModelBox(cube_r3, 19, 102, 52.0466F, -0.5F, 4.4179F, 1, 1, 5, 0, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-1, -3.5F, 5.5F);
        bone112.addChild(cube_r4);
        setRotationAngle(cube_r4, 0, -0.1309F, 0);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 117, 129, 55.0209F, -0.5F, -9.8095F, 1, 1, 5, 0, false));

        bone116 = new ModelRenderer(this);
        bone116.setRotationPoint(-57, -7, -0.3F);
        interior_wheel.addChild(bone116);
        setRotationAngle(bone116, 0.2269F, -0.1745F, 1.2217F);
        bone116.cubeList.add(new ModelBox(bone116, 62, 132, 18.8621F, -53.0222F, 8.5969F, 2, 7, 2, 0, false));

        bone117 = new ModelRenderer(this);
        bone117.setRotationPoint(-55.5F, 5, 4.3F);
        interior_wheel.addChild(bone117);
        setRotationAngle(bone117, -0.0698F, 0.4189F, -1.8151F);
        bone117.cubeList.add(new ModelBox(bone117, 150, 121, -14.3764F, 53.5886F, -1.7066F, 2, 6, 2, 0, false));

        bone118 = new ModelRenderer(this);
        bone118.setRotationPoint(-56.5F, 5, 4.3F);
        interior_wheel.addChild(bone118);
        setRotationAngle(bone118, -0.0698F, -0.4189F, 1.8151F);
        bone118.cubeList.add(new ModelBox(bone118, 160, 142, -12.3764F, -55.5886F, 1.7066F, 2, 6, 2, 0, false));

        bone115 = new ModelRenderer(this);
        bone115.setRotationPoint(-55, -7, -0.3F);
        interior_wheel.addChild(bone115);
        setRotationAngle(bone115, 0.2269F, 0.1745F, -1.2217F);
        bone115.cubeList.add(new ModelBox(bone115, 101, 142, 16.8621F, 51.0222F, -8.5969F, 2, 7, 2, 0, false));
        ...
        bone114.cubeList.add(new ModelBox(bone114, 60, 35, 51.2592F, 0.2015F, 16.1556F, 2, 10, 2, 0, false));
        ...
        bone113.cubeList.add(new ModelBox(bone113, 176, 101, 53.2592F, -12.2015F, -16.1556F, 2, 10, 2, 0, false));

        bone109 = new ModelRenderer(this);
        bone109.setRotationPoint(-55.5F, -4, -1);
        interior_wheel.addChild(bone109);
        setRotationAngle(bone109, -1.4137F, 0, 0);
        bone109.cubeList.add(new ModelBox(bone109, 102, 287, 53, -4, 2, 5, 4, 4, 0, false));
    }
