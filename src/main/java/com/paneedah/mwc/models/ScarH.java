...
public class ScarH extends ModelWithAttachments {
    ...
    public ScarH() {
        ...
        gun.addChild(gun132);
        setRotationAngle(gun132, 0, 0, -1.5783F);
        ...
        lowerreceiver.setRotationPoint(0, 0, 0);
        gun.addChild(lowerreceiver);
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 39, 14, -2.999F, -31, -7.5F, 3, 5, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 65, 93, 0.15F, -36, -15.55F, 1, 2, 1, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 130, 79, 0.2F, -34.5F, -15.551F, 1, 1, 1, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 130, 54, -0.1F, -35.5F, -15.8F, 1, 1, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 120, 68, 0.4F, -35.2F, -18.4F, 1, 1, 1, 0, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 96, 117, 0.2F, -32, -16.7F, 1, 1, 1, -0.201F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 36, 103, 0.1F, -33.7F, -6.3F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 22, 106, 0, -33.7F, -7.7F, 1, 1, 1, -0.301F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 30, 103, -4.1F, -33.7F, -6.3F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 4, 106, -4, -33.7F, -7.7F, 1, 1, 1, -0.301F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 81, 63, -0.25F, -32.7F, -20, 1, 1, 4, -0.16F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 91, 103, 0.2F, -31.8F, -16.7F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 129, 108, -0.1F, -35.5F, -15.3F, 1, 1, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 55, 48, -3.5F, -35.8F, -28.2F, 4, 2, 3, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 24, -3.5F, -36, -23.2F, 4, 8, 8, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 40, -3.5F, -28, -20.2F, 4, 1, 5, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 112, 19, -3.5F, -35.5F, -16, 4, 5, 14, -0.001F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 89, 103, -3.8F, -33.6F, -14, 1, 1, 1, -0.099F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 83, 103, -3.8F, -33.2F, -14, 1, 1, 1, -0.097F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 55, 67, -3.001F, -32, -15.8F, 3, 5, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 14, -3.001F, -26.75F, -14.3F, 3, 1, 7, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 39, 56, -3.5F, -36, -25.6F, 4, 7, 3, 0.001F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 16, 47, -3, -33.6F, -2, 3, 2, 4, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 24, 94, -3.5F, -36, -2.001F, 4, 3, 4, 0, false));

        gun58_r1 = new ModelRenderer(this);
        gun58_r1.setRotationPoint(0.499F, -33.8F, -28.2F);
        lowerreceiver.addChild(gun58_r1);
        setRotationAngle(gun58_r1, 0.925F, 0, 0);
        gun58_r1.cubeList.add(new ModelBox(gun58_r1, 90, 19, -3.999F, 0, 0, 4, 1, 1, -0.002F, false));

        gun31_r1 = new ModelRenderer(this);
        gun31_r1.setRotationPoint(-3.2F, -30.5F, -13.4F);
        lowerreceiver.addChild(gun31_r1);
        setRotationAngle(gun31_r1, 2.3562F, 0, 0);
        gun31_r1.cubeList.add(new ModelBox(gun31_r1, 63, 99, 0.2F, -2, 0, 3, 2, 1, 0, false));
        ...
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 99, 64, 0.2F, -2, -1, 3, 2, 1, 0, false));
        ...
        gun29_r1.cubeList.add(new ModelBox(gun29_r1, 39, 66, 0.2F, -1, -2, 3, 1, 2, 0, false));
        ...
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 40, 0, 0.1F, 0.0806F, 0.0981F, 4, 8, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 66, 72, 0.101F, -2.7194F, 0.098F, 4, 3, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 73, 0, 3.7F, 0.08F, 0.098F, 1, 8, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 55, 11, 3.699F, -2.72F, 0.1F, 1, 3, 1, 0, false));
        ...
        gun52_r1.cubeList.add(new ModelBox(gun52_r1, 34, 0, 0.065F, -2.4F, 0.085F, 1, 10, 1, 0, false));
        ...
        gun53_r1.cubeList.add(new ModelBox(gun53_r1, 73, 24, 0.065F, 7, 0.085F, 1, 1, 1, -0.001F, false));
        ...
        gun52_r2.cubeList.add(new ModelBox(gun52_r2, 118, 54, -1.065F, 7, 0.085F, 1, 1, 1, -0.001F, false));
        ...
        gun51_r2.cubeList.add(new ModelBox(gun51_r2, 39, 80, -1.065F, -2.4F, 0.085F, 1, 10, 1, 0, false));

        gun58_r2 = new ModelRenderer(this);
        gun58_r2.setRotationPoint(-3.5F, -33.5F, -27.2F);
        lowerreceiver.addChild(gun58_r2);
        setRotationAngle(gun58_r2, 0.9082F, 0, 0);
        gun58_r2.cubeList.add(new ModelBox(gun58_r2, 66, 63, 0, -0.123F, 0.1577F, 4, 2, 1, -0.004F, false));

        gun63_r1 = new ModelRenderer(this);
        gun63_r1.setRotationPoint(-2, -29.4F, -10.35F);
        lowerreceiver.addChild(gun63_r1);
        setRotationAngle(gun63_r1, -0.1297F, 0, 0);
        gun63_r1.cubeList.add(new ModelBox(gun63_r1, 79, 24, 0, -2, 0, 1, 4, 1, 0, false));

        gun131_r1 = new ModelRenderer(this);
        gun131_r1.setRotationPoint(1, -34.2F, -16.5F);
        lowerreceiver.addChild(gun131_r1);
        setRotationAngle(gun131_r1, 0, 0.5236F, 0);
        gun131_r1.cubeList.add(new ModelBox(gun131_r1, 120, 61, -1, -1, -1, 1, 1, 1, -0.002F, false));

        gun130_r1 = new ModelRenderer(this);
        gun130_r1.setRotationPoint(1.4F, -34.2F, -17.4F);
        lowerreceiver.addChild(gun130_r1);
        setRotationAngle(gun130_r1, 0, 1.1519F, 0);
        gun130_r1.cubeList.add(new ModelBox(gun130_r1, 120, 59, -1, -1, -1, 1, 1, 1, -0.001F, false));

        gun130_r2 = new ModelRenderer(this);
        gun130_r2.setRotationPoint(1, -34.2F, -19.3F);
        lowerreceiver.addChild(gun130_r2);
        setRotationAngle(gun130_r2, 0, -0.5236F, 0);
        gun130_r2.cubeList.add(new ModelBox(gun130_r2, 120, 63, -1, -1, 0, 1, 1, 1, -0.002F, false));

        gun129_r1 = new ModelRenderer(this);
        gun129_r1.setRotationPoint(1.4F, -34.2F, -18.4F);
        lowerreceiver.addChild(gun129_r1);
        setRotationAngle(gun129_r1, 0, -1.1519F, 0);
        gun129_r1.cubeList.add(new ModelBox(gun129_r1, 120, 66, -1, -1, 0, 1, 1, 1, -0.001F, false));

        gun131_r2 = new ModelRenderer(this);
        gun131_r2.setRotationPoint(1, -31, -14.9F);
        lowerreceiver.addChild(gun131_r2);
        setRotationAngle(gun131_r2, 0, -0.6632F, 0);
        ...
        setRotationAngle(gun131_r3, 0, -0.2094F, 0);
        gun131_r3.cubeList.add(new ModelBox(gun131_r3, 104, 117, -1, -1, 0.5F, 1, 1, 1, -0.001F, false));
        gun131_r3.cubeList.add(new ModelBox(gun131_r3, 118, 16, -1, -1, 0, 1, 1, 1, 0, false));

        gun131_r4 = new ModelRenderer(this);
        gun131_r4.setRotationPoint(1.1F, -31.7F, -15.8F);
        lowerreceiver.addChild(gun131_r4);
        setRotationAngle(gun131_r4, 0, 0.1745F, 0);
        gun131_r4.cubeList.add(new ModelBox(gun131_r4, 92, 117, -1, -1, -0.9F, 1, 1, 1, -0.15F, false));

        gun132_r1 = new ModelRenderer(this);
        gun132_r1.setRotationPoint(-3.9F, -31.9F, -6.7F);
        lowerreceiver.addChild(gun132_r1);
        setRotationAngle(gun132_r1, 0.4538F, 0, 0);
        gun132_r1.cubeList.add(new ModelBox(gun132_r1, 94, 80, 0, -2, 0, 1, 2, 2, -0.2F, false));
        gun132_r1.cubeList.add(new ModelBox(gun132_r1, 93, 95, 3.8F, -2, 0, 1, 2, 2, -0.2F, false));

        gun134_r1 = new ModelRenderer(this);
        gun134_r1.setRotationPoint(-3.6F, -32.9F, -4.5F);
        lowerreceiver.addChild(gun134_r1);
        setRotationAngle(gun134_r1, 0.4538F, 0, 0);
        gun134_r1.cubeList.add(new ModelBox(gun134_r1, 59, 103, 0, -2, 0, 1, 1, 1, -0.1F, false));
        gun134_r1.cubeList.add(new ModelBox(gun134_r1, 10, 106, 3.2F, -2, 0, 1, 1, 1, -0.1F, false));

        gun133_r1 = new ModelRenderer(this);
        gun133_r1.setRotationPoint(-3.7F, -29.8F, -8.7F);
        lowerreceiver.addChild(gun133_r1);
        setRotationAngle(gun133_r1, 0.4538F, 0, 0);
        gun133_r1.cubeList.add(new ModelBox(gun133_r1, 40, 103, 0, -2, 0, 1, 1, 1, -0.2F, false));
        gun133_r1.cubeList.add(new ModelBox(gun133_r1, 16, 106, 3.4F, -2, 0, 1, 1, 1, -0.2F, false));
        ...
        gun60.cubeList.add(new ModelBox(gun60, 101, 129, 0, 2.2633F, -5.0376F, 1, 1, 1, 0, false));
        gun60.cubeList.add(new ModelBox(gun60, 97, 129, -3.2F, 2.2633F, -5.0376F, 1, 1, 1, 0, false));
        ...
        barrel.setRotationPoint(0, 0.7F, 3.4F);
        gun.addChild(barrel);
        barrel.cubeList.add(new ModelBox(barrel, 135, 94, -1.8F, -37.8F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 135, 33, -2.2F, -37.8F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 134, 19, -2.2F, -38.2F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 133, 57, -1.8F, -38.2F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 23, 132, -1.6F, -38, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 79, 80, -2.4F, -38, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 24, 80, -2, -37.6F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 79, 57, -2, -38.4F, -87.5F, 1, 1, 13, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 75, 111, -2, -38.55F, -61.5F, 1, 1, 6, 0.1F, false));
        barrel.cubeList.add(new ModelBox(barrel, 79, 24, -2, -39.65F, -60.4F, 1, 1, 5, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 12, 103, -2, -39.65F, -61.6F, 1, 1, 2, -0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 39, 47, -2, -40.85F, -59.5F, 1, 1, 5, 0.3F, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 8, 24, -2, -42.35F, -58.8F, 1, 1, 3, 0.2F, false));
        barrel.cubeList.add(new ModelBox(barrel, 79, 94, -2, -44.35F, -58.1F, 1, 2, 2, 0, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 34, 95, -2, -37.55F, -61.5F, 1, 1, 6, 0.1F, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 167, 0, -2.2F, -38, -77.499F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 148, 166, -1.8F, -38, -77.501F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 165, 112, -2, -37.8F, -77.5F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 165, 54, -2, -38.2F, -77.5F, 1, 1, 47, 0, false));

        gun710_r1 = new ModelRenderer(this);
        gun710_r1.setRotationPoint(-2.6F, -39.05F, -61.8F);
        barrel.addChild(gun710_r1);
        setRotationAngle(gun710_r1, 0, 0, 0.5411F);
        gun710_r1.cubeList.add(new ModelBox(gun710_r1, 42, 27, -0.1F, -1, 0, 1, 1, 4, -0.2F, false));

        gun709_r1 = new ModelRenderer(this);
        gun709_r1.setRotationPoint(-0.4F, -39.05F, -61.8F);
        barrel.addChild(gun709_r1);
        setRotationAngle(gun709_r1, 0, 0, -0.5411F);
        gun709_r1.cubeList.add(new ModelBox(gun709_r1, 79, 80, -0.9F, -1, 0, 1, 1, 4, -0.2F, false));

        gun708_r1 = new ModelRenderer(this);
        gun708_r1.setRotationPoint(-0.4F, -41.05F, -59.8F);
        barrel.addChild(gun708_r1);
        setRotationAngle(gun708_r1, 0, 0, -0.5411F);
        gun708_r1.cubeList.add(new ModelBox(gun708_r1, 0, 103, -0.9F, -1, 0, 1, 1, 2, -0.002F, false));

        gun707_r1 = new ModelRenderer(this);
        gun707_r1.setRotationPoint(-2.6F, -41.05F, -59.8F);
        barrel.addChild(gun707_r1);
        setRotationAngle(gun707_r1, 0, 0, 0.5411F);
        gun707_r1.cubeList.add(new ModelBox(gun707_r1, 6, 103, -0.1F, -1, 0, 1, 1, 2, -0.001F, false));

        gun706_r1 = new ModelRenderer(this);
        gun706_r1.setRotationPoint(-2.4F, -41.45F, -57.2F);
        barrel.addChild(gun706_r1);
        setRotationAngle(gun706_r1, -0.3491F, 0, 0);
        gun706_r1.cubeList.add(new ModelBox(gun706_r1, 85, 90, -0.1F, -1, 0, 2, 1, 1, 0, false));

        upperreceiver = new ModelRenderer(this);
        upperreceiver.setRotationPoint(0.65F, -12.5F, -49);
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 133, 166, -4.45F, -1.999F, -2, 4, 3, 25, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 94, 27, -4.95F, -1.4F, 18.5F, 1, 1, 4, 0, false));
        ...
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 90, 14, -0.35F, -1.4F, 18.5F, 1, 1, 4, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 50, 165, -4.45F, -2, 35, 1, 3, 16, 0, false));
        ...
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 0, 0, -0.85F, -2, -2, 1, 3, 53, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 112, 0, -1.7F, -5.4F, -2, 1, 1, 18, 0.001F, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 55, 111, -1.7F, -5.4F, 33, 1, 3, 18, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 94, 32, -1.7F, -4.5F, -2, 1, 1, 4, -0.001F, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 93, 129, -1.7F, -4.5F, 5, 1, 1, 1, -0.001F, false));
        ...
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 110, 133, -1.7F, -3.6F, -2, 1, 1, 17, 0, false));
        ...
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 127, 115, -3.6F, -5.4F, -2, 1, 1, 17, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 55, 132, -3.6F, -3.6F, -2, 1, 1, 17, 0, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 83, 48, -3.6F, -4.5F, -2, 1, 1, 4, -0.001F, false));
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 83, 120, -3.6F, -4.5F, 5, 1, 1, 1, -0.001F, false));
        ...
        upperreceiver.cubeList.add(new ModelBox(upperreceiver, 110, 79, -3.6F, -5.4F, 33, 1, 3, 18, 0, false));
        ...
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 56, 0, 0, -2, 1, 1, 53, -0.001F, false));
        ...
        cube_r14.setRotationPoint(-3.6F, -3.8F, 6);
        ...
        cube_r15.setRotationPoint(-3.6F, -4.2F, 6);
        ...
        cube_r16.setRotationPoint(-3.6F, -3.8F, 5);
        ...
        cube_r17.setRotationPoint(-3.6F, -3.8F, 2);
        ...
        cube_r18.setRotationPoint(-3.6F, -4.2F, 5);
        ...
        cube_r19.setRotationPoint(-3.6F, -4.2F, 2);
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 55, 57, -1, 0, -2, 1, 1, 53, 0, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-4.45F, -2, 0);
        upperreceiver.addChild(cube_r21);
        setRotationAngle(cube_r21, 0, 0, 0.6283F);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 110, 58, 0, -1, -2, 1, 1, 53, 0.001F, false));
        cube_r21.cubeList.add(new ModelBox(cube_r21, 0, 110, 0, -1.58F, -2, 1, 1, 53, -0.001F, false));

        cube_r22 = new ModelRenderer(this);
        cube_r22.setRotationPoint(0.15F, -2, 0);
        upperreceiver.addChild(cube_r22);
        setRotationAngle(cube_r22, 0, 0, -0.6283F);
        cube_r22.cubeList.add(new ModelBox(cube_r22, 55, 111, -1, -1, -2, 1, 1, 53, 0.001F, false));
        cube_r22.cubeList.add(new ModelBox(cube_r22, 112, 0, -1, -1.58F, -2, 1, 1, 53, -0.001F, false));

        cube_r23 = new ModelRenderer(this);
        cube_r23.setRotationPoint(-5.75F, -1.6F, 35.2F);
        upperreceiver.addChild(cube_r23);
        setRotationAngle(cube_r23, 0, 0.0873F, 0);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 99, 49, 0, -0.1F, 0, 3, 2, 1, 0, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(-5.75F, -1.6F, 35.2F);
        upperreceiver.addChild(cube_r24);
        setRotationAngle(cube_r24, 0, 0.2618F, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 55, 99, 0, -0.1F, 0, 3, 2, 1, -0.001F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(-4.45F, 0.6F, 23);
        ...
        cube_r26.setRotationPoint(-4.45F, -1.4F, 23);
        ...
        cube_r27.cubeList.add(new ModelBox(cube_r27, 122, 21, -1, 0, 0, 1, 1, 1, 0, false));
        cube_r27.cubeList.add(new ModelBox(cube_r27, 122, 19, -1, 0.3F, 0, 1, 1, 1, 0.001F, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(0.65F, -1.4F, 19.5F);
        upperreceiver.addChild(cube_r28);
        setRotationAngle(cube_r28, 0, 0, 0.4189F);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 90, 71, -1, 0, -1, 1, 1, 4, -0.001F, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(0.95F, -1.4F, 21.7F);
        upperreceiver.addChild(cube_r29);
        setRotationAngle(cube_r29, -0.2967F, 0, 0);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 121, 121, -1.05F, 0, 0, 1, 1, 1, -0.2F, false));
        cube_r29.cubeList.add(new ModelBox(cube_r29, 75, 122, -6.15F, 0, 0, 1, 1, 1, -0.2F, false));

        cube_r30 = new ModelRenderer(this);
        cube_r30.setRotationPoint(0.95F, -1.4F, 18.7F);
        upperreceiver.addChild(cube_r30);
        setRotationAngle(cube_r30, -0.2967F, 0, 0);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 121, 119, -1.05F, 0, 0, 1, 1, 1, -0.2F, false));
        cube_r30.cubeList.add(new ModelBox(cube_r30, 122, 54, -6.15F, 0, 0, 1, 1, 1, -0.2F, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(0.75F, -1.4F, 20.2F);
        upperreceiver.addChild(cube_r31);
        setRotationAngle(cube_r31, -0.2967F, 0, 0);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 121, 117, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));
        cube_r31.cubeList.add(new ModelBox(cube_r31, 79, 122, -5.85F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r32 = new ModelRenderer(this);
        cube_r32.setRotationPoint(0.65F, -0.1F, 19.5F);
        upperreceiver.addChild(cube_r32);
        setRotationAngle(cube_r32, 0, 0, -0.4189F);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 79, 85, -1, -1, -1, 1, 1, 4, -0.001F, false));
        ...
        cube_r33.cubeList.add(new ModelBox(cube_r33, 30, 106, -1, -1, -2, 1, 1, 2, 0, false));

        cube_r34 = new ModelRenderer(this);
        cube_r34.setRotationPoint(0.65F, -1.1F, 18.5F);
        upperreceiver.addChild(cube_r34);
        setRotationAngle(cube_r34, 0, 0.2443F, 0);
        cube_r34.cubeList.add(new ModelBox(cube_r34, 24, 106, -1, 0, -2, 1, 1, 2, 0.001F, false));
        cube_r34.cubeList.add(new ModelBox(cube_r34, 18, 106, -1, -0.3F, -2, 1, 1, 2, 0, false));
        ...
        cube_r35.cubeList.add(new ModelBox(cube_r35, 12, 106, -1, 0, -2, 1, 1, 2, 0, false));

        cube_r36 = new ModelRenderer(this);
        cube_r36.setRotationPoint(0.25F, -1.1F, 50);
        upperreceiver.addChild(cube_r36);
        setRotationAngle(cube_r36, -0.2967F, 0, 0);
        cube_r36.cubeList.add(new ModelBox(cube_r36, 79, 120, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));
        cube_r36.cubeList.add(new ModelBox(cube_r36, 120, 81, -4.85F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r37 = new ModelRenderer(this);
        cube_r37.setRotationPoint(-2.85F, -5.4F, -0.6F);
        upperreceiver.addChild(cube_r37);
        setRotationAngle(cube_r37, -0.2967F, 0, 0);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 36, 94, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));
        cube_r37.cubeList.add(new ModelBox(cube_r37, 96, 16, 1.35F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r38 = new ModelRenderer(this);
        cube_r38.setRotationPoint(0.25F, -1.7F, 29.6F);
        upperreceiver.addChild(cube_r38);
        setRotationAngle(cube_r38, -0.2967F, 0, 0);
        cube_r38.cubeList.add(new ModelBox(cube_r38, 120, 70, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r39 = new ModelRenderer(this);
        cube_r39.setRotationPoint(0.25F, -1.7F, 37.6F);
        upperreceiver.addChild(cube_r39);
        setRotationAngle(cube_r39, -0.2967F, 0, 0);
        cube_r39.cubeList.add(new ModelBox(cube_r39, 120, 72, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r40 = new ModelRenderer(this);
        cube_r40.setRotationPoint(0.25F, -1.7F, 47.6F);
        upperreceiver.addChild(cube_r40);
        setRotationAngle(cube_r40, -0.2967F, 0, 0);
        cube_r40.cubeList.add(new ModelBox(cube_r40, 75, 120, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r41 = new ModelRenderer(this);
        cube_r41.setRotationPoint(0.25F, -1.1F, 48.8F);
        upperreceiver.addChild(cube_r41);
        setRotationAngle(cube_r41, -0.2967F, 0, 0);
        cube_r41.cubeList.add(new ModelBox(cube_r41, 120, 75, -0.95F, 0, 0, 1, 1, 1, -0.1F, false));
        cube_r41.cubeList.add(new ModelBox(cube_r41, 120, 79, -4.85F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r42 = new ModelRenderer(this);
        cube_r42.setRotationPoint(-4.55F, -1.1F, 37.7F);
        upperreceiver.addChild(cube_r42);
        setRotationAngle(cube_r42, -0.2967F, 0, 0);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 120, 57, -0.05F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r43 = new ModelRenderer(this);
        cube_r43.setRotationPoint(-4.55F, -1.1F, 36.5F);
        upperreceiver.addChild(cube_r43);
        setRotationAngle(cube_r43, -0.2967F, 0, 0);
        cube_r43.cubeList.add(new ModelBox(cube_r43, 120, 48, -0.05F, 0, 0, 1, 1, 1, -0.1F, false));

        cube_r44 = new ModelRenderer(this);
        cube_r44.setRotationPoint(-4.95F, -1.1F, 18.5F);
        upperreceiver.addChild(cube_r44);
        setRotationAngle(cube_r44, 0, -0.2443F, 0);
        cube_r44.cubeList.add(new ModelBox(cube_r44, 55, 106, 0, 0, -2, 1, 1, 2, 0.001F, false));
        cube_r44.cubeList.add(new ModelBox(cube_r44, 61, 106, 0, -0.3F, -2, 1, 1, 2, 0, false));
        ...
        cube_r45.cubeList.add(new ModelBox(cube_r45, 36, 106, 0, -1, -2, 1, 1, 2, 0, false));
        ...
        cube_r46.cubeList.add(new ModelBox(cube_r46, 42, 106, 0, 0, -2, 1, 1, 2, 0, false));

        cube_r47 = new ModelRenderer(this);
        cube_r47.setRotationPoint(-4.95F, -0.1F, 19.5F);
        upperreceiver.addChild(cube_r47);
        setRotationAngle(cube_r47, 0, 0, 0.4189F);
        cube_r47.cubeList.add(new ModelBox(cube_r47, 93, 48, 0, -1, -1, 1, 1, 4, -0.001F, false));

        cube_r48 = new ModelRenderer(this);
        cube_r48.setRotationPoint(-4.95F, -1.4F, 19.5F);
        upperreceiver.addChild(cube_r48);
        setRotationAngle(cube_r48, 0, 0, -0.4189F);
        cube_r48.cubeList.add(new ModelBox(cube_r48, 65, 93, 0, 0, -1, 1, 1, 4, -0.001F, false));

        cube_r49 = new ModelRenderer(this);
        cube_r49.setRotationPoint(-4.95F, -1.1F, 22.5F);
        upperreceiver.addChild(cube_r49);
        setRotationAngle(cube_r49, 0, 1.117F, 0);
        cube_r49.cubeList.add(new ModelBox(cube_r49, 83, 122, 0, 0, 0, 1, 1, 1, 0.001F, false));
        cube_r49.cubeList.add(new ModelBox(cube_r49, 122, 95, 0, -0.3F, 0, 1, 1, 1, 0, false));
        ...
        bone3.cubeList.add(new ModelBox(bone3, 110, 112, -1.9F, 0.4F, -3.25F, 1, 1, 53, 0, false));
