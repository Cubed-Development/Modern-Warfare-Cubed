...
public class GunCase extends ModelBase {
    ...
    public GunCase() {
        ...
        Shape1.cubeList.add(new ModelBox(Shape1, 91, 7, -1, -0.01F, 1, 16, 5, 58, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 65, -2.3F, -1.5F, 10.0F, 2, 3, 9, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 33, 42, -2.3F, -1.5F, 41, 2, 3, 9, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 65, -1, -3.1F, 0.45F, 16, 3, 59, 0.0F, false));
        ...
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 39, -0.99F, -3.3F, 1, 16, 1, 5, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 44, 13, 14.5F, -2.1F, 6.0F, 2, 5, 3, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 26, 14.5F, -2.1F, 21, 2, 5, 3, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 13, 14.5F, -2.1F, 36.0F, 2, 5, 3, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 0, 14.5F, -2.1F, 51, 2, 5, 3, 0.0F, false));
        ...
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 127, 15.0F, -1.1F, 1, 1, 2, 58, 0.0F, false));
        ...
        Shape1.cubeList.add(new ModelBox(Shape1, 0, 51, 0.0F, -1.1F, -1, 14, 2, 2, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 92, 92, -2.0F, -1.1F, 1, 1, 2, 58, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 44, 0, 16.0F, -1.1F, 3.5F, 1, 2, 2, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 52, 31, 14.2F, 1, 25.0F, 2, 3, 2, 0.0F, false));
        Shape1.cubeList.add(new ModelBox(Shape1, 52, 19, 14.2F, 1, 33.0F, 2, 3, 2, 0.0F, false));
