...
public class ATV extends ModelBase {
    ...
    public ATV() {
        ...
        body.setRotationPoint(0, 9.9311F, 22.2017F);
        body.cubeList.add(new ModelBox(body, 31, 25, -14, -8.7029F, -18.2022F, 28, 2, 2, 0, false));
        body.cubeList.add(new ModelBox(body, 19, 112, 8.9411F, -9.2771F, -25.1578F, 3, 2, 7, 0, false));
        body.cubeList.add(new ModelBox(body, 111, 111, -11.9411F, -9.2771F, -25.1578F, 3, 2, 7, 0, false));
        body.cubeList.add(new ModelBox(body, 38, 32, -10, -8.7011F, -26.2022F, 20, 2, 10, 0, false));
        body.cubeList.add(new ModelBox(body, 92, 4, -4.5F, -9.2783F, -28.1964F, 9, 2, 8, 0, false));
        body.cubeList.add(new ModelBox(body, 64, 4, -3, -5.7029F, -30.2022F, 6, 5, 1, 0, false));
        body.cubeList.add(new ModelBox(body, 0, 0, -13.5F, 3.5689F, -10.9517F, 27, 2, 10, 0, false));
        body.cubeList.add(new ModelBox(body, 0, 12, -3.5F, -7.4311F, -27.9517F, 7, 13, 17, 0, false));
        body.cubeList.add(new ModelBox(body, 37, 53, -3.5F, -4.4311F, -0.7017F, 7, 9, 13, 0, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(0, 0, 0);
        body.addChild(cube_r1);
        setRotationAngle(cube_r1, -0.3491F, 0, 0);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 64, -13, -5.5F, -1, 2, 11, 2, 0, false));
        cube_r1.cubeList.add(new ModelBox(cube_r1, 39, 131, 11, -5.5F, -1, 2, 11, 2, 0, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-13.25F, 0, 0);
        body.addChild(cube_r2);
        setRotationAngle(cube_r2, -0.3488F, -0.0149F, -0.041F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 104, 130, -0.5F, -5.5F, -1.0017F, 1, 11, 2, 0, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-12.5F, -6.3791F, 2.5211F);
        body.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.48F, 0, 0);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 111, -1.5F, -1.5F, -1, 3, 3, 2, 0, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 105, 111, 23.5F, -1.5F, -1, 3, 3, 2, 0, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(13.25F, 0, 0);
        body.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.3488F, 0.0149F, 0.041F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 16, 132, -0.5F, -5.5F, -1.0017F, 1, 11, 2, 0, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(0, 0, 0.5F);
        body.addChild(cube_r5);
        setRotationAngle(cube_r5, -0.3491F, 0, 0);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 64, 53, -11, -5.5F, -1, 22, 11, 2, 0, false));

        cube_r6 = new ModelRenderer(this);
        cube_r6.setRotationPoint(5.8998F, -0.3117F, 10.5483F);
        body.addChild(cube_r6);
        setRotationAngle(cube_r6, -0.0873F, 0, -0.3927F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 42, -1, -5, -1, 2, 12, 2, 0, false));

        cube_r7 = new ModelRenderer(this);
        cube_r7.setRotationPoint(-5.8998F, -0.3117F, 10.5483F);
        body.addChild(cube_r7);
        setRotationAngle(cube_r7, -0.0873F, 0, 0.3927F);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 8, 42, -1, -5, -1, 2, 12, 2, 0, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(-5.8998F, -0.3117F, -21.4517F);
        body.addChild(cube_r8);
        setRotationAngle(cube_r8, -0.0873F, 0, 0.3927F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 88, 130, -1, -5, -1, 2, 12, 2, 0, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(5.8998F, -0.3117F, -21.4517F);
        body.addChild(cube_r9);
        setRotationAngle(cube_r9, -0.0873F, 0, -0.3927F);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 96, 130, -1, -5, -1, 2, 12, 2, 0, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(5.7221F, -6.2736F, -20.4517F);
        body.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, 0, -0.3927F);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 88, 34, -3.5F, -0.5F, -5.5F, 7, 2, 10, 0, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-5.7221F, -6.2736F, -20.4517F);
        body.addChild(cube_r11);
        setRotationAngle(cube_r11, 0, 0, 0.3927F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 92, -3.5F, -0.5F, -5.5F, 7, 2, 10, 0, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-4.5302F, 5.1479F, 8.2983F);
        body.addChild(cube_r12);
        setRotationAngle(cube_r12, 0, 0.1309F, -0.3491F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 11, 128, -4, -1, -2, 8, 2, 2, 0, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(4.5302F, 5.1479F, 9.2983F);
        body.addChild(cube_r13);
        setRotationAngle(cube_r13, 0, 0.1309F, 0.3491F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 52, 126, -4, -1, 0, 8, 2, 2, 0, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(4.5302F, 5.1479F, 8.2983F);
        body.addChild(cube_r14);
        setRotationAngle(cube_r14, 0, -0.1309F, 0.3491F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 124, 111, -4, -1, -2, 8, 2, 2, 0, false));

        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(-4.5302F, 5.1479F, 9.2983F);
        body.addChild(cube_r15);
        setRotationAngle(cube_r15, 0, -0.1309F, -0.3491F);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 112, 54, -4, -1, 0, 8, 2, 2, 0, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(4.5302F, 5.1479F, -21.7017F);
        body.addChild(cube_r16);
        setRotationAngle(cube_r16, 0, 0.1309F, 0.3491F);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 129, 58, -4, -1, 0, 8, 2, 2, 0, false));

        cube_r17 = new ModelRenderer(this);
        cube_r17.setRotationPoint(4.5302F, 5.1479F, -22.7017F);
        body.addChild(cube_r17);
        setRotationAngle(cube_r17, 0, -0.1309F, 0.3491F);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 70, 128, -4, -1, -2, 8, 2, 2, 0, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(-4.5302F, 5.1479F, -21.7017F);
        body.addChild(cube_r18);
        setRotationAngle(cube_r18, 0, -0.1309F, -0.3491F);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 129, 62, -4, -1, 0, 8, 2, 2, 0, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(-4.5302F, 5.1479F, -22.7017F);
        body.addChild(cube_r19);
        setRotationAngle(cube_r19, 0, 0.1309F, -0.3491F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 129, 89, -4, -1, -2, 8, 2, 2, 0, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(0, -5.9844F, -14.7284F);
        body.addChild(cube_r20);
        setRotationAngle(cube_r20, -0.829F, 0, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 31, 12, -13.99F, -0.75F, -3, 28, 2, 5, 0, false));
        ...
        cube_r21.cubeList.add(new ModelBox(cube_r21, 0, 92, -1, -3.5F, -1.0056F, 2, 7, 2, 0, false));
        ...
        cube_r22.cubeList.add(new ModelBox(cube_r22, 97, 66, -1, -3.5F, -1.0056F, 2, 7, 2, 0, false));

        cube_r23 = new ModelRenderer(this);
        cube_r23.setRotationPoint(0, 1.9128F, -11.5962F);
        body.addChild(cube_r23);
        setRotationAngle(cube_r23, 0.48F, 0, 0);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 33, 44, -13, -3.5F, -1, 26, 7, 2, 0, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(0, -2.2506F, -14.1136F);
        body.addChild(cube_r24);
        setRotationAngle(cube_r24, 0.1745F, 0, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 31, 19, -14, -2.5F, -0.25F, 28, 4, 2, 0, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(-8.4445F, -7.7029F, -25.941F);
        body.addChild(cube_r25);
        setRotationAngle(cube_r25, 0, 0.4363F, 0);
        ...
        setRotationAngle(cube_r26, -0.6981F, 0.4363F, 0);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 130, 81, -4, -0.25F, -0.5F, 8, 1, 1, 0, false));

        cube_r27 = new ModelRenderer(this);
        cube_r27.setRotationPoint(8.2219F, -8.7647F, -26.6468F);
        body.addChild(cube_r27);
        setRotationAngle(cube_r27, -0.6981F, -0.4363F, 0);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 130, 85, -4, -0.25F, -0.5F, 8, 1, 1, 0, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(8.4445F, -7.7029F, -25.941F);
        body.addChild(cube_r28);
        setRotationAngle(cube_r28, 0, -0.4363F, 0);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 120, 104, -4.5F, -1.0002F, -1.25F, 8, 2, 3, -0.01F, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(0, -6.3118F, -29.0768F);
        body.addChild(cube_r29);
        setRotationAngle(cube_r29, -0.2182F, 0, 0);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 76, 78, -4, -1.5F, -1, 8, 3, 2, 0, false));

        cube_r30 = new ModelRenderer(this);
        cube_r30.setRotationPoint(0, -7.9311F, -29.0241F);
        body.addChild(cube_r30);
        setRotationAngle(cube_r30, -0.8727F, 0, 0);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 130, 83, -4, -0.5F, -0.5F, 8, 1, 1, 0, false));
        cube_r30.cubeList.add(new ModelBox(cube_r30, 118, 7, -5, -1.5F, -0.5F, 10, 1, 1, 0, false));
        ...
        cube_r31.cubeList.add(new ModelBox(cube_r31, 0, 22, -0.5F, -2, -1, 1, 4, 2, 0, false));
        ...
        cube_r32.cubeList.add(new ModelBox(cube_r32, 64, 97, -0.5F, -2, -1, 1, 4, 2, 0, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(3.25F, -2.7029F, -29.4522F);
        body.addChild(cube_r33);
        setRotationAngle(cube_r33, 0, -0.4363F, 0);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 130, 133, -1, -2, -1, 2, 4, 2, 0, false));

        cube_r34 = new ModelRenderer(this);
        cube_r34.setRotationPoint(-3.25F, -2.7029F, -29.4522F);
        body.addChild(cube_r34);
        setRotationAngle(cube_r34, 0, 0.4363F, 0);
        cube_r34.cubeList.add(new ModelBox(cube_r34, 0, 134, -1, -2, -1, 2, 4, 2, 0, false));
        ...
        cube_r35.cubeList.add(new ModelBox(cube_r35, 52, 87, -1, -2.5F, -0.5F, 2, 6, 1, 0, false));
        ...
        cube_r36.cubeList.add(new ModelBox(cube_r36, 91, 19, -1, -2.5F, -0.5F, 2, 6, 1, 0, false));

        cube_r37 = new ModelRenderer(this);
        cube_r37.setRotationPoint(-5.5F, -0.6209F, -29.4743F);
        body.addChild(cube_r37);
        setRotationAngle(cube_r37, 0.2618F, 0, 0);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 51, 103, -1, -0.5F, -0.5F, 2, 1, 1, 0, false));
        cube_r37.cubeList.add(new ModelBox(cube_r37, 64, 103, 10, -0.5F, -0.5F, 2, 1, 1, 0, false));

        cube_r38 = new ModelRenderer(this);
        cube_r38.setRotationPoint(0, 1.4878F, -29.1505F);
        body.addChild(cube_r38);
        setRotationAngle(cube_r38, 0.2618F, 0, 0);
        cube_r38.cubeList.add(new ModelBox(cube_r38, 112, 39, -3, -2.75F, -0.75F, 6, 1, 1, 0, false));
        cube_r38.cubeList.add(new ModelBox(cube_r38, 112, 41, -3, 3.25F, -0.75F, 6, 1, 1, 0, false));
        cube_r38.cubeList.add(new ModelBox(cube_r38, 69, 132, -3, -2.5F, -0.5F, 6, 6, 1, 0, false));

        cube_r39 = new ModelRenderer(this);
        cube_r39.setRotationPoint(-6.8367F, -8.2776F, -23.6762F);
        body.addChild(cube_r39);
        setRotationAngle(cube_r39, 0, 0.4363F, 0);
        cube_r39.cubeList.add(new ModelBox(cube_r39, 64, 99, -4, -0.9985F, -3.5F, 8, 2, 7, 0, false));

        cube_r40 = new ModelRenderer(this);
        cube_r40.setRotationPoint(6.8367F, -8.2776F, -23.6762F);
        body.addChild(cube_r40);
        setRotationAngle(cube_r40, 0, -0.4363F, 0);
        cube_r40.cubeList.add(new ModelBox(cube_r40, 107, 80, -4, -0.9985F, -3.5F, 8, 2, 7, 0, false));
        ...
        cube_r41.cubeList.add(new ModelBox(cube_r41, 124, 120, -0.5F, -0.925F, -3.5F, 2, 2, 7, 0, false));

        cube_r42 = new ModelRenderer(this);
        cube_r42.setRotationPoint(-11.5603F, -7.7029F, -21.4112F);
        body.addChild(cube_r42);
        setRotationAngle(cube_r42, 0, -0.1309F, 0);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 36, 98, -1.5F, -1.25F, -3.5F, 4, 2, 7, 0, false));
        ...
        cube_r43.cubeList.add(new ModelBox(cube_r43, 0, 125, -1.5F, -0.925F, -3.5F, 2, 2, 7, 0, false));

        cube_r44 = new ModelRenderer(this);
        cube_r44.setRotationPoint(11.5603F, -7.7029F, -21.4112F);
        body.addChild(cube_r44);
        setRotationAngle(cube_r44, 0, 0.1309F, 0);
        cube_r44.cubeList.add(new ModelBox(cube_r44, 109, 25, -2.5F, -1.25F, -3.5F, 4, 2, 7, 0, false));
        ...
        cube_r45.cubeList.add(new ModelBox(cube_r45, 89, 46, -4, -1, -2.5F, 8, 2, 4, 0, false));
        ...
        cube_r46.cubeList.add(new ModelBox(cube_r46, 107, 89, -4.25F, -0.9961F, -1.5F, 8, 2, 6, 0, false));
        ...
        cube_r47.cubeList.add(new ModelBox(cube_r47, 128, 129, -4, -1, -1, 7, 2, 2, 0, false));
        ...
        cube_r48.cubeList.add(new ModelBox(cube_r48, 130, 77, -3, -1, -1, 7, 2, 2, 0, false));
        ...
        cube_r49.cubeList.add(new ModelBox(cube_r49, 91, 4, -0.5F, -2.5F, -1, 2, 5, 2, 0, false));
        ...
        cube_r50.cubeList.add(new ModelBox(cube_r50, 103, 16, -1.5F, -2.5F, -1, 2, 5, 2, 0, false));
        ...
        cube_r51.cubeList.add(new ModelBox(cube_r51, 130, 47, -4, -1.75F, -0.5F, 8, 3, 1, 0, false));
        ...
        cube_r52.cubeList.add(new ModelBox(cube_r52, 51, 130, -4, -1.75F, -0.5F, 8, 3, 1, 0, false));
        ...
        cube_r53.cubeList.add(new ModelBox(cube_r53, 0, 56, -3.5F, -1.25F, -0.425F, 7, 2, 1, 0, false));
        ...
        cube_r54.cubeList.add(new ModelBox(cube_r54, 131, 71, -3.5F, -1.25F, -0.425F, 7, 2, 1, 0, false));
        ...
        cube_r55.cubeList.add(new ModelBox(cube_r55, 28, 75, -5, -0.9973F, -4.5F, 10, 2, 10, 0, false));
        ...
        cube_r56.cubeList.add(new ModelBox(cube_r56, 67, 66, -5, -0.9973F, -4.5F, 10, 2, 10, 0, false));
        ...
        cube_r57.cubeList.add(new ModelBox(cube_r57, 109, 69, -3.75F, -0.9961F, -1.5F, 8, 2, 6, 0, false));
        ...
        cube_r58.cubeList.add(new ModelBox(cube_r58, 110, 48, -4, -1, -2.5F, 8, 2, 4, 0, false));

        cube_r59 = new ModelRenderer(this);
        cube_r59.setRotationPoint(0, -5.0762F, 2.9618F);
        body.addChild(cube_r59);
        setRotationAngle(cube_r59, 0.0436F, 0, 0);
        cube_r59.cubeList.add(new ModelBox(cube_r59, 64, 0, -11, -0.5F, -1.5F, 22, 1, 3, 0, false));

        cube_r60 = new ModelRenderer(this);
        cube_r60.setRotationPoint(-4.5141F, -7.3991F, 8.0915F);
        body.addChild(cube_r60);
        setRotationAngle(cube_r60, 0.0436F, 0, 0);
        cube_r60.cubeList.add(new ModelBox(cube_r60, 48, 124, -0.5F, -0.999F, -1, 1, 2, 2, 0, false));
        cube_r60.cubeList.add(new ModelBox(cube_r60, 0, 125, 8.5282F, -0.999F, -1, 1, 2, 2, 0, false));
        ...
        cube_r61.cubeList.add(new ModelBox(cube_r61, 0, 0, -0.45F, -2.75F, -1.5F, 2, 5, 3, 0, false));
        ...
        cube_r62.cubeList.add(new ModelBox(cube_r62, 58, 75, -1.55F, -2.75F, -1.5F, 2, 5, 3, 0, false));
        ...
        cube_r63.cubeList.add(new ModelBox(cube_r63, 31, 12, -0.5F, -2, -0.5F, 1, 4, 1, 0, false));
        ...
        cube_r64.cubeList.add(new ModelBox(cube_r64, 25, 66, -0.5F, -2, -0.5F, 1, 4, 1, 0, false));

        cube_r65 = new ModelRenderer(this);
        cube_r65.setRotationPoint(0, -3.8958F, 19.2791F);
        body.addChild(cube_r65);
        setRotationAngle(cube_r65, -0.3491F, 0, 0);
        cube_r65.cubeList.add(new ModelBox(cube_r65, 0, 8, -2, -0.5F, -0.75F, 4, 1, 1, 0, false));

        cube_r66 = new ModelRenderer(this);
        cube_r66.setRotationPoint(0, -7.6739F, 14.1093F);
        body.addChild(cube_r66);
        setRotationAngle(cube_r66, 0.0436F, 0, 0);
        cube_r66.cubeList.add(new ModelBox(cube_r66, 103, 14, -3, 5, -4.5F, 6, 2, 9, 0, false));
        cube_r66.cubeList.add(new ModelBox(cube_r66, 0, 81, -4, 4, -4.5F, 8, 1, 10, 0.01F, false));
        cube_r66.cubeList.add(new ModelBox(cube_r66, 26, 87, -4, -1, -4.5F, 8, 1, 10, 0, false));

        cube_r67 = new ModelRenderer(this);
        cube_r67.setRotationPoint(-0.25F, -0.1987F, 12.7188F);
        body.addChild(cube_r67);
        setRotationAngle(cube_r67, -0.3491F, 0, 0);
        cube_r67.cubeList.add(new ModelBox(cube_r67, 0, 12, -2.25F, -3.5F, -1.5F, 5, 7, 3, 0, false));

        cube_r68 = new ModelRenderer(this);
        cube_r68.setRotationPoint(0, -6.893F, 19.1482F);
        body.addChild(cube_r68);
        setRotationAngle(cube_r68, 0.0436F, 0, 0);
        cube_r68.cubeList.add(new ModelBox(cube_r68, 92, 14, -4, -0.5F, -0.75F, 8, 1, 1, 0, false));

        cube_r69 = new ModelRenderer(this);
        cube_r69.setRotationPoint(12.5F, -7.5431F, 10.8622F);
        body.addChild(cube_r69);
        setRotationAngle(cube_r69, 0.0436F, 0, 0);
        ...
        cube_r70.cubeList.add(new ModelBox(cube_r70, 71, 30, -3, -0.5F, -0.5F, 6, 1, 1, 0, false));

        cube_r71 = new ModelRenderer(this);
        cube_r71.setRotationPoint(10.75F, -9.7572F, 4.2593F);
        body.addChild(cube_r71);
        setRotationAngle(cube_r71, 0.0436F, 0, 0);
        cube_r71.cubeList.add(new ModelBox(cube_r71, 14, 112, -2.5F, -0.5F, -0.5F, 5, 1, 1, 0, false));
        cube_r71.cubeList.add(new ModelBox(cube_r71, 14, 114, -24, -0.5F, -0.5F, 5, 1, 1, 0, false));

        cube_r72 = new ModelRenderer(this);
        cube_r72.setRotationPoint(7.75F, -9.8226F, 5.7579F);
        body.addChild(cube_r72);
        setRotationAngle(cube_r72, 0.0436F, 0, 0);
        cube_r72.cubeList.add(new ModelBox(cube_r72, 51, 98, -0.5F, -0.4985F, -2, 1, 1, 4, 0, false));
        cube_r72.cubeList.add(new ModelBox(cube_r72, 87, 108, -16, -0.4985F, -2, 1, 1, 4, 0, false));
        ...
        cube_r73.cubeList.add(new ModelBox(cube_r73, 36, 107, -3, -0.5F, -0.5F, 6, 1, 1, 0, false));
        ...
        cube_r74.cubeList.add(new ModelBox(cube_r74, 6, 42, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));
        ...
        cube_r75.cubeList.add(new ModelBox(cube_r75, 33, 42, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));
        ...
        cube_r76.cubeList.add(new ModelBox(cube_r76, 94, 66, -0.5F, -0.4643F, -6.5F, 1, 1, 13, 0, false));

        cube_r77 = new ModelRenderer(this);
        cube_r77.setRotationPoint(13.75F, -9.9971F, 9.7541F);
        body.addChild(cube_r77);
        setRotationAngle(cube_r77, 0.0436F, 0, 0);
        cube_r77.cubeList.add(new ModelBox(cube_r77, 0, 104, -0.5F, -0.5F, -6, 1, 1, 12, 0, false));
        cube_r77.cubeList.add(new ModelBox(cube_r77, 106, 98, -28, -0.5F, -6, 1, 1, 12, 0, false));
        ...
        cube_r78.cubeList.add(new ModelBox(cube_r78, 21, 98, -0.5F, -0.4643F, -6.5F, 1, 1, 13, 0, false));
        ...
        cube_r79.cubeList.add(new ModelBox(cube_r79, 89, 46, -0.75F, -0.75F, -0.25F, 1, 2, 1, 0, false));
        ...
        cube_r80.cubeList.add(new ModelBox(cube_r80, 92, 87, -0.25F, -0.75F, -0.25F, 1, 2, 1, 0, false));
        ...
        cube_r81.cubeList.add(new ModelBox(cube_r81, 75, 108, -1.5F, -5.5F, 0, 3, 14, 6, 0, false));
        ...
        cube_r82.cubeList.add(new ModelBox(cube_r82, 94, 88, -1.5F, -5.5F, -5.5F, 1, 11, 11, 0, false));
        ...
        cube_r84.cubeList.add(new ModelBox(cube_r84, 122, 133, -0.5F, -2, 1, 2, 4, 2, 0, false));
        ...
        cube_r85.cubeList.add(new ModelBox(cube_r85, 8, 134, -1.5F, -2, 1, 2, 4, 2, 0, false));
        ...
        cube_r86.cubeList.add(new ModelBox(cube_r86, 110, 133, -1.5F, -2, 0, 3, 4, 3, 0.01F, false));
        ...
        cube_r87.cubeList.add(new ModelBox(cube_r87, 93, 110, -1.5F, -5.5F, 0, 3, 14, 6, 0, false));
        ...
        cube_r88.cubeList.add(new ModelBox(cube_r88, 51, 97, 0.5F, -5.5F, -5.5F, 1, 11, 11, 0, false));

        cube_r89 = new ModelRenderer(this);
        cube_r89.setRotationPoint(0, -5.7641F, 5.7252F);
        body.addChild(cube_r89);
        setRotationAngle(cube_r89, 0.0436F, 0, 0);
        cube_r89.cubeList.add(new ModelBox(cube_r89, 0, 42, -4, -2, -4, 8, 5, 17, 0, false));

        cube_r90 = new ModelRenderer(this);
        cube_r90.setRotationPoint(0, -5.5024F, -0.2691F);
        body.addChild(cube_r90);
        setRotationAngle(cube_r90, 0.0436F, 0, 0);
        cube_r90.cubeList.add(new ModelBox(cube_r90, 0, 117, -3, -2, -2, 6, 4, 4, 0, false));
        ...
        cube_r91.cubeList.add(new ModelBox(cube_r91, 0, 81, -0.5F, -1.9881F, -2, 1, 4, 4, 0, false));
        ...
        cube_r92.cubeList.add(new ModelBox(cube_r92, 88, 34, -0.5F, -1.9881F, -2, 1, 4, 4, 0, false));

        cube_r93 = new ModelRenderer(this);
        cube_r93.setRotationPoint(0, -7.7959F, -4.1815F);
        body.addChild(cube_r93);
        setRotationAngle(cube_r93, -0.3491F, 0, 0);
        cube_r93.cubeList.add(new ModelBox(cube_r93, 109, 58, -3, -0.5F, -4, 6, 3, 8, 0, false));

        cube_r94 = new ModelRenderer(this);
        cube_r94.setRotationPoint(0, -5.1811F, -15.7017F);
        body.addChild(cube_r94);
        setRotationAngle(cube_r94, 0.0436F, 0, 0);
        cube_r94.cubeList.add(new ModelBox(cube_r94, 0, 64, -3, -4.5F, -5, 6, 4, 13, 0, false));
        ...
        setRotationAngle(cube_r95, 0.0436F, 0, 0);
        cube_r95.cubeList.add(new ModelBox(cube_r95, 131, 32, -4, -0.5F, -2.5F, 8, 1, 1, 0, false));
        cube_r95.cubeList.add(new ModelBox(cube_r95, 131, 69, -4, -0.5F, -0.5F, 8, 1, 1, 0, false));
        ...
        cube_r96.cubeList.add(new ModelBox(cube_r96, 0, 81, -0.5F, -1.5F, -0.5041F, 1, 3, 1, 0, false));
        ...
        cube_r97.cubeList.add(new ModelBox(cube_r97, 6, 81, -0.5F, -1.5F, -0.5041F, 1, 3, 1, 0, false));

        cube_r98 = new ModelRenderer(this);
        cube_r98.setRotationPoint(4.2988F, -4.0051F, -0.0339F);
        bone3.addChild(cube_r98);
        setRotationAngle(cube_r98, 0.0436F, 0, 0);
        cube_r98.cubeList.add(new ModelBox(cube_r98, 36, 109, -3, -0.25F, -0.5F, 6, 1, 1, 0, false));
        ...
        cube_r99.cubeList.add(new ModelBox(cube_r99, 51, 98, -0.5F, -0.5F, -0.5F, 1, 2, 1, 0, false));
        cube_r99.cubeList.add(new ModelBox(cube_r99, 94, 34, 9.25F, -0.5F, -0.5F, 1, 2, 1, 0, false));
        ...
        cube_r100.cubeList.add(new ModelBox(cube_r100, 57, 98, -10.25F, -0.5F, -0.5F, 1, 2, 1, 0, false));
        cube_r100.cubeList.add(new ModelBox(cube_r100, 58, 103, -0.5F, -0.5F, -0.5F, 1, 2, 1, 0, false));
        ...
        cube_r101.cubeList.add(new ModelBox(cube_r101, 109, 46, -5, -0.5F, -0.5F, 10, 1, 1, 0, false));
        ...
        cube_r102.cubeList.add(new ModelBox(cube_r102, 109, 77, -5, -0.5F, -0.5F, 10, 1, 1, 0, false));
        ...
        cube_r103.cubeList.add(new ModelBox(cube_r103, 48, 29, -5, -0.5F, -0.5F, 11, 1, 1, 0, false));
        ...
        cube_r104.cubeList.add(new ModelBox(cube_r104, 25, 64, -6, -0.5F, -0.5F, 11, 1, 1, 0, false));
        ...
        cube_r105.cubeList.add(new ModelBox(cube_r105, 24, 92, -2, -0.5F, -1, 4, 1, 2, 0, false));
        ...
        cube_r106.cubeList.add(new ModelBox(cube_r106, 8, 71, -0.325F, -1.25F, -0.5F, 1, 3, 1, 0, false));
        ...
        cube_r107.cubeList.add(new ModelBox(cube_r107, 110, 129, -4.075F, -1.25F, -0.5F, 8, 3, 1, 0, false));
        ...
        cube_r108.cubeList.add(new ModelBox(cube_r108, 52, 94, -0.375F, -1.4F, -0.7419F, 2, 2, 1, 0, false));
        ...
        cube_r109.cubeList.add(new ModelBox(cube_r109, 88, 34, -0.6F, -1, -0.55F, 1, 2, 1, 0, false));
        ...
        cube_r110.cubeList.add(new ModelBox(cube_r110, 103, 25, -2.6F, -0.4F, -0.5F, 5, 1, 1, 0, false));
        ...
        cube_r111.cubeList.add(new ModelBox(cube_r111, 103, 27, -2.6F, -0.4F, -0.7F, 5, 1, 1, 0, false));
        ...
        cube_r112.cubeList.add(new ModelBox(cube_r112, 75, 108, -0.5F, -1.5F, -1, 1, 3, 2, 0, false));
        ...
        cube_r113.cubeList.add(new ModelBox(cube_r113, 124, 115, -4, -0.5F, -1, 8, 1, 2, 0.01F, false));
        ...
        cube_r114.cubeList.add(new ModelBox(cube_r114, 26, 81, -2, -0.5F, -1, 4, 1, 2, 0, false));
        ...
        cube_r115.cubeList.add(new ModelBox(cube_r115, 32, 66, -0.675F, -1.25F, -0.5F, 1, 3, 1, 0, false));
        ...
        cube_r116.cubeList.add(new ModelBox(cube_r116, 32, 112, -3.925F, -1.25F, -0.5F, 8, 3, 1, 0, false));
        ...
        cube_r117.cubeList.add(new ModelBox(cube_r117, 91, 26, -1.625F, -1.4F, -0.7419F, 2, 2, 1, 0, false));
        ...
        cube_r118.cubeList.add(new ModelBox(cube_r118, 13, 12, -0.4F, -1, -0.55F, 1, 2, 1, 0, false));
        ...
        cube_r119.cubeList.add(new ModelBox(cube_r119, 25, 75, -2.4F, -0.4F, -0.5F, 5, 1, 1, 0, false));
        ...
        cube_r120.cubeList.add(new ModelBox(cube_r120, 24, 95, -2.4F, -0.4F, -0.7F, 5, 1, 1, 0, false));
        ...
        cube_r121.cubeList.add(new ModelBox(cube_r121, 107, 89, -0.5F, -1.5F, -1, 1, 3, 2, 0, false));
        ...
        cube_r122.cubeList.add(new ModelBox(cube_r122, 88, 31, -4, -0.5F, -1, 8, 1, 2, 0.01F, false));

        steering_thing = new ModelRenderer(this);
        steering_thing.setRotationPoint(0, 0.2141F, 6.5824F);
        ...
        cube_r123.cubeList.add(new ModelBox(cube_r123, 36, 98, -0.5F, -3, -0.5F, 1, 6, 1, 0, false));
        ...
        cube_r124.cubeList.add(new ModelBox(cube_r124, 108, 80, -1, -1.5F, -0.5F, 2, 3, 1, 0, false));
        ...
        cube_r125.cubeList.add(new ModelBox(cube_r125, 109, 69, -1, -1.5F, -0.5F, 2, 3, 1, 0, false));
        ...
        cube_r126.cubeList.add(new ModelBox(cube_r126, 58, 83, -1.5F, -0.5F, -0.5F, 3, 1, 1, 0, false));
        ...
        cube_r127.cubeList.add(new ModelBox(cube_r127, 0, 89, -1, -0.5F, -3, 3, 1, 1, 0, false));

        cube_r128 = new ModelRenderer(this);
        cube_r128.setRotationPoint(0, -0.0689F, 2.2189F);
        steering_thing.addChild(cube_r128);
        setRotationAngle(cube_r128, 0.0436F, 0, 0);
        cube_r128.cubeList.add(new ModelBox(cube_r128, 8, 22, -1, -2.1F, -2, 2, 4, 2, 0, false));
        ...
        cube_r129.cubeList.add(new ModelBox(cube_r129, 8, 64, -0.5F, -3, -0.5F, 1, 6, 1, 0, false));
        ...
        cube_r130.cubeList.add(new ModelBox(cube_r130, 24, 98, -1, -0.496F, -3, 3, 1, 2, 0, false));
        ...
        cube_r131.cubeList.add(new ModelBox(cube_r131, 33, 57, -3, -0.25F, -0.5F, 6, 1, 1, 0, false));
        ...
        cube_r132.cubeList.add(new ModelBox(cube_r132, 129, 93, -2, -0.5F, -0.5F, 8, 1, 1, 0, false));
        cube_r132.cubeList.add(new ModelBox(cube_r132, 114, 0, -1, -1, -1, 2, 2, 2, 0, false));
        ...
        cube_r133.cubeList.add(new ModelBox(cube_r133, 22, 132, -1, -1, -1, 2, 2, 2, 0, false));
        cube_r133.cubeList.add(new ModelBox(cube_r133, 130, 54, -6, -0.5F, -0.5F, 8, 1, 1, 0, false));

        cube_r134 = new ModelRenderer(this);
        cube_r134.setRotationPoint(0, -5.6111F, -0.3394F);
        steering_thing.addChild(cube_r134);
        setRotationAngle(cube_r134, 0.1745F, 0, 0);
        cube_r134.cubeList.add(new ModelBox(cube_r134, 124, 17, -2, -0.5F, -2, 4, 1, 5, 0, false));

        cube_r135 = new ModelRenderer(this);
        cube_r135.setRotationPoint(0, -4.0746F, 2.7842F);
        steering_thing.addChild(cube_r135);
        setRotationAngle(cube_r135, 0.2182F, 0, 0);
        cube_r135.cubeList.add(new ModelBox(cube_r135, 76, 83, -2, -2.5F, -0.5F, 4, 4, 1, 0, false));
        ...
        cube_r136.cubeList.add(new ModelBox(cube_r136, 87, 99, -0.5007F, -2, -0.5F, 1, 3, 2, 0, false));
        ...
        cube_r137.cubeList.add(new ModelBox(cube_r137, 99, 87, -0.4993F, -2, -0.5F, 1, 3, 2, 0, false));
        ...
        cube_r138.cubeList.add(new ModelBox(cube_r138, 25, 66, -0.25F, -2, -2.5F, 1, 4, 5, 0.01F, false));
        ...
        cube_r139.cubeList.add(new ModelBox(cube_r139, 0, 22, -1, -0.5F, -3, 1, 1, 6, 0, false));
        ...
        cube_r140.cubeList.add(new ModelBox(cube_r140, 25, 131, 0, -0.5F, -3, 1, 1, 6, 0, false));
        ...
        cube_r141.cubeList.add(new ModelBox(cube_r141, 92, 87, -0.75F, -2, -2.5F, 1, 4, 5, 0.01F, false));

        cube_r142 = new ModelRenderer(this);
        cube_r142.setRotationPoint(0, -2.4793F, 0.1118F);
        steering_thing.addChild(cube_r142);
        setRotationAngle(cube_r142, 0.0436F, 0, 0);
        cube_r142.cubeList.add(new ModelBox(cube_r142, 74, 4, -2.5F, -0.5F, -3.5F, 5, 1, 7, 0, false));
        ...
        cube_r143.cubeList.add(new ModelBox(cube_r143, 26, 87, -2, -0.497F, -3, 3, 1, 2, 0, false));

        wheel_small = new ModelRenderer(this);
        wheel_small.setRotationPoint(11, 16.5308F, 0);
        wheel_small.cubeList.add(new ModelBox(wheel_small, 32, 124, -3, 4.4692F, -2, 6, 3, 4, 0.01F, false));
        wheel_small.cubeList.add(new ModelBox(wheel_small, 58, 78, -2, -4.5308F, -5, 4, 9, 10, 0, false));
        wheel_small.cubeList.add(new ModelBox(wheel_small, 120, 97, -3, -7.459F, -2, 6, 3, 4, 0.01F, false));

        cube_r144 = new ModelRenderer(this);
        cube_r144.setRotationPoint(-1, -6.9949F, -1.0359F);
        wheel_small.addChild(cube_r144);
        setRotationAngle(cube_r144, -1.5708F, 0, 0);
        cube_r144.cubeList.add(new ModelBox(cube_r144, 92, 80, -2, -8.5F, 5, 6, 3, 4, 0.01F, false));

        cube_r145 = new ModelRenderer(this);
        cube_r145.setRotationPoint(-1, 4.3042F, 2.4821F);
        wheel_small.addChild(cube_r145);
        setRotationAngle(cube_r145, 0.5236F, 0, 0);
        cube_r145.cubeList.add(new ModelBox(cube_r145, 14, 104, -2, -0.5F, -2, 6, 3, 4, -0.01F, false));

        cube_r146 = new ModelRenderer(this);
        cube_r146.setRotationPoint(-1, 2.4872F, 4.299F);
        wheel_small.addChild(cube_r146);
        setRotationAngle(cube_r146, 1.0472F, 0, 0);
        cube_r146.cubeList.add(new ModelBox(cube_r146, 35, 117, -2, -0.5F, -2, 6, 3, 4, 0, false));

        cube_r147 = new ModelRenderer(this);
        cube_r147.setRotationPoint(-1, -4.2939F, 2.4821F);
        wheel_small.addChild(cube_r147);
        setRotationAngle(cube_r147, -0.5236F, 0, 0);
        cube_r147.cubeList.add(new ModelBox(cube_r147, 118, 0, -2, -2.5F, -2, 6, 3, 4, -0.01F, false));

        cube_r148 = new ModelRenderer(this);
        cube_r148.setRotationPoint(-1, -2.4769F, 4.299F);
        wheel_small.addChild(cube_r148);
        setRotationAngle(cube_r148, -1.0472F, 0, 0);
        cube_r148.cubeList.add(new ModelBox(cube_r148, 55, 119, -2, -2.5F, -2, 6, 3, 4, 0, false));

        cube_r149 = new ModelRenderer(this);
        cube_r149.setRotationPoint(-1, 7.0051F, 1.0359F);
        wheel_small.addChild(cube_r149);
        setRotationAngle(cube_r149, -1.5708F, 0, 0);
        cube_r149.cubeList.add(new ModelBox(cube_r149, 111, 120, -2, 5.5F, -9, 6, 3, 4, 0.01F, false));

        cube_r150 = new ModelRenderer(this);
        cube_r150.setRotationPoint(-1, -4.2939F, -2.4821F);
        wheel_small.addChild(cube_r150);
        setRotationAngle(cube_r150, 0.5236F, 0, 0);
        cube_r150.cubeList.add(new ModelBox(cube_r150, 16, 121, -2, -2.5F, -2, 6, 3, 4, -0.01F, false));

        cube_r151 = new ModelRenderer(this);
        cube_r151.setRotationPoint(-1, -2.4769F, -4.299F);
        wheel_small.addChild(cube_r151);
        setRotationAngle(cube_r151, 1.0472F, 0, 0);
        cube_r151.cubeList.add(new ModelBox(cube_r151, 122, 39, -2, -2.5F, -2, 6, 3, 4, 0, false));

        cube_r152 = new ModelRenderer(this);
        cube_r152.setRotationPoint(-1, 4.3042F, -2.4821F);
        wheel_small.addChild(cube_r152);
        setRotationAngle(cube_r152, -0.5236F, 0, 0);
        cube_r152.cubeList.add(new ModelBox(cube_r152, 124, 10, -2, -0.5F, -2, 6, 3, 4, -0.01F, false));
        ...
        cube_r153.cubeList.add(new ModelBox(cube_r153, 124, 25, -2, -0.5F, -2, 6, 3, 4, 0, false));

        cube_r154 = new ModelRenderer(this);
        cube_r154.setRotationPoint(0, -0.0308F, 0);
        wheel_small.addChild(cube_r154);
        setRotationAngle(cube_r154, 0.7854F, 0, 0);
        cube_r154.cubeList.add(new ModelBox(cube_r154, 33, 53, -3, -1, -1, 6, 2, 2, 0, false));
    }

    @Override
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        body.render(f5);
//		steering_thing.renderer(f5);
//		wheel_small.renderer(f5);
    }
