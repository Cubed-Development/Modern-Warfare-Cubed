...
public class TruSpecCorduraBackpack extends ModelBiped {
    ...
    public TruSpecCorduraBackpack() {
        ...
        rightarm.cubeList.add(new ModelBox(rightarm, 36, 29, -3, -2, -2, 4, 12, 4, 0, false));
        ...
        leftleg.cubeList.add(new ModelBox(leftleg, 20, 29, -2, 0, -2, 4, 12, 4, 0, false));

        backpack = new ModelRenderer(this);
        backpack.setRotationPoint(0, 0, 0);
        backpack.cubeList.add(new ModelBox(backpack, 48, 0, -2.5F, 2.45F, 5, 5, 3, 2, 0, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(3, 2, 6.6F);
        backpack.addChild(cube_r1);
        setRotationAngle(cube_r1, -0.1041F, -0.8351F, 0.0773F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 16, 32, -1, 0, -1, 1, 9, 1, -0.001F, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-3, 2, 6.6F);
        backpack.addChild(cube_r2);
        setRotationAngle(cube_r2, -0.1041F, 0.8351F, -0.0773F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 32, 51, 0, 0, -1, 1, 9, 1, -0.001F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(3, 2, 6.6F);
        backpack.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.0698F, 0, 0);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 12, 44, -0.25F, 0, -4.7F, 1, 9, 4, 0.001F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 22, 45, -6.75F, 0, -4.7F, 1, 9, 4, 0.001F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 24, 16, -6, 0, -4, 6, 9, 4, 0, false));
        ...
        cube_r6.cubeList.add(new ModelBox(cube_r6, 20, 16, -1, 0, 0, 1, 3, 1, 0, false));
        ...
        cube_r10.cubeList.add(new ModelBox(cube_r10, 24, 4, -1, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 48, 28, 0, 0, -1, 4, 1, 1, 0, false));
        ...
        cube_r12.cubeList.add(new ModelBox(cube_r12, 48, 14, 0, 0, -1, 4, 1, 1, 0, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 48, 30, -4, 0, -1, 4, 1, 1, 0, false));
        ...
        cube_r14.cubeList.add(new ModelBox(cube_r14, 24, 6, 0, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r15.cubeList.add(new ModelBox(cube_r15, 50, 45, -4, 0, -1, 4, 1, 1, 0, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 24, 16, 0, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r17.cubeList.add(new ModelBox(cube_r17, 24, 18, -1, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 24, 0, -5, 0, -1, 5, 1, 1, -0.2F, false));
        ...
        cube_r19.cubeList.add(new ModelBox(cube_r19, 24, 2, 0, 0, -1, 5, 1, 1, -0.2F, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(-3, 4.75F, 7.9F);
        backpack.addChild(cube_r20);
        setRotationAngle(cube_r20, -0.0349F, 0, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 44, 16, 0, 1, -2, 6, 5, 2, 0, false));
        ...
        setRotationAngle(cube_r23, -0.1047F, 0, 0);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 44, 23, 0, 0, -1, 5, 2, 3, 0.002F, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(-2.5F, 2, 6.6F);
        backpack.addChild(cube_r24);
        setRotationAngle(cube_r24, -0.576F, 0, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 48, 5, 0, 0, -2, 5, 2, 2, 0.001F, false));
