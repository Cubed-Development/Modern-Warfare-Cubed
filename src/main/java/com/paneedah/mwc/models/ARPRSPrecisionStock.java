...
public class ARPRSPrecisionStock extends ModelBase {
    ...
    public ARPRSPrecisionStock() {
        ...
        stock.cubeList.add(new ModelBox(stock, 0, 41, -1, -0.75F, 0.0F, 2, 1, 39, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 19, 0, -1, 2.25F, 0.0F, 2, 3, 2, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 17, 41, -1.5F, 10.25F, 31, 3, 3, 8, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 0, 16, -1, -3.0F, 15.0F, 2, 1, 15, 0.0F, false));
        ...
        bone43.setRotationPoint(1, -0.75F, 0.0F);
        stock.addChild(bone43);
        setRotationAngle(bone43, 0.0F, 0.0F, -0.7854F);
        bone43.cubeList.add(new ModelBox(bone43, 41, 83, -1, 0.0F, 0.0F, 1, 1, 39, 0.0F, false));
        bone43.cubeList.add(new ModelBox(bone43, 43, 43, -1, 0.4F, 0.0F, 1, 1, 39, 0.0F, false));
        ...
        bone39.cubeList.add(new ModelBox(bone39, 61, 16, -2.001F, -11, 0.0F, 3, 7, 5, 0.0F, false));
        ...
        bone46.cubeList.add(new ModelBox(bone46, 84, 86, -1, 0.0F, 2.0F, 1, 3, 37, 0.0F, false));

        bone47 = new ModelRenderer(this);
        bone47.setRotationPoint(2.0F, 2.25F, 2.0F);
        stock.addChild(bone47);
        setRotationAngle(bone47, 0.0F, 0.0873F, 0.2793F);
        bone47.cubeList.add(new ModelBox(bone47, 28, 32, -1, 0.0F, -2.0F, 1, 3, 2, 0.0F, false));
        ...
        bone42.setRotationPoint(-1, 4.0F, 5.0F);
        stock.addChild(bone42);
        setRotationAngle(bone42, -0.7854F, 0.0F, 0.0F);
        bone42.cubeList.add(new ModelBox(bone42, 0, 27, -1, -2.0F, 0.0F, 4, 2, 2, 0.0F, false));
        ...
        bone49.setRotationPoint(1.5F, -1, 16.0F);
        stock.addChild(bone49);
        setRotationAngle(bone49, 0.0F, 0.0F, -0.7854F);
        bone49.cubeList.add(new ModelBox(bone49, 0, 41, 0.0607F, -1.7678F, -1, 1, 2, 15, 0.0F, false));
        bone49.cubeList.add(new ModelBox(bone49, 0, 0, -2.3536F, -3.182F, -1, 2, 1, 15, 0.0F, false));
    }
