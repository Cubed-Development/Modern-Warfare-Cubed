...
public class DSR1Barrel extends ModelWithAttachments {
    ...
    public DSR1Barrel() {
        ...
        barrel.cubeList.add(new ModelBox(barrel, 108, 224, -2, -36.088F, -59.5F, 1, 2, 40, 0, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 82, 164, -2, -34.838F, -67.5F, 1, 1, 9, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 159, 160, -2, -36.338F, -67.5F, 1, 1, 9, 0, false));
        ...
        cube_r119_r1.setRotationPoint(25.0913F, -10.6003F, 0);
        barrel.addChild(cube_r119_r1);
        setRotationAngle(cube_r119_r1, 0, 0, -0.7854F);
        ...
        cube_r118_r1.setRotationPoint(24.3842F, -10.3074F, 0);
        barrel.addChild(cube_r118_r1);
        setRotationAngle(cube_r118_r1, 0, 0, -0.7854F);
        ...
        cube_r117_r1.setRotationPoint(-25.97F, -8.479F, 0);
        barrel.addChild(cube_r117_r1);
        setRotationAngle(cube_r117_r1, 0, 0, 0.7854F);
        ...
        cube_r116_r1.setRotationPoint(-25.2629F, -8.1861F, 0);
        barrel.addChild(cube_r116_r1);
        setRotationAngle(cube_r116_r1, 0, 0, 0.7854F);
