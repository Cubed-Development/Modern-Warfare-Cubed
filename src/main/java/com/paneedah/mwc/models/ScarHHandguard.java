...
public class ScarHHandguard extends ModelWithAttachments {
    ...
    public ScarHHandguard() {
        ...
        handguard.cubeList.add(new ModelBox(handguard, 55, 0, 2.5F, -0.6F, 0, 1, 2, 22, 0.001F, false));
        handguard.cubeList.add(new ModelBox(handguard, 0, 80, 3.5F, -1, 0, 1, 1, 22, -0.001F, false));
        handguard.cubeList.add(new ModelBox(handguard, 0, 0, 1.1F, -0.6F, 0, 2, 2, 22, 0.002F, false));
        handguard.cubeList.add(new ModelBox(handguard, 55, 80, 0.1F, -1, 0, 1, 1, 22, -0.001F, false));
        ...
        setRotationAngle(cube_r52, 0, 0, -0.9076F);
        ...
        setRotationAngle(cube_r53, 0, 0, 0.9076F);
        ...
        setRotationAngle(cube_r54, 0, 0, -0.7854F);
        ...
        cube_r58.setRotationPoint(0.1F, 0, 0);
        handguard.addChild(cube_r58);
        setRotationAngle(cube_r58, 0, 0, -0.8552F);
        cube_r58.cubeList.add(new ModelBox(cube_r58, 0, 56, 0, 0, 0, 1, 2, 22, -0.002F, false));

        cube_r59 = new ModelRenderer(this);
        cube_r59.setRotationPoint(4.5F, 0, 0);
        handguard.addChild(cube_r59);
        setRotationAngle(cube_r59, 0, 0, 0.8552F);
        cube_r59.cubeList.add(new ModelBox(cube_r59, 55, 24, -1, 0, 0, 1, 2, 22, -0.002F, false));
        ...
        bone4.cubeList.add(new ModelBox(bone4, 165, 87, 12.1F, 0.4F, -1.25F, 1, 1, 11, 0, false));
        ...
        cube_r60.setRotationPoint(-1.6F, 0, -1.25F);
        bone4.addChild(cube_r60);
        setRotationAngle(cube_r60, 0, 0, 0.8901F);
        ...
        cube_r61.setRotationPoint(0, 0, -1.25F);
        bone4.addChild(cube_r61);
        setRotationAngle(cube_r61, 0, 0, -0.8901F);
        ...
        setRotationAngle(bone6, 0, 0, -3.1416F);
        ...
        bone6.cubeList.add(new ModelBox(bone6, 55, 57, 12.1F, 0.4F, -1.25F, 1, 1, 22, 0, false));
        bone6.cubeList.add(new ModelBox(bone6, 87, 94, 12.2F, -0.2F, -1.45F, 2, 1, 2, -0.199F, false));

        cube_r62 = new ModelRenderer(this);
        cube_r62.setRotationPoint(-1.6F, 0, -1.25F);
        ...
        cube_r63.setRotationPoint(0, 0, -1.25F);
        bone6.addChild(cube_r63);
        setRotationAngle(cube_r63, 0, 0, -0.8901F);
        ...
        bone5.cubeList.add(new ModelBox(bone5, 110, 151, -13.1F, 0.4F, -1.25F, 1, 1, 11, 0, false));
        ...
        cube_r64.setRotationPoint(1.6F, 0, -1.25F);
        bone5.addChild(cube_r64);
        setRotationAngle(cube_r64, 0, 0, -0.8901F);
        ...
        cube_r65.setRotationPoint(0, 0, -1.25F);
        bone5.addChild(cube_r65);
        setRotationAngle(cube_r65, 0, 0, 0.8901F);
