...
public class UMP45 extends ModelWithAttachments {
    ...
    public UMP45() {
        ...
        gun240_r1.cubeList.add(new ModelBox(gun240_r1, 0, 74, -0.499F, -1, -0.5F, 1, 2, 1, 0, false));

        gun239_r1 = new ModelRenderer(this);
        gun239_r1.setRotationPoint(-1.1075F, -5.9532F, -6.9352F);
        grip.addChild(gun239_r1);
        setRotationAngle(gun239_r1, 0.1222F, 0, 0);
        gun239_r1.cubeList.add(new ModelBox(gun239_r1, 38, 33, -0.5F, -2, -0.5F, 1, 3, 1, 0, false));

        gun239_r2 = new ModelRenderer(this);
        gun239_r2.setRotationPoint(-1.1075F, -2.7094F, -4.7174F);
        grip.addChild(gun239_r2);
        setRotationAngle(gun239_r2, 0.5236F, 0, 0);
        gun239_r2.cubeList.add(new ModelBox(gun239_r2, 38, 33, -1.501F, -0.5F, -2, 3, 1, 4, 0, false));

        gun239_r3 = new ModelRenderer(this);
        gun239_r3.setRotationPoint(-1.1075F, -1.6359F, -13.6445F);
        grip.addChild(gun239_r3);
        setRotationAngle(gun239_r3, -1.0297F, 0, 0);
        gun239_r3.cubeList.add(new ModelBox(gun239_r3, 37, 16, -1.501F, -1.5F, -4, 3, 1, 4, 0, false));
        ...
        gun238_r1.cubeList.add(new ModelBox(gun238_r1, 74, 76, -1.5F, -0.5F, -4, 3, 1, 7, 0, false));
        ...
        gun240_r2.cubeList.add(new ModelBox(gun240_r2, 96, 76, -1, -7.5F, -0.5F, 2, 14, 2, 0, false));
        ...
        gun242_r1.cubeList.add(new ModelBox(gun242_r1, 18, 26, -0.5F, -6.5F, -0.5F, 1, 13, 1, 0, false));
        ...
        gun240_r3.cubeList.add(new ModelBox(gun240_r3, 96, 57, -1, -6, -1.5F, 2, 10, 2, 0, false));

        gun241_r1 = new ModelRenderer(this);
        gun241_r1.setRotationPoint(0, 1.2708F, 4.0268F);
        bone.addChild(gun241_r1);
        setRotationAngle(gun241_r1, 0.4363F, 0, 0);
        gun241_r1.cubeList.add(new ModelBox(gun241_r1, 20, 74, -2.003F, -6, -1.175F, 4, 10, 3, -0.001F, false));
        ...
        gun241_r2.setRotationPoint(0, 0, 0);
        bone6.addChild(gun241_r2);
        setRotationAngle(gun241_r2, 0.4363F, 0, 0);
        gun241_r2.cubeList.add(new ModelBox(gun241_r2, 16, 15, -1, -8, -0.5F, 2, 4, 1, 0, false));
        ...
        gun242_r2.cubeList.add(new ModelBox(gun242_r2, 38, 26, -2.004F, -8, -1.175F, 4, 4, 3, -0.003F, false));
    }
