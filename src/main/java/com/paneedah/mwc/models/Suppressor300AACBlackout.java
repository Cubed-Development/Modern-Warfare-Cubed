...
public class Suppressor300AACBlackout extends ModelBase {
	...
	public Suppressor300AACBlackout() {
		...
		suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0.0F, -20.9F, 8.0F, 2, 1, 12, 0.0F, true));
		suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0.5F, -24.2F, 10.5F, 1, 1, 7, 0.0F, true));
		suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0.5F, -20.8F, 10.5F, 1, 1, 7, 0.0F, true));
		suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 2.2F, -22.5F, 10.5F, 1, 1, 7, 0.0F, true));
		suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.2F, -22.5F, 10.5F, 1, 1, 7, 0.0F, true));

		gun46_r1 = new ModelRenderer(this);
		gun46_r1.setRotationPoint(-16.8915F, -6.9508F, 0.0F);
		suppressor.addChild(gun46_r1);
		setRotationAngle(gun46_r1, 0.0F, 0.0F, 0.7808F);
		gun46_r1.cubeList.add(new ModelBox(gun46_r1, 0, 0, -0.15F, -21.4F, 10.5F, 1, 1, 7, 0.0F, true));
		gun46_r1.cubeList.add(new ModelBox(gun46_r1, 0, 0, 0.0F, -24.0F, -2.0F, 1, 1, 22, 0.0F, true));
		...
		gun45_r1.cubeList.add(new ModelBox(gun45_r1, 0, 0, 3.0F, -20.8F, 10.5F, 1, 1, 7, 0.0F, true));
		...
		gun44_r1.cubeList.add(new ModelBox(gun44_r1, 0, 0, 2.2F, -23.95F, 10.5F, 1, 1, 7, 0.0F, true));
		...
		gun43_r1.cubeList.add(new ModelBox(gun43_r1, 0, 0, -0.25F, -23.95F, 10.5F, 1, 1, 7, 0.0F, true));
		...
		gun37_r1.cubeList.add(new ModelBox(gun37_r1, 0, 0, 0.0F, -21.3F, 8.0F, 1, 1, 12, 0.0F, true));
		...
		gun33_r1.cubeList.add(new ModelBox(gun33_r1, 0, 0, 0.3F, -23.0F, 8.0F, 1, 1, 12, 0.0F, true));
		...
		gun32_r1.cubeList.add(new ModelBox(gun32_r1, 0, 0, 0.0F, -24.1F, 8.0F, 1, 1, 12, 0.0F, true));
		...
		gun31_r1.cubeList.add(new ModelBox(gun31_r1, 0, 0, 2.0F, -21.3F, 8.0F, 1, 1, 12, 0.0F, true));
		...
		gun28_r1.cubeList.add(new ModelBox(gun28_r1, 0, 0, 3.1F, -23.0F, 8.0F, 1, 1, 12, 0.0F, true));
		...
		gun27_r1.cubeList.add(new ModelBox(gun27_r1, 0, 0, 2.0F, -24.1F, 8.0F, 1, 1, 12, 0.0F, true));
