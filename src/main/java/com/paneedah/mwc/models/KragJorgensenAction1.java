...
public class KragJorgensenAction1 extends ModelWithAttachments {
    ...
    public KragJorgensenAction1() {
        ...
        action.setRotationPoint(-4.5889F, 24, 0.2294F);
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -39.6F, -9.8294F, 1, 1, 1, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -40.7F, -31.7294F, 1, 3, 14, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 1.0889F, -39.7F, -31.7294F, 3, 1, 16, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 1.5889F, -40.65F, -17.7294F, 2, 1, 3, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 1.1889F, -39.7F, -15.7294F, 1, 1, 4, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.9889F, -39.7F, -15.7294F, 1, 1, 2, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -40.8F, -13.7294F, 1, 1, 1, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -39.1F, -13.7294F, 1, 1, 2, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 3.3889F, -39.6F, -17.8294F, 1, 1, 6, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -39.8F, -13.0294F, 1, 1, 3, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.0889F, -39.4F, -13.0294F, 1, 1, 3, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 2.2889F, -39.6F, -13.0294F, 1, 1, 3, 0, true));
        action.cubeList.add(new ModelBox(action, 200, 0, 1.8889F, -39.6F, -13.0294F, 1, 1, 3, 0, true));

        action49_r1 = new ModelRenderer(this);
        action49_r1.setRotationPoint(0, 0, 0);
        action.addChild(action49_r1);
        setRotationAngle(action49_r1, 0, -0.4461F, 0);
        action49_r1.cubeList.add(new ModelBox(action49_r1, 200, 0, -2.8F, -39.6F, -10, 1, 1, 1, 0, true));

        action48_r1 = new ModelRenderer(this);
        action48_r1.setRotationPoint(8.4943F, 0, -2.1134F);
        action.addChild(action48_r1);
        setRotationAngle(action48_r1, 0, 0.4461F, 0);
        action48_r1.cubeList.add(new ModelBox(action48_r1, 200, 0, -2.2F, -39.6F, -9.55F, 1, 1, 1, 0, true));

        action47_r1 = new ModelRenderer(this);
        action47_r1.setRotationPoint(4.5889F, 0.2642F, -18.1647F);
        action.addChild(action47_r1);
        setRotationAngle(action47_r1, -0.4461F, 0, 0);
        action47_r1.cubeList.add(new ModelBox(action47_r1, 200, 0, -2.5F, -39.4F, -9.55F, 1, 1, 1, 0, true));

        action46_r1 = new ModelRenderer(this);
        action46_r1.setRotationPoint(4.5889F, -8.2106F, 15.9651F);
        action.addChild(action46_r1);
        setRotationAngle(action46_r1, 0.4461F, 0, 0);
        action46_r1.cubeList.add(new ModelBox(action46_r1, 200, 0, -2.5F, -39.8F, -10, 1, 1, 1, 0, true));

        action45_r1 = new ModelRenderer(this);
        action45_r1.setRotationPoint(21.8508F, -6.9659F, -0.2294F);
        action.addChild(action45_r1);
        setRotationAngle(action45_r1, 0, 0, -0.4833F);
        action45_r1.cubeList.add(new ModelBox(action45_r1, 200, 0, -5, -38.5F, -16.5F, 3, 1, 1, 0, true));
        action45_r1.cubeList.add(new ModelBox(action45_r1, 200, 0, -5, -38.5F, -16.9F, 3, 1, 1, 0, true));

        action36_r1 = new ModelRenderer(this);
        action36_r1.setRotationPoint(-13.9365F, -1.6311F, -0.2294F);
        action.addChild(action36_r1);
        setRotationAngle(action36_r1, 0, 0, 0.5205F);
        action36_r1.cubeList.add(new ModelBox(action36_r1, 200, 0, -5.6F, -35.6F, -17.2F, 1, 2, 2, 0, true));
        ...
        action19_r1.cubeList.add(new ModelBox(action19_r1, 200, 0, -4.8F, -38.7F, -16.7F, 1, 4, 1, 0, true));
