...
public class S710TricunActionPully extends ModelWithAttachments {
    ...
    public S710TricunActionPully() {
        ...
        action_pully.setRotationPoint(-3.4F, -13.95F, -20);
        action_pully.cubeList.add(new ModelBox(action_pully, 0, 76, 0.9F, -2.5F, 0.9F, 2, 1, 20, -0.2F, false));
        action_pully.cubeList.add(new ModelBox(action_pully, 16, 46, 0.9F, -2.6F, 19.4F, 2, 1, 2, 0, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(0.6F, -1.6F, 21.1F);
        action_pully.addChild(cube_r33);
        setRotationAngle(cube_r33, 0, -0.384F, 0);
        ...
        setRotationAngle(cube_r34, 0, 0.384F, 0);
        ...
        cube_r35.setRotationPoint(1.3F, -1.65F, 20);
        action_pully.addChild(cube_r35);
        setRotationAngle(cube_r35, 0, -0.2443F, 0);
        ...
        cube_r36.setRotationPoint(2.5F, -1.65F, 20);
        action_pully.addChild(cube_r36);
        setRotationAngle(cube_r36, 0, 0.2443F, 0);
        ...
        setRotationAngle(cube_r37, 0, -1.2654F, 0);
        ...
        setRotationAngle(cube_r38, 0, 1.2654F, 0);
        ...
        setRotationAngle(cube_r39, 0, -1.2654F, 0);
        ...
        setRotationAngle(cube_r40, 0, 1.2654F, 0);
        ...
        setRotationAngle(cube_r41, 0, -0.6283F, 0);
        ...
        setRotationAngle(cube_r42, 0, 0.6283F, 0);
        ...
        cube_r43.setRotationPoint(0.9F, -2, 21.4F);
        action_pully.addChild(cube_r43);
        setRotationAngle(cube_r43, 0, -0.6981F, 0);
        ...
        cube_r44.setRotationPoint(2.9F, -2, 21.4F);
        action_pully.addChild(cube_r44);
        setRotationAngle(cube_r44, 0, 0.6981F, 0);
        ...
        setRotationAngle(cube_r45, 0, -0.3927F, 0);
        cube_r45.cubeList.add(new ModelBox(cube_r45, 9, 80, 0, 0, -1, 3, 1, 1, -0.1F, false));

        cube_r46 = new ModelRenderer(this);
        cube_r46.setRotationPoint(2.1F, -2.6F, 21.15F);
        action_pully.addChild(cube_r46);
        setRotationAngle(cube_r46, 0, 0.3927F, 0);
        cube_r46.cubeList.add(new ModelBox(cube_r46, 36, 80, 0, 0, -1, 3, 1, 1, -0.1F, false));
    }
