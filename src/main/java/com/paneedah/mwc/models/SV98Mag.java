...
public class SV98Mag extends ModelWithAttachments {
    ...
    public SV98Mag() {
        ...
        mag.setRotationPoint(0.75F, -2, -26.7F);
        ...
        mag.cubeList.add(new ModelBox(mag, 0, 0, -3.3F, -8.45F, -3.1F, 2, 6, 2, 0, false));
        mag.cubeList.add(new ModelBox(mag, 60, 36, -2.5F, -8.45F, -1.65F, 1, 6, 2, 0, false));
        ...
        mag.cubeList.add(new ModelBox(mag, 0, 66, -1.6F, -8.1F, 4.4F, 1, 8, 6, 0, false));
        ...
        mag.cubeList.add(new ModelBox(mag, 38, 66, -1.85F, -8.3F, 0.4F, 1, 8, 4, 0, false));
        ...
        mag.cubeList.add(new ModelBox(mag, 16, 53, -4, -9.1F, 4.4F, 1, 1, 6, 0.001F, false));
        mag.cubeList.add(new ModelBox(mag, 33, 33, -3.9F, -8.1F, 4.4F, 1, 8, 6, 0, false));
        mag.cubeList.add(new ModelBox(mag, 86, 95, -1.6F, -0.1F, 5.4F, 1, 1, 5, 0, false));
        mag.cubeList.add(new ModelBox(mag, 86, 101, -3.9F, -0.1F, 5.4F, 1, 1, 5, 0, false));
        ...
        mag.cubeList.add(new ModelBox(mag, 24, 66, -3.65F, -8.3F, 0.4F, 1, 8, 4, 0, false));
        ...
        mag.cubeList.add(new ModelBox(mag, 60, 0, -3, -8.45F, -1.65F, 1, 6, 2, 0, false));
        ...
        setRotationAngle(cube_r16_r1, 0, 0, 1.1519F);
        cube_r16_r1.cubeList.add(new ModelBox(cube_r16_r1, 102, 88, -0.75F, -35.1F, -21.5F, 1, 1, 5, 0, false));
        ...
        setRotationAngle(cube_r13_r1, -0.0524F, 0, 0);
        ...
        setRotationAngle(cube_r12_r1, -0.2094F, 0, 0);
        ...
        cube_r12_r1.cubeList.add(new ModelBox(cube_r12_r1, 26, 41, -3.35F, -28.1F, -23, 1, 1, 1, -0.001F, false));
        ...
        cube_r12_r1.cubeList.add(new ModelBox(cube_r12_r1, 61, 69, -2.45F, -27.1F, -30, 3, 1, 1, -0.102F, false));
        cube_r12_r1.cubeList.add(new ModelBox(cube_r12_r1, 72, 42, -3.55F, -27.1F, -30, 3, 1, 1, -0.101F, false));
        ...
        cube_r12_r1.cubeList.add(new ModelBox(cube_r12_r1, 95, 17, -0.65F, -28.1F, -23, 1, 1, 1, -0.001F, false));
        ...
        setRotationAngle(cube_r11_r1, -0.7854F, 0, 0);
        cube_r11_r1.cubeList.add(new ModelBox(cube_r11_r1, 64, 31, -3.35F, -30.7F, -26.3F, 1, 1, 1, 0, false));
        cube_r11_r1.cubeList.add(new ModelBox(cube_r11_r1, 64, 0, -3.35F, -30.7F, -26.8F, 1, 1, 1, -0.001F, false));
        cube_r11_r1.cubeList.add(new ModelBox(cube_r11_r1, 76, 91, -0.65F, -30.7F, -26.3F, 1, 1, 1, 0, false));
        ...
        setRotationAngle(cube_r10_r1, -0.7854F, 0, 0);
        cube_r10_r1.cubeList.add(new ModelBox(cube_r10_r1, 64, 36, -3.35F, -30.2F, -28.8F, 1, 1, 1, 0, false));
        cube_r10_r1.cubeList.add(new ModelBox(cube_r10_r1, 64, 23, -3.35F, -30.7F, -28.8F, 1, 1, 1, -0.001F, false));
        cube_r10_r1.cubeList.add(new ModelBox(cube_r10_r1, 89, 39, -0.65F, -30.2F, -28.8F, 1, 1, 1, 0, false));
        ...
        setRotationAngle(cube_r9_r1, -0.7854F, 0, 0);
        cube_r9_r1.cubeList.add(new ModelBox(cube_r9_r1, 24, 82, -3.35F, -27.25F, -26.75F, 1, 1, 1, 0, false));
        cube_r9_r1.cubeList.add(new ModelBox(cube_r9_r1, 65, 7, -3.35F, -27.65F, -26.75F, 1, 1, 1, -0.001F, false));
        cube_r9_r1.cubeList.add(new ModelBox(cube_r9_r1, 89, 32, -0.65F, -27.25F, -26.75F, 1, 1, 1, 0, false));
        ...
        setRotationAngle(cube_r8_r1, -0.7854F, 0, 0);
        cube_r8_r1.cubeList.add(new ModelBox(cube_r8_r1, 89, 3, -3.35F, -28.65F, -29.75F, 1, 1, 1, 0, false));
        cube_r8_r1.cubeList.add(new ModelBox(cube_r8_r1, 89, 30, -0.65F, -28.65F, -29.75F, 1, 1, 1, 0, false));

        cube_r7_r1 = new ModelRenderer(this);
        cube_r7_r1.setRotationPoint(-0.75F, 34.4433F, 13.4339F);
        mag.addChild(cube_r7_r1);
        setRotationAngle(cube_r7_r1, -0.384F, 0, 0);
        ...
        setRotationAngle(cube_r6_r1, 0.1745F, 0, 0);
        cube_r6_r1.cubeList.add(new ModelBox(cube_r6_r1, 0, 24, -3.25F, -35.1F, -16.55F, 1, 4, 1, 0, false));
        cube_r6_r1.cubeList.add(new ModelBox(cube_r6_r1, 57, 82, -2.75F, -35.1F, -16.551F, 3, 4, 1, 0, false));

        cube_r5_r1 = new ModelRenderer(this);
        cube_r5_r1.setRotationPoint(-0.75F, 27.1112F, 25.3029F);
        mag.addChild(cube_r5_r1);
        setRotationAngle(cube_r5_r1, -0.0524F, 0, 0);
        ...
        setRotationAngle(cube_r4_r1, 0.1222F, 0, 0);
        ...
        setRotationAngle(cube_r3_r1, 0.1222F, 0, 0);
        ...
        setRotationAngle(cube_r2_r1, -0.0524F, 0, 0);
        cube_r2_r1.cubeList.add(new ModelBox(cube_r2_r1, 77, 49, -3.35F, -31.3F, -27, 1, 5, 1, -0.199F, false));
        cube_r2_r1.cubeList.add(new ModelBox(cube_r2_r1, 47, 82, -0.65F, -31.3F, -27, 1, 5, 1, -0.199F, false));

        cube_r1_r1 = new ModelRenderer(this);
        cube_r1_r1.setRotationPoint(29.3871F, 2.208F, 26.7F);
        mag.addChild(cube_r1_r1);
        setRotationAngle(cube_r1_r1, 0, 0, -1.1519F);
        cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 102, 82, -3.25F, -35.1F, -21.5F, 1, 1, 5, 0, false));
    }
