...
public class DSR1Mag extends ModelWithAttachments {
    ...
    public DSR1Mag() {
        ...
        magazine_actual.setRotationPoint(0, -3, 7.1F);
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 0, 92, -1.2F, -5.4F, 0, 1, 5, 10, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 35, 0, -2.8F, -5.4F, 0, 2, 5, 10, -0.001F, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 108, 91, -3, -0.4F, -0.25F, 3, 3, 5, 0.1F, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 80, 63, -0.75F, -0.501F, -0.05F, 1, 1, 4, 0, false));
        ...
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 15, 77, -0.75F, -0.501F, 5.95F, 1, 1, 4, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 47, 53, -0.75F, 0.499F, 5.95F, 1, 2, 1, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 32, 51, -0.75F, 0.499F, 2.95F, 1, 2, 1, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 88, 33, -0.75F, 0.799F, 3.95F, 1, 1, 2, 0, false));
        ...
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 5, 47, -3.25F, 0.499F, 2.95F, 1, 2, 1, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 88, 0, -3.25F, 0.799F, 3.95F, 1, 1, 2, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 32, 45, -3.25F, 0.499F, 5.95F, 1, 2, 1, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 0, 77, -3.25F, -0.501F, 5.95F, 1, 1, 4, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 51, 73, -3.25F, -0.501F, -0.05F, 1, 1, 4, 0, false));
        magazine_actual.cubeList.add(new ModelBox(magazine_actual, 131, 50, -3, -0.4F, 4.15F, 3, 3, 6, 0.101F, false));
        ...
        setRotationAngle(cube_r136_r1, 0, 0, -0.1222F);
        cube_r136_r1.cubeList.add(new ModelBox(cube_r136_r1, 22, 47, -0.75F, -30.101F, 11.05F, 1, 3, 2, 0, false));
        ...
        setRotationAngle(cube_r135_r1, 0, 0, 0.1222F);
        cube_r135_r1.cubeList.add(new ModelBox(cube_r135_r1, 39, 45, -3.25F, -30.101F, 11.05F, 1, 3, 2, 0, false));
        ...
        setRotationAngle(cube_r134_r1, 0, 0, -0.0873F);
        cube_r134_r1.cubeList.add(new ModelBox(cube_r134_r1, 88, 46, -0.85F, -27.501F, 11.05F, 1, 1, 2, 0, false));
        ...
        setRotationAngle(cube_r133_r1, 0, 0, -0.0873F);
        ...
        setRotationAngle(cube_r132_r1, 0, 0, 0.0873F);
        cube_r132_r1.cubeList.add(new ModelBox(cube_r132_r1, 88, 28, -3.15F, -27.501F, 11.05F, 1, 1, 2, 0, false));
        ...
        setRotationAngle(cube_r131_r1, 0, 0, 0.0873F);
