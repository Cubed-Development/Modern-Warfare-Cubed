...
public class TaurusBullets extends ModelWithAttachments {
    ...
    public TaurusBullets() {
        ...
        cube_r6.cubeList.add(new ModelBox(cube_r6, 69, 51, -1, -1.101F, -1.003F, 1, 1, 1, 0.0F, false));
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 19, 75, -1, -0.001F, -1.003F, 1, 1, 1, 0.0F, false));
