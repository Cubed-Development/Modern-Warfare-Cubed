...
public class MLOKExtendedHandguard extends ModelBase {
	...
	public MLOKExtendedHandguard() {
		...
		guard1.cubeList.add(new ModelBox(guard1, 0, 0, 0.0F, -0.001F, 0.0F, 4, 3, 4, 0.0F, false));

		guard2 = new ModelRenderer(this);
		guard2.setRotationPoint(-2.5F, -9.3F, -71.5F);
		guard2.cubeList.add(new ModelBox(guard2, 42, 1, 0.0F, 0.0F, -0.001F, 2, 2, 32, 0.0F, false));
		...
		guard4.cubeList.add(new ModelBox(guard4, 18, 16, 0.0F, -0.001F, -0.002F, 1, 1, 4, 0.0F, false));

		guard5 = new ModelRenderer(this);
		guard5.setRotationPoint(-0.5F, -7.0F, -39.5F);
		setRotationAngle(guard5, 0.0F, 0.0F, -2.3562F);
		guard5.cubeList.add(new ModelBox(guard5, 6, 17, 0.001F, 0.0F, -0.002F, 1, 1, 4, 0.0F, false));

		guard6 = new ModelRenderer(this);
		guard6.setRotationPoint(-0.5F, -7.0F, -39.5F);
		setRotationAngle(guard6, 0.0F, 0.0F, -2.3562F);
		guard6.cubeList.add(new ModelBox(guard6, 0, 16, 0.0F, 0.4F, -0.001F, 1, 1, 4, 0.0F, false));

		guard7 = new ModelRenderer(this);
		guard7.setRotationPoint(-2.5F, -7.0F, -39.5F);
		setRotationAngle(guard7, 0.0F, 0.0F, -2.3562F);
		guard7.cubeList.add(new ModelBox(guard7, 12, 15, 0.4F, 0.0F, -0.001F, 1, 1, 4, 0.0F, false));

		guard8 = new ModelRenderer(this);
		guard8.setRotationPoint(-3.5F, -8.0F, -39.5F);
		setRotationAngle(guard8, 1.7474F, 0.0F, 0.0F);
		guard8.cubeList.add(new ModelBox(guard8, 13, 12, 0.0F, 0.0F, 0.0F, 4, 1, 2, 0.0F, false));

		guard10 = new ModelRenderer(this);
		guard10.setRotationPoint(-2.5F, -15.8F, -70.5F);
		guard10.cubeList.add(new ModelBox(guard10, 102, 67, 0.0F, 0.0F, -0.001F, 2, 1, 30, 0.0F, false));

		guard11 = new ModelRenderer(this);
		guard11.setRotationPoint(-3.5F, -12.4F, -69.5F);
		guard11.cubeList.add(new ModelBox(guard11, 111, 0, -0.001F, 0.0F, 0.0F, 1, 1, 28, 0.0F, false));

		guard18 = new ModelRenderer(this);
		guard18.setRotationPoint(-4.0F, -10.5F, -71.5F);
		guard18.cubeList.add(new ModelBox(guard18, 0, 33, 0.001F, 0.0F, 0.0F, 5, 1, 32, 0.0F, false));

		guard19 = new ModelRenderer(this);
		guard19.setRotationPoint(-3.5F, -9.0F, -39.5F);
		guard19.cubeList.add(new ModelBox(guard19, 0, 7, 0.001F, 0.0F, 0.0F, 4, 1, 4, 0.0F, false));

		guard20 = new ModelRenderer(this);
		guard20.setRotationPoint(-4.0F, -12.0F, -71.5F);
		guard20.cubeList.add(new ModelBox(guard20, 0, 0, 0.0F, -0.001F, -0.001F, 5, 1, 32, 0.0F, false));

		guard21 = new ModelRenderer(this);
		guard21.setRotationPoint(-0.5F, -12.4F, -69.5F);
		guard21.cubeList.add(new ModelBox(guard21, 109, 32, 0.001F, 0.0F, 0.0F, 1, 1, 28, 0.0F, false));

		guard22 = new ModelRenderer(this);
		guard22.setRotationPoint(-0.5F, -14.0F, -71.5F);
		guard22.cubeList.add(new ModelBox(guard22, 33, 101, 0.0F, 0.0F, -0.001F, 1, 1, 31, 0.0F, false));

		guard23 = new ModelRenderer(this);
		guard23.setRotationPoint(-3.5F, -14.0F, -71.5F);
		...
		setRotationAngle(guard35, 0.0F, 0.0F, 2.5281F);
		guard35.cubeList.add(new ModelBox(guard35, 23, 23, 0.0F, 0.0F, 0.0F, 1, 2, 3, 0.0F, false));
		...
		guard45.cubeList.add(new ModelBox(guard45, 127, 126, 0.0F, 0.0F, 0.0F, 1, 1, 27, 0.0F, false));

		guard46 = new ModelRenderer(this);
		guard46.setRotationPoint(0.5F, -14.0F, -67.5F);
		setRotationAngle(guard46, 0.0F, 0.0F, 2.5281F);
		guard46.cubeList.add(new ModelBox(guard46, 71, 132, -0.001F, 1.4F, 0.0F, 1, 1, 26, 0.0F, false));

		guard47 = new ModelRenderer(this);
		guard47.setRotationPoint(-3.5F, -13.0F, -71.5F);
		guard47.cubeList.add(new ModelBox(guard47, 12, 8, 0.0F, 0.0F, -0.001F, 4, 1, 2, 0.0F, false));

		guard48 = new ModelRenderer(this);
		guard48.setRotationPoint(-3.5F, -13.0F, -68.5F);
		guard48.cubeList.add(new ModelBox(guard48, 10, 35, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard49 = new ModelRenderer(this);
		guard49.setRotationPoint(-3.5F, -13.0F, -65.5F);
		guard49.cubeList.add(new ModelBox(guard49, 0, 35, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard50 = new ModelRenderer(this);
		guard50.setRotationPoint(-3.5F, -13.0F, -62.5F);
		guard50.cubeList.add(new ModelBox(guard50, 20, 33, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard51 = new ModelRenderer(this);
		guard51.setRotationPoint(-3.5F, -13.0F, -59.5F);
		guard51.cubeList.add(new ModelBox(guard51, 10, 33, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard52 = new ModelRenderer(this);
		guard52.setRotationPoint(-3.5F, -13.0F, -56.5F);
		guard52.cubeList.add(new ModelBox(guard52, 0, 33, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard53 = new ModelRenderer(this);
		guard53.setRotationPoint(-3.5F, -13.0F, -53.5F);
		guard53.cubeList.add(new ModelBox(guard53, 20, 30, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard54 = new ModelRenderer(this);
		guard54.setRotationPoint(-3.5F, -13.0F, -50.5F);
		guard54.cubeList.add(new ModelBox(guard54, 10, 30, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard55 = new ModelRenderer(this);
		guard55.setRotationPoint(-3.5F, -13.0F, -47.5F);
		guard55.cubeList.add(new ModelBox(guard55, 0, 30, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard56 = new ModelRenderer(this);
		guard56.setRotationPoint(-3.5F, -13.0F, -44.5F);
		guard56.cubeList.add(new ModelBox(guard56, 14, 28, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		guard57 = new ModelRenderer(this);
		guard57.setRotationPoint(-3.5F, -13.0F, -41.5F);
		guard57.cubeList.add(new ModelBox(guard57, 5, 27, 0.0F, 0.0F, -0.001F, 4, 1, 1, 0.0F, false));

		guard58 = new ModelRenderer(this);
		guard58.setRotationPoint(-0.6F, -13.0F, -69.5F);
		guard58.cubeList.add(new ModelBox(guard58, 96, 103, 0.0F, 0.0F, 0.0F, 1, 1, 28, 0.0F, false));

		guard59 = new ModelRenderer(this);
		guard59.setRotationPoint(-3.4F, -13.0F, -69.5F);
		guard59.cubeList.add(new ModelBox(guard59, 66, 102, 0.0F, 0.0F, 0.0F, 1, 1, 28, 0.0F, false));
		...
		guard75.cubeList.add(new ModelBox(guard75, 0, 131, -0.999F, 1.4F, 0.0F, 1, 1, 26, 0.0F, false));

		guard76 = new ModelRenderer(this);
		guard76.setRotationPoint(-4.0F, -9.5F, -71.5F);
		...
		guard78.setRotationPoint(-4.0F, -9.5F, -71.5F);
		setRotationAngle(guard78, 0.0F, 0.0F, -2.3422F);
		guard78.cubeList.add(new ModelBox(guard78, 26, 0, -1.5F, 0.0F, 0.002F, 1, 1, 2, 0.0F, false));

		guard79 = new ModelRenderer(this);
		guard79.setRotationPoint(-4.0F, -9.5F, -67.5F);
		setRotationAngle(guard79, 0.0F, 0.0F, -2.3422F);
		guard79.cubeList.add(new ModelBox(guard79, 28, 17, -1.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		guard80 = new ModelRenderer(this);
		guard80.setRotationPoint(-4.0F, -9.5F, -62.5F);
		setRotationAngle(guard80, 0.0F, 0.0F, -2.3422F);
		guard80.cubeList.add(new ModelBox(guard80, 28, 9, -1.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		guard81 = new ModelRenderer(this);
		guard81.setRotationPoint(-4.0F, -9.5F, -57.5F);
		setRotationAngle(guard81, 0.0F, 0.0F, -2.3422F);
		guard81.cubeList.add(new ModelBox(guard81, 28, 7, -1.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		guard82 = new ModelRenderer(this);
		guard82.setRotationPoint(-4.0F, -9.5F, -52.5F);
		setRotationAngle(guard82, 0.0F, 0.0F, -2.3422F);
		guard82.cubeList.add(new ModelBox(guard82, 27, 20, -1.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		guard83 = new ModelRenderer(this);
		guard83.setRotationPoint(-4.0F, -9.5F, -47.5F);
		setRotationAngle(guard83, 0.0F, 0.0F, -2.3422F);
		guard83.cubeList.add(new ModelBox(guard83, 22, 24, -1.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		guard9.setRotationPoint(-3.5F, -13.0F, -50.5F);
