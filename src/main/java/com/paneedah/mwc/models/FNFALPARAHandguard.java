...
public class FNFALPARAHandguard extends ModelBase {
    ...
    public FNFALPARAHandguard() {
        ...
        handguard.cubeList.add(new ModelBox(handguard, 101, 101, 1, -37.4587F, -66.5436F, 1, 1, 31, 0.0F, false));
        ...
        bone27.cubeList.add(new ModelBox(bone27, 66, 104, -1, 0.0F, 0.0F, 1, 1, 31, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 68, 71, -1, 2.0F, 0.0F, 1, 2, 31, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 10, 11, -1.22F, 0.0588F, 30.9F, 1, 3, 3, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 3, 37, -1, 1, 0.0F, 1, 1, 1, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 0, 28, -1, 1, 5.0F, 1, 1, 2, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 0, 24, -1, 1, 11, 1, 1, 2, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 20, 16, -1, 1, 17.0F, 1, 1, 2, 0.0F, false));
        bone27.cubeList.add(new ModelBox(bone27, 10, 11, -1, 1, 23.0F, 1, 1, 8, 0.0F, false));

        bone35 = new ModelRenderer(this);
        bone35.setRotationPoint(0.0F, 1.6087F, 1);
        ...
        bone35.cubeList.add(new ModelBox(bone35, 3, 33, -1.014F, -12.5879F, -13.5043F, 1, 1, 1, 0.0F, false));
        bone35.cubeList.add(new ModelBox(bone35, 26, 32, -1.014F, -15.8406F, -16.757F, 1, 1, 1, 0.0F, false));
        ...
        bone35.cubeList.add(new ModelBox(bone35, 9, 36, -1.001F, -13.3366F, -12.7279F, 1, 1, 1, 0.0F, false));
        bone35.cubeList.add(new ModelBox(bone35, 16, 32, -1.001F, -16.5893F, -15.9806F, 1, 1, 1, 0.0F, false));
        ...
        bone31.cubeList.add(new ModelBox(bone31, 25, 36, 0.0F, 1, 0.0F, 1, 1, 1, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 14, 2, 0.0F, 1, 5.0F, 1, 1, 2, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 0, 3, 0.0F, 1, 11, 1, 1, 2, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 0, 0, 0.0F, 1, 17.0F, 1, 1, 2, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 0, 10, 0.0F, 1, 23.0F, 1, 1, 8, 0.0F, false));
        ...
        bone36.cubeList.add(new ModelBox(bone36, 27, 4, -1.014F, -12.5879F, -13.5043F, 1, 1, 1, 0.0F, false));
        bone36.cubeList.add(new ModelBox(bone36, 27, 0, -1.014F, -15.8406F, -16.757F, 1, 1, 1, 0.0F, false));
        ...
        bone36.cubeList.add(new ModelBox(bone36, 4, 24, -1.001F, -13.3366F, -12.7279F, 1, 1, 1, 0.0F, false));
        bone36.cubeList.add(new ModelBox(bone36, 22, 20, -1.001F, -16.5893F, -15.9806F, 1, 1, 1, 0.0F, false));
        ...
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -1, -1, 0.0F, 2, 1, 30, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 0.45F, -0.75F, 6.0F, 1, 1, 23, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -1.45F, -0.75F, 11, 1, 1, 18, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 1.35F, 0.05F, 6.0F, 1, 1, 23, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -2.35F, 0.05F, 11, 1, 1, 18, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 0.95F, -0.35F, 8.0F, 1, 1, 19, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -1.95F, -0.35F, 12.0F, 1, 1, 15, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 0.75F, 1.1F, 3.0F, 2, 1, 27, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -2.75F, 1.1F, 10.0F, 2, 1, 20, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 0.751F, 0.6F, 3.0F, 2, 1, 27, 0.0F, false));
        sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -2.749F, 0.6F, 10.0F, 2, 1, 20, 0.0F, false));

        bone101 = new ModelRenderer(this);
        bone101.setRotationPoint(2.751F, 1.6F, 3.0F);
        sa58dustcover.addChild(bone101);
        setRotationAngle(bone101, -0.6283F, -1.3614F, 0.6458F);
        bone101.cubeList.add(new ModelBox(bone101, 0, 0, -3.0F, -1, 0.0F, 3, 1, 1, 0.0F, false));
        bone101.cubeList.add(new ModelBox(bone101, 0, 0, -2.999F, -0.5F, -0.001F, 3, 1, 1, 0.0F, false));

        bone99 = new ModelRenderer(this);
        bone99.setRotationPoint(1, -1, 0.0F);
        sa58dustcover.addChild(bone99);
        setRotationAngle(bone99, 0.0F, 0.0F, 0.733F);
        bone99.cubeList.add(new ModelBox(bone99, 0, 0, 0.0F, 0.0F, 0.0F, 1, 1, 30, 0.0F, false));
        bone99.cubeList.add(new ModelBox(bone99, 0, 0, 0.7F, -0.002F, 0.001F, 1, 2, 30, 0.0F, false));
        bone99.cubeList.add(new ModelBox(bone99, 0, 0, 1.35F, -0.001F, 2.999F, 1, 1, 27, 0.0F, false));

        bone100 = new ModelRenderer(this);
        bone100.setRotationPoint(2.35F, -0.001F, 2.999F);
        bone99.addChild(bone100);
        setRotationAngle(bone100, 0.0F, -1.3614F, 0.0F);
        bone100.cubeList.add(new ModelBox(bone100, 0, 0, -3.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F, false));

        bone102 = new ModelRenderer(this);
        bone102.setRotationPoint(-1, -1, 0.0F);
        sa58dustcover.addChild(bone102);
        setRotationAngle(bone102, 0.0F, 0.0F, -0.733F);
        bone102.cubeList.add(new ModelBox(bone102, 0, 0, -1, 0.0F, 0.0F, 1, 1, 30, 0.0F, false));
        bone102.cubeList.add(new ModelBox(bone102, 0, 0, -2.35F, -0.001F, 9.999F, 2, 2, 20, 0.0F, false));

        bone103 = new ModelRenderer(this);
        bone103.setRotationPoint(-1.8F, -0.001F, 9.999F);
        bone102.addChild(bone103);
        setRotationAngle(bone103, 0.0F, 0.6632F, 0.0F);
        bone103.cubeList.add(new ModelBox(bone103, 0, 0, 0.0F, -0.001F, 0.0F, 1, 1, 1, 0.0F, false));

        bone104 = new ModelRenderer(this);
        bone104.setRotationPoint(2.9F, 1.6F, 5.0F);
        sa58dustcover.addChild(bone104);
        setRotationAngle(bone104, -0.4363F, 0.0F, 0.0F);
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1, -7.3393F, 13.5946F, 1, 1, 1, 0.0F, false));
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -5.8F, -7.3393F, 13.5946F, 1, 1, 1, 0.0F, false));
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1, -4.3809F, 7.2505F, 1, 1, 1, 0.0F, false));
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -5.8F, -4.3809F, 7.2505F, 1, 1, 1, 0.0F, false));
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1, -10.2976F, 19.9388F, 1, 1, 1, 0.0F, false));
        bone104.cubeList.add(new ModelBox(bone104, 0, 0, -5.8F, -10.2976F, 19.9388F, 1, 1, 1, 0.0F, false));
    }
