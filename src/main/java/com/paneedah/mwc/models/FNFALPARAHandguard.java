...
public class FNFALPARAHandguard extends ModelBase {
	...
	public FNFALPARAHandguard() {
		...
		sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -1.0F, -1.0F, 0.0F, 2, 1, 30, 0.0F, false));
		sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 0.45F, -0.75F, 6.0F, 1, 1, 23, 0.0F, false));
		sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -1.45F, -0.75F, 11.0F, 1, 1, 18, 0.0F, false));
		sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, 1.35F, 0.05F, 6.0F, 1, 1, 23, 0.0F, false));
		sa58dustcover.cubeList.add(new ModelBox(sa58dustcover, 0, 0, -2.35F, 0.05F, 11.0F, 1, 1, 18, 0.0F, false));
		...
		bone101.cubeList.add(new ModelBox(bone101, 0, 0, -3.0F, -1.0F, 0.0F, 3, 1, 1, 0.0F, false));
		bone101.cubeList.add(new ModelBox(bone101, 0, 0, -2.999F, -0.5F, -0.001F, 3, 1, 1, 0.0F, false));

		bone99 = new ModelRenderer(this);
		bone99.setRotationPoint(1.0F, -1.0F, 0.0F);
		...
		bone102.setRotationPoint(-1.0F, -1.0F, 0.0F);
		sa58dustcover.addChild(bone102);
		setRotationAngle(bone102, 0.0F, 0.0F, -0.733F);
		bone102.cubeList.add(new ModelBox(bone102, 0, 0, -1.0F, 0.0F, 0.0F, 1, 1, 30, 0.0F, false));
		...
		bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1.0F, -7.3393F, 13.5946F, 1, 1, 1, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 0, 0, -5.8F, -7.3393F, 13.5946F, 1, 1, 1, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1.0F, -4.3809F, 7.2505F, 1, 1, 1, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 0, 0, -5.8F, -4.3809F, 7.2505F, 1, 1, 1, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 0, 0, -1.0F, -10.2976F, 19.9388F, 1, 1, 1, 0.0F, false));
