...
public class AR15Action extends ModelBase {
    ...
    public AR15Action() {
        ...
        Action1.setRotationPoint(-0.3F, 0, 0);
        Action1.cubeList.add(new ModelBox(Action1, 0, 0, 0, -0.001F, -0.099F, 2, 1, 15, 0, false));

        Action2 = new ModelRenderer(this);
        Action2.setRotationPoint(-2, -0.5F, 14.5F);
        Action2.cubeList.add(new ModelBox(Action2, 0, 11, 0, -0.001F, 0, 3, 2, 1, 0, false));
        ...
        Action3.setRotationPoint(-2, -0.5F, 14.5F);
        setRotationAngle(Action3, 0, 0.5577F, 0);
        Action3.cubeList.add(new ModelBox(Action3, 0, 16, 0, 0, 0, 2, 2, 1, 0, false));

        Action4 = new ModelRenderer(this);
        Action4.setRotationPoint(4, -0.5F, 14.5F);
        setRotationAngle(Action4, 0, -2.1192F, 0);
        ...
        Action5.setRotationPoint(-1, -0.5F, 14);
        Action5.cubeList.add(new ModelBox(Action5, 0, 0, 0, 0.001F, 0, 4, 2, 1, 0, false));

        Action6 = new ModelRenderer(this);
        Action6.setRotationPoint(1.5F, 0, 13.7F);
        setRotationAngle(Action6, 0, 0.0744F, 0);
        Action6.cubeList.add(new ModelBox(Action6, 7, 13, 0.2F, 0.098F, 0, 3, 1, 1, -0.2F, false));

        Action7 = new ModelRenderer(this);
        Action7.setRotationPoint(1.3F, 0, 0);
        Action7.cubeList.add(new ModelBox(Action7, 0, 16, 0, 0, -0.1F, 1, 1, 15, 0, false));
        ...
        setRotationAngle(Action7_r1, 0, 0.1222F, 0);
        ...
        setRotationAngle(Action9_r1, 0, -1.0297F, 0);
        Action9_r1.cubeList.add(new ModelBox(Action9_r1, 5, 18, -1, -1.1F, -1.6F, 1, 1, 1, 0, false));
        Action9_r1.cubeList.add(new ModelBox(Action9_r1, 9, 18, -1.001F, -1.101F, -1, 1, 1, 1, 0, false));
        Action9_r1.cubeList.add(new ModelBox(Action9_r1, 17, 16, -0.998F, -1.401F, -1.599F, 1, 1, 1, 0, false));
        Action9_r1.cubeList.add(new ModelBox(Action9_r1, 17, 18, -0.999F, -1.4F, -0.999F, 1, 1, 1, 0, false));
    }
