...
public class SV98Action extends ModelWithAttachments {
    ...
    public SV98Action() {
        ...
        action.cubeList.add(new ModelBox(action, 86, 138, -2.6F, -39.3F, -28.4F, 1, 1, 18, 0, false));
        action.cubeList.add(new ModelBox(action, 122, 0, -1.2F, -39.3F, -28.4F, 1, 1, 18, 0, false));
        action.cubeList.add(new ModelBox(action, 42, 132, -1.9F, -40, -28.4F, 1, 1, 18, 0, false));
        action.cubeList.add(new ModelBox(action, 120, 30, -1.9F, -38.6F, -28.4F, 1, 1, 18, 0, false));

        Action18_r1 = new ModelRenderer(this);
        Action18_r1.setRotationPoint(-24.9822F, -6.9806F, -0.1F);
        action.addChild(Action18_r1);
        setRotationAngle(Action18_r1, 0, 0, 0.679F);
        Action18_r1.cubeList.add(new ModelBox(Action18_r1, 47, 94, -3.0406F, -38.0156F, -13.3F, 1, 5, 1, 0, false));
        ...
        setRotationAngle(Action19_r1_r1, 0, 0, 0.8884F);
        ...
        setRotationAngle(Action12_r2_r1, 0, 0, -0.4363F);
        Action12_r2_r1.cubeList.add(new ModelBox(Action12_r2_r1, 103, 51, -1.3F, -39.6F, -11, 1, 1, 1, -0.1F, false));
        ...
        setRotationAngle(Action13_r1_r1, 0, 0, -2.7053F);
        Action13_r1_r1.cubeList.add(new ModelBox(Action13_r1_r1, 86, 103, -0.5F, -39.6F, -11, 1, 1, 1, -0.098F, false));

        Action11_r3_r1 = new ModelRenderer(this);
        Action11_r3_r1.setRotationPoint(-16.4977F, -2.6266F, -0.1F);
        action.addChild(Action11_r3_r1);
        setRotationAngle(Action11_r3_r1, 0, 0, 0.4363F);
        Action11_r3_r1.cubeList.add(new ModelBox(Action11_r3_r1, 93, 103, -2.7F, -39.6F, -11, 1, 1, 1, -0.098F, false));
        ...
        setRotationAngle(Action12_r1_r1, 0, 0, 2.7053F);
        Action12_r1_r1.cubeList.add(new ModelBox(Action12_r1_r1, 104, 60, -3.5F, -39.6F, -11, 1, 1, 1, -0.1F, false));
        ...
        setRotationAngle(Action10_r2_r1, 0, 0, -1.1345F);
        Action10_r2_r1.cubeList.add(new ModelBox(Action10_r2_r1, 104, 64, -1.6F, -38.5F, -11, 1, 1, 1, -0.099F, false));
        ...
        setRotationAngle(Action11_r2_r1, 0, 0, 1.1345F);
        Action11_r2_r1.cubeList.add(new ModelBox(Action11_r2_r1, 69, 104, -2.4F, -38.5F, -11, 1, 1, 1, -0.1F, false));

        Action9_r1_r1 = new ModelRenderer(this);
        Action9_r1_r1.setRotationPoint(-36.8378F, -21.7216F, -0.1F);
        action.addChild(Action9_r1_r1);
        setRotationAngle(Action9_r1_r1, 0, 0, 1.1345F);
        Action9_r1_r1.cubeList.add(new ModelBox(Action9_r1_r1, 106, 15, -1.6F, -39.9F, -11, 1, 1, 1, -0.1F, false));
        ...
        setRotationAngle(Action10_r1_r1, 0, 0, -1.1345F);
        Action10_r1_r1.cubeList.add(new ModelBox(Action10_r1_r1, 104, 69, -2.4F, -39.9F, -11, 1, 1, 1, -0.099F, false));

        Action11_r1_r1 = new ModelRenderer(this);
        Action11_r1_r1.setRotationPoint(19.5192F, -6.0268F, -0.1F);
        action.addChild(Action11_r1_r1);
        setRotationAngle(Action11_r1_r1, 0, 0, -0.5236F);
        ...
        setRotationAngle(Action2_r1_r1, 0, 0, -0.7854F);
        Action2_r1_r1.cubeList.add(new ModelBox(Action2_r1_r1, 126, 131, -3, -39.9F, -28.3F, 1, 1, 18, -0.001F, false));

        Action3_r2_r1 = new ModelRenderer(this);
        Action3_r2_r1.setRotationPoint(28.0207F, -12.4936F, -0.1F);
        action.addChild(Action3_r2_r1);
        setRotationAngle(Action3_r2_r1, 0, 0, -0.7854F);
        Action3_r2_r1.cubeList.add(new ModelBox(Action3_r2_r1, 130, 61, -2, -39.9F, -28.3F, 1, 1, 18, -0.001F, false));

        Action3_r1_r1 = new ModelRenderer(this);
        Action3_r1_r1.setRotationPoint(-27.0023F, -9.6693F, -0.1F);
        action.addChild(Action3_r1_r1);
        setRotationAngle(Action3_r1_r1, 0, 0, 0.7854F);
        Action3_r1_r1.cubeList.add(new ModelBox(Action3_r1_r1, 119, 82, -3, -38.5F, -28.3F, 1, 1, 18, -0.001F, false));

        Action4_r1_r1 = new ModelRenderer(this);
        Action4_r1_r1.setRotationPoint(-26.7094F, -10.3764F, -0.1F);
        action.addChild(Action4_r1_r1);
        setRotationAngle(Action4_r1_r1, 0, 0, 0.7854F);
        Action4_r1_r1.cubeList.add(new ModelBox(Action4_r1_r1, 120, 112, -2, -38.5F, -28.3F, 1, 1, 18, -0.001F, false));
    }
