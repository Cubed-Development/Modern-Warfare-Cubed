...
public class AK101DustCover extends ModelBase {
    ...
    public AK101DustCover() {
        ...
        DustCover40.cubeList.add(new ModelBox(DustCover40, 14, 0, 0.001F, 0.0F, 0.0F, 2, 2, 2, 0.0F, false));
        ...
        DustCover39.cubeList.add(new ModelBox(DustCover39, 14, 4, -0.001F, 0.0F, 0.0F, 2, 2, 2, 0.0F, false));
        ...
        DustCover47.cubeList.add(new ModelBox(DustCover47, 0, 0, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        DustCover12.cubeList.add(new ModelBox(DustCover12, 0, 2, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
