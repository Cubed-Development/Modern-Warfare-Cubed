...
public class BulletSmall extends ModelBase {
    ...
    public BulletSmall() {
        ...
        setRotationAngle(cube_r1, 0, -0.7854F, 0);
        ...
        setRotationAngle(cube_r2, 0, 0.7854F, 0);
        ...
        setRotationAngle(cube_r3, 0, -0.7854F, 0);
        ...
        setRotationAngle(cube_r4, 0, 0.7854F, 0);
        ...
        bullet.setRotationPoint(0, 25.75F, 0);
        ...
        bullet_r1.cubeList.add(new ModelBox(bullet_r1, 12, 0, -0.8F, -2, -0.8F, 1, 3, 1, -0.201F, false));
        ...
        bullet_r2.cubeList.add(new ModelBox(bullet_r2, 8, 10, -0.8F, -2, -0.2F, 1, 3, 1, -0.201F, false));
        ...
        bullet_r3.cubeList.add(new ModelBox(bullet_r3, 12, 4, -0.2F, -2, -0.8F, 1, 3, 1, -0.201F, false));
        ...
        bullet_r4.cubeList.add(new ModelBox(bullet_r4, 12, 8, -0.2F, -2, -0.2F, 1, 3, 1, -0.201F, false));

        bullet_r5 = new ModelRenderer(this);
        bullet_r5.setRotationPoint(-1.3F, -11.3F, 0.6F);
        bullet.addChild(bullet_r5);
        setRotationAngle(bullet_r5, 0, 0, 0.3491F);
        ...
        setRotationAngle(bullet_r6, 0, 0, -0.3491F);
        ...
        setRotationAngle(bullet_r7, 0.3491F, 0, 0);
        ...
        setRotationAngle(bullet_r8, -0.3491F, 0, 0);
