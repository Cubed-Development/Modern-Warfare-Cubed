...
public class ScarIron1 extends ModelBase {
    ...
    public ScarIron1() {
        ...
        sight.cubeList.add(new ModelBox(sight, 8, 19, 1, -30.0F, 0.0F, 1, 1, 1, -0.202F, false));
        ...
        sight16_r1.cubeList.add(new ModelBox(sight16_r1, 0, 21, 0.0F, 0.0F, 1, 9, 3, 3, -0.4F, false));
        ...
        sight19_r1.cubeList.add(new ModelBox(sight19_r1, 24, 9, -11, 0.0F, 0.0F, 3, 4, 4, 0.0F, false));
        ...
        sight8_r1.cubeList.add(new ModelBox(sight8_r1, 4, 36, -1.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight8_r1.cubeList.add(new ModelBox(sight8_r1, 15, 35, -1, 0.0F, -1, 1, 7, 1, 0.0F, false));
        ...
        sight10_r1.cubeList.add(new ModelBox(sight10_r1, 4, 44, -1.35F, -2.0F, -1, 1, 2, 1, -0.003F, false));
        sight10_r1.cubeList.add(new ModelBox(sight10_r1, 44, 31, -1, -2.0F, -1, 1, 2, 1, 0.0F, false));
        ...
        sight9_r1.cubeList.add(new ModelBox(sight9_r1, 44, 6, 0.35F, -2.0F, -1, 1, 2, 1, -0.003F, false));
        sight9_r1.cubeList.add(new ModelBox(sight9_r1, 20, 44, 0.0F, -2.0F, -1, 1, 2, 1, -0.001F, false));

        sight10_r2 = new ModelRenderer(this);
        sight10_r2.setRotationPoint(0.0F, 1, -0.5F);
        bone.addChild(sight10_r2);
        setRotationAngle(sight10_r2, 0.0F, 0.4363F, 0.0F);
        sight10_r2.cubeList.add(new ModelBox(sight10_r2, 35, 40, 0.2F, -4.0F, -1, 1, 2, 1, -0.002F, false));
        sight10_r2.cubeList.add(new ModelBox(sight10_r2, 42, 25, 0.0F, -4.0F, -1, 1, 2, 1, -0.001F, false));

        sight9_r2 = new ModelRenderer(this);
        sight9_r2.setRotationPoint(0.0F, 1, -0.5F);
        bone.addChild(sight9_r2);
        setRotationAngle(sight9_r2, 0.0F, -0.4363F, 0.0F);
        sight9_r2.cubeList.add(new ModelBox(sight9_r2, 42, 0, -1.2F, -4.0F, -1, 1, 2, 1, 0.0F, false));
        sight9_r2.cubeList.add(new ModelBox(sight9_r2, 34, 6, -1, -4.0F, -2.0F, 1, 2, 2, 0.003F, false));
        ...
        sight9_r3.cubeList.add(new ModelBox(sight9_r3, 0, 36, 0.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight9_r3.cubeList.add(new ModelBox(sight9_r3, 36, 32, 0.0F, 0.0F, -1, 1, 7, 1, 0.001F, false));
        ...
        sight9_r4.cubeList.add(new ModelBox(sight9_r4, 4, 9, -1, 0.0F, 0.0F, 1, 7, 1, 0.0F, false));
        ...
        sight11_r1.cubeList.add(new ModelBox(sight11_r1, 16, 43, -1, -2.0F, 0.0F, 1, 2, 1, 0.0F, false));
        ...
        sight10_r4.setRotationPoint(0.0F, -1, 0.5F);
        ...
        sight10_r4.cubeList.add(new ModelBox(sight10_r4, 0, 0, -1, -2.0F, 0.0F, 1, 2, 2, 0.0F, false));

        sight11_r2 = new ModelRenderer(this);
        sight11_r2.setRotationPoint(0.0F, -1, 0.5F);
        ...
        sight9_r5.cubeList.add(new ModelBox(sight9_r5, 28, 32, -1.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight9_r5.cubeList.add(new ModelBox(sight9_r5, 32, 32, -1, 0.0F, -1, 1, 7, 1, 0.0F, false));
        ...
        sight11_r3.cubeList.add(new ModelBox(sight11_r3, 44, 3, -1, -1.25F, -1, 1, 2, 1, 0.0F, false));
        ...
        sight10_r6.cubeList.add(new ModelBox(sight10_r6, 0, 44, 0.0F, -1.25F, -1, 1, 2, 1, -0.001F, false));
        ...
        sight10_r7.cubeList.add(new ModelBox(sight10_r7, 34, 24, 0.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight10_r7.cubeList.add(new ModelBox(sight10_r7, 11, 35, 0.0F, 0.0F, -1, 1, 7, 1, 0.001F, false));
        ...
        sight10_r8.cubeList.add(new ModelBox(sight10_r8, 12, 27, 0.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight10_r8.cubeList.add(new ModelBox(sight10_r8, 16, 27, 0.0F, 0.0F, -1, 1, 7, 1, 0.0F, false));
        ...
        sight12_r1.cubeList.add(new ModelBox(sight12_r1, 34, 43, 0.0F, -1.25F, -1, 1, 2, 1, 0.0F, false));
        ...
        sight11_r5.cubeList.add(new ModelBox(sight11_r5, 20, 32, -1.6F, 0.0F, -1, 1, 7, 1, -0.001F, false));
        sight11_r5.cubeList.add(new ModelBox(sight11_r5, 24, 32, -1, 0.0F, -1, 1, 7, 1, 0.001F, false));
    }
