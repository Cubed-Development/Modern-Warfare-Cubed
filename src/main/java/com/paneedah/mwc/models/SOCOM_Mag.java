...
public class SOCOM_Mag extends ModelBase {
    ...
    public SOCOM_Mag() {
        ...
        mag.cubeList.add(new ModelBox(mag, 4, 11, 3.101F, -34.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun36.setRotationPoint(1, -29.0F, 0.0F);
        mag.addChild(gun36);
        ...
        gun34.setRotationPoint(1, -29.0F, -1.6F);
        mag.addChild(gun34);
        ...
        gun33.setRotationPoint(1, -29.0F, 1.5F);
        mag.addChild(gun33);
        ...
        mag.addChild(gun30);
        gun30.cubeList.add(new ModelBox(gun30, 34, 19, -1, 0.0F, 0.001F, 2, 1, 1, 0.0F, false));
        ...
        gun21.cubeList.add(new ModelBox(gun21, 12, 30, -1, 0.599F, 0.0F, 2, 3, 1, -0.001F, false));
        ...
        gun20.cubeList.add(new ModelBox(gun20, 34, 7, -1, 0.129F, 0.0F, 2, 3, 1, -0.001F, false));
        ...
        gun14.cubeList.add(new ModelBox(gun14, 14, 35, -1, 0.0F, 0.0F, 2, 6, 1, 0.001F, false));
        ...
        gun11.cubeList.add(new ModelBox(gun11, 20, 35, -1, 0.0F, 0.0F, 2, 1, 1, -0.001F, false));
        ...
        gun10.cubeList.add(new ModelBox(gun10, 36, 0, -1, 0.0F, 0.0F, 2, 1, 1, -0.001F, false));
        ...
        gun9.cubeList.add(new ModelBox(gun9, 26, 12, -1, 0.0F, 0.0F, 2, 5, 1, -0.001F, false));
        ...
        gun1.setRotationPoint(1, -36.0F, -2.5F);
        mag.addChild(gun1);
        gun1.cubeList.add(new ModelBox(gun1, 18, 24, 0.0F, 0.0F, 0.0F, 3, 7, 4, 0.0F, false));

        gun3_r1 = new ModelRenderer(this);
        gun3_r1.setRotationPoint(0.0F, 0.0F, 1);
        gun1.addChild(gun3_r1);
        setRotationAngle(gun3_r1, 0.0F, 0.0F, 0.576F);
        gun3_r1.cubeList.add(new ModelBox(gun3_r1, 16, 6, 0.0F, -1, 0.0F, 1, 1, 3, -0.001F, false));

        gun2_r1 = new ModelRenderer(this);
        gun2_r1.setRotationPoint(3.0F, 0.0F, 1);
        gun1.addChild(gun2_r1);
        setRotationAngle(gun2_r1, 0.0F, 0.0F, -0.576F);
        gun2_r1.cubeList.add(new ModelBox(gun2_r1, 12, 24, -1, -1, 0.0F, 1, 1, 3, -0.001F, false));
    }
