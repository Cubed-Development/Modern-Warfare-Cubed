...
public class Tyke extends ModelBiped {
    ...
    public Tyke() {
        ...
        head.setRotationPoint(0, 16.8F, -5.4F);
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 4, 0, -2, 0, 1, 2, 0, 4, 0, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-1.9F, 5.3F, -4.1F);
        head.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.9835F, 0.0873F, -0.6452F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 4, 5, 0, 0, 1, 2, 0, 4, 0, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-2.7F, 4.6F, -5.5F);
        head.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.832F, -0.1013F, -0.4337F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 20, 35, 0, 0, 1, 1, 3, 6, 0, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-2.2F, 3.3F, -5.5F);
        head.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.7441F, -0.4261F, -0.1035F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 30, 42, 0, -1, 3, 3, 3, 4, 0, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(2.2F, 3.3F, -5.5F);
        head.addChild(cube_r5);
        setRotationAngle(cube_r5, 0.7441F, 0.4261F, 0.1035F);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 43, -3, -1, 3, 3, 3, 4, 0, false));

        cube_r6 = new ModelRenderer(this);
        cube_r6.setRotationPoint(2.7F, 4.6F, -5.5F);
        head.addChild(cube_r6);
        setRotationAngle(cube_r6, 0.832F, 0.1013F, 0.4337F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 38, 0, -1, 0, 1, 1, 3, 6, 0, false));

        cube_r7 = new ModelRenderer(this);
        cube_r7.setRotationPoint(0, 0.3F, -6);
        head.addChild(cube_r7);
        setRotationAngle(cube_r7, 0.636F, 0.6557F, 0.4528F);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 30, 29, -6, 0, 0, 6, 3, 6, 0, false));

        body = new ModelRenderer(this);
        body.setRotationPoint(3, 8.6F, 2.9F);


        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(0.5F, 8, -9.6F);
        body.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.2967F, 0, 0);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 18, -7, -1, 0, 7, 6, 11, 0, false));

        bodyback = new ModelRenderer(this);
        bodyback.setRotationPoint(-3, 4.8F, -2);
        body.addChild(bodyback);


        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(3, -4, 2);
        bodyback.addChild(cube_r9);
        setRotationAngle(cube_r9, -0.7156F, 0, 0);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 0, -6, 0, 0, 6, 6, 12, 0, false));

        leftwing = new ModelRenderer(this);
        leftwing.setRotationPoint(-0.9F, 5.7F, -7);
        ...
        cube_r10.cubeList.add(new ModelBox(cube_r10, 14, 18, -1, 0, 0, 7, 0, 11, 0, false));

        rightwing = new ModelRenderer(this);
        rightwing.setRotationPoint(-5.1F, 5.7F, -7);
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 13, 0, -6, 0, 0, 7, 0, 11, 0, false));
        ...
        setRotationAngle(cube_r12, 0.8029F, 0.7854F, 0);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 39, 23, -3, -1, 0, 3, 1, 5, 0, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(0, 2.2F, -0.3F);
        rightarm.addChild(cube_r13);
        setRotationAngle(cube_r13, -0.2147F, -0.454F, 0.9093F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 36, 15, -10, -1, 1, 10, 1, 1, 0, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(0, 0.8F, 0);
        rightarm.addChild(cube_r14);
        setRotationAngle(cube_r14, -0.1454F, -0.4791F, 0.7554F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 36, 9, -10, -2, 0, 11, 2, 2, 0, false));
        ...
        cube_r15.setRotationPoint(1.6F, 1.2F, -1);
        rightarmjoint.addChild(cube_r15);
        setRotationAngle(cube_r15, -0.2901F, 0.3536F, 0.1483F);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 36, 48, -2, -1, 0, 0, 13, 1, 0, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(0.6F, 1.2F, -1);
        rightarmjoint.addChild(cube_r16);
        setRotationAngle(cube_r16, -0.3425F, 0.3536F, 0.1483F);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 20, 44, -2, -1, 0, 2, 13, 1, 0, false));
        ...
        setRotationAngle(cube_r17, 0.8029F, -0.7854F, 0);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 39, 17, 0, -1, 0, 3, 1, 5, 0, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(0, 2.2F, -0.3F);
        leftarm.addChild(cube_r18);
        setRotationAngle(cube_r18, -0.2147F, 0.454F, -0.9093F);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 36, 13, 0, -1, 1, 10, 1, 1, 0, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(0, 0.8F, 0);
        leftarm.addChild(cube_r19);
        setRotationAngle(cube_r19, -0.1454F, 0.4791F, -0.7554F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 35, -1, -2, 0, 11, 2, 2, 0, false));
        ...
        cube_r20.setRotationPoint(-1.6F, 1.2F, -1);
        leftarmjoint.addChild(cube_r20);
        setRotationAngle(cube_r20, -0.2901F, -0.3536F, -0.1483F);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 34, 48, 2, -1, 0, 0, 13, 1, 0, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-0.6F, 1.2F, -1);
        leftarmjoint.addChild(cube_r21);
        setRotationAngle(cube_r21, -0.3425F, -0.3536F, -0.1483F);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 14, 43, 0, -1, 0, 2, 13, 1, 0, false));
        ...
        cube_r22.cubeList.add(new ModelBox(cube_r22, 0, 5, -2, -1, 0, 2, 1, 4, 0, false));

        cube_r23 = new ModelRenderer(this);
        cube_r23.setRotationPoint(0.2F, 1.6F, -0.3F);
        rightleg.addChild(cube_r23);
        setRotationAngle(cube_r23, -0.198F, -0.2319F, 0.7378F);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 48, 33, -6, -1, 1, 6, 1, 1, 0, false));
        ...
        cube_r24.cubeList.add(new ModelBox(cube_r24, 48, 29, -3, -2, 0, 4, 2, 2, -0.3F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(0, 0.8F, 0);
        rightleg.addChild(cube_r25);
        setRotationAngle(cube_r25, -0.0105F, -0.2371F, 0.5972F);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 0, 39, -6, -2, 0, 7, 2, 2, -0.1F, false));
        ...
        cube_r26.cubeList.add(new ModelBox(cube_r26, 32, 48, 0, -1, 0, 0, 13, 1, 0, false));

        cube_r27 = new ModelRenderer(this);
        cube_r27.setRotationPoint(-1.3F, 0.4F, -1);
        rightlegjoint.addChild(cube_r27);
        setRotationAngle(cube_r27, -0.0857F, 1.227F, 0.3859F);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 44, 42, -1, -1, 0, 1, 13, 1, 0, false));
        ...
        cube_r32.cubeList.add(new ModelBox(cube_r32, 30, 48, 0, -1, 0, 0, 13, 1, 0, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(1.3F, 0.4F, -1);
        leftlegjoint.addChild(cube_r33);
        setRotationAngle(cube_r33, -0.0857F, -1.227F, -0.3859F);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 26, 44, 0, -1, 0, 1, 13, 1, 0, false));
    }
...
//        float f3 = -(MathHelper.cos(limbSwing * 0.6662F * 2 + 0) * 0.4F) * limbSwingAmount;
//        float f4 = -(MathHelper.cos(limbSwing * 0.6662F * 2 + (float)Math.PI) * 0.4F) * limbSwingAmount;
//        float f5 = -(MathHelper.cos(limbSwing * 0.6662F * 2 + ((float)Math.PI / 2F)) * 0.4F) * limbSwingAmount;
//        float f6 = -(MathHelper.cos(limbSwing * 0.6662F * 2 + ((float)Math.PI * 3F / 2F)) * 0.4F) * limbSwingAmount;
//        float f7 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + 0) * 0.4F) * limbSwingAmount;
