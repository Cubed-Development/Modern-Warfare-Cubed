...
public class Beowulf50CalMagazine extends ModelBase {
    ...
    public Beowulf50CalMagazine() {
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 11, 0, -1, 0.0F, 0.1F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 12, -1, 0.0F, -3.7F, 1, 1, 4, 0.0F, false));
    }
