...
public class G3ChargingHandle extends ModelWithAttachments {
    ...
    public G3ChargingHandle() {
        ...
        charginghandle.cubeList.add(new ModelBox(charginghandle, 0, 224, -1.2F, -1, 3.0F, 1, 1, 17, 0.0F, false));

        gun8_r8 = new ModelRenderer(this);
        gun8_r8.setRotationPoint(-0.2F, -1, 17.0F);
        charginghandle.addChild(gun8_r8);
        setRotationAngle(gun8_r8, 0.0F, 0.0F, -0.7941F);
        gun8_r8.cubeList.add(new ModelBox(gun8_r8, 106, 110, -1, -1, -14.0F, 1, 1, 17, 0.0F, false));
        ...
        gun9_r9.cubeList.add(new ModelBox(gun9_r9, 13, 107, -1.05F, -1, 0.0F, 1, 1, 3, -0.2F, false));
        ...
        gun9_r10.cubeList.add(new ModelBox(gun9_r10, 0, 107, -1.05F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        gun8_r9.cubeList.add(new ModelBox(gun8_r9, 55, 60, -2.05F, -1, 0.0F, 2, 1, 1, -0.2F, false));
    }
