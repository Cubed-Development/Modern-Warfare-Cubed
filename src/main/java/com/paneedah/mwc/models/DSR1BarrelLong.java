...
public class DSR1BarrelLong extends ModelWithAttachments {
    ...
    public DSR1BarrelLong() {
        ...
        barrel_long.setRotationPoint(0, 24, -19);
        barrel_long.cubeList.add(new ModelBox(barrel_long, 69, 124, -2, -36.088F, -59.5F, 1, 2, 59, 0, false));
        ...
        barrel_long.cubeList.add(new ModelBox(barrel_long, 130, 134, -2, -34.838F, -67.5F, 1, 1, 9, 0, false));
        barrel_long.cubeList.add(new ModelBox(barrel_long, 131, 10, -2, -36.338F, -67.5F, 1, 1, 9, 0, false));
        ...
        cube_r123_r1.setRotationPoint(25.0913F, -10.6003F, 19);
        barrel_long.addChild(cube_r123_r1);
        setRotationAngle(cube_r123_r1, 0, 0, -0.7854F);
        ...
        cube_r122_r1.setRotationPoint(24.3842F, -10.3074F, 19);
        barrel_long.addChild(cube_r122_r1);
        setRotationAngle(cube_r122_r1, 0, 0, -0.7854F);
        ...
        cube_r121_r1.setRotationPoint(-25.97F, -8.479F, 19);
        barrel_long.addChild(cube_r121_r1);
        setRotationAngle(cube_r121_r1, 0, 0, 0.7854F);
        ...
        cube_r120_r1.setRotationPoint(-25.2629F, -8.1861F, 19);
        barrel_long.addChild(cube_r120_r1);
        setRotationAngle(cube_r120_r1, 0, 0, 0.7854F);
