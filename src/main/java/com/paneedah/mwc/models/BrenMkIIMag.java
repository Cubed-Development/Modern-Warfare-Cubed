...
public class BrenMkIIMag extends ModelWithAttachments {
    ...
    public BrenMkIIMag() {
        ...
        magazine.cubeList.add(new ModelBox(magazine, 0, 0, 1, -31, 6.4F, 3, 2, 7, 0.0F, true));
        magazine.cubeList.add(new ModelBox(magazine, 0, 0, 1, -31, 14.4F, 3, 2, 1, 0.0F, true));
        ...
        Mag10_r1.cubeList.add(new ModelBox(Mag10_r1, 0, 0, 1, -48.1F, -4.0F, 3, 1, 9, 0.0F, true));
        Mag10_r1.cubeList.add(new ModelBox(Mag10_r1, 0, 0, 1, -46.0F, -4.0F, 3, 7, 9, 0.0F, true));
        ...
        Mag8_r1.cubeList.add(new ModelBox(Mag8_r1, 0, 0, 1, -41.65F, -1.45F, 3, 1, 10, 0.0F, true));
        ...
        Mag7_r1.cubeList.add(new ModelBox(Mag7_r1, 0, 0, 1, -36.5F, 13.5F, 3, 6, 1, 0.0F, true));
        ...
        Mag5_r1.cubeList.add(new ModelBox(Mag5_r1, 0, 0, 1, -41.1F, -2.5F, 3, 7, 9, 0.0F, true));
        ...
        Mag4_r1.cubeList.add(new ModelBox(Mag4_r1, 0, 0, 1, -35.0F, 5.5F, 3, 6, 7, 0.0F, true));
        Mag4_r1.cubeList.add(new ModelBox(Mag4_r1, 0, 0, 1, -34.0F, 2.5F, 3, 5, 2, 0.0F, true));
        ...
        Mag3_r1.cubeList.add(new ModelBox(Mag3_r1, 0, 0, 1, -39.6F, -5.85F, 3, 2, 7, 0.0F, true));
        ...
        Mag2_r1.cubeList.add(new ModelBox(Mag2_r1, 0, 0, 1, -34.0F, -2.5F, 3, 2, 7, 0.0F, true));
    }
