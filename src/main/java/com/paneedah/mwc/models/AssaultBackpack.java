...
public class AssaultBackpack extends ModelBiped {
    ...
    public AssaultBackpack() {
        ...
        cube_r1.setRotationPoint(2.5F, 2, 5.8F);
        backpack.addChild(cube_r1);
        setRotationAngle(cube_r1, -0.1041F, -0.8351F, 0.0773F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 14, 48, -1, 0, -1, 1, 9, 1, -0.001F, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-2.5F, 2, 5.8F);
        backpack.addChild(cube_r2);
        setRotationAngle(cube_r2, -0.1041F, 0.8351F, -0.0773F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 18, 48, 0, 0, -1, 1, 9, 1, -0.001F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(2.5F, 2, 5.8F);
        backpack.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.0698F, 0, 0);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 40, 16, -0.25F, 0, -4.7F, 1, 9, 4, 0.001F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 28, 45, -5.75F, 0, -4.7F, 1, 9, 4, 0.001F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 32, 32, -5, 0, -4, 5, 9, 4, 0, false));
        ...
        cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 0, 0, 0, 0, 2, 6, 1, 0, false));
        ...
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 16, 0, 0, 0, 1, 3, 1, 0, false));
        ...
        cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 32, -1, 0, 0, 1, 3, 1, 0, false));
        ...
        cube_r7.cubeList.add(new ModelBox(cube_r7, 48, 4, -2, 0, 0, 2, 6, 1, 0, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(2.85F, -0.15F, 2.75F);
        backpack.addChild(cube_r8);
        setRotationAngle(cube_r8, -0.0524F, -0.1396F, 0);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 45, 24, -2, 0, -5, 2, 1, 5, 0, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(-2.85F, -0.15F, 2.75F);
        backpack.addChild(cube_r9);
        setRotationAngle(cube_r9, -0.0524F, 0.1396F, 0);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 46, 11, 0, 0, -5, 2, 1, 5, 0, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(3.3F, 9.15F, 5);
        backpack.addChild(cube_r10);
        setRotationAngle(cube_r10, -0.1577F, 0.4995F, -0.0956F);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 36, 16, -1, 0, -1, 1, 1, 1, 0.001F, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-3.3F, 9.15F, 5);
        backpack.addChild(cube_r11);
        setRotationAngle(cube_r11, -1.1227F, -1.2438F, 1.1436F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 12, 32, -3, 0, -1, 3, 1, 1, 0, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(3.3F, 9.15F, 5);
        backpack.addChild(cube_r12);
        setRotationAngle(cube_r12, -1.1227F, 1.2438F, -1.1436F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 28, 32, 0, 0, -1, 3, 1, 1, 0, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(-3.3F, 9.15F, 5);
        backpack.addChild(cube_r13);
        setRotationAngle(cube_r13, -0.1577F, -0.4995F, 0.0956F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 36, 18, 0, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r14.cubeList.add(new ModelBox(cube_r14, 12, 34, -3, 0, -1, 3, 1, 1, 0, false));
        ...
        cube_r15.cubeList.add(new ModelBox(cube_r15, 39, 17, 0, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 40, 29, -1, 0, -1, 1, 1, 1, 0.001F, false));
        ...
        cube_r17.cubeList.add(new ModelBox(cube_r17, 24, 0, -5, 0, -1, 5, 1, 1, -0.2F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 24, 2, 0, 0, -1, 5, 1, 1, -0.2F, false));
        ...
        cube_r19.cubeList.add(new ModelBox(cube_r19, 28, 34, 0, 0, -1, 3, 1, 1, 0, false));

        cube_r20 = new ModelRenderer(this);
        cube_r20.setRotationPoint(-2.5F, 2.45F, 6.2F);
        backpack.addChild(cube_r20);
        setRotationAngle(cube_r20, 0.1047F, 0, 0);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 46, 30, 0, 0, -2, 5, 3, 2, 0, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-2.5F, 4.75F, 6.2F);
        backpack.addChild(cube_r21);
        setRotationAngle(cube_r21, 0.0175F, 0, 0);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 38, 45, 0, 1, -2, 5, 5, 2, 0, false));
        ...
        cube_r22.cubeList.add(new ModelBox(cube_r22, 20, 16, -2, 0, 0, 2, 1, 2, 0.001F, false));
        ...
        cube_r23.cubeList.add(new ModelBox(cube_r23, 24, 4, 0, 0, 0, 2, 1, 2, 0.001F, false));

        cube_r24 = new ModelRenderer(this);
        cube_r24.setRotationPoint(-2.5F, 0.4F, 2.1F);
        backpack.addChild(cube_r24);
        setRotationAngle(cube_r24, -0.1047F, 0, 0);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 44, 0, 0, 0, 0, 5, 2, 2, 0.002F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(-2.5F, 2, 5.8F);
        backpack.addChild(cube_r25);
        setRotationAngle(cube_r25, -0.576F, 0, 0);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 0, 48, 0, 0, -2, 5, 2, 2, 0.001F, false));
        ...
        leftarm.cubeList.add(new ModelBox(leftarm, 24, 16, -1, -2, -2, 4, 12, 4, 0, false));

        rightarm = new ModelRenderer(this);
        rightarm.setRotationPoint(-5, 2, 0);
        rightarm.cubeList.add(new ModelBox(rightarm, 32, 0, -3, -2, -2, 4, 12, 4, 0, false));
        ...
        leftleg.cubeList.add(new ModelBox(leftleg, 16, 32, -2, 0, -2, 4, 12, 4, 0, false));
