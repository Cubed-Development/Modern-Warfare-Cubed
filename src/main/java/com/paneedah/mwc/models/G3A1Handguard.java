...
public class G3A1Handguard extends ModelWithAttachments {
    ...
    public G3A1Handguard() {
        ...
        handguard_a1.cubeList.add(new ModelBox(handguard_a1, 224, 45, -1, 0.0F, 16.0F, 1, 1, 19, 0.0F, false));
        ...
        cube_r7.cubeList.add(new ModelBox(cube_r7, 108, 70, -1, 0.0F, 0.0F, 1, 1, 11, 0.0F, false));
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 55, -1, -2.0F, -14.0F, 1, 1, 14, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 176, 62, -1, -1, -24.0F, 1, 1, 24, 0.0F, false));
        ...
        cube_r9.cubeList.add(new ModelBox(cube_r9, 79, 175, 0.0F, -1, -24.0F, 1, 1, 24, 0.0F, false));
        ...
        cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 36, -1, 0.0F, -16.0F, 1, 3, 16, 0.0F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 38, 37, -1, 0.0F, 0.0F, 1, 2, 1, -0.2F, false));
        ...
        cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 45, -1, 0.0F, -0.5F, 1, 2, 1, 0.0F, false));

        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(0.0F, 0.0F, 16.0F);
        handguard_a1.addChild(cube_r15);
        setRotationAngle(cube_r15, 0.0F, 0.0F, -0.3054F);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 23, 223, -1, 0.0F, 0.0F, 1, 3, 19, 0.0F, false));
        ...
        cube_r17.cubeList.add(new ModelBox(cube_r17, 36, 74, -1, 0.0F, -16.0F, 1, 1, 16, 0.0F, false));
    }
