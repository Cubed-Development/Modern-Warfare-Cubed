...
public class BulletBig extends ModelBase {
    ...
    public BulletBig() {
        ...
        shell.cubeList.add(new ModelBox(shell, 4, 14, -1, -7.0F, -1, 1, 7, 1, 0.0F, false));
        ...
        shell.cubeList.add(new ModelBox(shell, 10, 0, -1, -7.0F, 0.45F, 1, 7, 1, 0.0F, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(-1, -7.0F, 1.43F);
        shell.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.4389F, 0.6743F, 0.6447F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 22, 22, 0.0F, -1, -1, 1, 1, 1, -0.001F, false));
        ...
        cube_r3.setRotationPoint(0.0F, -7.0F, -1);
        shell.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.4389F, 0.6743F, -0.6447F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 7, 23, -1, -1, 0.0F, 1, 1, 1, -0.001F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-1, -7.0F, -1);
        shell.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.4389F, -0.6743F, 0.6447F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 23, 9, 0.0F, -1, 0.0F, 1, 1, 1, -0.001F, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-1, 0.0F, -1);
        ...
        cube_r6.setRotationPoint(-1, 0.0F, 1.45F);
        shell.addChild(cube_r6);
        setRotationAngle(cube_r6, 0.0F, 0.7854F, 0.0F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 4, 0, 0.0F, -7.0F, -1, 1, 7, 1, -0.001F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 8, -1, -7.0F, -1, 1, 7, 1, -0.001F, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(0.0F, 0.0F, -1);
        shell.addChild(cube_r12);
        setRotationAngle(cube_r12, 0.0F, 0.7854F, 0.0F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 14, 0, -1, -7.0F, 0.0F, 1, 7, 1, -0.001F, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(-1.03F, -7.0F, -1);
        shell.addChild(cube_r13);
        setRotationAngle(cube_r13, -0.4538F, 0.0F, 0.0F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 11, 23, 0.0F, -1, 0.0F, 1, 1, 1, 0.001F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(-1.03F, -7.0F, 1.46F);
        shell.addChild(cube_r14);
        setRotationAngle(cube_r14, 0.4538F, 0.0F, 0.0F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 23, 13, 0.0F, -1, -1, 1, 1, 1, 0.001F, false));

        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(-1.71F, -7.0F, -0.28F);
        shell.addChild(cube_r15);
        setRotationAngle(cube_r15, 0.0F, 0.0F, 0.4538F);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 23, 15, 0.0F, -1, 0.0F, 1, 1, 1, 0.001F, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(0.71F, -7.0F, -0.28F);
        shell.addChild(cube_r16);
        setRotationAngle(cube_r16, 0.0F, 0.0F, -0.4538F);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 23, 18, -1, -1, 0.0F, 1, 1, 1, 0.001F, false));
