...
public class ACRStock extends ModelWithAttachments {
	...
	public ACRStock() {
		...
		stock.cubeList.add(new ModelBox(stock, 146, 140, -1.2515F, -4.8294F, -8.959F, 2, 2, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 124, 146, 0.3485F, -4.8294F, -8.959F, 1, 2, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 166, 140, -0.8515F, -3.8294F, -10.159F, 3, 3, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 131, 94, -2.0515F, -3.8294F, -10.159F, 2, 3, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 0, 161, -0.8015F, -1.4294F, -10.659F, 3, 3, 4, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 138, 159, -2.0515F, -1.4294F, -10.659F, 3, 3, 4, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 92, 157, -1.4515F, -1.0794F, -10.659F, 3, 3, 4, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 77, 159, 1.7485F, -2.8294F, -9.859F, 1, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 57, 159, 1.7485F, 0.1706F, -9.859F, 1, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 14, 67, 2.1485F, -2.3294F, -9.859F, 1, 3, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 141, 111, -0.8515F, -1.4294F, -6.559F, 3, 3, 14, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 141, 94, -2.0515F, -1.4294F, -6.559F, 3, 3, 14, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 186, 179, -1.4515F, -1.0794F, -6.559F, 3, 3, 12, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 133, 107, 1.4485F, -1.2294F, -5.559F, 1, 2, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 115, 130, -2.3515F, -1.2294F, -5.559F, 1, 2, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 138, 166, 1.4485F, -1.4294F, -5.559F, 1, 1, 4, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 166, 27, -2.3515F, -1.4294F, -5.559F, 1, 1, 4, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 82, 34, -2.4515F, -0.3294F, -3.059F, 5, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 23, 159, -2.2515F, 0.6706F, -4.759F, 1, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 17, 159, 1.3485F, 0.6706F, -4.759F, 1, 1, 1, 0.0F, false));
		...
		stock.cubeList.add(new ModelBox(stock, 130, 60, -1.4515F, 1.8706F, 6.541F, 3, 4, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 29, 124, -0.8515F, -3.0294F, 6.441F, 3, 2, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 31, 162, -2.0515F, -3.0294F, 6.441F, 2, 2, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 166, 145, -0.9515F, -3.5294F, 6.441F, 2, 1, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 32, 199, -0.6515F, -2.4294F, -6.559F, 3, 1, 12, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 0, 200, -2.2515F, -2.4294F, -6.559F, 2, 1, 12, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 141, 133, -1.9515F, -2.5294F, -7.659F, 4, 4, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 164, 33, -0.9515F, 0.8706F, -7.659F, 2, 1, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 57, 68, -0.9515F, -4.0294F, 8.441F, 2, 13, 2, 0.0F, false));
		...
		ACR176_r1.cubeList.add(new ModelBox(ACR176_r1, 133, 114, -1.2F, -41.4F, 3.0F, 1, 2, 2, 0.0F, false));
		ACR176_r1.cubeList.add(new ModelBox(ACR176_r1, 52, 163, -2.8F, -41.4F, 3.0F, 2, 2, 2, 0.0F, false));
		...
		ACR261_r1.cubeList.add(new ModelBox(ACR261_r1, 128, 67, -3.5F, -39.0F, 23.3F, 4, 6, 1, 0.0F, false));
		...
		ACR260_r1.cubeList.add(new ModelBox(ACR260_r1, 143, 24, 0.5F, -28.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR259_r1.cubeList.add(new ModelBox(ACR259_r1, 143, 27, -3.5F, -28.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR258_r1.cubeList.add(new ModelBox(ACR258_r1, 143, 38, 0.5F, -39.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR257_r1.cubeList.add(new ModelBox(ACR257_r1, 143, 41, -0.5F, -40.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR256_r1.cubeList.add(new ModelBox(ACR256_r1, 46, 143, -3.5F, -39.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR255_r1.cubeList.add(new ModelBox(ACR255_r1, 55, 143, -2.5F, -40.0F, 21.3F, 1, 1, 2, 0.0F, false));
		...
		ACR253_r1.cubeList.add(new ModelBox(ACR253_r1, 161, 94, -2.5F, -27.0F, 23.3F, 2, 1, 7, 0.0F, false));
		...
		ACR252_r1.cubeList.add(new ModelBox(ACR252_r1, 59, 0, -2.5F, -40.0F, 23.3F, 2, 7, 1, 0.0F, false));

		ACR248_r1 = new ModelRenderer(this);
		ACR248_r1.setRotationPoint(32.8046F, 13.6972F, -12.859F);
		stock.addChild(ACR248_r1);
		setRotationAngle(ACR248_r1, 0.0F, 0.0F, -1.041F);
		ACR248_r1.cubeList.add(new ModelBox(ACR248_r1, 11, 106, -3.8F, -38.4F, 5.5F, 2, 1, 1, 0.0F, false));
		ACR248_r1.cubeList.add(new ModelBox(ACR248_r1, 143, 38, -3.8F, -38.4F, 13.3F, 1, 1, 6, 0.0F, false));
		ACR248_r1.cubeList.add(new ModelBox(ACR248_r1, 161, 111, -3.8F, -38.4F, 6.3F, 2, 1, 7, 0.0F, false));

		ACR247_r1 = new ModelRenderer(this);
		ACR247_r1.setRotationPoint(-15.4245F, -36.4782F, -12.859F);
		stock.addChild(ACR247_r1);
		setRotationAngle(ACR247_r1, 0.0F, 0.0F, 2.6397F);
		ACR247_r1.cubeList.add(new ModelBox(ACR247_r1, 141, 73, 0.8F, -38.4F, 5.5F, 1, 2, 1, 0.0F, false));
		ACR247_r1.cubeList.add(new ModelBox(ACR247_r1, 46, 156, 0.8F, -38.4F, 13.3F, 1, 1, 6, 0.0F, false));
		ACR247_r1.cubeList.add(new ModelBox(ACR247_r1, 96, 18, 0.8F, -38.4F, 6.3F, 1, 2, 7, 0.0F, false));

		ACR246_r1 = new ModelRenderer(this);
		ACR246_r1.setRotationPoint(33.2487F, 13.6719F, -12.859F);
		stock.addChild(ACR246_r1);
		setRotationAngle(ACR246_r1, 0.0F, 0.0F, -1.041F);
		ACR246_r1.cubeList.add(new ModelBox(ACR246_r1, 143, 24, -3.6F, -38.8F, 13.3F, 1, 1, 6, 0.0F, false));
		...
		ACR243_r1.cubeList.add(new ModelBox(ACR243_r1, 141, 102, -3.6F, -39.0F, 19.3F, 1, 2, 1, 0.0F, false));
		ACR243_r1.cubeList.add(new ModelBox(ACR243_r1, 144, 166, -2.4F, -39.0F, 19.3F, 3, 2, 1, 0.0F, false));
		...
		ACR241_r1.cubeList.add(new ModelBox(ACR241_r1, 14, 43, 0.6F, -34.4F, 19.3F, 6, 1, 1, 0.0F, false));
		ACR241_r1.cubeList.add(new ModelBox(ACR241_r1, 69, 158, 0.6F, -34.4F, 16.3F, 1, 1, 1, 0.0F, false));
		ACR241_r1.cubeList.add(new ModelBox(ACR241_r1, 125, 135, 0.6F, -34.4F, 18.3F, 4, 1, 1, 0.0F, false));
		ACR241_r1.cubeList.add(new ModelBox(ACR241_r1, 56, 125, 0.6F, -34.4F, 17.3F, 3, 1, 1, 0.0F, false));
		...
		ACR240_r1.cubeList.add(new ModelBox(ACR240_r1, 110, 36, -3.6F, -34.4F, 19.3F, 1, 6, 1, 0.0F, false));
		ACR240_r1.cubeList.add(new ModelBox(ACR240_r1, 86, 158, -3.6F, -34.4F, 16.3F, 1, 1, 1, 0.0F, false));
		ACR240_r1.cubeList.add(new ModelBox(ACR240_r1, 14, 73, -3.6F, -34.4F, 18.3F, 1, 4, 1, 0.0F, false));
		ACR240_r1.cubeList.add(new ModelBox(ACR240_r1, 8, 67, -3.6F, -34.4F, 17.3F, 1, 3, 1, 0.0F, false));
		...
		ACR239_r1.cubeList.add(new ModelBox(ACR239_r1, 0, 154, 0.6F, -38.8F, 13.3F, 1, 1, 6, 0.0F, false));
		...
		ACR234_r1.cubeList.add(new ModelBox(ACR234_r1, 19, 124, -2.5F, -40.85F, 6.0F, 2, 1, 3, 0.0F, false));
		...
		ACR233_r1.cubeList.add(new ModelBox(ACR233_r1, 47, 68, -2.5F, -39.7F, 19.3F, 2, 14, 3, 0.0F, false));
		...
		ACR232_r1.cubeList.add(new ModelBox(ACR232_r1, 92, 144, -0.5F, -39.5F, 19.3F, 1, 1, 2, 0.0F, false));
		...
		ACR231_r1.cubeList.add(new ModelBox(ACR231_r1, 101, 144, -2.5F, -39.5F, 19.3F, 1, 1, 2, 0.0F, false));
		...
		ACR2211_r1.cubeList.add(new ModelBox(ACR2211_r1, 47, 130, -3.0F, -27.9F, 19.3F, 3, 2, 5, 0.0F, false));
		...
		ACR220_r1.cubeList.add(new ModelBox(ACR220_r1, 114, 126, -3.0F, -31.2F, 16.3F, 3, 1, 2, 0.0F, false));
		...
		ACR218_r1.cubeList.add(new ModelBox(ACR218_r1, 115, 31, -3.0F, -28.4F, 17.4F, 3, 1, 3, 0.0F, false));
		...
		ACR217_r1.cubeList.add(new ModelBox(ACR217_r1, 116, 79, -3.0F, -27.4F, 20.3F, 3, 1, 3, 0.0F, false));
		...
		ACR214_r1.cubeList.add(new ModelBox(ACR214_r1, 123, 158, 0.8F, -34.3F, 8.1F, 1, 1, 1, 0.0F, false));
		...
		ACR213_r1.cubeList.add(new ModelBox(ACR213_r1, 129, 158, -3.8F, -34.3F, 8.1F, 1, 1, 1, 0.0F, false));
		...
		ACR209_r1.cubeList.add(new ModelBox(ACR209_r1, 107, 130, -3.9F, -37.2F, 11.3F, 1, 2, 2, 0.0F, false));
		...
		ACR208_r1.cubeList.add(new ModelBox(ACR208_r1, 146, 128, 0.9F, -37.2F, 11.3F, 2, 2, 1, 0.0F, false));
		...
		ACR205_r1.cubeList.add(new ModelBox(ACR205_r1, 64, 145, 0.9F, -37.2F, 9.3F, 1, 2, 1, 0.0F, false));
		...
		ACR204_r1.cubeList.add(new ModelBox(ACR204_r1, 71, 145, -3.9F, -37.2F, 9.3F, 1, 2, 1, 0.0F, false));
		...
		ACR203_r1.cubeList.add(new ModelBox(ACR203_r1, 78, 145, -3.9F, -37.2F, 7.3F, 1, 2, 1, 0.0F, false));
		...
		ACR202_r1.cubeList.add(new ModelBox(ACR202_r1, 85, 145, 0.9F, -37.2F, 7.3F, 1, 2, 1, 0.0F, false));
		...
		ACR194_r1.cubeList.add(new ModelBox(ACR194_r1, 146, 80, 0.8F, -36.8F, 4.4F, 1, 2, 1, 0.0F, false));
		...
		ACR190_r1.cubeList.add(new ModelBox(ACR190_r1, 83, 159, -4.2F, -36.9F, 3.9F, 1, 1, 1, 0.0F, false));
		...
		ACR189_r1.cubeList.add(new ModelBox(ACR189_r1, 92, 159, -4.2F, -36.8F, 3.5F, 1, 1, 1, 0.0F, false));
		...
		ACR188_r1.cubeList.add(new ModelBox(ACR188_r1, 110, 146, -4.2F, -39.4F, 3.5F, 1, 2, 1, 0.0F, false));
		...
		ACR187_r1.cubeList.add(new ModelBox(ACR187_r1, 117, 146, -4.2F, -39.3F, 3.0F, 1, 2, 1, 0.0F, false));
		...
		ACR186_r1.cubeList.add(new ModelBox(ACR186_r1, 67, 80, -4.0F, -39.0F, 3.3F, 1, 4, 1, 0.0F, false));
		...
		ACR178_r1.cubeList.add(new ModelBox(ACR178_r1, 166, 159, -3.6F, -39.8F, 4.7F, 2, 2, 3, 0.0F, false));
		ACR178_r1.cubeList.add(new ModelBox(ACR178_r1, 17, 154, -2.4F, -39.8F, 4.7F, 3, 2, 3, 0.0F, false));
	}
