...
public class AKRail6 extends ModelBase {
	...
	public AKRail6() {
		...
		Rail3.cubeList.add(new ModelBox(Rail3, 21, 20, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));
		...
		Rail32.cubeList.add(new ModelBox(Rail32, 4, 21, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));
