...
public class AUGScope extends ModelWithAttachments {
	...
	public AUGScope() {
		...
		scope.cubeList.add(new ModelBox(scope, 41, 117, -1.2769F, 1.5812F, -10.3093F, 2, 1, 4, 0.0F, false));
		scope.cubeList.add(new ModelBox(scope, 60, 87, 0.1231F, 1.5812F, -10.3093F, 1, 1, 4, 0.0F, false));
		scope.cubeList.add(new ModelBox(scope, 105, 87, -1.0769F, 0.0812F, 9.7907F, 2, 2, 1, 0.0F, false));
		...
		scope6_r1.cubeList.add(new ModelBox(scope6_r1, 0, 39, -2.5F, -38.0F, -4.6F, 2, 5, 1, 0.0F, false));
		...
		scope5_r1.cubeList.add(new ModelBox(scope5_r1, 97, 19, -2.5F, -41.0F, -3.8F, 2, 2, 2, 0.0F, false));
		...
		scope4_r1.cubeList.add(new ModelBox(scope4_r1, 123, 127, -2.5F, -37.9F, -5.8F, 2, 1, 6, 0.0F, false));
		...
		scope3_r1.cubeList.add(new ModelBox(scope3_r1, 17, 21, -2.5F, -36.0F, -6.2F, 2, 1, 2, 0.0F, false));
		...
		scope2_r1.cubeList.add(new ModelBox(scope2_r1, 32, 98, -2.5F, -36.5F, -22.2F, 2, 1, 9, 0.0F, false));
		...
		scope1_r1.cubeList.add(new ModelBox(scope1_r1, 168, 159, -2.5F, -37.1F, -22.0F, 2, 1, 8, 0.0F, false));
		...
		scope13_r1.cubeList.add(new ModelBox(scope13_r1, 97, 37, -3.0F, -38.1F, -23.8F, 3, 1, 1, 0.0F, false));
		...
		scope12_r1.cubeList.add(new ModelBox(scope12_r1, 42, 62, -2.0F, -37.3F, -23.5F, 1, 1, 1, 0.0F, false));
		...
		scope11_r1.cubeList.add(new ModelBox(scope11_r1, 110, 22, -2.7F, -36.5F, -25.7F, 2, 1, 4, 0.0F, false));
		scope11_r1.cubeList.add(new ModelBox(scope11_r1, 32, 87, -1.3F, -36.5F, -25.7F, 1, 1, 4, 0.0F, false));
	}
