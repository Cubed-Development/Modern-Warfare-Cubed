...
public class MP7Rail extends ModelBase {
	...
	public MP7Rail() {
		...
		Rail2.setRotationPoint(0.5F, 0.0F, 0.0F);
		setRotationAngle(Rail2, 0.0F, 0.0F, 1.0038F);
		Rail2.cubeList.add(new ModelBox(Rail2, 20, 21, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail3 = new ModelRenderer(this);
		Rail3.setRotationPoint(3.0F, 0.0F, 0.0F);
		...
		Rail24.setRotationPoint(3.0F, 0.0F, 6.0F);
		setRotationAngle(Rail24, 0.0F, 0.0F, 0.5949F);
		Rail24.cubeList.add(new ModelBox(Rail24, 8, 21, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail26 = new ModelRenderer(this);
		Rail26.setRotationPoint(3.0F, 0.0F, 12.0F);
		setRotationAngle(Rail26, 0.0F, 0.0F, 0.5949F);
		Rail26.cubeList.add(new ModelBox(Rail26, 4, 21, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail28 = new ModelRenderer(this);
		Rail28.setRotationPoint(3.0F, 0.0F, 18.0F);
		...
		Rail30.setRotationPoint(3.0F, 0.0F, 24.0F);
		setRotationAngle(Rail30, 0.0F, 0.0F, 0.5949F);
		Rail30.cubeList.add(new ModelBox(Rail30, 20, 17, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail32 = new ModelRenderer(this);
		Rail32.setRotationPoint(0.5F, 0.001F, 0.0F);
		Rail32.cubeList.add(new ModelBox(Rail32, 20, 6, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail34 = new ModelRenderer(this);
		Rail34.setRotationPoint(0.5F, 0.001F, 6.0F);
		Rail34.cubeList.add(new ModelBox(Rail34, 20, 4, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail36 = new ModelRenderer(this);
		Rail36.setRotationPoint(0.5F, 0.001F, 12.0F);
		Rail36.cubeList.add(new ModelBox(Rail36, 20, 2, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail38 = new ModelRenderer(this);
		Rail38.setRotationPoint(0.5F, 0.001F, 18.0F);
		...
		Rail40.setRotationPoint(0.5F, 0.001F, 24.0F);
		Rail40.cubeList.add(new ModelBox(Rail40, 11, 20, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));
		...
		Rail43.cubeList.add(new ModelBox(Rail43, 19, 12, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		Rail45 = new ModelRenderer(this);
		Rail45.setRotationPoint(3.0F, 0.0F, 16.5F);
		setRotationAngle(Rail45, 0.0F, 0.0F, 0.5949F);
		Rail45.cubeList.add(new ModelBox(Rail45, 19, 10, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		Rail47.cubeList.add(new ModelBox(Rail47, 14, 19, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		Rail49.cubeList.add(new ModelBox(Rail49, 4, 19, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		Rail51.cubeList.add(new ModelBox(Rail51, 0, 6, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

		Rail53 = new ModelRenderer(this);
		Rail53.setRotationPoint(0.5F, 0.0F, 6.0F);
		setRotationAngle(Rail53, 0.0F, 0.0F, 1.0038F);
		Rail53.cubeList.add(new ModelBox(Rail53, 17, 18, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail55 = new ModelRenderer(this);
		Rail55.setRotationPoint(0.5F, 0.0F, 12.0F);
		setRotationAngle(Rail55, 0.0F, 0.0F, 1.0038F);
		Rail55.cubeList.add(new ModelBox(Rail55, 11, 18, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail57 = new ModelRenderer(this);
		Rail57.setRotationPoint(0.5F, 0.0F, 18.0F);
		setRotationAngle(Rail57, 0.0F, 0.0F, 1.0038F);
		...
		Rail59.setRotationPoint(0.5F, 0.0F, 24.0F);
		setRotationAngle(Rail59, 0.0F, 0.0F, 1.0038F);
		Rail59.cubeList.add(new ModelBox(Rail59, 17, 3, 0.0F, 0.0F, 0.5F, 1, 1, 1, 0.0F, false));

		Rail61 = new ModelRenderer(this);
		Rail61.setRotationPoint(0.5F, 0.0F, 28.5F);
		setRotationAngle(Rail61, 0.0F, 0.0F, 1.0038F);
		Rail61.cubeList.add(new ModelBox(Rail61, 4, 4, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
		...
		Rail64.cubeList.add(new ModelBox(Rail64, 14, 17, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		Rail66 = new ModelRenderer(this);
		Rail66.setRotationPoint(0.5F, 0.001F, 16.5F);
		Rail66.cubeList.add(new ModelBox(Rail66, 8, 17, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		Rail68.cubeList.add(new ModelBox(Rail68, 0, 17, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		setRotationAngle(Rail73, 0.0F, 0.0F, 1.0038F);
		Rail73.cubeList.add(new ModelBox(Rail73, 11, 16, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		setRotationAngle(Rail75, 0.0F, 0.0F, 1.0038F);
		Rail75.cubeList.add(new ModelBox(Rail75, 8, 15, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		setRotationAngle(Rail77, 0.0F, 0.0F, 1.0038F);
		Rail77.cubeList.add(new ModelBox(Rail77, 0, 15, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		Rail79 = new ModelRenderer(this);
		Rail79.setRotationPoint(0.5F, 0.0F, 22.5F);
		setRotationAngle(Rail79, 0.0F, 0.0F, 1.0038F);
		Rail79.cubeList.add(new ModelBox(Rail79, 14, 4, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		Rail81.cubeList.add(new ModelBox(Rail81, 0, 0, 0.02F, 0.0F, 0.0F, 3, 1, 30, 0.0F, false));
		...
		Rail83.cubeList.add(new ModelBox(Rail83, 12, 0, 0.0F, 0.0F, 0.0F, 2, 0, 30, 0.0F, false));

		Rail84 = new ModelRenderer(this);
		Rail84.setRotationPoint(-0.35F, 0.55F, 0.5F);
		setRotationAngle(Rail84, 0.0F, 0.0F, -0.5949F);
		Rail84.cubeList.add(new ModelBox(Rail84, 0, 1, 0.0F, 0.0F, 0.0F, 0, 1, 30, 0.0F, false));

		Rail85 = new ModelRenderer(this);
		Rail85.setRotationPoint(3.85F, 0.55F, 0.5F);
		setRotationAngle(Rail85, 0.0F, 0.0F, 2.1935F);
		...
		Rail87.setRotationPoint(0.5F, 0.0F, 30.5F);
		setRotationAngle(Rail87, -0.8179F, 0.0F, 0.0F);
		Rail87.cubeList.add(new ModelBox(Rail87, 13, 2, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
	}
