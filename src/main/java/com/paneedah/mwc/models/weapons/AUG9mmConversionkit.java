...
public class AUG9mmConversionkit extends ModelWithAttachments {
	...
	public AUG9mmConversionkit() {
		...
		conversionkit18_r1.cubeList.add(new ModelBox(conversionkit18_r1, 60, 82, -3.0F, -19.1F, 10.8F, 3, 1, 1, 0.0F, false));
		...
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 44, 87, -0.8F, -19.1F, 11.1F, 1, 1, 5, 0.0F, false));
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 72, 87, -3.2F, -19.1F, 11.1F, 1, 1, 5, 0.0F, false));
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 50, 60, -1.3F, -25.1F, 15.7F, 1, 7, 1, 0.0F, false));
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 17, 27, -2.7F, -25.1F, 15.7F, 2, 7, 1, 0.0F, false));
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 32, 39, -2.5F, -25.1F, 11.0F, 2, 7, 1, 0.0F, false));
		conversionkit17_r1.cubeList.add(new ModelBox(conversionkit17_r1, 67, 19, -3.0F, -25.1F, 11.3F, 3, 7, 5, 0.0F, false));
		...
		conversionkit14_r1.cubeList.add(new ModelBox(conversionkit14_r1, 32, 13, -2.3F, -21.5F, 21.2F, 1, 4, 4, 0.0F, false));
		...
		conversionkit12_r1.cubeList.add(new ModelBox(conversionkit12_r1, 0, 0, -1.7F, -22.3F, 21.9F, 1, 4, 1, 0.0F, false));
		conversionkit12_r1.cubeList.add(new ModelBox(conversionkit12_r1, 7, 0, -2.3F, -22.3F, 21.9F, 1, 4, 1, 0.0F, false));
		...
		conversionkit9_r1.cubeList.add(new ModelBox(conversionkit9_r1, 0, 27, -2.5F, -17.9F, 16.4F, 2, 7, 1, 0.0F, false));
		...
		conversionkit7_r1.cubeList.add(new ModelBox(conversionkit7_r1, 97, 13, -3.0F, -25.3F, 9.9F, 3, 3, 1, 0.0F, false));
		...
		conversionkit4_r1.cubeList.add(new ModelBox(conversionkit4_r1, 87, 14, -3.3F, -26.3F, 17.7F, 3, 1, 1, 0.0F, false));
		conversionkit4_r1.cubeList.add(new ModelBox(conversionkit4_r1, 0, 62, -0.7F, -26.3F, 17.7F, 1, 1, 1, 0.0F, false));
		conversionkit4_r1.cubeList.add(new ModelBox(conversionkit4_r1, 108, 41, -0.7F, -26.3F, 10.0F, 1, 1, 8, 0.0F, false));
		conversionkit4_r1.cubeList.add(new ModelBox(conversionkit4_r1, 87, 100, -3.3F, -26.3F, 10.0F, 3, 1, 8, 0.0F, false));
	}
