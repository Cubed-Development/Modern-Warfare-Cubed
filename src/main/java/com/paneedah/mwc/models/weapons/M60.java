...
public class M60 extends ModelWithAttachments {
	...
	public M60() {
		...
		body.addChild(bone);
		bone.cubeList.add(new ModelBox(bone, 0, 99, 0.0F, -19.5F, 19.2F, 1, 1, 2, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 137, 112, -2.4F, -20.0F, 33.0F, 4, 2, 4, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 147, 56, -3.0F, -23.0F, 35.0F, 6, 3, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 30, 0, 5.0F, -17.5F, 38.0F, 1, 12, 8, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 216, 214, -3.0F, -18.0F, 37.0F, 1, 1, 15, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 14, 106, -3.0F, -20.0F, 47.3F, 6, 2, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 14, 86, -2.5F, -23.5F, 34.5F, 1, 2, 3, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 83, 123, -3.3F, -13.0F, 64.0F, 1, 3, 8, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 79, 25, -3.1F, -22.5F, 35.5F, 1, 1, 1, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 26, 110, 3.4F, -17.5F, 71.0F, 1, 3, 10, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 79, 2, 3.6F, -13.0F, 63.0F, 1, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 79, 0, 3.6F, -13.0F, 49.0F, 1, 1, 1, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 12, 0, -3.4F, -18.0F, 52.0F, 1, 2, 5, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 0, 110, -3.4F, -18.0F, 71.0F, 1, 3, 10, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 74, 78, -3.4F, -14.5F, 67.0F, 1, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 78, 22, -3.4F, -14.5F, 54.0F, 1, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 75, 58, -3.4F, -14.5F, 40.0F, 1, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 56, 78, -3.5F, -16.0F, 34.0F, 8, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 60, 22, -3.5F, -14.0F, 34.0F, 8, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 222, 51, 3.0F, -20.0F, 47.0F, 1, 2, 34, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 75, 56, 3.1F, -22.5F, 35.5F, 1, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 137, 74, -2.4F, -19.7F, 29.0F, 5, 1, 4, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 36, 49, -2.4F, -19.0F, 29.0F, 5, 1, 4, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 67, 102, -2.4F, -20.0F, 29.0F, 5, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 82, 56, -3.4F, -16.5F, 52.0F, 1, 1, 5, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 168, 216, -3.0F, -16.0F, 37.0F, 1, 1, 15, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 45, 17, 2.5F, -23.5F, 34.5F, 1, 2, 3, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 68, 62, -1.5F, -19.3F, 23.2F, 4, 2, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 86, 45, -1.5F, -19.5F, 23.7F, 4, 1, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 0, 93, -0.5F, -20.3F, 23.2F, 2, 1, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 82, 74, -0.5F, -20.7F, 23.2F, 2, 1, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 99, 87, 0.0F, -20.9F, 23.2F, 1, 1, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 56, 62, -1.0F, -18.3F, 19.2F, 3, 2, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 99, 84, -0.2F, -19.3F, 19.2F, 1, 1, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 99, 81, 0.2F, -19.3F, 19.2F, 1, 1, 2, 0.0F, false));
		...
		Main59_r1.cubeList.add(new ModelBox(Main59_r1, 56, 95, -3.0F, -20.0F, 40.0F, 3, 2, 1, 0.0F, false));
		...
		Main37_r1.cubeList.add(new ModelBox(Main37_r1, 0, 93, -3.0F, -17.9F, 23.0F, 1, 2, 10, 0.0F, false));
		...
		Main35_r1.cubeList.add(new ModelBox(Main35_r1, 0, 81, -2.3F, -14.4F, 23.0F, 2, 2, 10, 0.0F, false));
		Main35_r1.cubeList.add(new ModelBox(Main35_r1, 0, 68, -2.3F, -17.4F, 23.0F, 2, 1, 10, 0.0F, false));
		...
		Main28_r1.cubeList.add(new ModelBox(Main28_r1, 14, 73, -3.1F, -20.5F, 40.0F, 1, 3, 1, 0.0F, false));
		...
		Main19_r1.cubeList.add(new ModelBox(Main19_r1, 47, 73, 4.0F, -21.0F, 46.0F, 2, 3, 1, 0.0F, false));
		...
		Main18_r1.cubeList.add(new ModelBox(Main18_r1, 82, 92, 3.0F, -21.0F, 37.0F, 3, 3, 1, 0.0F, false));
		...
		Main17_r1.cubeList.add(new ModelBox(Main17_r1, 112, 123, 4.0F, -18.0F, 38.0F, 2, 1, 8, 0.0F, false));
		...
		Main77_r1.cubeList.add(new ModelBox(Main77_r1, 68, 56, -1.1F, -19.2F, 14.2F, 1, 1, 5, 0.0F, false));
		...
		Main79_r1.cubeList.add(new ModelBox(Main79_r1, 42, 32, 0.9F, -19.2F, 14.7F, 5, 1, 1, 0.0F, false));
		Main79_r1.cubeList.add(new ModelBox(Main79_r1, 72, 6, 0.9F, -19.2F, 14.2F, 5, 1, 1, 0.0F, false));
		...
		Main81_r1.cubeList.add(new ModelBox(Main81_r1, 24, 165, 5.6F, -19.9F, 14.2F, 1, 1, 14, 0.0F, false));
		Main81_r1.cubeList.add(new ModelBox(Main81_r1, 218, 104, 5.1F, -20.9F, 14.2F, 2, 1, 14, 0.0F, false));
		...
		Main83_r1.cubeList.add(new ModelBox(Main83_r1, 80, 136, 4.8F, -19.7F, 14.2F, 1, 1, 14, 0.0F, false));
		...
		Main82_r1.cubeList.add(new ModelBox(Main82_r1, 136, 136, 4.2F, -20.6F, 14.2F, 1, 1, 14, 0.0F, false));
		...
		grip.cubeList.add(new ModelBox(grip, 82, 81, -1.0F, -51.9121F, 15.6164F, 3, 4, 1, 0.0F, false));
		grip.cubeList.add(new ModelBox(grip, 137, 96, -1.0F, -48.4121F, 16.1164F, 3, 1, 5, 0.0F, false));
		grip.cubeList.add(new ModelBox(grip, 82, 92, -2.0F, -52.3121F, 23.1164F, 5, 1, 8, 0.0F, false));
		grip.cubeList.add(new ModelBox(grip, 172, 19, 1.8F, -54.4121F, 13.6164F, 1, 3, 18, 0.0F, false));
		grip.cubeList.add(new ModelBox(grip, 137, 82, -2.0F, -51.3121F, 23.1164F, 5, 3, 4, 0.0F, false));
		...
		Grip14_r1.cubeList.add(new ModelBox(Grip14_r1, 0, 106, -2.0F, 3.5F, 48.1F, 5, 1, 2, 0.0F, false));

		Grip13_r1 = new ModelRenderer(this);
		Grip13_r1.setRotationPoint(0.0F, -95.7681F, 3.8884F);
		...
		Grip13_r1.cubeList.add(new ModelBox(Grip13_r1, 80, 166, -2.0F, -10.0F, 49.0F, 5, 5, 10, 0.0F, false));
		...
		Grip12_r1.cubeList.add(new ModelBox(Grip12_r1, 56, 86, -1.0F, -2.5F, 44.5F, 3, 3, 1, 0.0F, false));
		...
		Grip9_r1.cubeList.add(new ModelBox(Grip9_r1, 40, 89, -2.0F, -6.4F, 52.5F, 5, 2, 2, 0.0F, false));

		Stock = new ModelRenderer(this);
		Stock.setRotationPoint(-22.7851F, 11.6811F, 0.0F);
		body.addChild(Stock);
		Stock.cubeList.add(new ModelBox(Stock, 26, 55, -3.5F, -21.3F, 84.0F, 8, 13, 5, 0.0F, false));
		...
		Stock.cubeList.add(new ModelBox(Stock, 0, 55, -3.0F, -9.0F, 84.0F, 7, 8, 5, 0.0F, false));
		Stock.cubeList.add(new ModelBox(Stock, 0, 220, -2.5F, -9.5F, 72.0F, 6, 1, 9, 0.0F, false));
		Stock.cubeList.add(new ModelBox(Stock, 0, 123, -3.5F, -21.3F, 81.0F, 8, 4, 3, 0.0F, false));
		...
		Stock8_r1.cubeList.add(new ModelBox(Stock8_r1, 26, 81, -3.5F, -8.5F, 72.0F, 1, 1, 12, 0.0F, false));
		...
		barrel.cubeList.add(new ModelBox(barrel, 93, 123, -0.5F, -12.0F, -30.0F, 2, 1, 6, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 71, 70, -0.5F, -16.0F, -21.0F, 2, 4, 2, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 30, 0, -0.5F, -16.0F, -14.0F, 2, 4, 2, 0.0F, false));
		...
		muzzle.cubeList.add(new ModelBox(muzzle, 112, 136, 1.5F, -17.0F, -38.0F, 1, 1, 8, 0.0F, false));
		muzzle.cubeList.add(new ModelBox(muzzle, 137, 65, 0.0F, -18.5F, -38.0F, 1, 1, 8, 0.0F, false));
		muzzle.cubeList.add(new ModelBox(muzzle, 137, 56, 0.0F, -15.5F, -38.0F, 1, 1, 8, 0.0F, false));
		muzzle.cubeList.add(new ModelBox(muzzle, 35, 137, -1.5F, -17.0F, -38.0F, 1, 1, 8, 0.0F, false));
		...
		Muzzle8_r1.cubeList.add(new ModelBox(Muzzle8_r1, 25, 135, -1.0F, -14.5F, -38.0F, 1, 2, 8, 0.0F, false));
		...
		Muzzle7_r1.cubeList.add(new ModelBox(Muzzle7_r1, 56, 136, 1.0F, -14.5F, -38.0F, 1, 2, 8, 0.0F, false));
		...
		Muzzle6_r1.cubeList.add(new ModelBox(Muzzle6_r1, 26, 123, -2.0F, -18.5F, -38.0F, 2, 1, 8, 0.0F, false));
		...
		Muzzle5_r1.cubeList.add(new ModelBox(Muzzle5_r1, 56, 123, 1.0F, -18.5F, -38.0F, 2, 1, 8, 0.0F, false));

		frontsight = new ModelRenderer(this);
		frontsight.setRotationPoint(-40.1527F, 3.4102F, 0.0F);
		body.addChild(frontsight);
		frontsight.cubeList.add(new ModelBox(frontsight, 78, 30, 17.3676F, -17.7291F, -29.2F, 1, 8, 1, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 40, 0, 17.3676F, -17.7291F, -29.0F, 1, 3, 2, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 96, 143, 17.3676F, -9.9291F, -30.0F, 1, 1, 6, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 141, 24, 18.5676F, -8.7291F, -30.0F, 1, 1, 6, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 141, 14, 16.1676F, -8.7291F, -30.0F, 1, 1, 6, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 48, 8, 17.3676F, -17.7291F, -29.5F, 1, 8, 1, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 137, 125, 17.3676F, -7.5291F, -30.0F, 1, 1, 6, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 56, 98, 17.6676F, -17.8291F, -29.5F, 1, 1, 2, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 30, 98, 17.0676F, -17.8291F, -29.5F, 1, 1, 2, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 26, 75, 17.0676F, -17.8291F, -28.0F, 1, 1, 1, 0.0F, false));
		frontsight.cubeList.add(new ModelBox(frontsight, 73, 45, 17.6676F, -17.8291F, -28.0F, 1, 1, 1, 0.0F, false));
		...
		IronsightFront25_r1.cubeList.add(new ModelBox(IronsightFront25_r1, 73, 43, 0.3F, -25.1F, -28.0F, 1, 1, 1, 0.0F, false));
		IronsightFront25_r1.cubeList.add(new ModelBox(IronsightFront25_r1, 38, 97, 0.3F, -25.1F, -29.5F, 1, 1, 2, 0.0F, false));
		...
		IronsightFront23_r1.cubeList.add(new ModelBox(IronsightFront23_r1, 47, 97, -0.3F, -25.1F, -29.5F, 1, 1, 2, 0.0F, false));
		IronsightFront23_r1.cubeList.add(new ModelBox(IronsightFront23_r1, 73, 27, -0.3F, -25.1F, -28.0F, 1, 1, 1, 0.0F, false));
		...
		IronsightFront18_r1.cubeList.add(new ModelBox(IronsightFront18_r1, 95, 111, 1.0F, -14.1F, -30.0F, 1, 1, 6, 0.0F, false));
		IronsightFront18_r1.cubeList.add(new ModelBox(IronsightFront18_r1, 137, 118, 1.0F, -14.8F, -30.0F, 1, 1, 6, 0.0F, false));
		...
		IronsightFront17_r1.cubeList.add(new ModelBox(IronsightFront17_r1, 96, 136, 0.7F, -14.8F, -30.0F, 1, 1, 6, 0.0F, false));
		IronsightFront17_r1.cubeList.add(new ModelBox(IronsightFront17_r1, 136, 136, 0.0F, -14.8F, -30.0F, 1, 1, 6, 0.0F, false));
		...
		IronsightFront11_r1.cubeList.add(new ModelBox(IronsightFront11_r1, 141, 0, 0.0F, -17.5F, -30.0F, 1, 1, 6, 0.0F, false));
		IronsightFront11_r1.cubeList.add(new ModelBox(IronsightFront11_r1, 141, 7, 0.0F, -18.2F, -30.0F, 1, 1, 6, 0.0F, false));
		...
		IronsightFront6_r1.cubeList.add(new ModelBox(IronsightFront6_r1, 141, 31, 1.7F, -18.2F, -30.0F, 1, 1, 6, 0.0F, false));
		IronsightFront6_r1.cubeList.add(new ModelBox(IronsightFront6_r1, 141, 38, 1.0F, -18.2F, -30.0F, 1, 1, 6, 0.0F, false));
