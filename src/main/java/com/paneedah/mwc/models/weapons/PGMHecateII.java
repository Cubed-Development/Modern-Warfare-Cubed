...
public class PGMHecateII extends ModelWithAttachments {
	...
	public PGMHecateII() {
		...
		carry_handle.setRotationPoint(-1.0F, 6.75F, 53.5F);
		Body.addChild(carry_handle);
		...
		handle_arm.setRotationPoint(0.0F, 0.0F, 0.0F);
		Body.addChild(handle_arm);
		...
		chassis.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		bone.cubeList.add(new ModelBox(bone, 100, 222, 1.35F, -0.01F, 0.001F, 1, 1, 30, 0.0F, false));
		...
		barrel.setRotationPoint(-1.0F, 5.5F, -7.0F);
		...
		bone50.cubeList.add(new ModelBox(bone50, 0, 91, -2.0F, 0.27F, -7.0F, 2, 1, 7, 0.0F, false));
		...
		bone15.cubeList.add(new ModelBox(bone15, 0, 0, -2.23F, -6.4843F, 9.6493F, 1, 5, 3, 0.0F, false));
		...
		bone42.cubeList.add(new ModelBox(bone42, 40, 96, 0.5898F, -3.62F, 19.0F, 1, 1, 6, 0.0F, false));
