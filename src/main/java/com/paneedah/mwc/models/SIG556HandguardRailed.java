...
public class SIG556HandguardRailed extends ModelWithAttachments {
    ...
    public SIG556HandguardRailed() {
        ...
        handguard2.setRotationPoint(0, -15.3F, -35);
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 0, -2.5F, 2.3F, -36.85F, 2, 2, 45, -0.1F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 35, 0, -2.5F, -1, -20.85F, 2, 6, 3, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 70, 63, -2, -1.45F, -20.85F, 1, 1, 3, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 21, -2, -4.2F, -20.35F, 1, 3, 2, -0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 40, 88, -2, 4.8F, -19.6F, 1, 2, 1, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 32, 47, -3, 0.8F, -20.85F, 3, 4, 3, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 131, 129, -0.2F, -0.4F, -18.05F, 1, 4, 27, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 100, -0.195F, 0, -17.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 97, 66, -0.195F, 0, -14.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 97, 63, -0.195F, 0, -11.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 27, 95, -0.195F, 0, -8.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 18, 95, -0.195F, 0, -5.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 9, 95, -0.195F, 0, -2.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 95, -0.195F, 0, 0.95F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 27, 92, -0.195F, 0, 3.95F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 21, 82, -3.805F, 0, 3.95F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 38, 85, -3.805F, 0, 0.95F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 7, 87, -3.805F, 0, -2.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 46, 87, -3.805F, 0, -5.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 88, 37, -3.805F, 0, -8.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 92, -3.805F, 0, -11.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 9, 92, -3.805F, 0, -14.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 18, 92, -3.805F, 0, -17.05F, 1, 1, 2, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 160, 115, 0.6F, 1.05F, -18.15F, 1, 2, 27, -0.101F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 35, 127, -0.2F, -0.7F, -18.05F, 1, 1, 1, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 108, 24, -0.2F, -0.7F, -16.55F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 106, 64, -0.2F, -0.7F, -12.05F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 106, 59, -0.2F, -0.7F, -7.55F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 105, 72, -0.2F, -0.7F, -3.05F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 76, 103, -0.2F, -0.7F, 1.45F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 21, 67, -0.2F, -0.7F, 5.95F, 1, 1, 3, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 131, 98, -3.8F, -0.4F, -18.05F, 1, 4, 27, 0.001F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 31, 127, -3.8F, -0.7F, -18.05F, 1, 1, 1, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 86, 0, -3.8F, -0.7F, -16.55F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 86, 5, -3.8F, -0.7F, -12.05F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 76, 92, -3.8F, -0.7F, -7.55F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 98, 28, -3.8F, -0.7F, -3.05F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 47, 102, -3.8F, -0.7F, 1.45F, 1, 1, 4, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 10, 34, -3.8F, -0.7F, 5.95F, 1, 1, 3, 0, false));
        ...
        handguard2.cubeList.add(new ModelBox(handguard2, 90, 149, -2.35F, 4.35F, -18.15F, 2, 1, 27, 0, false));
        ...
        handguard2.cubeList.add(new ModelBox(handguard2, 240, 48, -2, 2.1F, -36.85F, 1, 1, 19, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 21, 78, -2, 2, -43.95F, 1, 1, 7, 0.1F, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 66, 0, -2, 3.6F, -43.95F, 1, 1, 7, 0.1F, false));
        ...
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 47, -2, 3.4F, -36.85F, 1, 1, 44, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 67, -1.4F, 2.8F, -36.85F, 1, 1, 19, 0, false));
        handguard2.cubeList.add(new ModelBox(handguard2, 0, 47, -2.6F, 2.8F, -36.85F, 1, 1, 19, 0, false));

        cube_r106 = new ModelRenderer(this);
        cube_r106.setRotationPoint(-3.55F, -0.7F, 5.95F);
        handguard2.addChild(cube_r106);
        setRotationAngle(cube_r106, 0, 0, -0.7679F);
        cube_r106.cubeList.add(new ModelBox(cube_r106, 35, 14, 0, 0, 0, 2, 1, 3, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 121, 16, 0, 0, -4, 2, 1, 1, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 121, 14, 0, 0, -8, 2, 1, 1, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 121, 12, 0, 0, -12, 2, 1, 1, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 12, 121, 0, 0, -16, 2, 1, 1, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 0, 214, -0.45F, -0.1F, -23.5F, 1, 1, 24, -0.1F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 121, 10, 0, 0, -24, 2, 1, 1, -0.01F, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 121, 8, 0, 0, -20, 2, 1, 1, -0.01F, false));
        ...
        setRotationAngle(cube_r107, 0, 0, 0.7679F);
        cube_r107.cubeList.add(new ModelBox(cube_r107, 18, 121, -2, 0, 0, 2, 1, 1, -0.01F, false));
        cube_r107.cubeList.add(new ModelBox(cube_r107, 83, 76, -2, 0, 4, 2, 1, 3, -0.01F, false));
        cube_r107.cubeList.add(new ModelBox(cube_r107, 121, 20, -2, 0, -8, 2, 1, 1, -0.01F, false));
        cube_r107.cubeList.add(new ModelBox(cube_r107, 121, 18, -2, 0, -4, 2, 1, 1, -0.01F, false));
        cube_r107.cubeList.add(new ModelBox(cube_r107, 121, 22, -2, 0, -12, 2, 1, 1, -0.01F, false));
        cube_r107.cubeList.add(new ModelBox(cube_r107, 24, 121, -2, 0, -16, 2, 1, 1, -0.01F, false));
        ...
        cube_r107.cubeList.add(new ModelBox(cube_r107, 121, 24, -2, 0, -20, 2, 1, 1, -0.01F, false));

        cube_r108 = new ModelRenderer(this);
        cube_r108.setRotationPoint(-3.8F, 3.6F, -18.05F);
        handguard2.addChild(cube_r108);
        setRotationAngle(cube_r108, 0, 0, -0.5585F);
        cube_r108.cubeList.add(new ModelBox(cube_r108, 49, 36, 0, 0, 0, 1, 2, 2, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 26, 71, 0, 0, 5, 1, 2, 1, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 26, 67, 0, 0, 9, 1, 2, 1, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 57, 57, 0, 0, 13, 1, 2, 1, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 26, 47, 0, 0, 17, 1, 2, 1, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 15, 21, 0, 0, 21, 1, 2, 1, 0.01F, false));
        cube_r108.cubeList.add(new ModelBox(cube_r108, 12, 13, 0, 0, 25, 1, 2, 2, 0.01F, false));

        cube_r109 = new ModelRenderer(this);
        cube_r109.setRotationPoint(0.8F, 3.6F, 2.95F);
        handguard2.addChild(cube_r109);
        setRotationAngle(cube_r109, 0, 0, 0.5585F);
        cube_r109.cubeList.add(new ModelBox(cube_r109, 75, 63, -1, 0, 0, 1, 2, 1, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 54, 47, -1, 0, 4, 1, 2, 2, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 15, 76, -1, 0, -8, 1, 2, 1, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 75, 67, -1, 0, -4, 1, 2, 1, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 40, 77, -1, 0, -12, 1, 2, 1, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 15, 80, -1, 0, -16, 1, 2, 1, 0.01F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 57, 0, -1, 0, -21, 1, 2, 2, 0.01F, false));

        cube_r110 = new ModelRenderer(this);
        cube_r110.setRotationPoint(-3, 1.55F, -5.15F);
        handguard2.addChild(cube_r110);
        setRotationAngle(cube_r110, -0.384F, 0, 0);
        cube_r110.cubeList.add(new ModelBox(cube_r110, 15, 17, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r111 = new ModelRenderer(this);
        cube_r111.setRotationPoint(-3, 1.55F, 6.85F);
        handguard2.addChild(cube_r111);
        setRotationAngle(cube_r111, -0.384F, 0, 0);
        cube_r111.cubeList.add(new ModelBox(cube_r111, 41, 41, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r112 = new ModelRenderer(this);
        cube_r112.setRotationPoint(-3, 1.55F, -17.15F);
        handguard2.addChild(cube_r112);
        setRotationAngle(cube_r112, -0.384F, 0, 0);
        cube_r112.cubeList.add(new ModelBox(cube_r112, 41, 43, -1, 0, 0, 1, 1, 1, 0, false));

        cube_r113 = new ModelRenderer(this);
        cube_r113.setRotationPoint(-1, -4.2F, -20.35F);
        handguard2.addChild(cube_r113);
        setRotationAngle(cube_r113, -0.1745F, 0, 0);
        cube_r113.cubeList.add(new ModelBox(cube_r113, 0, 13, -1, 0, 0, 1, 3, 1, -0.002F, false));

        cube_r114 = new ModelRenderer(this);
        cube_r114.setRotationPoint(-1, -2, -20.95F);
        handguard2.addChild(cube_r114);
        setRotationAngle(cube_r114, 0.4712F, 0, 0);
        cube_r114.cubeList.add(new ModelBox(cube_r114, 39, 127, -1, 0, 0, 1, 1, 1, 0.2F, false));
        ...
        cube_r115.setRotationPoint(0, 0.6F, 4.75F);
        rail5.addChild(cube_r115);
        setRotationAngle(cube_r115, 0, 0, -0.9425F);
        ...
        setRotationAngle(cube_r116, 0, 0, 0.9425F);
        ...
        setRotationAngle(rail6, 0, 0, -1.5708F);
        ...
        cube_r117.setRotationPoint(0, 0.6F, 4.75F);
        rail6.addChild(cube_r117);
        setRotationAngle(cube_r117, 0, 0, -0.9425F);
        ...
        setRotationAngle(cube_r118, 0, 0, 0.9425F);
        ...
        rail7.setRotationPoint(-2.3F, 6, -21.8F);
        ...
        cube_r119.setRotationPoint(0, 0.6F, 4.75F);
        rail7.addChild(cube_r119);
        setRotationAngle(cube_r119, 0, 0, -0.9425F);
        ...
        setRotationAngle(cube_r120, 0, 0, 0.9425F);
