...
public class Suppressor556x45 extends ModelBase {
    ...
    public Suppressor556x45() {
        ...
        gun35_r1.cubeList.add(new ModelBox(gun35_r1, 0, 0, 0.3F, -21, 13.0F, 1, 1, 7, 0.0F, true));
        gun35_r1.cubeList.add(new ModelBox(gun35_r1, 0, 0, 0.3F, -21, -1.8F, 1, 1, 8, 0.0F, true));
        ...
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 0, 0, 3.1F, -21, 13.0F, 1, 1, 7, 0.0F, true));
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 0, 0, 3.1F, -21, -1.8F, 1, 1, 8, 0.0F, true));
