...
public class Suppressor556x45 extends ModelBase {
    ...
    public Suppressor556x45() {
        ...
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0, -24.1F, -1.8F, 2, 1, 8, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 2.1F, -23, -1.8F, 1, 2, 8, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0, -20.9F, -1.8F, 2, 1, 8, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.1F, -23, -1.8F, 1, 2, 8, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0, -24.1F, 13, 2, 1, 7, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 2.1F, -23, 13, 1, 2, 7, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.1F, -23, 13, 1, 2, 7, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.1F, -23, 13, 1, 2, 7, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0, -20.9F, 13, 2, 1, 7, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0.5F, -24.2F, 13.5F, 1, 1, 3, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 0.5F, -20.8F, 13.5F, 1, 1, 3, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 2.2F, -22.5F, 13.5F, 1, 1, 3, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.2F, -22.5F, 13.5F, 1, 1, 3, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, 2.2F, -23, 18.5F, 1, 2, 1, 0, true));
        suppressor.cubeList.add(new ModelBox(suppressor, 0, 0, -1.2F, -23, 18.5F, 1, 2, 1, 0, true));

        gun46_r1 = new ModelRenderer(this);
        gun46_r1.setRotationPoint(-15.105F, -6.0922F, 0);
        suppressor.addChild(gun46_r1);
        setRotationAngle(gun46_r1, 0, 0, 0.7808F);
        gun46_r1.cubeList.add(new ModelBox(gun46_r1, 0, 0, -0.15F, -21.4F, 13.5F, 1, 1, 3, 0, true));

        gun45_r1 = new ModelRenderer(this);
        gun45_r1.setRotationPoint(-9.1921F, -37.917F, 0);
        suppressor.addChild(gun45_r1);
        setRotationAngle(gun45_r1, 0, 0, 2.3794F);
        gun45_r1.cubeList.add(new ModelBox(gun45_r1, 0, 0, 3, -20.8F, 13.5F, 1, 1, 3, 0, true));

        gun44_r1 = new ModelRenderer(this);
        gun44_r1.setRotationPoint(-16.2192F, -8.4847F, 0);
        suppressor.addChild(gun44_r1);
        setRotationAngle(gun44_r1, 0, 0, 0.7808F);
        gun44_r1.cubeList.add(new ModelBox(gun44_r1, 0, 0, 2.2F, -23.95F, 13.5F, 1, 1, 3, 0, true));

        gun43_r1 = new ModelRenderer(this);
        gun43_r1.setRotationPoint(-16.9287F, -6.7603F, 0);
        suppressor.addChild(gun43_r1);
        setRotationAngle(gun43_r1, 0, 0, 0.7808F);
        gun43_r1.cubeList.add(new ModelBox(gun43_r1, 0, 0, -0.25F, -23.95F, 13.5F, 1, 1, 3, 0, true));

        gun37_r1 = new ModelRenderer(this);
        gun37_r1.setRotationPoint(-14.9912F, -6.1688F, 0);
        suppressor.addChild(gun37_r1);
        setRotationAngle(gun37_r1, 0, 0, 0.7808F);
        gun37_r1.cubeList.add(new ModelBox(gun37_r1, 0, 0, 0, -21.3F, 13, 1, 1, 7, 0, true));
        gun37_r1.cubeList.add(new ModelBox(gun37_r1, 0, 0, 0, -21.3F, -1.8F, 1, 1, 8, 0, true));

        gun35_r1 = new ModelRenderer(this);
        gun35_r1.setRotationPoint(-13.9832F, -36.3974F, 0);
        suppressor.addChild(gun35_r1);
        setRotationAngle(gun35_r1, 0, 0, 2.3794F);
        gun35_r1.cubeList.add(new ModelBox(gun35_r1, 0, 0, 0.3F, -21, 13, 1, 1, 7, 0, true));
        gun35_r1.cubeList.add(new ModelBox(gun35_r1, 0, 0, 0.3F, -21, -1.8F, 1, 1, 8, 0, true));

        gun33_r1 = new ModelRenderer(this);
        gun33_r1.setRotationPoint(-15.3642F, -39.8441F, 0);
        suppressor.addChild(gun33_r1);
        setRotationAngle(gun33_r1, 0, 0, 2.3794F);
        gun33_r1.cubeList.add(new ModelBox(gun33_r1, 0, 0, 0.3F, -23, 13, 1, 1, 7, 0, true));
        gun33_r1.cubeList.add(new ModelBox(gun33_r1, 0, 0, 0.3F, -23, -1.8F, 1, 1, 8, 0, true));

        gun32_r1 = new ModelRenderer(this);
        gun32_r1.setRotationPoint(-16.9619F, -6.9797F, 0);
        suppressor.addChild(gun32_r1);
        setRotationAngle(gun32_r1, 0, 0, 0.7808F);
        gun32_r1.cubeList.add(new ModelBox(gun32_r1, 0, 0, 0, -24.1F, 13, 1, 1, 7, 0, true));
        gun32_r1.cubeList.add(new ModelBox(gun32_r1, 0, 0, 0, -24.1F, -1.8F, 1, 1, 8, 0, true));

        gun31_r1 = new ModelRenderer(this);
        gun31_r1.setRotationPoint(-14.412F, -7.5764F, 0);
        suppressor.addChild(gun31_r1);
        setRotationAngle(gun31_r1, 0, 0, 0.7808F);
        gun31_r1.cubeList.add(new ModelBox(gun31_r1, 0, 0, 2, -21.3F, 13, 1, 1, 7, 0, true));
        gun31_r1.cubeList.add(new ModelBox(gun31_r1, 0, 0, 2, -21.3F, -1.8F, 1, 1, 8, 0, true));

        gun30_r1 = new ModelRenderer(this);
        gun30_r1.setRotationPoint(-9.1579F, -38.3308F, 0);
        suppressor.addChild(gun30_r1);
        setRotationAngle(gun30_r1, 0, 0, 2.3794F);
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 0, 0, 3.1F, -21, 13, 1, 1, 7, 0, true));
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 0, 0, 3.1F, -21, -1.8F, 1, 1, 8, 0, true));

        gun28_r1 = new ModelRenderer(this);
        gun28_r1.setRotationPoint(-10.5388F, -41.7774F, 0);
        suppressor.addChild(gun28_r1);
        setRotationAngle(gun28_r1, 0, 0, 2.3794F);
        gun28_r1.cubeList.add(new ModelBox(gun28_r1, 0, 0, 3.1F, -23, 13, 1, 1, 7, 0, true));
        gun28_r1.cubeList.add(new ModelBox(gun28_r1, 0, 0, 3.1F, -23, -1.8F, 1, 1, 8, 0, true));

        gun27_r1 = new ModelRenderer(this);
        gun27_r1.setRotationPoint(-16.3827F, -8.3873F, 0);
        suppressor.addChild(gun27_r1);
        setRotationAngle(gun27_r1, 0, 0, 0.7808F);
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 0, 0, 2, -24.1F, 13, 1, 1, 7, 0, true));
        gun27_r1.cubeList.add(new ModelBox(gun27_r1, 0, 0, 2, -24.1F, -1.8F, 1, 1, 8, 0, true));
