...
public class SandbagWall extends ModelBase {
    ...
    public SandbagWall() {
        ...
        Sandbag4.setRotationPoint(0, 12.7F, 0);
        Sandbag4.cubeList.add(new ModelBox(Sandbag4, 0, 0, -8, -4.9F, -4.5F, 16, 4, 8, 0, false));

        bone19 = new ModelRenderer(this);
        bone19.setRotationPoint(0, -6.3F, -0.5F);
        Sandbag4.addChild(bone19);
        setRotationAngle(bone19, -0.1222F, 0, 0.0873F);
        bone19.cubeList.add(new ModelBox(bone19, 28, 30, 0.0396F, 0, 0, 8, 2, 4, -0.001F, false));

        bone20 = new ModelRenderer(this);
        bone20.setRotationPoint(0, -6.3F, -0.5F);
        Sandbag4.addChild(bone20);
        setRotationAngle(bone20, 0.1222F, 0, 0.0873F);
        bone20.cubeList.add(new ModelBox(bone20, 28, 18, 0.0396F, 0, -4, 8, 2, 4, -0.001F, false));

        bone21 = new ModelRenderer(this);
        bone21.setRotationPoint(0, -6.3F, -0.5F);
        Sandbag4.addChild(bone21);
        setRotationAngle(bone21, 0.1222F, 0, -0.0873F);
        bone21.cubeList.add(new ModelBox(bone21, 24, 12, -7.9604F, 0, -4, 8, 2, 4, -0.001F, false));

        bone22 = new ModelRenderer(this);
        bone22.setRotationPoint(0, -6.3F, -0.5F);
        Sandbag4.addChild(bone22);
        setRotationAngle(bone22, -0.1222F, 0, -0.0873F);
        bone22.cubeList.add(new ModelBox(bone22, 24, 24, -7.9604F, 0, 0, 8, 2, 4, -0.001F, false));

        bone23 = new ModelRenderer(this);
        bone23.setRotationPoint(0.1F, -8, -1);
        ...
        bone24.setRotationPoint(0, -7, 0);
        Sandbag4.addChild(bone24);
        setRotationAngle(bone24, 0, 0, -0.0873F);
