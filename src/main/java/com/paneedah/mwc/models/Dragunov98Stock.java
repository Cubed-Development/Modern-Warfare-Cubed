...
public class Dragunov98Stock extends ModelBase {
    ...
    public Dragunov98Stock() {
        ...
        grip.cubeList.add(new ModelBox(grip, 0, 56, -3.0F, -32.7F, 1, 3, 2, 5, 0.0F, false));
        ...
        receiver15_r1.cubeList.add(new ModelBox(receiver15_r1, 75, 76, -1, 0.0F, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver14_r1.cubeList.add(new ModelBox(receiver14_r1, 46, 77, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver17_r1.cubeList.add(new ModelBox(receiver17_r1, 65, 78, -1, -1, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver17_r2.cubeList.add(new ModelBox(receiver17_r2, 78, 65, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver17_r3.cubeList.add(new ModelBox(receiver17_r3, 79, 16, -1, 0.0F, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver15_r3.cubeList.add(new ModelBox(receiver15_r3, 79, 29, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        grip5_r1.cubeList.add(new ModelBox(grip5_r1, 36, 0, -1, 0.0F, 0.0F, 1, 1, 3, -0.001F, false));
        ...
        grip4_r1.cubeList.add(new ModelBox(grip4_r1, 54, 16, -1, 0.0F, 0.0F, 1, 1, 3, -0.001F, false));
        ...
        grip10_r1.setRotationPoint(-3.0F, -30.7F, 1);
        ...
        grip9_r1.setRotationPoint(0.0F, -30.7F, 1);
        grip.addChild(grip9_r1);
        setRotationAngle(grip9_r1, 0.0F, 0.0F, 0.3665F);
        grip9_r1.cubeList.add(new ModelBox(grip9_r1, 13, 27, -1, -2.0F, 0.0F, 1, 2, 5, -0.001F, false));

        grip9_r2 = new ModelRenderer(this);
        grip9_r2.setRotationPoint(0.0F, -29.7F, 1);
        ...
        grip3_r2.cubeList.add(new ModelBox(grip3_r2, 132, 51, 0.499F, -1, 0.0F, 3, 1, 12, 0.0F, false));
        ...
        grip13_r1.cubeList.add(new ModelBox(grip13_r1, 28, 27, 3.2F, 0.5F, 1, 1, 9, 4, 0.0F, false));
        grip13_r1.cubeList.add(new ModelBox(grip13_r1, 30, 0, 0.0F, 0.5F, 1, 1, 9, 4, 0.0F, false));
    }
