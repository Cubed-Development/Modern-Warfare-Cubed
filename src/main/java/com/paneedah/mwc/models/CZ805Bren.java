...
public class CZ805Bren extends ModelWithAttachments {
    ...
    public CZ805Bren() {
        ...
        lowerreceiver.setRotationPoint(0, 24, 0);
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 22, 162, -3.1F, -33.25F, -23, 2, 3, 17, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 58, 0, -2.5F, -33.45F, -48, 2, 1, 23, 0.001F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 69, 0, -2.5F, -34.45F, -47.9F, 2, 1, 4, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 43, 102, -2.5F, -34.45F, -33.25F, 2, 1, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 85, 3, -2.5F, -34.45F, -29.35F, 2, 1, 2, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 25, 81, -3.25F, -33.25F, -24, 3, 5, 11, 0.001F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 0, 0, -0.75F, -33.25F, -24, 1, 5, 11, 0, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 0, 0, -2.5F, -33, -14.25F, 3, 7, 2, -0.002F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 11, 66, -3.5F, -30, -14.25F, 1, 4, 2, -0.002F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 83, 69, -2.5F, -27.25F, -14.25F, 2, 1, 7, 0, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 27, 61, -0.5F, -31, -18.4F, 1, 1, 5, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 27, 73, -3.1F, -33.55F, -0.7F, 2, 2, 3, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 71, 11, -1.9F, -33.55F, -0.7F, 2, 2, 3, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 162, 0, -2, -33.25F, -23, 2, 3, 17, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 56, 68, -1.9F, -33.25F, -8, 2, 3, 2, 0.001F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 48, 87, -1.9F, -33.25F, -13, 2, 3, 1, 0.001F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 58, 41, -1.9F, -32.25F, -11, 2, 1, 3, 0.001F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 27, 7, -1.79F, -32.25F, -11, 2, 1, 4, -0.1F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 12, 85, -1.9F, -31.5F, -9, 2, 1, 1, 0.002F, false));
        ...
        setRotationAngle(cube_r42, 0.2793F, 0, 0);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 0, 71, -1.7F, -1.7F, -0.3F, 2, 2, 2, -0.3F, false));

        cube_r43 = new ModelRenderer(this);
        cube_r43.setRotationPoint(0.1F, -30.25F, -6);
        lowerreceiver.addChild(cube_r43);
        setRotationAngle(cube_r43, 0.2269F, 0, 0);
        cube_r43.cubeList.add(new ModelBox(cube_r43, 85, 13, -2, -3, 0, 2, 3, 6, -0.001F, false));
        cube_r43.cubeList.add(new ModelBox(cube_r43, 87, 24, -3.2F, -3, 0, 2, 3, 6, -0.001F, false));

        cube_r44 = new ModelRenderer(this);
        cube_r44.setRotationPoint(0.25F, -28.25F, -24);
        lowerreceiver.addChild(cube_r44);
        setRotationAngle(cube_r44, -0.2269F, 0, 0);
        cube_r44.cubeList.add(new ModelBox(cube_r44, 0, 27, -1, -3, 0, 1, 3, 10, -0.001F, false));
        cube_r44.cubeList.add(new ModelBox(cube_r44, 25, 110, -3.5F, -3, 0, 3, 3, 10, 0, false));

        cube_r45 = new ModelRenderer(this);
        cube_r45.setRotationPoint(-3.25F, -29.7F, -13.65F);
        lowerreceiver.addChild(cube_r45);
        setRotationAngle(cube_r45, -0.5411F, 0, 0);
        cube_r45.cubeList.add(new ModelBox(cube_r45, 97, 59, -0.25F, 0, -2, 1, 1, 2, -0.001F, false));

        cube_r46 = new ModelRenderer(this);
        cube_r46.setRotationPoint(-3.25F, -31.8F, -13.65F);
        lowerreceiver.addChild(cube_r46);
        setRotationAngle(cube_r46, 0.5411F, 0, 0);
        cube_r46.cubeList.add(new ModelBox(cube_r46, 60, 97, -0.25F, -1, -2, 1, 1, 2, -0.001F, false));

        cube_r47 = new ModelRenderer(this);
        cube_r47.setRotationPoint(0.5F, -30, -15.9F);
        lowerreceiver.addChild(cube_r47);
        setRotationAngle(cube_r47, -0.5411F, 0, 0);
        cube_r47.cubeList.add(new ModelBox(cube_r47, 97, 56, -1, -1, 0, 1, 1, 2, -0.001F, false));

        cube_r48 = new ModelRenderer(this);
        cube_r48.setRotationPoint(1, -31.85F, -14.3F);
        lowerreceiver.addChild(cube_r48);
        setRotationAngle(cube_r48, 0, -0.1396F, 0);
        cube_r48.cubeList.add(new ModelBox(cube_r48, 37, 97, -1, -1, 0, 1, 1, 2, -0.2F, false));

        cube_r49 = new ModelRenderer(this);
        cube_r49.setRotationPoint(0.8F, -30.15F, -13.3F);
        lowerreceiver.addChild(cube_r49);
        setRotationAngle(cube_r49, 0, -0.1571F, 0);
        cube_r49.cubeList.add(new ModelBox(cube_r49, 107, 25, -1.1F, -1, -0.5F, 1, 1, 1, 0.051F, false));
        cube_r49.cubeList.add(new ModelBox(cube_r49, 107, 27, -1.1F, -1, 0, 1, 1, 1, 0.05F, false));

        cube_r50 = new ModelRenderer(this);
        cube_r50.setRotationPoint(-3.7F, -30.25F, -14.2F);
        lowerreceiver.addChild(cube_r50);
        setRotationAngle(cube_r50, 0, 0.2094F, 0);
        cube_r50.cubeList.add(new ModelBox(cube_r50, 107, 23, 0, -1, 0.75F, 1, 1, 1, 0.001F, false));
        cube_r50.cubeList.add(new ModelBox(cube_r50, 24, 107, 0, -1, 0, 1, 1, 1, 0.002F, false));

        cube_r51 = new ModelRenderer(this);
        cube_r51.setRotationPoint(0.5F, -30.7F, -19.1F);
        lowerreceiver.addChild(cube_r51);
        setRotationAngle(cube_r51, -0.7854F, 0, 0);
        cube_r51.cubeList.add(new ModelBox(cube_r51, 36, 107, -1, -1, 0, 1, 1, 1, -0.001F, false));

        cube_r52 = new ModelRenderer(this);
        cube_r52.setRotationPoint(-2.5F, -26.25F, -7.25F);
        lowerreceiver.addChild(cube_r52);
        setRotationAngle(cube_r52, 0.3142F, 0, 0);
        cube_r52.cubeList.add(new ModelBox(cube_r52, 66, 68, 0, -1, 0, 2, 1, 4, -0.001F, false));

        cube_r53 = new ModelRenderer(this);
        cube_r53.setRotationPoint(-2.5F, -27.25F, -11.25F);
        lowerreceiver.addChild(cube_r53);
        setRotationAngle(cube_r53, 0.5585F, 0, 0);
        cube_r53.cubeList.add(new ModelBox(cube_r53, 97, 27, 0, -2, -1, 2, 2, 1, -0.001F, false));

        cube_r54 = new ModelRenderer(this);
        cube_r54.setRotationPoint(-3.5F, -28.25F, -23.95F);
        lowerreceiver.addChild(cube_r54);
        setRotationAngle(cube_r54, 1.3439F, 0, 0);
        cube_r54.cubeList.add(new ModelBox(cube_r54, 72, 24, -0.1F, 0, -0.1F, 1, 10, 1, -0.101F, false));
        cube_r54.cubeList.add(new ModelBox(cube_r54, 74, 80, 3.1F, 0, -0.1F, 1, 10, 1, -0.101F, false));

        cube_r55 = new ModelRenderer(this);
        cube_r55.setRotationPoint(0.74F, -31.93F, -14.3F);
        lowerreceiver.addChild(cube_r55);
        setRotationAngle(cube_r55, 0, -1.4486F, 0);
        ...
        setRotationAngle(cube_r56, 0, 0, 0.7854F);
        cube_r56.cubeList.add(new ModelBox(cube_r56, 31, 97, -0.75F, 0, 0, 1, 1, 2, -0.002F, false));

        cube_r57 = new ModelRenderer(this);
        cube_r57.setRotationPoint(1.2F, -29.6F, -12.75F);
        lowerreceiver.addChild(cube_r57);
        setRotationAngle(cube_r57, 0, -1.2217F, 0);
        ...
        setRotationAngle(cube_r58, -0.4363F, 0, 0);
        cube_r58.cubeList.add(new ModelBox(cube_r58, 12, 35, -4, -1, 0, 4, 1, 1, -0.002F, false));

        cube_r59 = new ModelRenderer(this);
        cube_r59.setRotationPoint(0.25F, -32.05F, -26.15F);
        lowerreceiver.addChild(cube_r59);
        setRotationAngle(cube_r59, -0.4363F, 0, 0);
        cube_r59.cubeList.add(new ModelBox(cube_r59, 48, 55, -1, -3, 0, 1, 3, 2, -0.002F, false));
        cube_r59.cubeList.add(new ModelBox(cube_r59, 68, 61, -3.5F, -3, 0, 3, 3, 2, 0, false));

        cube_r60 = new ModelRenderer(this);
        cube_r60.setRotationPoint(-3.55F, -30.55F, -24.75F);
        lowerreceiver.addChild(cube_r60);
        setRotationAngle(cube_r60, 0.6807F, 0, 0);
        ...
        cube_r60.cubeList.add(new ModelBox(cube_r60, 85, 6, 0.6F, 0, 0, 3, 2, 1, -0.002F, false));

        cube_r61 = new ModelRenderer(this);
        cube_r61.setRotationPoint(-2.5F, -33.45F, -26.65F);
        lowerreceiver.addChild(cube_r61);
        setRotationAngle(cube_r61, 1.0472F, 0, 0);
        cube_r61.cubeList.add(new ModelBox(cube_r61, 31, 102, 0, -1, -1, 2, 1, 1, -0.001F, false));

        cube_r62 = new ModelRenderer(this);
        cube_r62.setRotationPoint(-2.5F, -33.45F, -30.05F);
        lowerreceiver.addChild(cube_r62);
        setRotationAngle(cube_r62, -1.0472F, 0, 0);
        cube_r62.cubeList.add(new ModelBox(cube_r62, 37, 102, 0, -1, 0, 2, 1, 1, -0.001F, false));

        cube_r63 = new ModelRenderer(this);
        cube_r63.setRotationPoint(-2.1F, -29.55F, -7.9F);
        lowerreceiver.addChild(cube_r63);
        setRotationAngle(cube_r63, -0.5411F, 0, 0);
        cube_r63.cubeList.add(new ModelBox(cube_r63, 27, 68, 0, 0, 0, 1, 2, 1, -0.001F, false));

        cube_r64 = new ModelRenderer(this);
        cube_r64.setRotationPoint(-2.1F, -30.65F, -8.6F);
        lowerreceiver.addChild(cube_r64);
        setRotationAngle(cube_r64, 0.2967F, 0, 0);
        cube_r64.cubeList.add(new ModelBox(cube_r64, 33, 68, 0, 0, 0, 1, 2, 1, 0, false));

        rail = new ModelRenderer(this);
        rail.setRotationPoint(-2.3F, -32.6F, -48);
        ...
        cube_r65.setRotationPoint(0, 0.6F, 0);
        rail.addChild(cube_r65);
        setRotationAngle(cube_r65, 0, 0, -0.9425F);
        ...
        cube_r66.setRotationPoint(1.6F, 0.6F, 0);
        rail.addChild(cube_r66);
        setRotationAngle(cube_r66, 0, 0, 0.9425F);
        ...
        grip2_r1.setRotationPoint(-3, -28.8F, -5.5F);
        grip.addChild(grip2_r1);
        setRotationAngle(grip2_r1, 0.4765F, 0, 0);
        grip2_r1.cubeList.add(new ModelBox(grip2_r1, 58, 24, 0, -2.5F, 0, 3, 13, 4, 0.002F, false));

        grip7_r1 = new ModelRenderer(this);
        grip7_r1.setRotationPoint(0, -30.4F, 0.2F);
        grip.addChild(grip7_r1);
        setRotationAngle(grip7_r1, 0.3316F, 0, 0);
        grip7_r1.cubeList.add(new ModelBox(grip7_r1, 12, 81, -3, -2, 0, 3, 2, 2, -0.002F, false));

        grip6_r1 = new ModelRenderer(this);
        grip6_r1.setRotationPoint(0, -27.8F, -2.7F);
        grip.addChild(grip6_r1);
        setRotationAngle(grip6_r1, -0.3665F, 0, 0);
        grip6_r1.cubeList.add(new ModelBox(grip6_r1, 13, 0, -3, -5, -1, 3, 5, 3, 0, false));

        grip7_r2 = new ModelRenderer(this);
        grip7_r2.setRotationPoint(-3, -29, -1);
        grip.addChild(grip7_r2);
        setRotationAngle(grip7_r2, -0.9909F, 0, 0);
        grip7_r2.cubeList.add(new ModelBox(grip7_r2, 31, 39, -0.001F, -1, 0, 3, 2, 8, 0, false));

        grip10_r1 = new ModelRenderer(this);
        grip10_r1.setRotationPoint(0, -18.4F, -1.729F);
        grip.addChild(grip10_r1);
        setRotationAngle(grip10_r1, -0.0213F, 0, 0);
        grip10_r1.cubeList.add(new ModelBox(grip10_r1, 25, 81, -3, -4, 0, 3, 4, 1, -0.002F, false));

        grip9_r1 = new ModelRenderer(this);
        grip9_r1.setRotationPoint(0, -23, 4.171F);
        grip.addChild(grip9_r1);
        setRotationAngle(grip9_r1, 0.2929F, 0, 0);
        grip9_r1.cubeList.add(new ModelBox(grip9_r1, 56, 80, -3, 0, -6, 3, 3, 6, 0, false));

        barrel = new ModelRenderer(this);
        barrel.setRotationPoint(-2, -11.25F, -73);
        barrel.cubeList.add(new ModelBox(barrel, 0, 162, 0, -1.05F, 5, 1, 1, 20, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 161, 106, 0, -0.65F, 5, 1, 1, 20, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 160, 155, 0.2F, -0.85F, 5, 1, 1, 20, 0.002F, false));
        barrel.cubeList.add(new ModelBox(barrel, 159, 134, -0.2F, -0.85F, 5, 1, 1, 20, 0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 86, 47, -0.45F, -1.35F, 0, 2, 2, 5, 0.002F, false));
        barrel.cubeList.add(new ModelBox(barrel, 72, 47, 0.05F, -1.55F, -1, 1, 1, 6, 0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 11, 66, 0.05F, -0.15F, -1, 1, 1, 6, 0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 41, 55, -0.65F, -0.9F, 0, 1, 1, 5, 0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 27, 55, 0.75F, -0.9F, 0, 1, 1, 5, 0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 64, 90, 0, -3.25F, 19, 1, 1, 6, 0.2F, false));
        barrel.cubeList.add(new ModelBox(barrel, 56, 89, -0.5F, -3.75F, 20.25F, 2, 2, 5, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 10, 76, -0.5F, -1.75F, 20.25F, 2, 1, 3, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 83, 64, 0, 0.9F, 20.55F, 1, 1, 3, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 68, 56, -0.5F, -1.25F, 22.25F, 2, 2, 3, 0, false));
