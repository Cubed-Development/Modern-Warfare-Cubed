...
//        this.bipedEars.addBox(-3, -6, -1, 6, 6, 1, p_i1149_1_);
        ...
        this.bipedRightArm.setRotationPoint(-1, 0 + p_i1149_2_, -2);
        this.bipedLeftArm = new ModelRenderer(this, 40, 16);
        this.bipedLeftArm.mirror = true;
        this.bipedLeftArm.addBox(-1, -2, -2, 0, 0, 0, p_i1149_1_);
        this.bipedLeftArm.setRotationPoint(0, 0 + p_i1149_2_, -2);
        this.bipedRightLeg = new ModelRenderer(this, 0, 16);
        this.bipedRightLeg.addBox(-2, 0, -2, 0, 0, 0, p_i1149_1_);
        this.bipedRightLeg.setRotationPoint(-2, 13 + p_i1149_2_, 0);
        this.bipedLeftLeg = new ModelRenderer(this, 0, 16);
        this.bipedLeftLeg.mirror = true;
        this.bipedLeftLeg.addBox(-2, 0, -2, 0, 0, 0, p_i1149_1_);
        this.bipedLeftLeg.setRotationPoint(2, 13 + p_i1149_2_, 0);
...
//        {
//            f6 = this.onGround;
//            this.bipedBody.rotateAngleY = MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2) * 0.2F;
