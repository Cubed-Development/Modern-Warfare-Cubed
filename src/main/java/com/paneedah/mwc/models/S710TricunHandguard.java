...
public class S710TricunHandguard extends ModelWithAttachments {
    ...
    public S710TricunHandguard() {
        ...
        handguard.cubeList.add(new ModelBox(handguard, 0, 72, -3.5F, -2.0F, -1, 2, 1, 2, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 44, 65, -3.9F, -1.2F, -1, 1, 2, 2, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 13, 62, -3.9F, -1.2F, -17.0F, 1, 2, 3, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 36, 65, -2.1F, -1.2F, -1, 1, 2, 2, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 56, 35, -2.1F, -1.2F, -17.0F, 1, 2, 3, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 77, 56, -3.0F, -1, -15.0F, 1, 1, 2, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 83, -3.0F, -1, -12.0F, 1, 1, 1, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 70, -3.0F, -1, -8.0F, 1, 1, 1, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 60, -3.0F, -1, -4.0F, 1, 1, 1, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 81, -3.0F, -1, -10.0F, 1, 1, 1, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 79, -3.0F, -1, -6.0F, 1, 1, 1, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 90, 64, -3.0F, -1, -2.0F, 1, 1, 1, 0.0F, false));
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 11, 88, 0.0F, 1, -18.0F, 1, 1, 1, 0.0F, false));
        ...
        cube_r2.cubeList.add(new ModelBox(cube_r2, 51, 15, -1, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 19, 61, -1, 0.0F, -4.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 62, 62, -1, 0.0F, -10.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 61, 25, -1, 0.0F, -8.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 63, 0, -1, 0.0F, -14.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 57, 52, -1, 0.0F, -2.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 61, 30, -1, 0.0F, -6.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 62, -1, 0.0F, -12.0F, 1, 2, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 88, 21, -1, 1, -18.0F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 25, 65, -1, 0.0F, -17.0F, 1, 2, 2, 0.0F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-2.05F, 2.8F, -16.2F);
        handguard.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.0F, 0.7854F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 52, 96, -0.95F, 1, 0.0F, 1, 1, 16, -0.2F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-0.2F, 2.8F, -16.2F);
        handguard.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.0F, 0.0F, 0.7854F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 18, 98, -0.943F, 1, 0.0F, 1, 1, 16, -0.2F, false));
        ...
        cube_r7.setRotationPoint(-1, 3.4F, -19.0F);
        ...
        cube_r10.setRotationPoint(-3.0F, -1, -2.0F);
        ...
        cube_r11.setRotationPoint(-2.0F, -1, -2.0F);
        handguard.addChild(cube_r11);
        setRotationAngle(cube_r11, 0.0F, 0.0F, -0.8727F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 11, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 17, -1, 0.0F, -4.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 33, -1, 0.0F, -8.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 9, -1, 0.0F, -2.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 13, -1, 0.0F, -6.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 90, 35, -1, 0.0F, -10.0F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 77, 51, -1, 0.0F, -13.0F, 1, 1, 2, 0.0F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 117, 38, -1, 0.0F, 0.0F, 1, 1, 14, 0.0F, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 70, 96, -1.3F, 0.0F, 1, 1, 1, 13, 0.0F, false));

        cube_r17 = new ModelRenderer(this);
        cube_r17.setRotationPoint(-1.1F, -0.85F, -15.0F);
        handguard.addChild(cube_r17);
        setRotationAngle(cube_r17, 0.0F, 0.0F, 1.0036F);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 118, 17, 0.7F, 0.0F, 1, 1, 1, 13, 0.0F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 88, 75, -1.4F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        cube_r19.cubeList.add(new ModelBox(cube_r19, 46, 74, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        cube_r21.cubeList.add(new ModelBox(cube_r21, 76, 8, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
