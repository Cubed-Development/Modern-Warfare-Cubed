...
public class AudiS4 extends ModelBase {
	...
	public AudiS4() {
		...
		cube_r6.cubeList.add(new ModelBox(cube_r6, 166, 259, -3.0F, -6.6478F, 1.9172F, 5, 5, 7, 0.0F, false));

		bone11 = new ModelRenderer(this);
		bone11.setRotationPoint(-166.0F, 0.0F, 0.0F);
		...
		bone95.cubeList.add(new ModelBox(bone95, 202, 285, 169.0F, 1.989F, 0.2091F, 10, 4, 16, 0.0F, false));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(8.0F, 3.989F, 8.2091F);
		bone95.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 0.0F, -0.3927F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 337, 0, 158.1356F, 62.6735F, -8.0F, 3, 4, 16, 0.0F, false));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(8.0F, 3.989F, 8.2091F);
		bone95.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, 0.0F, 0.3927F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 80, 314, 145.5924F, -64.3774F, -8.0F, 3, 4, 16, 0.0F, false));
		...
		bone101.cubeList.add(new ModelBox(bone101, 0, 270, 163.0F, 1.2476F, -3.9652F, 6, 5, 4, 0.0F, false));
		bone101.cubeList.add(new ModelBox(bone101, 325, 239, 163.0F, 6.178F, -3.4701F, 6, 4, 5, 0.0F, false));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 75, 75, 101.5756F, 32.3754F, -125.417F, 4, 10, 3, 0.0F, false));

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(-2.0273F, -0.3362F, -3.6812F);
		bone4.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.48F, 0.0F, 0.0F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 173, 103.6029F, -56.7213F, -115.5372F, 4, 7, 2, 0.0F, false));
		...
		bone12.setRotationPoint(2.0F, 10.0F, -1.5F);
		...
		cube_r13.cubeList.add(new ModelBox(cube_r13, 49, 73, 101.5756F, -44.3754F, 122.417F, 4, 10, 3, 0.0F, false));
		...
		bone13.setRotationPoint(-27.0F, -15.0F, 33.0F);
		seat_passenger.addChild(bone13);
		setRotationAngle(bone13, -0.1047F, 0.0F, 0.0F);
		bone13.cubeList.add(new ModelBox(bone13, 202, 285, 169.0F, 1.989F, 0.2091F, 10, 4, 16, 0.0F, false));

		cube_r15 = new ModelRenderer(this);
		cube_r15.setRotationPoint(8.0F, 3.989F, 8.2091F);
		bone13.addChild(cube_r15);
		setRotationAngle(cube_r15, 0.0F, 0.0F, -0.3927F);
		cube_r15.cubeList.add(new ModelBox(cube_r15, 337, 0, 158.1356F, 62.6735F, -8.0F, 3, 4, 16, 0.0F, false));

		cube_r16 = new ModelRenderer(this);
		cube_r16.setRotationPoint(8.0F, 3.989F, 8.2091F);
		bone13.addChild(cube_r16);
		setRotationAngle(cube_r16, 0.0F, 0.0F, 0.3927F);
		cube_r16.cubeList.add(new ModelBox(cube_r16, 80, 314, 145.5924F, -64.3774F, -8.0F, 3, 4, 16, 0.0F, false));
		...
		bone15.cubeList.add(new ModelBox(bone15, 0, 270, 163.0F, 1.2476F, -3.9652F, 6, 5, 4, 0.0F, false));
		bone15.cubeList.add(new ModelBox(bone15, 325, 239, 163.0F, 6.178F, -3.4701F, 6, 4, 5, 0.0F, false));

		bone16 = new ModelRenderer(this);
		bone16.setRotationPoint(-13.0F, -28.0F, 58.0F);
		...
		bone17.setRotationPoint(-2.0F, 10.0F, -1.5F);
		...
		cube_r18.cubeList.add(new ModelBox(cube_r18, 75, 75, 101.5756F, 32.3754F, -125.417F, 4, 10, 3, 0.0F, false));

		cube_r19 = new ModelRenderer(this);
		cube_r19.setRotationPoint(-2.0273F, -0.3362F, -3.6812F);
		bone17.addChild(cube_r19);
		setRotationAngle(cube_r19, 0.48F, 0.0F, 0.0F);
		cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 173, 103.6029F, -56.7213F, -115.5372F, 4, 7, 2, 0.0F, false));

		bone18 = new ModelRenderer(this);
		bone18.setRotationPoint(-25.0F, -28.0F, 58.0F);
		...
		bone19.setRotationPoint(2.0F, 10.0F, -1.5F);
		...
		cube_r21.cubeList.add(new ModelBox(cube_r21, 49, 73, 101.5756F, -44.3754F, 122.417F, 4, 10, 3, 0.0F, false));
		...
		bone108.cubeList.add(new ModelBox(bone108, 126, 345, 135.0F, 1.989F, 0.2091F, 46, 4, 16, 0.0F, false));
		...
		bone119.cubeList.add(new ModelBox(bone119, 366, 90, 160.0F, 0.342F, -3.9397F, 12, 21, 3, 0.0F, false));
		...
		bone120.cubeList.add(new ModelBox(bone120, 152, 217, 160.0F, 2.1392F, -3.9903F, 10, 6, 3, 0.0F, false));
		bone120.cubeList.add(new ModelBox(bone120, 202, 161, 130.0F, 2.1392F, -3.9903F, 10, 6, 3, 0.0F, false));
		bone120.cubeList.add(new ModelBox(bone120, 243, 266, 145.0F, 3.2783F, -4.9805F, 10, 5, 3, 0.0F, false));
		...
		bone121.cubeList.add(new ModelBox(bone121, 211, 73, 98.8209F, -0.407F, -133.3254F, 4, 16, 3, 0.0F, false));
		...
		bone124.cubeList.add(new ModelBox(bone124, 366, 66, 160.0F, 0.0F, -3.0F, 12, 21, 3, 0.0F, false));
		bone124.cubeList.add(new ModelBox(bone124, 0, 201, 174.0F, 0.342F, -3.9397F, 16, 21, 3, 0.0F, false));
		...
		bone126.cubeList.add(new ModelBox(bone126, 202, 254, 100.8235F, -0.6713F, -134.2844F, 4, 18, 3, 0.0F, false));
		...
		bone127.cubeList.add(new ModelBox(bone127, 101, 73, 103.5756F, 0.6633F, 126.7215F, 4, 16, 3, 0.0F, false));
		...
		cube_r23.setRotationPoint(-60.0F, -13.5F, 49.0F);
		body_audi.addChild(cube_r23);
		setRotationAngle(cube_r23, 0.0F, 0.0F, 0.0436F);
		cube_r23.cubeList.add(new ModelBox(cube_r23, 282, 282, -4.0F, 7.5F, -37.0F, 8, 2, 68, 0.0F, false));

		cube_r24 = new ModelRenderer(this);
		cube_r24.setRotationPoint(-61.5F, -28.0F, 46.0F);
		body_audi.addChild(cube_r24);
		setRotationAngle(cube_r24, 0.0436F, 0.0F, 0.0873F);
		cube_r24.cubeList.add(new ModelBox(cube_r24, 0, 73, -0.5F, -2.0F, -34.0F, 5, 9, 91, 0.0F, false));

		cube_r25 = new ModelRenderer(this);
		cube_r25.setRotationPoint(-0.5F, -28.0F, 46.0F);
		body_audi.addChild(cube_r25);
		setRotationAngle(cube_r25, 0.0436F, 0.0F, -0.0873F);
		cube_r25.cubeList.add(new ModelBox(cube_r25, 101, 101, -4.5F, -2.0F, -34.0F, 5, 9, 91, 0.0F, false));
		...
		cube_r26.cubeList.add(new ModelBox(cube_r26, 49, 73, -5.0F, 0.5F, -3.5F, 5, 4, 16, 0.0F, false));
		...
		cube_r27.cubeList.add(new ModelBox(cube_r27, 46, 143, 0.0F, 0.5F, -3.5F, 5, 4, 16, 0.0F, false));
		...
		cube_r28.cubeList.add(new ModelBox(cube_r28, 150, 101, -5.0F, 0.5F, -3.5F, 5, 4, 16, 0.0F, false));
		...
		cube_r29.cubeList.add(new ModelBox(cube_r29, 152, 201, -5.0F, -2.5F, -13.5F, 6, 5, 27, 0.0F, false));
		...
		cube_r31.cubeList.add(new ModelBox(cube_r31, 0, 37, -1.5F, -2.0F, -10.5F, 10, 10, 21, 0.0F, false));

		cube_r32 = new ModelRenderer(this);
		cube_r32.setRotationPoint(-60.5F, -15.0F, 113.5F);
		body_audi.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.0873F, 0.1745F, 0.0F);
		cube_r32.cubeList.add(new ModelBox(cube_r32, 0, 0, -1.5F, -8.0F, -10.5F, 10, 16, 21, 0.0F, false));
		...
		cube_r33.cubeList.add(new ModelBox(cube_r33, 186, 0, 0.0F, 0.5F, -3.5F, 5, 4, 16, 0.0F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 202, 254, -8.5F, -2.0F, -10.5F, 10, 10, 21, 0.0F, false));

		cube_r37 = new ModelRenderer(this);
		cube_r37.setRotationPoint(-1.5F, -15.0F, 113.5F);
		body_audi.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0873F, -0.1745F, 0.0F);
		cube_r37.cubeList.add(new ModelBox(cube_r37, 0, 114, -8.5F, -8.0F, -10.5F, 10, 16, 21, 0.0F, false));

		cube_r38 = new ModelRenderer(this);
		cube_r38.setRotationPoint(-61.25F, -13.0F, -21.5F);
		body_audi.addChild(cube_r38);
		setRotationAngle(cube_r38, -0.0436F, 0.0F, 0.0F);
		cube_r38.cubeList.add(new ModelBox(cube_r38, 264, 352, -3.5F, -10.0F, 0.5F, 5, 18, 10, 0.0F, false));
		cube_r38.cubeList.add(new ModelBox(cube_r38, 318, 352, 57.75F, -10.0F, 0.5F, 5, 18, 10, 0.0F, false));

		cube_r39 = new ModelRenderer(this);
		cube_r39.setRotationPoint(-2.0F, -13.5F, 49.0F);
		body_audi.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.0F, 0.0F, -0.0873F);
		cube_r39.cubeList.add(new ModelBox(cube_r39, 282, 73, -4.0F, 7.5F, -37.0F, 8, 2, 68, 0.0F, false));

		cube_r40 = new ModelRenderer(this);
		cube_r40.setRotationPoint(-60.8799F, -11.4535F, 46.0F);
		body_audi.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.0F, 0.0F, -0.0436F);
		cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 266, -3.0F, -5.5F, -34.0F, 6, 11, 68, 0.0F, false));

		cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(-2.25F, -8.5F, 49.0F);
		body_audi.addChild(cube_r41);
		setRotationAngle(cube_r41, 0.0F, 0.0F, 0.0436F);
		cube_r41.cubeList.add(new ModelBox(cube_r41, 202, 266, -2.0F, -8.5F, -37.0F, 6, 11, 68, 0.0F, false));

		cube_r42 = new ModelRenderer(this);
		cube_r42.setRotationPoint(-60.0F, -18.5F, 49.0F);
		body_audi.addChild(cube_r42);
		setRotationAngle(cube_r42, 0.0F, 0.0F, 0.1745F);
		cube_r42.cubeList.add(new ModelBox(cube_r42, 202, 61, -4.0F, -9.5F, -37.0F, 6, 12, 68, 0.0F, false));

		cube_r43 = new ModelRenderer(this);
		cube_r43.setRotationPoint(-64.4803F, -30.0858F, 22.5F);
		body_audi.addChild(cube_r43);
		setRotationAngle(cube_r43, 0.0F, 0.1745F, 0.1745F);
		cube_r43.cubeList.add(new ModelBox(cube_r43, 246, 312, -3.5F, -2.0F, -2.5F, 7, 4, 5, 0.0F, false));

		cube_r44 = new ModelRenderer(this);
		cube_r44.setRotationPoint(2.4803F, -30.0858F, 22.5F);
		body_audi.addChild(cube_r44);
		setRotationAngle(cube_r44, 0.0F, -0.1745F, -0.1745F);
		cube_r44.cubeList.add(new ModelBox(cube_r44, 323, 293, -3.5F, -2.0F, -2.5F, 7, 4, 5, 0.0F, false));

		cube_r45 = new ModelRenderer(this);
		cube_r45.setRotationPoint(-2.0F, -18.5F, 49.0F);
		body_audi.addChild(cube_r45);
		setRotationAngle(cube_r45, 0.0F, 0.0F, -0.1745F);
		...
		cube_r47.setRotationPoint(-12.0F, -24.6107F, -27.0475F);
		body_audi.addChild(cube_r47);
		setRotationAngle(cube_r47, 0.2618F, -0.3054F, 0.0F);
		cube_r47.cubeList.add(new ModelBox(cube_r47, 134, 285, -8.0F, -1.5F, -2.0F, 18, 3, 9, 0.0F, false));

		cube_r48 = new ModelRenderer(this);
		cube_r48.setRotationPoint(-33.5F, -25.75F, -19.5F);
		body_audi.addChild(cube_r48);
		setRotationAngle(cube_r48, 0.2618F, 0.0F, 0.0F);
		cube_r48.cubeList.add(new ModelBox(cube_r48, 101, 142, -10.5F, -3.0F, -12.0F, 25, 3, 9, 0.0F, false));

		cube_r49 = new ModelRenderer(this);
		cube_r49.setRotationPoint(-33.5F, -26.0F, -18.0F);
		body_audi.addChild(cube_r49);
		setRotationAngle(cube_r49, 0.2618F, 0.0F, 0.0F);
		cube_r49.cubeList.add(new ModelBox(cube_r49, 202, 177, -27.5F, -3.0F, -5.0F, 59, 3, 8, 0.0F, false));
		...
		cube_r50.cubeList.add(new ModelBox(cube_r50, 0, 73, -3.5F, -4.5F, -19.0F, 7, 6, 35, 0.0F, false));
		...
		cube_r51.cubeList.add(new ModelBox(cube_r51, 101, 101, -3.5F, -4.5F, -19.0F, 7, 6, 35, 0.0F, false));

		cube_r52 = new ModelRenderer(this);
		cube_r52.setRotationPoint(-33.5F, -27.0F, -7.0F);
		body_audi.addChild(cube_r52);
		setRotationAngle(cube_r52, 0.0436F, 0.0F, 0.0F);
		...
		cube_r54.setRotationPoint(5.0F, 0.0F, 0.0F);
		bone128.addChild(cube_r54);
		setRotationAngle(cube_r54, 0.0F, -0.1745F, 0.0F);
		cube_r54.cubeList.add(new ModelBox(cube_r54, 325, 195, -9.0F, -5.0F, -3.0F, 17, 10, 6, 0.0F, false));

		cube_r55 = new ModelRenderer(this);
		cube_r55.setRotationPoint(42.9581F, 0.0F, 0.0F);
		bone128.addChild(cube_r55);
		setRotationAngle(cube_r55, 0.0F, 0.1745F, 0.0F);
		cube_r55.cubeList.add(new ModelBox(cube_r55, 0, 317, -8.0F, -5.0F, -3.0F, 17, 10, 6, 0.0F, false));
		...
		cube_r58.cubeList.add(new ModelBox(cube_r58, 101, 129, -2.5F, -0.5F, -3.0F, 5, 1, 6, 0.0F, false));

		cube_r59 = new ModelRenderer(this);
		cube_r59.setRotationPoint(0.4698F, 4.5F, 6.829F);
		bone131.addChild(cube_r59);
		setRotationAngle(cube_r59, 0.0F, 0.3491F, 0.0F);
		cube_r59.cubeList.add(new ModelBox(cube_r59, 191, 201, -8.5F, -17.5F, -3.0F, 18, 17, 6, 0.0F, false));
		...
		cube_r60.cubeList.add(new ModelBox(cube_r60, 345, 211, 0.5F, -5.5F, -3.0F, 8, 6, 6, 0.0F, false));

		cube_r61 = new ModelRenderer(this);
		cube_r61.setRotationPoint(0.4698F, -1.5F, 4.829F);
		bone131.addChild(cube_r61);
		setRotationAngle(cube_r61, -0.0873F, 0.3491F, 0.0F);
		cube_r61.cubeList.add(new ModelBox(cube_r61, 348, 143, -8.5F, -5.5F, -3.0F, 18, 6, 6, 0.0F, false));

		cube_r62 = new ModelRenderer(this);
		cube_r62.setRotationPoint(0.4698F, 4.5F, 4.829F);
		bone131.addChild(cube_r62);
		setRotationAngle(cube_r62, 0.0F, 0.3491F, 0.0F);
		cube_r62.cubeList.add(new ModelBox(cube_r62, 202, 312, -8.5F, -0.5F, -3.0F, 16, 1, 6, 0.0F, false));
		...
		setRotationAngle(cube_r65, 0.0F, -0.3491F, 0.0F);
		cube_r65.cubeList.add(new ModelBox(cube_r65, 0, 287, -9.5F, -17.5F, -3.0F, 18, 17, 6, 0.0F, false));

		cube_r66 = new ModelRenderer(this);
		cube_r66.setRotationPoint(42.4883F, -1.5F, 4.829F);
		bone131.addChild(cube_r66);
		setRotationAngle(cube_r66, -0.0873F, -0.3491F, 0.0F);
		cube_r66.cubeList.add(new ModelBox(cube_r66, 243, 254, -9.5F, -5.5F, -3.0F, 18, 6, 6, 0.0F, false));
		...
		cube_r67.cubeList.add(new ModelBox(cube_r67, 60, 378, -8.5F, -5.5F, -3.0F, 8, 6, 6, 0.0F, false));

		cube_r68 = new ModelRenderer(this);
		cube_r68.setRotationPoint(42.4883F, 4.5F, 4.829F);
		bone131.addChild(cube_r68);
		setRotationAngle(cube_r68, 0.0F, -0.3491F, 0.0F);
		cube_r68.cubeList.add(new ModelBox(cube_r68, 45, 189, -7.5F, -0.5F, -3.0F, 16, 1, 6, 0.0F, false));
		...
		setRotationAngle(cube_r72, -0.1309F, 0.0F, 0.3927F);
		cube_r72.cubeList.add(new ModelBox(cube_r72, 73, 93, -2.0F, -4.5F, -3.0F, 3, 4, 6, 0.0F, false));

		cube_r73 = new ModelRenderer(this);
		cube_r73.setRotationPoint(-23.0F, 0.0F, 0.0F);
		bone132.addChild(cube_r73);
		setRotationAngle(cube_r73, -0.1309F, 0.0F, -0.1309F);
		...
		setRotationAngle(cube_r75, 0.0F, -0.1745F, 0.0F);
		cube_r75.cubeList.add(new ModelBox(cube_r75, 190, 233, -4.076F, -4.0F, -3.8682F, 17, 11, 6, 0.0F, false));

		cube_r76 = new ModelRenderer(this);
		cube_r76.setRotationPoint(42.9581F, 0.0F, 0.0F);
		bone129.addChild(cube_r76);
		setRotationAngle(cube_r76, 0.0F, 0.1745F, 0.0F);
		cube_r76.cubeList.add(new ModelBox(cube_r76, 282, 310, -8.0F, -4.0F, -3.0F, 17, 11, 6, 0.0F, false));
		...
		setRotationAngle(cube_r77, 0.0F, -0.1745F, 0.0F);
		cube_r77.cubeList.add(new ModelBox(cube_r77, 238, 285, -3.9332F, 1.0757F, -2.971F, 9, 7, 6, 0.0F, false));
		cube_r77.cubeList.add(new ModelBox(cube_r77, 41, 266, 5.0668F, 1.0757F, -2.971F, 7, 6, 6, 0.0F, false));
		cube_r77.cubeList.add(new ModelBox(cube_r77, 152, 365, -3.076F, -2.0F, -3.8682F, 16, 7, 6, 0.0F, false));

		cube_r78 = new ModelRenderer(this);
		cube_r78.setRotationPoint(21.4721F, -1.3333F, -0.5833F);
		bone130.addChild(cube_r78);
		setRotationAngle(cube_r78, 0.0F, 0.1745F, 0.0F);
		cube_r78.cubeList.add(new ModelBox(cube_r78, 243, 89, -7.1428F, 1.0757F, -2.1028F, 7, 6, 6, 0.0F, false));
		cube_r78.cubeList.add(new ModelBox(cube_r78, 317, 66, -0.1428F, 1.0757F, -2.1028F, 9, 7, 6, 0.0F, false));
		cube_r78.cubeList.add(new ModelBox(cube_r78, 196, 365, -8.0F, -2.0F, -3.0F, 16, 7, 6, 0.0F, false));

		cube_r79 = new ModelRenderer(this);
		cube_r79.setRotationPoint(0.014F, -2.5063F, -8.7268F);
		bone130.addChild(cube_r79);
		setRotationAngle(cube_r79, -0.1309F, 0.0F, 0.0F);
		cube_r79.cubeList.add(new ModelBox(cube_r79, 101, 73, -20.5F, -4.0F, -10.0F, 45, 8, 20, 0.0F, false));
		...
		setRotationAngle(cube_r80, 0.2182F, 0.0F, 0.5236F);
		cube_r80.cubeList.add(new ModelBox(cube_r80, 0, 114, -3.0F, -12.5F, -2.5F, 4, 16, 5, 0.0F, false));

		cube_r81 = new ModelRenderer(this);
		cube_r81.setRotationPoint(-0.25F, 0.0F, -29.0F);
		bone.addChild(cube_r81);
		setRotationAngle(cube_r81, -0.1745F, 0.0F, 0.5236F);
		cube_r81.cubeList.add(new ModelBox(cube_r81, 282, 61, -3.0F, -12.5F, -2.5F, 4, 17, 5, 0.0F, false));

		cube_r82 = new ModelRenderer(this);
		cube_r82.setRotationPoint(54.5F, 0.0F, 0.0F);
		bone.addChild(cube_r82);
		setRotationAngle(cube_r82, 0.2182F, 0.0F, -0.5236F);
		cube_r82.cubeList.add(new ModelBox(cube_r82, 72, 132, -3.0F, -13.5F, -2.5F, 4, 17, 5, 0.0F, false));

		cube_r83 = new ModelRenderer(this);
		cube_r83.setRotationPoint(54.5F, 0.0F, -29.0F);
		bone.addChild(cube_r83);
		setRotationAngle(cube_r83, -0.1745F, 0.0F, -0.5236F);
		cube_r83.cubeList.add(new ModelBox(cube_r83, 282, 279, -3.0F, -13.5F, -2.5F, 4, 17, 5, 0.0F, false));
	}
