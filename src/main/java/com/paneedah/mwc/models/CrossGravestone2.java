...
public class CrossGravestone2 extends ModelBase {
    ...
    public CrossGravestone2() {
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 0, -1, -3.0F, 0.0F, 13, 3, 7, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 0, 10, 0.0F, -14.0F, 1, 11, 11, 5, 0.0F, false));
        ...
        bone2.setRotationPoint(5.5F, -17.0F, 1);
        bone.addChild(bone2);
        setRotationAngle(bone2, 0.0F, 0.0F, -1.9373F);
        bone2.cubeList.add(new ModelBox(bone2, 12, 32, -1, -7.0F, 0.0F, 1, 7, 5, 0.0F, false));

        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(5.5F, -17.0F, 1);
        bone.addChild(bone3);
