...
public class G3Stock extends ModelWithAttachments {
    ...
    public G3Stock() {
        ...
        stock.cubeList.add(new ModelBox(stock, 102, 58, -0.2F, -0.9F, -1, 1, 1, 3, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 13, 89, -0.7F, -0.9F, -1, 1, 1, 3, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 101, 41, 0.75F, 0.2F, -1, 1, 1, 3, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 62, 91, 1.35F, 2.8F, -1, 1, 1, 3, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 89, 25, 1.351F, 3.2F, -1, 1, 1, 3, 0.0F, false));
        ...
        stock.cubeList.add(new ModelBox(stock, 89, 41, -2.25F, 2.8F, -1, 1, 1, 3, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 88, 70, -2.251F, 2.8F, -1.5F, 1, 1, 1, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 89, 37, -2.251F, 3.2F, -1, 1, 1, 3, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 0, 89, -2.252F, 3.2F, -1.5F, 1, 1, 1, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 85, 93, 0.55F, 0.95F, -1, 1, 1, 3, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 13, 93, -1.45F, 0.95F, -1, 1, 1, 3, 0.0F, false));
        stock.cubeList.add(new ModelBox(stock, 101, 37, -1.65F, 0.2F, -1, 1, 1, 3, 0.0F, false));
        ...
        gun11_r3.cubeList.add(new ModelBox(gun11_r3, 62, 99, 0.0F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        gun10_r1.cubeList.add(new ModelBox(gun10_r1, 100, 25, -1, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        gun12_r5.cubeList.add(new ModelBox(gun12_r5, 85, 110, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun11_r4.cubeList.add(new ModelBox(gun11_r4, 63, 110, -1, -1.45F, -0.15F, 1, 1, 2, 0.0F, false));
        gun11_r4.cubeList.add(new ModelBox(gun11_r4, 95, 110, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun10_r2.cubeList.add(new ModelBox(gun10_r2, 85, 97, 0.0F, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        gun9_r11.cubeList.add(new ModelBox(gun9_r11, 98, 74, -1, -1, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        gun12_r6.cubeList.add(new ModelBox(gun12_r6, 89, 46, -0.001F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun13_r3.cubeList.add(new ModelBox(gun13_r3, 24, 89, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun12_r7.cubeList.add(new ModelBox(gun12_r7, 30, 89, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun11_r5.cubeList.add(new ModelBox(gun11_r5, 89, 58, -0.999F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        gun11_r5.cubeList.add(new ModelBox(gun11_r5, 44, 81, -1, -2.0F, 0.5F, 1, 2, 3, 0.0F, false));
        ...
        gun13_r4.cubeList.add(new ModelBox(gun13_r4, 24, 94, 0.0F, -1, 0.5F, 2, 1, 3, 0.0F, false));
        ...
        gun12_r8.cubeList.add(new ModelBox(gun12_r8, 72, 98, -2.0F, -1, 0.5F, 2, 1, 3, 0.0F, false));
        ...
        gun12_r10.cubeList.add(new ModelBox(gun12_r10, 58, 8, -1, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
        ...
        gun14_r5.cubeList.add(new ModelBox(gun14_r5, 76, 111, 0.001F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun13_r6.cubeList.add(new ModelBox(gun13_r6, 112, 0, -0.999F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun12_r11.cubeList.add(new ModelBox(gun12_r11, 112, 3, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun11_r6.cubeList.add(new ModelBox(gun11_r6, 58, 25, -1, -2.0F, 0.0F, 1, 2, 2, 0.0F, false));
        ...
        gun14_r6.cubeList.add(new ModelBox(gun14_r6, 58, 37, -1, -1, 0.0F, 1, 2, 2, -0.2F, false));
        gun14_r6.cubeList.add(new ModelBox(gun14_r6, 8, 65, 2.6F, -1, 0.0F, 1, 2, 2, -0.2F, false));
        ...
        gun13_r8.cubeList.add(new ModelBox(gun13_r8, 58, 44, -1, -1, 0.0F, 1, 2, 2, -0.2F, false));
        gun13_r8.cubeList.add(new ModelBox(gun13_r8, 65, 56, 2.6F, -1, 0.0F, 1, 2, 2, -0.2F, false));
        ...
        gun11_r7.cubeList.add(new ModelBox(gun11_r7, 0, 0, 0.0F, -1, 0.0F, 1, 3, 1, -0.2F, false));
        ...
        gun10_r4.cubeList.add(new ModelBox(gun10_r4, 12, 0, -1, -1, 0.0F, 1, 3, 1, -0.2F, false));
        ...
        gun9_r12.cubeList.add(new ModelBox(gun9_r12, 55, 56, -1, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
        ...
        gun10_r5.cubeList.add(new ModelBox(gun10_r5, 106, 110, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun9_r13.cubeList.add(new ModelBox(gun9_r13, 80, 81, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun11_r8.cubeList.add(new ModelBox(gun11_r8, 28, 9, -1, -3.0F, 0.0F, 1, 3, 2, 0.0F, false));
        ...
        gun11_r9.cubeList.add(new ModelBox(gun11_r9, 36, 202, 0.0F, 0.0F, -1, 1, 1, 20, 0.0F, false));
        ...
        gun10_r6.cubeList.add(new ModelBox(gun10_r6, 202, 57, -1, 0.0F, -1, 1, 1, 20, 0.0F, false));
        ...
        gun12_r14.cubeList.add(new ModelBox(gun12_r14, 28, 72, 0.0F, 1, 0.0F, 1, 10, 2, 0.0F, false));
        gun12_r14.cubeList.add(new ModelBox(gun12_r14, 28, 124, 2.6F, 1, 0.0F, 1, 10, 2, 0.0F, false));
        ...
        gun11_r10.cubeList.add(new ModelBox(gun11_r10, 54, 84, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun11_r12.setRotationPoint(-0.7F, 1, 5.0F);
        ...
        gun10_r8.setRotationPoint(0.8F, 1, 5.0F);
        stock.addChild(gun10_r8);
        setRotationAngle(gun10_r8, -0.3229F, -0.384F, -0.8378F);
        gun10_r8.cubeList.add(new ModelBox(gun10_r8, 24, 89, -1, 0.0F, 0.0F, 1, 1, 4, 0.0F, false));

        gun10_r9 = new ModelRenderer(this);
        gun10_r9.setRotationPoint(1.8F, 1, 5.0F);
        ...
        gun12_r16.cubeList.add(new ModelBox(gun12_r16, 58, 88, 0.001F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun13_r9.cubeList.add(new ModelBox(gun13_r9, 48, 88, -1, -1.65F, 0.0F, 1, 1, 1, 0.0F, false));
        gun13_r9.cubeList.add(new ModelBox(gun13_r9, 54, 88, -0.999F, -2.0F, -0.3F, 1, 1, 1, 0.0F, false));
        gun13_r9.cubeList.add(new ModelBox(gun13_r9, 62, 88, -0.999F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun11_r13.cubeList.add(new ModelBox(gun11_r13, 26, 86, 0.0F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun12_r17.cubeList.add(new ModelBox(gun12_r17, 18, 86, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun12_r18.cubeList.add(new ModelBox(gun12_r18, 49, 109, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun11_r14.cubeList.add(new ModelBox(gun11_r14, 22, 86, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun14_r8.cubeList.add(new ModelBox(gun14_r8, 108, 100, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        gun12_r19.cubeList.add(new ModelBox(gun12_r19, 86, 0, 0.0F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun11_r15.cubeList.add(new ModelBox(gun11_r15, 86, 2, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun10_r11.cubeList.add(new ModelBox(gun10_r11, 66, 88, -1, 0.0F, -1, 1, 1, 1, 0.0F, false));
        ...
        gun10_r12.cubeList.add(new ModelBox(gun10_r12, 59, 109, 0.0F, 0.0F, 1, 1, 1, 2, 0.0F, false));
        ...
        gun10_r13.cubeList.add(new ModelBox(gun10_r13, 40, 110, -1, 0.0F, 1, 1, 1, 2, 0.0F, false));
