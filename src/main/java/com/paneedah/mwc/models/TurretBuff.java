...
public class TurretBuff extends ModelBiped {
    ...
    public TurretBuff() {
        ...
        cube_r23.cubeList.add(new ModelBox(cube_r23, 6, 6, -1, 0.0F, 0.0F, 1, 2, 1, -0.001F, false));
        ...
        cube_r26.cubeList.add(new ModelBox(cube_r26, 31, 13, -1, 0.0F, 0.0F, 1, 1, 6, 0.001F, false));
        ...
        cube_r30.setRotationPoint(2.0F, 0.0F, 1);
        magazine.addChild(cube_r30);
        setRotationAngle(cube_r30, 0.0F, 0.4538F, 0.0F);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 22, 33, -1, 0.0F, -2.0F, 1, 1, 2, 0.005F, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(-0.4F, 0.0F, 4.05F);
        magazine.addChild(cube_r31);
        setRotationAngle(cube_r31, 0.0F, 0.6807F, 0.0F);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 29, 6, 0.0F, 0.0F, -1, 2, 1, 1, 0.0F, false));
        ...
        cube_r33.setRotationPoint(2.0F, 0.0F, 1);
        magazine.addChild(cube_r33);
        setRotationAngle(cube_r33, 0.0F, -0.4538F, 0.0F);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 21, 40, -1, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
    }
