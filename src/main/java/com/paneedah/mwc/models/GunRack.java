...
public class GunRack extends ModelBase {
    ...
    public GunRack() {
        ...
        bone.cubeList.add(new ModelBox(bone, 83, 40, -1, -39.0F, -15.0F, 7, 2, 7, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 83, 71, -1, -39.0F, -7.0F, 7, 2, 7, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 83, 83, -2.0F, -35.0F, -11, 10, 4, 12, 0.0F, false));
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 88, 0.0F, -11, -9.0F, 7, 4, 9, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 28, 168, -2.0F, -24.0F, 21, 6, 20, 1, 0.0F, false));
        ...
        bone.cubeList.add(new ModelBox(bone, 32, 52, -2.0F, -41, 21, 6, 4, 1, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 32, 57, -2.0F, -41, 18.0F, 6, 4, 1, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 32, 72, -2.0F, -41, 12.0F, 6, 4, 1, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 83, 0, -2.0F, -41, 9.25F, 6, 4, 1, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 123, 41, -2.0F, -37.0F, -17.0F, 11, 1, 18, 0.0F, false));
        bone.cubeList.add(new ModelBox(bone, 123, 22, -2.0F, -31, -17.0F, 11, 1, 18, 0.0F, false));
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 0, -2.0F, -48.0F, 1, 10, 44, 2, 0.0F, false));
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 0, -5.0F, -51, -20.0F, 17, 3, 49, 0.0F, false));
