...
public class M110Receiver extends ModelWithAttachments {
    ...
    public M110Receiver() {
        ...
        gun.cubeList.add(new ModelBox(gun, 84, 77, -3.0F, -33.35F, -1, 3, 1, 4, 0.0F, false));
        ...
        receiver17_r1.cubeList.add(new ModelBox(receiver17_r1, 32, 86, -1, 0.0F, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver18_r1.cubeList.add(new ModelBox(receiver18_r1, 0, 86, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver17_r3.cubeList.add(new ModelBox(receiver17_r3, 24, 86, -1, -1, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver16_r2.cubeList.add(new ModelBox(receiver16_r2, 0, 89, -1, 0.0F, 0.002F, 1, 1, 2, 0.0F, false));
        ...
        receiver15_r1.cubeList.add(new ModelBox(receiver15_r1, 59, 86, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver14_r1.cubeList.add(new ModelBox(receiver14_r1, 32, 89, 0.0F, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver15_r2.cubeList.add(new ModelBox(receiver15_r2, 46, 0, -1, 0.0F, -0.999F, 1, 2, 4, 0.0F, false));
        ...
        receiver14_r3.cubeList.add(new ModelBox(receiver14_r3, 34, 58, -1, -2.0F, 0.0F, 1, 2, 2, 0.0F, false));
        ...
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 92, 4, 0.2F, -2.0F, -1, 3, 2, 1, 0.0F, false));
        ...
        gun29_r1.cubeList.add(new ModelBox(gun29_r1, 59, 77, 0.2F, -1, -2.0F, 3, 1, 2, 0.0F, false));
        ...
        gun39_r1.cubeList.add(new ModelBox(gun39_r1, 112, 46, -1.05F, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        gun38_r1.cubeList.add(new ModelBox(gun38_r1, 112, 78, -1.05F, -1, 0.0F, 1, 1, 1, -0.1F, false));
        ...
        gun37_r1.cubeList.add(new ModelBox(gun37_r1, 97, 53, 0.0F, -1, 0.0F, 3, 1, 1, 0.0F, false));
        ...
        gun40_r1.cubeList.add(new ModelBox(gun40_r1, 75, 111, -1, -0.5F, -0.5F, 1, 1, 1, 0.0F, false));
        ...
        gun59_r2.cubeList.add(new ModelBox(gun59_r2, 32, 112, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun59_r3.cubeList.add(new ModelBox(gun59_r3, 13, 103, -0.701F, -1, 0.0F, 2, 1, 1, 0.0F, false));
        ...
        gun87_r1.cubeList.add(new ModelBox(gun87_r1, 95, 111, -1, -2.6F, 2.3F, 1, 1, 1, 0.0F, false));
        ...
        gun88_r1.cubeList.add(new ModelBox(gun88_r1, 28, 112, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        gun156_r1.cubeList.add(new ModelBox(gun156_r1, 40, 93, -1, -1, 0.0F, 1, 1, 2, 0.0F, false));
        ...
        receiver.cubeList.add(new ModelBox(receiver, 32, 93, -2.0F, -40.3F, -1, 1, 1, 2, 0.0F, false));
        ...
        receiver13_r1.cubeList.add(new ModelBox(receiver13_r1, 70, 51, -1, 0.0F, 0.001F, 1, 1, 3, 0.0F, false));
        ...
        receiver12_r1.cubeList.add(new ModelBox(receiver12_r1, 59, 0, -1, 0.0F, -1.999F, 1, 1, 26, 0.0F, false));
        ...
        receiver11_r1.cubeList.add(new ModelBox(receiver11_r1, 0, 0, -1, -2.0F, -2.0F, 1, 2, 26, 0.0F, false));
        ...
        gun170.cubeList.add(new ModelBox(gun170, 92, 8, -1.2F, -0.201F, -1, 3, 2, 1, 0.0F, false));
        ...
        gun172_r1.cubeList.add(new ModelBox(gun172_r1, 92, 0, 0.0F, 0.05F, -1, 3, 2, 1, 0.0F, false));
        ...
        gun172_r2.cubeList.add(new ModelBox(gun172_r2, 65, 44, 1, 0.05F, -2.0F, 1, 2, 1, 0.0F, false));
        ...
        receiver15_r6.cubeList.add(new ModelBox(receiver15_r6, 85, 51, -1, -0.001F, -1.999F, 1, 1, 3, 0.0F, false));
        receiver15_r6.cubeList.add(new ModelBox(receiver15_r6, 84, 68, -1, 0.0F, 4.001F, 1, 1, 3, 0.0F, false));
        ...
        receiver15_r7.cubeList.add(new ModelBox(receiver15_r7, 87, 4, -0.001F, -1, -0.001F, 1, 1, 3, 0.0F, false));
        receiver15_r7.cubeList.add(new ModelBox(receiver15_r7, 87, 14, -0.001F, -1, -6.001F, 1, 1, 3, 0.0F, false));
        ...
        receiver16_r7.cubeList.add(new ModelBox(receiver16_r7, 84, 64, -0.001F, -1, -0.001F, 1, 1, 3, 0.0F, false));

        grip = new ModelRenderer(this);
        grip.setRotationPoint(0.0F, 24.0F, 0.0F);
        grip.cubeList.add(new ModelBox(grip, 71, 71, -3.0F, -31, -1, 3, 5, 1, 0.0F, false));
        grip.cubeList.add(new ModelBox(grip, 88, 39, -3.499F, -31, -6.0F, 4, 5, 5, 0.0F, false));
        ...
        grip3_r2.cubeList.add(new ModelBox(grip3_r2, 118, 159, 0.499F, -1, 0.0F, 3, 1, 12, 0.0F, false));
        ...
        grip13_r1.cubeList.add(new ModelBox(grip13_r1, 28, 58, 3.2F, 0.5F, 1, 1, 9, 4, 0.0F, false));
        grip13_r1.cubeList.add(new ModelBox(grip13_r1, 43, 58, 0.0F, 0.5F, 1, 1, 9, 4, 0.0F, false));
        ...
        handguard.cubeList.add(new ModelBox(handguard, 0, 22, -2.0F, 4.2F, 31, 2, 1, 3, 0.0F, false));
        handguard.cubeList.add(new ModelBox(handguard, 160, 0, -1.5F, 4.4F, -2.999F, 1, 1, 34, 0.0F, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(0.0F, 5.9F, 31);
        handguard.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.5934F, 0.0F, 0.0F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 42, 79, -2.001F, -1, 0.0F, 2, 1, 2, 0.0F, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-0.05F, 5.0F, 33.0F);
        handguard.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, 1.1868F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 59, 107, -1, -1, -0.002F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 14, 35, -1.001F, -1, -3.502F, 1, 1, 4, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 67, 107, -1.001F, -1, -7.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 75, 107, -1.001F, -1, -11.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 83, 107, -1.001F, -1, -15.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 91, 107, -1.001F, -1, -19.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 99, 107, -1.001F, -1, -23.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 107, 103, -1.001F, -1, -27.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 108, 60, -1.001F, -1, -31.502F, 1, 1, 1, 0.0F, false));
        ...
        cube_r2.cubeList.add(new ModelBox(cube_r2, 108, 95, -1, -1, -35.502F, 1, 1, 1, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 40, 158, -0.999F, -0.3F, -36.002F, 1, 1, 37, 0.0F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 109, 45, -0.998F, -1, -36.003F, 1, 1, 1, 0.0F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-1.95F, 5.0F, 33.0F);
        handguard.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.0F, -1.1868F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 50, 109, 0.0F, -1, -0.002F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 59, 18, 0.001F, -1, -3.502F, 1, 1, 4, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 63, 109, 0.001F, -1, -7.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 109, 65, 0.001F, -1, -11.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 109, 67, 0.001F, -1, -15.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 71, 109, 0.001F, -1, -19.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 109, 77, 0.001F, -1, -23.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 109, 79, 0.001F, -1, -27.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 83, 109, 0.001F, -1, -31.502F, 1, 1, 1, 0.0F, false));
        ...
        cube_r3.cubeList.add(new ModelBox(cube_r3, 87, 109, 0.0F, -1, -35.502F, 1, 1, 1, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 79, 159, -0.001F, -0.3F, -36.004F, 1, 1, 37, 0.0F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 99, 109, -0.002F, -1, -36.003F, 1, 1, 1, 0.0F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-1.95F, 1, 33.0F);
        ...
        cube_r5.setRotationPoint(-0.05F, 1, 33.0F);
        handguard.addChild(cube_r5);
        setRotationAngle(cube_r5, 0.0F, 0.0F, -1.1868F);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 28, 110, -1, 0.0F, -0.002F, 1, 1, 1, 0.0F, false));
        ...
        cube_r5.cubeList.add(new ModelBox(cube_r5, 71, 111, -1, 0.0F, -35.502F, 1, 1, 1, 0.0F, false));
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 158, -0.999F, -0.7F, -37.002F, 1, 1, 38, 0.0F, false));
        cube_r5.cubeList.add(new ModelBox(cube_r5, 19, 71, -1, 0.0F, -39.002F, 1, 1, 2, 0.0F, false));
        ...
        cube_r7.cubeList.add(new ModelBox(cube_r7, 59, 59, -1, 0.0F, -0.002F, 1, 2, 10, 0.0F, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(1.25F, 3.7F, 33.0F);
        handguard.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.0F, 0.0F, -1.1868F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 63, 107, -1, -0.999F, -0.001F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 59, 13, -1, -1, -3.501F, 1, 1, 4, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 71, 107, -1, -1, -7.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 79, 107, -1, -1, -11.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 87, 107, -1, -1, -15.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 95, 107, -1, -1, -19.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 103, 107, -1, -1, -23.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 53, 108, -1, -1, -27.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 108, 93, -1, -1, -31.501F, 1, 1, 1, 0.0F, false));
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 106, 108, -1, -1, -35.501F, 1, 1, 1, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 160, 41, -0.3F, -0.999F, -37.001F, 1, 1, 34, 0.0F, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 109, 24, -1, -1.001F, -36.001F, 1, 1, 1, 0.0F, false));
        ...
        cube_r9.cubeList.add(new ModelBox(cube_r9, 59, 27, 0.0F, -1, -3.501F, 1, 1, 4, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 59, 109, 0.0F, -1, -7.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 109, 63, 0.0F, -1, -11.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 67, 109, 0.0F, -1, -15.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 109, 69, 0.0F, -1, -19.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 75, 109, 0.0F, -1, -23.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 79, 109, 0.0F, -1, -27.501F, 1, 1, 1, 0.0F, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 109, 81, 0.0F, -1, -31.501F, 1, 1, 1, 0.0F, false));
        ...
        cube_r9.cubeList.add(new ModelBox(cube_r9, 91, 109, 0.0F, -1, -35.501F, 1, 1, 1, 0.0F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 32, 110, -1, -0.001F, -0.001F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 59, 59, -1, 0.0F, -3.501F, 1, 1, 4, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 40, 110, -1, 0.0F, -7.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 53, 110, -1, 0.0F, -11.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 110, 102, -1, 0.0F, -15.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 111, 22, -1, 0.0F, -19.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 111, 55, -1, 0.0F, -23.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 111, 59, -1, 0.0F, -27.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 111, 61, -1, 0.0F, -31.501F, 1, 1, 1, 0.0F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 67, 111, -1, 0.0F, -35.501F, 1, 1, 1, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 168, 111, -0.3F, -0.001F, -37.001F, 1, 1, 34, 0.0F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 42, 72, -1, 0.0F, -39.001F, 1, 1, 2, 0.0F, false));
        ...
        bone3.cubeList.add(new ModelBox(bone3, 107, 19, -1, 0.0F, -8.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 107, 10, -1, 0.0F, -6.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 106, 70, -1, 0.0F, -4.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 106, 64, -1, 0.0F, -10.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 106, 46, -1, 0.0F, -12.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 8, 106, -1, 0.0F, -14.901F, 1, 1, 1, 0.0F, false));
        bone3.cubeList.add(new ModelBox(bone3, 105, 94, -1, 0.0F, -16.801F, 1, 1, 1, 0.0F, false));
        ...
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 11, 105, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 100, 104, -1, 0.0F, -4.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 92, 104, -1, 0.0F, -8.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 104, 104, -1, 0.0F, -2.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 96, 104, -1, 0.0F, -6.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 88, 104, -1, 0.0F, -10.0F, 1, 1, 1, 0.0F, false));
        handguard118_r1.cubeList.add(new ModelBox(handguard118_r1, 84, 104, -1, 0.0F, -11.9F, 1, 1, 1, 0.0F, false));
        ...
        handguard119_r1.cubeList.add(new ModelBox(handguard119_r1, 104, 54, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard118_r2.cubeList.add(new ModelBox(handguard118_r2, 64, 104, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 24, 105, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 32, 105, -1, -1, -4.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 36, 105, -1, -1, -8.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 15, 105, -1, -1, -2.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 28, 105, -1, -1, -6.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 40, 105, -1, -1, -10.0F, 1, 1, 1, 0.0F, false));
        handguard117_r1.cubeList.add(new ModelBox(handguard117_r1, 105, 48, -1, -1, -11.9F, 1, 1, 1, 0.0F, false));
        ...
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 0, 106, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 18, 106, -1, -1, 1.9F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 53, 106, -1, -1, 3.9F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 106, 62, -1, -1, 5.9F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 106, 106, -1, -1, 11.9F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 107, 8, -1, -1, 9.9F, 1, 1, 1, 0.0F, false));
        handguard112_r1.cubeList.add(new ModelBox(handguard112_r1, 107, 21, -1, -1, 7.9F, 1, 1, 1, 0.0F, false));

        handguard113_r1 = new ModelRenderer(this);
        handguard113_r1.setRotationPoint(0.0F, 1, -16.8F);
        bone3.addChild(handguard113_r1);
        setRotationAngle(handguard113_r1, 0.0F, 0.0F, 0.2967F);
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 50, 105, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 4, 106, -1, 0.0F, 1.9F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 106, 44, -1, 0.0F, 3.9F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 106, 66, -1, 0.0F, 5.9F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 106, 68, -1, 0.0F, 11.9F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 107, 15, -1, 0.0F, 9.9F, 1, 1, 1, 0.0F, false));
        handguard113_r1.cubeList.add(new ModelBox(handguard113_r1, 107, 17, -1, 0.0F, 7.9F, 1, 1, 1, 0.0F, false));
        ...
        handguard108_r1.cubeList.add(new ModelBox(handguard108_r1, 50, 107, -1, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard109_r1.cubeList.add(new ModelBox(handguard109_r1, 107, 55, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard109_r2.cubeList.add(new ModelBox(handguard109_r2, 44, 134, -1, 0.0F, -1.999F, 1, 1, 16, 0.0F, false));
        ...
        handguard108_r2.cubeList.add(new ModelBox(handguard108_r2, 84, 134, -1, 0.0F, -2.0F, 1, 1, 16, 0.0F, false));
        ...
        handguard107_r1.cubeList.add(new ModelBox(handguard107_r1, 152, 41, -1, -1, -2.0F, 1, 1, 16, 0.0F, false));
        ...
        handguard108_r3.cubeList.add(new ModelBox(handguard108_r3, 0, 158, -1, -1, -1.999F, 1, 1, 16, 0.0F, false));
        ...
        handguard119_r3.cubeList.add(new ModelBox(handguard119_r3, 80, 15, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 80, 17, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 81, 0, 0.0F, -1, -4.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 81, 4, 0.0F, -1, -8.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 81, 9, 0.0F, -1, -2.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 84, 77, 0.0F, -1, -6.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 18, 86, 0.0F, -1, -10.0F, 1, 1, 1, 0.0F, false));
        handguard118_r3.cubeList.add(new ModelBox(handguard118_r3, 88, 39, 0.0F, -1, -11.9F, 1, 1, 1, 0.0F, false));
        ...
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 40, 88, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 88, 41, 0.0F, -1, 1.9F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 92, 14, 0.0F, -1, 3.9F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 92, 62, 0.0F, -1, 5.9F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 0, 104, 0.0F, -1, 11.9F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 4, 104, 0.0F, -1, 9.9F, 1, 1, 1, 0.0F, false));
        handguard113_r2.cubeList.add(new ModelBox(handguard113_r2, 104, 32, 0.0F, -1, 7.9F, 1, 1, 1, 0.0F, false));

        handguard114_r1 = new ModelRenderer(this);
        handguard114_r1.setRotationPoint(0.0F, 1, -16.8F);
        ...
        handguard109_r3.cubeList.add(new ModelBox(handguard109_r3, 104, 34, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard108_r4.cubeList.add(new ModelBox(handguard108_r4, 126, 117, 0.0F, -1, -2.0F, 1, 1, 16, 0.0F, false));
        ...
        handguard109_r5.cubeList.add(new ModelBox(handguard109_r5, 0, 133, 0.0F, -1, -1.999F, 1, 1, 16, 0.0F, false));
        ...
        handguard120_r3.cubeList.add(new ModelBox(handguard120_r3, 7, 50, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 14, 50, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 53, 55, 0.0F, -1, -4.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 59, 54, 0.0F, -1, -8.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 7, 61, 0.0F, -1, -2.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 21, 61, 0.0F, -1, -6.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 66, 0, 0.0F, -1, -10.0F, 1, 1, 1, 0.0F, false));
        handguard119_r4.cubeList.add(new ModelBox(handguard119_r4, 65, 66, 0.0F, -1, -11.9F, 1, 1, 1, 0.0F, false));
        ...
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 53, 67, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 53, 69, 0.0F, -1, 1.9F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 0, 71, 0.0F, -1, 3.9F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 6, 71, 0.0F, -1, 5.9F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 13, 73, 0.0F, -1, 11.9F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 75, 51, 0.0F, -1, 9.9F, 1, 1, 1, 0.0F, false));
        handguard114_r2.cubeList.add(new ModelBox(handguard114_r2, 77, 39, 0.0F, -1, 7.9F, 1, 1, 1, 0.0F, false));

        handguard115_r1 = new ModelRenderer(this);
        handguard115_r1.setRotationPoint(0.0F, 1, -16.8F);
        ...
        handguard110_r3.cubeList.add(new ModelBox(handguard110_r3, 77, 41, 0.0F, -1, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        handguard109_r6.cubeList.add(new ModelBox(handguard109_r6, 118, 0, 0.0F, -1, -2.0F, 1, 1, 16, 0.0F, false));
        ...
        handguard110_r5.cubeList.add(new ModelBox(handguard110_r5, 118, 17, 0.0F, -1, -1.999F, 1, 1, 16, 0.0F, false));

        m110_stock = new ModelRenderer(this);
        m110_stock.setRotationPoint(0.0F, 23.9F, 1);
        ...
        receiver16_r8.cubeList.add(new ModelBox(receiver16_r8, 196, 0, 0.0F, -1, 0.0F, 2, 1, 32, 0.0F, false));
        ...
        receiver19_r1.cubeList.add(new ModelBox(receiver19_r1, 59, 27, -3.001F, -1, 0.0F, 3, 1, 23, 0.0F, false));
        ...
        receiver18_r2.cubeList.add(new ModelBox(receiver18_r2, 87, 14, -3.0F, -1, 0.0F, 3, 1, 9, 0.0F, false));
        ...
        receiver23_r1.cubeList.add(new ModelBox(receiver23_r1, 102, 78, 0.0F, 1, -11, 1, 10, 5, 0.0F, false));
        ...
        receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 24, 86, -1, 4.0F, -30.0F, 1, 5, 14, 0.0F, false));
        receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 43, 28, -1, 2.0F, -16.0F, 1, 8, 5, 0.0F, false));
        receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 18, 116, -1, 1, -11, 1, 10, 5, 0.0F, false));
        receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 0, 86, -1, 0.0F, -6.0F, 1, 12, 6, 0.0F, false));
        ...
        receiver19_r2.cubeList.add(new ModelBox(receiver19_r2, 74, 117, 0.0F, 0.0F, -1, 2, 13, 1, 0.0F, false));
        ...
        receiver18_r3.cubeList.add(new ModelBox(receiver18_r3, 84, 117, -2.0F, 0.0F, -1, 2, 13, 1, 0.0F, false));
        ...
        receiver20_r2.cubeList.add(new ModelBox(receiver20_r2, 20, 35, -1, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
        ...
        receiver21_r2.cubeList.add(new ModelBox(receiver21_r2, 59, 71, -1, 0.0F, 0.0F, 1, 3, 3, 0.0F, false));
        ...
        receiver18_r4.cubeList.add(new ModelBox(receiver18_r4, 64, 197, -1, 0.0F, 0.0F, 1, 4, 31, 0.0F, false));
        ...
        receiver16_r9.cubeList.add(new ModelBox(receiver16_r9, 123, 195, -2.0F, -1, 0.0F, 2, 1, 32, 0.0F, false));
        ...
        receiver17_r4.cubeList.add(new ModelBox(receiver17_r4, 193, 212, -1, 0.0F, 0.002F, 1, 1, 32, 0.0F, false));
        ...
        magazine.cubeList.add(new ModelBox(magazine, 14, 86, -1, -6.0F, 0.0F, 1, 15, 2, 0.0F, false));
        ...
        magazine.cubeList.add(new ModelBox(magazine, 70, 117, -1, -6.0F, 2.75F, 1, 15, 1, 0.0F, false));
        magazine.cubeList.add(new ModelBox(magazine, 62, 117, -1, -5.9F, 4.5F, 1, 15, 1, 0.0F, false));
        magazine.cubeList.add(new ModelBox(magazine, 54, 116, -1, -6.0F, 6.5F, 1, 16, 1, 0.0F, false));
