...
public class Turret extends ModelBiped {
    ...
    public Turret() {
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 7, 0.0F, -1, -4.0F, 1, 1, 5, 0.001F, false));
        ...
        cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 22, -3.0F, -1, 0.0F, 3, 1, 1, 0.001F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(1, -4.0F, 4.95F);
        body.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.6604F, 0.3563F, -0.2557F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 11, 22, 0.0F, -1, 0.0F, 3, 1, 1, 0.001F, false));
        ...
        head.cubeList.add(new ModelBox(head, 0, 0, -1, -4.25F, -2.5F, 2, 2, 13, 0.0F, false));
        head.cubeList.add(new ModelBox(head, 22, 23, -1, -2.25F, 9.5F, 2, 1, 1, 0.0F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 44, 28, 0.0F, -1, 0.0F, 1, 1, 5, 0.001F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(0.8F, -2.45F, -7.0F);
        head.addChild(cube_r19);
        setRotationAngle(cube_r19, 0.0F, 0.0F, -0.9599F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 45, -1, -1, 0.0F, 1, 1, 5, 0.0F, false));
        ...
        cube_r21.cubeList.add(new ModelBox(cube_r21, 36, 30, -1, 0.0F, 0.0F, 1, 2, 6, -0.001F, false));
        ...
        cube_r24.cubeList.add(new ModelBox(cube_r24, 22, 26, -1, -1, 0.0F, 1, 1, 3, -0.001F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(-1.98F, -1.68F, 2.0F);
        head.addChild(cube_r25);
        setRotationAngle(cube_r25, 0.5317F, 0.166F, 0.0969F);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 31, 18, 0.0F, -1, 0.0F, 1, 1, 3, -0.001F, false));

        cube_r26 = new ModelRenderer(this);
        cube_r26.setRotationPoint(-0.85F, -4.8F, -6.0F);
        head.addChild(cube_r26);
        setRotationAngle(cube_r26, 0.0F, 0.0F, -0.4363F);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 0, 38, -1, 0.0F, 0.0F, 1, 1, 6, 0.001F, false));

        cube_r27 = new ModelRenderer(this);
        cube_r27.setRotationPoint(0.5F, 0.73F, 10.0F);
        head.addChild(cube_r27);
        setRotationAngle(cube_r27, -0.2618F, 0.0F, 0.0F);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 7, 0, -1, 0.0F, -6.0F, 1, 2, 2, -0.1F, false));
        cube_r27.cubeList.add(new ModelBox(cube_r27, 0, 0, -1, 0.0F, -5.0F, 1, 2, 5, 0.0F, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(0.5F, -1.25F, 10.25F);
        head.addChild(cube_r28);
        setRotationAngle(cube_r28, -0.1222F, 0.0F, 0.0F);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 7, 7, -1, 0.0F, -6.0F, 1, 2, 2, -0.099F, false));
        cube_r28.cubeList.add(new ModelBox(cube_r28, 17, 43, -1, 0.0F, -5.0F, 1, 2, 5, 0.001F, false));
        ...
        cube_r30.cubeList.add(new ModelBox(cube_r30, 22, 15, -1, 0.0F, -7.0F, 1, 1, 7, -0.002F, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(1, -1.25F, 9.5F);
        head.addChild(cube_r31);
        setRotationAngle(cube_r31, -0.6632F, 0.0F, 0.0F);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 25, 8, -2.0F, -1, -2.0F, 2, 1, 2, -0.001F, false));

        cube_r32 = new ModelRenderer(this);
        cube_r32.setRotationPoint(-1.1F, -3.85F, 9.6F);
        head.addChild(cube_r32);
        setRotationAngle(cube_r32, 0.5411F, 0.0F, 0.0F);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 0, 10, 0.0F, 0.0F, -1, 1, 1, 1, 0.0F, false));
        cube_r32.cubeList.add(new ModelBox(cube_r32, 23, 8, 1.2F, 0.0F, -1, 1, 1, 1, 0.0F, false));
