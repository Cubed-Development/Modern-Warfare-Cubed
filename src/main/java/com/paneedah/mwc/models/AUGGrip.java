...
public class AUGGrip extends ModelWithAttachments {
    ...
    public AUGGrip() {
        ...
        grip.cubeList.add(new ModelBox(grip, 5, 39, -0.499F, -7.3335F, -0.348F, 1, 1, 1, 0, false));
        grip.cubeList.add(new ModelBox(grip, 89, 40, -1.509F, -6.3335F, -1.148F, 3, 12, 3, 0, false));
        grip.cubeList.add(new ModelBox(grip, 88, 71, -1.499F, 4.6665F, -1.848F, 3, 1, 1, 0, false));

        grip8_r1 = new ModelRenderer(this);
        grip8_r1.setRotationPoint(1.501F, 19.1661F, -24.2081F);
        grip.addChild(grip8_r1);
        setRotationAngle(grip8_r1, -1.8589F, 0, 0);
        grip8_r1.cubeList.add(new ModelBox(grip8_r1, 72, 82, -3, -21.05F, -23.5F, 3, 1, 3, 0, false));

        grip7_r1 = new ModelRenderer(this);
        grip7_r1.setRotationPoint(1.501F, 27.3539F, -17.9603F);
        grip.addChild(grip7_r1);
        setRotationAngle(grip7_r1, -1.3756F, 0, 0);
        grip7_r1.cubeList.add(new ModelBox(grip7_r1, 72, 60, -3, -25, -24.3F, 3, 1, 4, 0, false));

        grip6_r1 = new ModelRenderer(this);
        grip6_r1.setRotationPoint(1.501F, 16.8667F, 30.5648F);
        grip.addChild(grip6_r1);
        setRotationAngle(grip6_r1, 0.2231F, 0, 0);
        grip6_r1.cubeList.add(new ModelBox(grip6_r1, 18, 74, -3, -23.1F, -28.15F, 3, 4, 1, 0, false));

        grip5_r1 = new ModelRenderer(this);
        grip5_r1.setRotationPoint(1.501F, 30.5256F, 17.3337F);
        grip.addChild(grip5_r1);
        setRotationAngle(grip5_r1, -0.2974F, 0, 0);
        grip5_r1.cubeList.add(new ModelBox(grip5_r1, 86, 0, -3, -26, -27.3F, 3, 3, 1, 0, false));

        grip4_r1 = new ModelRenderer(this);
        grip4_r1.setRotationPoint(1.501F, 29.9828F, 14.9523F);
        grip.addChild(grip4_r1);
        setRotationAngle(grip4_r1, -0.3346F, 0, 0);
        grip4_r1.cubeList.add(new ModelBox(grip4_r1, 30, 77, -3, -30, -24.3F, 3, 4, 1, 0, false));

        grip3_r1 = new ModelRenderer(this);
        grip3_r1.setRotationPoint(1.501F, 30.7983F, -17.4735F);
        grip.addChild(grip3_r1);
        setRotationAngle(grip3_r1, -1.1525F, 0, 0);
        grip3_r1.cubeList.add(new ModelBox(grip3_r1, 12, 97, -3, -30, -27.3F, 3, 1, 3, 0, false));

        grip10_r1 = new ModelRenderer(this);
        grip10_r1.setRotationPoint(1.501F, 2.198F, 31.8996F);
        grip.addChild(grip10_r1);
        setRotationAngle(grip10_r1, 0.6692F, 0, 0);
        grip10_r1.cubeList.add(new ModelBox(grip10_r1, 88, 69, -3, -19, -28, 3, 1, 1, 0, false));
    }
