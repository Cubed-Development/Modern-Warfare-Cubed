...
public class MPXHandguardRailed extends ModelWithAttachments {
    private final ModelRenderer mpx_handguard2;
    ...
    public MPXHandguardRailed() {
        ...
        mpx_handguard2.setRotationPoint(0, 24, 0);
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 49, 50, 1, -40, -46.5F, 1, 3, 21, 0, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 176, 173, -3, -36.25F, -46.5F, 3, 1, 21, 0, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 0, 50, -5, -40, -46.5F, 1, 3, 21, 0, false));
        ...
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 76, 45, -2.5F, -35, -46.7F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 84, 45, -2.5F, -35, -44.2F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 10, 89, -2.5F, -35, -41.7F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 70, 90, -2.5F, -35, -39.2F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 92, 45, -2.5F, -35, -36.7F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 54, 97, -2.5F, -35, -34.2F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 79, 97, -2.5F, -35, -31.7F, 2, 1, 2, -0.2F, false));
        mpx_handguard2.cubeList.add(new ModelBox(mpx_handguard2, 99, 82, -2.5F, -35, -29.2F, 2, 1, 2, -0.2F, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-0.7F, -34.2F, -29);
        mpx_handguard2.addChild(cube_r5);
        setRotationAngle(cube_r5, 0, 0, -0.576F);
        ...
        cube_r6.setRotationPoint(-2.3F, -34.2F, -29);
        mpx_handguard2.addChild(cube_r6);
        setRotationAngle(cube_r6, 0, 0, 0.576F);
        ...
        cube_r7.setRotationPoint(-6, -39.3F, -27.1F);
        mpx_handguard2.addChild(cube_r7);
        setRotationAngle(cube_r7, 0, 0, 0.576F);
        ...
        cube_r8.setRotationPoint(-6, -37.7F, -27.1F);
        mpx_handguard2.addChild(cube_r8);
        setRotationAngle(cube_r8, 0, 0, -0.576F);
        ...
        cube_r9.setRotationPoint(3, -37.7F, -27.1F);
        mpx_handguard2.addChild(cube_r9);
        setRotationAngle(cube_r9, 0, 0, 0.576F);
        ...
        cube_r10.setRotationPoint(3, -39.3F, -27.1F);
        mpx_handguard2.addChild(cube_r10);
        setRotationAngle(cube_r10, 0, 0, -0.576F);
        ...
        mpx_handguard_left_r39.setRotationPoint(2, -40, -46.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r39);
        setRotationAngle(mpx_handguard_left_r39, 0, 0, 0.925F);
        mpx_handguard_left_r39.cubeList.add(new ModelBox(mpx_handguard_left_r39, 117, 180, -2, 0, 0, 2, 1, 21, 0.001F, false));

        mpx_handguard_left_r40 = new ModelRenderer(this);
        mpx_handguard_left_r40.setRotationPoint(-3, -35.25F, -46.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r40);
        setRotationAngle(mpx_handguard_left_r40, 0, 0, 0.7156F);
        mpx_handguard_left_r40.cubeList.add(new ModelBox(mpx_handguard_left_r40, 98, 95, -2.6F, -1, 0, 1, 1, 21, -0.002F, false));
        mpx_handguard_left_r40.cubeList.add(new ModelBox(mpx_handguard_left_r40, 179, 94, -2, -1, 0, 2, 1, 21, -0.001F, false));

        mpx_handguard_left_r41 = new ModelRenderer(this);
        mpx_handguard_left_r41.setRotationPoint(0, -35.25F, -46.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r41);
        setRotationAngle(mpx_handguard_left_r41, 0, 0, -0.7156F);
        mpx_handguard_left_r41.cubeList.add(new ModelBox(mpx_handguard_left_r41, 99, 45, 1.6F, -1, 0, 1, 1, 21, -0.002F, false));
        mpx_handguard_left_r41.cubeList.add(new ModelBox(mpx_handguard_left_r41, 180, 0, 0, -1, 0, 2, 1, 21, -0.001F, false));

        mpx_handguard_left_r42 = new ModelRenderer(this);
        mpx_handguard_left_r42.setRotationPoint(2, -37, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r42);
        setRotationAngle(mpx_handguard_left_r42, -0.0249F, 0.6064F, 0.8305F);
        mpx_handguard_left_r42.cubeList.add(new ModelBox(mpx_handguard_left_r42, 17, 58, -1, 0, -1, 1, 2, 1, 0, false));

        mpx_handguard_left_r43 = new ModelRenderer(this);
        mpx_handguard_left_r43.setRotationPoint(-5, -37, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r43);
        setRotationAngle(mpx_handguard_left_r43, -0.0249F, -0.6064F, -0.8305F);
        mpx_handguard_left_r43.cubeList.add(new ModelBox(mpx_handguard_left_r43, 67, 23, 0, 0, -1, 1, 2, 1, 0, false));

        mpx_handguard_left_r44 = new ModelRenderer(this);
        mpx_handguard_left_r44.setRotationPoint(-5, -40, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r44);
        setRotationAngle(mpx_handguard_left_r44, 0, 0.7854F, 0.576F);
        mpx_handguard_left_r44.cubeList.add(new ModelBox(mpx_handguard_left_r44, 67, 32, 0, -2, 0, 1, 2, 1, 0, false));

        mpx_handguard_left_r45 = new ModelRenderer(this);
        mpx_handguard_left_r45.setRotationPoint(2, -40, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r45);
        setRotationAngle(mpx_handguard_left_r45, 0, -0.7854F, -0.576F);
        mpx_handguard_left_r45.cubeList.add(new ModelBox(mpx_handguard_left_r45, 67, 36, -1, -2, 0, 1, 2, 1, 0, false));

        mpx_handguard_left_r46 = new ModelRenderer(this);
        mpx_handguard_left_r46.setRotationPoint(-5, -37, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r46);
        setRotationAngle(mpx_handguard_left_r46, 0, 0.7854F, 0);
        mpx_handguard_left_r46.cubeList.add(new ModelBox(mpx_handguard_left_r46, 37, 0, 0, -3, 0, 1, 3, 1, 0, false));

        mpx_handguard_left_r47 = new ModelRenderer(this);
        mpx_handguard_left_r47.setRotationPoint(2, -37, -25.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r47);
        setRotationAngle(mpx_handguard_left_r47, 0, -0.7854F, 0);
        mpx_handguard_left_r47.cubeList.add(new ModelBox(mpx_handguard_left_r47, 43, 0, -1, -3, 0, 1, 3, 1, 0, false));

        mpx_handguard_left_r48 = new ModelRenderer(this);
        mpx_handguard_left_r48.setRotationPoint(-5, -40, -46.5F);
        mpx_handguard2.addChild(mpx_handguard_left_r48);
        setRotationAngle(mpx_handguard_left_r48, 0, 0, -0.925F);
        mpx_handguard_left_r48.cubeList.add(new ModelBox(mpx_handguard_left_r48, 0, 181, 0, 0, 0, 2, 1, 21, 0.001F, false));

        barrel2 = new ModelRenderer(this);
        barrel2.setRotationPoint(-1, -40, -51);
        mpx_handguard2.addChild(barrel2);
        barrel2.cubeList.add(new ModelBox(barrel2, 77, 85, -1, 0, 0, 1, 1, 5, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 48, 97, -1.5F, 0.5F, 5, 2, 2, 21, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 82, 15, -1, 2, 0, 1, 1, 5, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 65, 108, -2, 1, 4, 1, 1, 1, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 31, 108, -2, 1, 0, 1, 1, 1, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 107, 86, 0, 1, 0, 1, 1, 1, 0, false));
        barrel2.cubeList.add(new ModelBox(barrel2, 40, 107, 0, 1, 4, 1, 1, 1, 0, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-1, 0.3F, -0.8F);
        barrel2.addChild(cube_r11);
        setRotationAngle(cube_r11, 0, 0, 0.7854F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 225, 64, 0, 0, 1, 1, 1, 5, 0.204F, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-1, 1.3F, -0.8F);
        barrel2.addChild(cube_r12);
        setRotationAngle(cube_r12, 0, 0, 0.7854F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 239, 69, 0, 0, 1, 1, 1, 5, 0.203F, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(0, 1.3F, -0.8F);
        barrel2.addChild(cube_r13);
        setRotationAngle(cube_r13, 0, 0, 0.7854F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 225, 53, 0, 0, 1, 1, 1, 5, 0.202F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(0, 0.3F, -0.8F);
        barrel2.addChild(cube_r14);
        setRotationAngle(cube_r14, 0, 0, 0.7854F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 212, 50, 0, 0, 1, 1, 1, 5, 0.201F, false));
    }
