...
public class MAS21Mount extends ModelBase {
	...
	public MAS21Mount() {
		...
		cube_r32.cubeList.add(new ModelBox(cube_r32, 0, 0, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));

		cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(0.1F, 0.1F, 0.5F);
		sightmount.addChild(cube_r33);
		setRotationAngle(cube_r33, -0.3054F, 0.0F, 0.0F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 0, 0, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 0, 0, -1.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
		...
		cube_r39.cubeList.add(new ModelBox(cube_r39, 0, 0, -1.0F, -5.0F, 0.0F, 1, 5, 2, 0.0F, false));
		cube_r39.cubeList.add(new ModelBox(cube_r39, 0, 0, -0.5F, -5.0F, 0.0F, 3, 5, 2, 0.0F, false));

		cube_r40 = new ModelRenderer(this);
		cube_r40.setRotationPoint(-1.0F, 3.85F, 3.85F);
		...
		cube_r41.cubeList.add(new ModelBox(cube_r41, 0, 0, -1.0F, -2.0F, 0.0F, 1, 2, 2, 0.0F, false));
