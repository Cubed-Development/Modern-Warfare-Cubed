...
public class KedrAction extends ModelBase {
    ...
    public KedrAction() {
        ...
        action.cubeList.add(new ModelBox(action, 14, 74, -3.3F, -37.5F, -18, 3, 1, 6, 0, false));
        action.cubeList.add(new ModelBox(action, 51, 21, -3.9F, -36.9F, -18, 1, 2, 6, 0, false));

        action3_r1_r1 = new ModelRenderer(this);
        action3_r1_r1.setRotationPoint(-3.9853F, 0, -23.9728F);
        action.addChild(action3_r1_r1);
        setRotationAngle(action3_r1_r1, -3.1416F, -0.6878F, 3.1416F);
        action3_r1_r1.cubeList.add(new ModelBox(action3_r1_r1, 36, 40, 2.3F, -35.5F, -12.7F, 3, 1, 1, 0, false));

        action4_r1_r1 = new ModelRenderer(this);
        action4_r1_r1.setRotationPoint(3.7876F, 0, -0.0545F);
        action.addChild(action4_r1_r1);
        setRotationAngle(action4_r1_r1, 0, 0.2793F, 0);
        action4_r1_r1.cubeList.add(new ModelBox(action4_r1_r1, 10, 0, 0.7F, -35.5F, -14.5F, 1, 1, 1, 0, false));

        action2_r1_r1 = new ModelRenderer(this);
        action2_r1_r1.setRotationPoint(-10.8336F, 0, -17.9804F);
        action.addChild(action2_r1_r1);
        setRotationAngle(action2_r1_r1, -3.1416F, -1.4314F, 3.1416F);
        action2_r1_r1.cubeList.add(new ModelBox(action2_r1_r1, 64, 70, 2.4F, -35.501F, -13.7F, 1, 1, 2, 0, false));

        gun53_r1_r1 = new ModelRenderer(this);
        gun53_r1_r1.setRotationPoint(-27.6538F, -8.638F, 0);
        action.addChild(gun53_r1_r1);
        setRotationAngle(gun53_r1_r1, 0, 0, 0.7854F);
