...
public class Floodlight extends ModelBase {
    ...
    public Floodlight() {
        ...
        bone4.cubeList.add(new ModelBox(bone4, 0, 40, -3.0F, -1, 7.0F, 6, 1, 1, 0.0F, false));
        bone4.cubeList.add(new ModelBox(bone4, 22, 0, -1, -2.75F, -0.5F, 2, 2, 9, 0.0F, false));
        ...
        bone4.cubeList.add(new ModelBox(bone4, 36, 34, -3.0F, -1, 0.0F, 6, 1, 1, 0.0F, false));
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 0, -1, -4.0F, -4.5F, 2, 5, 9, 0.0F, false));
