...
public class ScarL extends ModelWithAttachments {
    ...
    public ScarL() {
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 0, -2.999F, -31, -7.5F, 3, 5, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 117, 63, 0.15F, -36, -15.55F, 1, 2, 1, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 159, 128, 0.2F, -34.5F, -15.551F, 1, 1, 1, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 159, 126, -0.1F, -35.5F, -15.8F, 1, 1, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 93, 152, 0.4F, -35.2F, -18.4F, 1, 1, 1, 0, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 122, 151, 0.2F, -32, -16.7F, 1, 1, 1, -0.201F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 97, 132, 0.1F, -33.7F, -6.3F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 89, 150, 0, -33.7F, -7.7F, 1, 1, 1, -0.301F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 89, 132, -4.1F, -33.7F, -6.3F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 150, 83, -4, -33.7F, -7.7F, 1, 1, 1, -0.301F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 117, 85, -0.25F, -32.7F, -20, 1, 1, 4, -0.16F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 133, 115, 0.2F, -31.8F, -16.7F, 1, 1, 2, -0.2F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 159, 122, -0.1F, -35.5F, -15.3F, 1, 1, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 130, 44, -3.5F, -35.8F, -26.2F, 4, 2, 3, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 0, -3.5F, -36, -23.2F, 4, 8, 8, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 16, -3.5F, -28, -20.2F, 4, 1, 5, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 159, 71, -3.5F, -35.5F, -16, 4, 5, 14, -0.001F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 150, 73, -3.8F, -33.6F, -14, 1, 1, 1, -0.099F, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 73, 150, -3.8F, -33.2F, -14, 1, 1, 1, -0.097F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 26, 37, -3.001F, -32, -15.8F, 3, 5, 1, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 0, 64, -3.001F, -26.75F, -14.3F, 3, 1, 7, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 53, 0, -3.5F, -36, -23.6F, 4, 8, 1, 0.001F, false));
        ...
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 108, 15, -3, -33.6F, -2, 3, 2, 4, 0, false));
        lowerreceiver.cubeList.add(new ModelBox(lowerreceiver, 108, 0, -3.5F, -36, -2.001F, 4, 3, 4, 0, false));
        ...
        gun58_r1.cubeList.add(new ModelBox(gun58_r1, 82, 49, -3.999F, 0, 0, 4, 1, 1, -0.002F, false));
        ...
        gun31_r1.cubeList.add(new ModelBox(gun31_r1, 32, 101, 0.2F, -2, 0, 3, 2, 1, 0, false));
        ...
        gun30_r1.cubeList.add(new ModelBox(gun30_r1, 40, 101, 0.2F, -2, -1, 3, 2, 1, 0, false));
        ...
        gun29_r1.cubeList.add(new ModelBox(gun29_r1, 11, 60, 0.2F, -1, -2, 3, 1, 2, 0, false));
        ...
        gun28_r1.cubeList.add(new ModelBox(gun28_r1, 53, 101, 0.2F, 0, 0, 3, 2, 1, 0, false));
        ...
        gun40_r2.cubeList.add(new ModelBox(gun40_r2, 150, 79, -0.05F, -0.9F, -0.1F, 1, 1, 1, 0, false));
        ...
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 53, 11, 0.1F, 0.0806F, 0.0981F, 4, 8, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 10, 84, 0.101F, -0.7194F, 0.098F, 4, 1, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 59, 35, 3.7F, 0.08F, 0.098F, 1, 8, 1, 0, false));
        gun51_r1.cubeList.add(new ModelBox(gun51_r1, 159, 116, 3.699F, -0.72F, 0.1F, 1, 1, 1, 0, false));
        ...
        gun53_r1.cubeList.add(new ModelBox(gun53_r1, 134, 151, 0.065F, 7, 0.085F, 1, 1, 1, -0.001F, false));
        gun53_r1.cubeList.add(new ModelBox(gun53_r1, 4, 54, 0.065F, -0.4F, 0.085F, 1, 8, 1, 0, false));
        ...
        gun52_r1.cubeList.add(new ModelBox(gun52_r1, 138, 151, -1.065F, 7, 0.085F, 1, 1, 1, -0.001F, false));
        gun52_r1.cubeList.add(new ModelBox(gun52_r1, 47, 54, -1.065F, -0.4F, 0.085F, 1, 8, 1, 0, false));
        ...
        gun58_r2.cubeList.add(new ModelBox(gun58_r2, 63, 48, 0, -0.123F, 0.1577F, 4, 2, 1, -0.004F, false));
        ...
        gun63_r1.cubeList.add(new ModelBox(gun63_r1, 99, 20, 0, -2, 0, 1, 4, 1, 0, false));
        ...
        gun130_r2.cubeList.add(new ModelBox(gun130_r2, 152, 88, -1, -1, 0, 1, 1, 1, -0.002F, false));
        ...
        gun129_r1.cubeList.add(new ModelBox(gun129_r1, 89, 152, -1, -1, 0, 1, 1, 1, -0.001F, false));
        ...
        gun131_r3.cubeList.add(new ModelBox(gun131_r3, 130, 151, -1, -1, 0, 1, 1, 1, 0, false));
        ...
        gun132_r1.cubeList.add(new ModelBox(gun132_r1, 44, 111, 0, -2, 0, 1, 2, 2, -0.2F, false));
        gun132_r1.cubeList.add(new ModelBox(gun132_r1, 14, 114, 3.8F, -2, 0, 1, 2, 2, -0.2F, false));
        ...
        gun134_r1.cubeList.add(new ModelBox(gun134_r1, 150, 63, 0, -2, 0, 1, 1, 1, -0.1F, false));
        gun134_r1.cubeList.add(new ModelBox(gun134_r1, 85, 150, 3.2F, -2, 0, 1, 1, 1, -0.1F, false));
        ...
        gun133_r1.cubeList.add(new ModelBox(gun133_r1, 150, 61, 0, -2, 0, 1, 1, 1, -0.2F, false));
        gun133_r1.cubeList.add(new ModelBox(gun133_r1, 150, 85, 3.4F, -2, 0, 1, 1, 1, -0.2F, false));
        ...
        gun60.cubeList.add(new ModelBox(gun60, 159, 120, 0, 1.6122F, -3.1466F, 1, 1, 1, 0, false));
        gun60.cubeList.add(new ModelBox(gun60, 159, 118, -3.2F, 1.6122F, -3.1466F, 1, 1, 1, 0, false));
        ...
        gun.addChild(barrel);
        barrel.cubeList.add(new ModelBox(barrel, 129, 89, -1.8F, -37.8F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 89, 129, -2.2F, -37.8F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 73, 129, -2.2F, -38.2F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 129, 67, -1.8F, -38.2F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 53, 129, -1.6F, -38, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 36, 128, -2.4F, -38, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 0, 128, -2, -37.6F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 106, 122, -2, -38.4F, -80.5F, 1, 1, 6, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 122, 99, -2, -38.55F, -59.5F, 1, 1, 6, 0.1F, false));
        barrel.cubeList.add(new ModelBox(barrel, 92, 24, -2, -39.65F, -58.4F, 1, 1, 5, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 131, 0, -2, -39.65F, -59.6F, 1, 1, 2, -0.001F, false));
        barrel.cubeList.add(new ModelBox(barrel, 92, 0, -2, -40.85F, -57.5F, 1, 1, 5, 0.3F, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 53, 87, -2, -42.35F, -56.8F, 1, 1, 3, 0.2F, false));
        barrel.cubeList.add(new ModelBox(barrel, 97, 107, -2, -44.35F, -56.1F, 1, 2, 2, 0, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 90, 119, -2, -37.55F, -59.5F, 1, 1, 6, 0.1F, false));
        ...
        barrel.cubeList.add(new ModelBox(barrel, 161, 0, -2.2F, -38, -75.499F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 148, 160, -1.8F, -38, -75.501F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 159, 108, -2, -37.8F, -75.5F, 1, 1, 47, 0, false));
        barrel.cubeList.add(new ModelBox(barrel, 159, 52, -2, -38.2F, -75.5F, 1, 1, 47, 0, false));
        ...
        gun710_r1.cubeList.add(new ModelBox(gun710_r1, 117, 63, -0.1F, -1, 0, 1, 1, 4, -0.2F, false));
        ...
        gun709_r1.cubeList.add(new ModelBox(gun709_r1, 117, 77, -0.9F, -1, 0, 1, 1, 4, -0.2F, false));
        ...
        gun708_r1.cubeList.add(new ModelBox(gun708_r1, 126, 130, -0.9F, -1, 0, 1, 1, 2, -0.002F, false));
        ...
        gun707_r1.cubeList.add(new ModelBox(gun707_r1, 0, 131, -0.1F, -1, 0, 1, 1, 2, -0.001F, false));
        ...
        gun706_r1.cubeList.add(new ModelBox(gun706_r1, 6, 140, -0.1F, -1, 0, 2, 1, 1, 0, false));
    }
