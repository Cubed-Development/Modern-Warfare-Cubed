...
public class G36C extends ModelWithAttachments {
    ...
    public G36C() {
        ...
        body.cubeList.add(new ModelBox(body, 130, 0, -1.1705F, 3, -1.7294F, 1, 4, 11, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 69, 129, -1.4707F, -6, 10.2706F, 1, 1, 17, 0, false));
        body.cubeList.add(new ModelBox(body, 116, 110, -1.1707F, 2.45F, -3.7294F, 1, 2, 13, 0, false));
        body.cubeList.add(new ModelBox(body, 70, 92, -0.9207F, 1.9F, 9.5206F, 1, 2, 2, 0, false));
        ...
        body.cubeList.add(new ModelBox(body, 64, 30, -0.6721F, 2.2348F, 29.2706F, 1, 2, 1, 0, false));
        body.cubeList.add(new ModelBox(body, 60, 100, -2.9222F, 2.2348F, 24.2706F, 3, 2, 3, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 110, 85, -2.9221F, 2.2348F, 23.5706F, 3, 2, 1, 0, false));
        body.cubeList.add(new ModelBox(body, 38, 47, -0.9221F, 2.2348F, 14.2206F, 1, 3, 1, 0, false));
        ...
        body.cubeList.add(new ModelBox(body, 100, 39, -0.9221F, -1.7652F, -8.7294F, 1, 3, 4, 0, false));
        body.cubeList.add(new ModelBox(body, 151, 110, -2.2957F, 1.1F, -2.7294F, 2, 4, 24, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 94, 66, -4.1957F, 2, -5.4794F, 4, 2, 1, 0.002F, false));
        body.cubeList.add(new ModelBox(body, 0, 0, -4.3457F, -4, -17.7294F, 4, 2, 45, 0, false));
        body.cubeList.add(new ModelBox(body, 47, 47, -4.3457F, -5, 10.2706F, 4, 1, 17, 0, false));
        body.cubeList.add(new ModelBox(body, 0, 130, -4.5209F, 3, -1.7294F, 1, 4, 11, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 116, 92, -4.5207F, 2.45F, -3.7294F, 1, 2, 13, 0, false));
        body.cubeList.add(new ModelBox(body, 22, 30, -4.7707F, 0.9F, 9.5206F, 1, 3, 2, 0, false));
        ...
        body.cubeList.add(new ModelBox(body, 0, 17, -4.7694F, -1.7652F, -4.7294F, 1, 4, 3, 0, false));
        body.cubeList.add(new ModelBox(body, 88, 129, -4.7694F, 0.2348F, -1.7294F, 1, 2, 12, 0, false));
        ...
        body.cubeList.add(new ModelBox(body, 25, 47, -4.7694F, 2.2348F, 14.2206F, 1, 3, 1, 0, false));
        body.cubeList.add(new ModelBox(body, 72, 55, -4.7708F, 2.4098F, 15.4706F, 1, 2, 6, 0.002F, false));
        body.cubeList.add(new ModelBox(body, 95, 15, -4.7694F, -1.7652F, -8.7294F, 1, 3, 4, 0, false));
        body.cubeList.add(new ModelBox(body, 151, 63, -4.3957F, 1.1F, -2.7294F, 2, 4, 24, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 0, 59, -4.4957F, 2, -5.4794F, 1, 2, 1, 0.001F, false));
        body.cubeList.add(new ModelBox(body, 0, 65, -4.2207F, -6, 10.2706F, 3, 1, 17, 0.001F, false));

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(-3.6386F, -5, 18.7706F);
        body.addChild(cube_r1);
        setRotationAngle(cube_r1, 0, 0, -0.7854F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 91, -0.5F, -0.5F, -8.5F, 1, 1, 17, 0, false));

        cube_r2 = new ModelRenderer(this);
        cube_r2.setRotationPoint(-2.6957F, 2.4135F, 23.295F);
        body.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.3927F, 0, 0);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 28, 87, -2.175F, 1, -2, 4, 1, 1, -0.1F, false));
        cube_r2.cubeList.add(new ModelBox(cube_r2, 104, 34, -1.125F, 1, -2, 4, 1, 1, -0.1F, false));

        cube_r3 = new ModelRenderer(this);
        cube_r3.setRotationPoint(-2.5957F, 3.3762F, 19.8813F);
        body.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.2182F, 0, 0);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 53, 39, -2.175F, 0, -2, 3, 2, 4, -0.002F, false));
        cube_r3.cubeList.add(new ModelBox(cube_r3, 67, 39, -0.325F, 0, -2, 3, 2, 4, -0.001F, false));

        cube_r4 = new ModelRenderer(this);
        cube_r4.setRotationPoint(-2.5957F, 4.2114F, 14.9838F);
        body.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.0873F, 0, 0);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 32, 39, -2.175F, -1.75F, 0.5F, 3, 3, 3, 0, false));
        cube_r4.cubeList.add(new ModelBox(cube_r4, 14, 83, -0.325F, -1.75F, 0.5F, 3, 3, 3, 0, false));

        cube_r5 = new ModelRenderer(this);
        cube_r5.setRotationPoint(-2.5957F, 4.9368F, 14.6694F);
        body.addChild(cube_r5);
        setRotationAngle(cube_r5, -0.0873F, 0, 0);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 24, -2.1752F, -0.5F, -0.5F, 3, 1, 1, 0, false));
        cube_r5.cubeList.add(new ModelBox(cube_r5, 11, 24, -0.3248F, -0.5F, -0.5F, 3, 1, 1, 0, false));

        cube_r6 = new ModelRenderer(this);
        cube_r6.setRotationPoint(-2.5957F, 4.7842F, 12.9261F);
        body.addChild(cube_r6);
        setRotationAngle(cube_r6, -0.0873F, 0, 0);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 59, -2.175F, -0.5F, -2.5F, 3, 1, 4, 0, false));
        ...
        setRotationAngle(cube_r7, -0.48F, 0, 0);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 98, 84, -0.4999F, -1, -3, 1, 2, 4, 0, false));
        cube_r7.cubeList.add(new ModelBox(cube_r7, 16, 39, -0.2001F, -1, -3, 4, 2, 4, 0.001F, false));

        cube_r8 = new ModelRenderer(this);
        cube_r8.setRotationPoint(-3.8956F, 2.6F, 22.2706F);
        body.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.48F, 0, 0);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 11, 17, -0.5F, -2, -1, 1, 4, 3, 0, false));
        cube_r8.cubeList.add(new ModelBox(cube_r8, 34, 65, 2.5998F, -2, -1, 1, 4, 3, 0, false));

        cube_r9 = new ModelRenderer(this);
        cube_r9.setRotationPoint(-3.8956F, 3.4691F, 15.7141F);
        body.addChild(cube_r9);
        setRotationAngle(cube_r9, -0.0873F, 0, 0);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 8, 65, -0.5F, -2, -1.5F, 1, 4, 3, 0, false));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 71, 21, 2.5998F, -2, -1.5F, 1, 4, 3, 0, false));

        cube_r10 = new ModelRenderer(this);
        cube_r10.setRotationPoint(-3.6457F, 2.6F, -2.9794F);
        body.addChild(cube_r10);
        setRotationAngle(cube_r10, -0.3054F, 0, 0);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 95, 0, -0.7499F, -2, -2, 1, 4, 4, 0, false));
        cube_r10.cubeList.add(new ModelBox(cube_r10, 53, 8, -0.6501F, -2, -2, 4, 4, 4, 0.001F, false));

        cube_r11 = new ModelRenderer(this);
        cube_r11.setRotationPoint(-4.5694F, 3.9301F, 22.708F);
        body.addChild(cube_r11);
        setRotationAngle(cube_r11, -0.7854F, 0, 0);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 33, 79, -0.5F, -0.5F, -1, 2, 1, 2, -0.3F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 111, 0, 2.9473F, -0.5F, -1, 2, 1, 2, -0.3F, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-4.2694F, 3.4705F, 21.8242F);
        body.addChild(cube_r12);
        setRotationAngle(cube_r12, -0.7854F, 0, 0);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 9, 101, -0.4998F, -2.7F, -1.225F, 1, 2, 3, 0, false));
        cube_r12.cubeList.add(new ModelBox(cube_r12, 111, 9, -0.5001F, -0.5F, -1, 1, 1, 2, 0.002F, false));
        cube_r12.cubeList.add(new ModelBox(cube_r12, 69, 102, 3.347F, -2.7F, -1.225F, 1, 2, 3, 0, false));
        cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 114, 3.3473F, -0.5F, -1, 1, 1, 2, 0.002F, false));

        cube_r13 = new ModelRenderer(this);
        cube_r13.setRotationPoint(-4.8123F, -0.7652F, 11.2706F);
        body.addChild(cube_r13);
        setRotationAngle(cube_r13, 0, 0.7854F, 0);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 13, 31, -0.5F, -1, -0.5F, 1, 2, 2, 0, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(-4.0207F, 5.4403F, -1.4147F);
        body.addChild(cube_r14);
        setRotationAngle(cube_r14, -1.0908F, 0, 0);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 99, -0.5F, -1, -1.5F, 3, 2, 3, -0.002F, false));
        cube_r14.cubeList.add(new ModelBox(cube_r14, 42, 102, 0.85F, -1, -1.5F, 3, 2, 3, -0.001F, false));

        cube_r15 = new ModelRenderer(this);
        cube_r15.setRotationPoint(-4.0207F, 4.7261F, -1.9479F);
        body.addChild(cube_r15);
        setRotationAngle(cube_r15, -0.7418F, 0, 0);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 19, 99, -0.5F, -1, -1.5F, 3, 2, 3, -0.001F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 79, 108, 0.85F, -1, -1.5F, 3, 2, 3, -0.002F, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(-3.0208F, 7.782F, 4.3866F);
        body.addChild(cube_r16);
        setRotationAngle(cube_r16, -0.1745F, 0, 0);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 42, 109, -1.5F, -0.5F, -6, 3, 1, 12, -0.001F, false));
        cube_r16.cubeList.add(new ModelBox(cube_r16, 110, 76, -0.1498F, -0.5F, -6, 3, 1, 12, 0, false));

        cube_r17 = new ModelRenderer(this);
        cube_r17.setRotationPoint(-1.0528F, -5, 18.7706F);
        body.addChild(cube_r17);
        setRotationAngle(cube_r17, 0, 0, 0.7854F);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 109, -0.5F, -0.5F, -8.5F, 1, 1, 17, 0, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 36, 87, -0.5015F, -1, 0, 1, 1, 2, -0.1F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(-4.7694F, 5.0098F, 16.5706F);
        body.addChild(cube_r19);
        setRotationAngle(cube_r19, 0.4189F, 0, 0);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 30, 11, -0.5015F, -2, 0, 1, 2, 2, -0.2F, false));
        cube_r19.cubeList.add(new ModelBox(cube_r19, 31, 0, 4.3487F, -2, 0, 1, 2, 2, -0.2F, false));
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 11, 91, -0.4985F, -1, 0, 1, 1, 2, -0.1F, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(-0.3684F, 0.7348F, 27.1478F);
        body.addChild(cube_r21);
        setRotationAngle(cube_r21, 0, 0.6109F, 0);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 54, 92, -0.5F, -3.5F, -0.5F, 1, 7, 1, 0, false));

        cube_r22 = new ModelRenderer(this);
        cube_r22.setRotationPoint(-0.1721F, -0.0977F, 29.2414F);
        body.addChild(cube_r22);
        setRotationAngle(cube_r22, 0.2182F, 0, 0);
        ...
        setRotationAngle(cube_r23, 0, 0.7854F, 0);
        ...
        setRotationAngle(cube_r24, 0, 0.7854F, 0);
        ...
        setRotationAngle(cube_r25, 0, 0.1309F, 0);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 117, 84, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r26 = new ModelRenderer(this);
        cube_r26.setRotationPoint(-4.7693F, -1.7652F, -7.7294F);
        body.addChild(cube_r26);
        setRotationAngle(cube_r26, 0, 0, 0.2269F);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 42, 92, 0, -2, 0, 1, 2, 35, 0, false));

        cube_r27 = new ModelRenderer(this);
        cube_r27.setRotationPoint(0.0779F, -1.7652F, -7.7294F);
        body.addChild(cube_r27);
        setRotationAngle(cube_r27, 0, 0, -0.2269F);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 94, 39, -1, -2, 0, 1, 2, 35, 0, false));

        grip = new ModelRenderer(this);
        grip.setRotationPoint(-0.3915F, 0.9283F, -0.4854F);
        grip.cubeList.add(new ModelBox(grip, 47, 65, -1.6075F, -6.8532F, -7.9352F, 1, 2, 1, 0, false));
        grip.cubeList.add(new ModelBox(grip, 60, 92, -1.9335F, -7.3283F, -16.0146F, 3, 4, 4, -0.001F, false));
        grip.cubeList.add(new ModelBox(grip, 47, 65, -3.2835F, -7.3283F, -16.0146F, 3, 4, 4, 0, false));
        grip.cubeList.add(new ModelBox(grip, 85, 0, -2.1835F, -3.3283F, -13.2646F, 2, 3, 1, 0, false));
        grip.cubeList.add(new ModelBox(grip, 102, 109, 0.0665F, -5.3283F, -20.0146F, 1, 1, 4, -0.001F, false));
        grip.cubeList.add(new ModelBox(grip, 102, 102, -3.2835F, -5.3283F, -20.0146F, 1, 1, 4, 0, false));
        grip.cubeList.add(new ModelBox(grip, 6, 109, 0.3165F, -7.8283F, -15.0146F, 1, 1, 3, 0, false));
        ...
        setRotationAngle(cube_r28, 0, 0.3927F, 0);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 19, 114, -0.5001F, -1, -1, 1, 1, 2, 0.001F, false));
        cube_r28.cubeList.add(new ModelBox(cube_r28, 25, 114, -0.5F, -1.45F, -1, 1, 1, 2, 0, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(1.0665F, -7.0783F, -12.7646F);
        grip.addChild(cube_r29);
        setRotationAngle(cube_r29, -0.3927F, 0, 0);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 86, 117, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r30 = new ModelRenderer(this);
        cube_r30.setRotationPoint(-1.1835F, -0.951F, -12.6128F);
        grip.addChild(cube_r30);
        setRotationAngle(cube_r30, 0.1745F, 0, 0);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 84, 65, -0.999F, -2.5F, -0.75F, 2, 3, 1, 0, false));

        gun240_r1 = new ModelRenderer(this);
        gun240_r1.setRotationPoint(-1.1075F, -3.9851F, -7.6398F);
        grip.addChild(gun240_r1);
        setRotationAngle(gun240_r1, -0.2182F, 0, 0);
        gun240_r1.cubeList.add(new ModelBox(gun240_r1, 39, 65, -0.499F, -1, -0.5F, 1, 2, 1, 0, false));

        gun239_r1 = new ModelRenderer(this);
        gun239_r1.setRotationPoint(-1.1075F, -2.7094F, -4.7174F);
        grip.addChild(gun239_r1);
        setRotationAngle(gun239_r1, 0.5236F, 0, 0);
        gun239_r1.cubeList.add(new ModelBox(gun239_r1, 47, 59, -1.501F, -0.5F, -2, 3, 1, 4, 0, false));

        gun238_r1 = new ModelRenderer(this);
        gun238_r1.setRotationPoint(-1.1075F, -2.0359F, -9.1445F);
        grip.addChild(gun238_r1);
        setRotationAngle(gun238_r1, -0.0873F, 0, 0);
        gun238_r1.cubeList.add(new ModelBox(gun238_r1, 72, 10, -1.5F, -0.5F, -3, 3, 1, 6, 0, false));
        ...
        setRotationAngle(gun240_r2, 0.3054F, 0, 0);
        gun240_r2.cubeList.add(new ModelBox(gun240_r2, 0, 0, -2.002F, -6.5F, 0.175F, 4, 13, 3, 0.001F, false));
        gun240_r2.cubeList.add(new ModelBox(gun240_r2, 0, 65, -1, -6.5F, -0.5F, 2, 13, 2, 0, false));

        gun241_r1 = new ModelRenderer(this);
        gun241_r1.setRotationPoint(-1, -0.0623F, 0.1975F);
        bone.addChild(gun241_r1);
        setRotationAngle(gun241_r1, 0.4194F, -0.7401F, -0.2921F);
        gun241_r1.cubeList.add(new ModelBox(gun241_r1, 41, 0, -0.5F, -6.5F, -0.5F, 1, 13, 1, 0, false));
        ...
        gun242_r1.cubeList.add(new ModelBox(gun242_r1, 41, 14, -0.5F, -6.5F, -0.5F, 1, 13, 1, 0, false));

        gun240_r3 = new ModelRenderer(this);
        gun240_r3.setRotationPoint(0, 0.4256F, 5.8394F);
        bone.addChild(gun240_r3);
        setRotationAngle(gun240_r3, 0.4363F, 0, 0);
        gun240_r3.cubeList.add(new ModelBox(gun240_r3, 94, 76, -1, -6, -1.5F, 2, 10, 2, 0, false));

        gun241_r2 = new ModelRenderer(this);
        gun241_r2.setRotationPoint(0, 1.2708F, 4.0268F);
        bone.addChild(gun241_r2);
        setRotationAngle(gun241_r2, 0.4363F, 0, 0);
        gun241_r2.cubeList.add(new ModelBox(gun241_r2, 22, 17, -2.003F, -6, -1.175F, 4, 10, 3, -0.001F, false));

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(0, 0.3374F, 2.6001F);
        bone.addChild(bone6);
        setRotationAngle(bone6, -0.6545F, 0, 0);


        gun241_r3 = new ModelRenderer(this);
        gun241_r3.setRotationPoint(0, 0, 0);
        bone6.addChild(gun241_r3);
        setRotationAngle(gun241_r3, 0.4363F, 0, 0);
        gun241_r3.cubeList.add(new ModelBox(gun241_r3, 30, 30, -1, -8, -0.5F, 2, 4, 1, 0, false));

        gun242_r2 = new ModelRenderer(this);
        gun242_r2.setRotationPoint(0, 0.8452F, -1.8126F);
        bone6.addChild(gun242_r2);
        setRotationAngle(gun242_r2, 0.4363F, 0, 0);
        gun242_r2.cubeList.add(new ModelBox(gun242_r2, 53, 30, -2.004F, -8, -1.175F, 4, 4, 3, -0.003F, false));

        stock = new ModelRenderer(this);
        stock.setRotationPoint(0, 24, 17.05F);
        stock.cubeList.add(new ModelBox(stock, 110, 79, -1.625F, -41, -12.5F, 2, 1, 2, 0.002F, false));
        stock.cubeList.add(new ModelBox(stock, 82, 27, -3.375F, -40.999F, -12.5F, 2, 1, 2, 0.001F, false));
        stock.cubeList.add(new ModelBox(stock, 47, 47, -3.5F, -40, -12.5F, 4, 9, 3, 0, false));
        stock.cubeList.add(new ModelBox(stock, 33, 91, -4.5F, -40, -12.5F, 1, 9, 1, 0, false));
        stock.cubeList.add(new ModelBox(stock, 94, 72, -3.5F, -40, -10.075F, 4, 1, 1, -0.001F, false));
        stock.cubeList.add(new ModelBox(stock, 42, 92, -3.5F, -39, -9.5F, 4, 8, 2, 0, false));
        stock.cubeList.add(new ModelBox(stock, 96, 99, -3.5F, -37, -0.5F, 4, 6, 1, 0, false));
        stock.cubeList.add(new ModelBox(stock, 151, 110, -3.5F, -38, 15.5F, 4, 18, 3, 0.002F, false));
        stock.cubeList.add(new ModelBox(stock, 10, 72, -2.5F, -33, 14.5F, 2, 6, 1, 0, false));
        stock.cubeList.add(new ModelBox(stock, 47, 65, -3.5F, -38, -0.5F, 4, 1, 16, 0, false));
        stock.cubeList.add(new ModelBox(stock, 47, 82, -3.5F, -32, -7.5F, 4, 1, 7, 0, false));
        stock.cubeList.add(new ModelBox(stock, 131, 63, -3.5F, -38, -7.5F, 4, 2, 7, 0, false));

        cube_r31 = new ModelRenderer(this);
        cube_r31.setRotationPoint(-1.5F, -27.7705F, 12.0186F);
        stock.addChild(cube_r31);
        setRotationAngle(cube_r31, -1.0908F, 0, 0);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 25, 57, -1.999F, -1.5F, 3.5F, 4, 2, 5, 0, false));

        cube_r32 = new ModelRenderer(this);
        cube_r32.setRotationPoint(-1.5F, -29.1864F, 8.1633F);
        stock.addChild(cube_r32);
        setRotationAngle(cube_r32, -0.6981F, 0, 0);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 131, 49, -1.998F, -0.5F, 0, 4, 1, 9, -0.003F, false));

        cube_r33 = new ModelRenderer(this);
        cube_r33.setRotationPoint(-1.5F, -29.1864F, 8.1633F);
        stock.addChild(cube_r33);
        setRotationAngle(cube_r33, -0.3054F, 0, 0);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 18, 11, -2, 1.5F, 4.75F, 4, 1, 4, 0, false));
        cube_r33.cubeList.add(new ModelBox(cube_r33, 0, 83, -1.999F, 0.5F, 2.5F, 4, 1, 6, 0, false));
        cube_r33.cubeList.add(new ModelBox(cube_r33, 0, 47, -1.999F, -0.5F, -8.5F, 4, 1, 17, 0, false));

        cube_r34 = new ModelRenderer(this);
        cube_r34.setRotationPoint(-0.5F, -39.7301F, -9.5581F);
        stock.addChild(cube_r34);
        setRotationAngle(cube_r34, -0.5585F, 0, 0);
        ...
        setRotationAngle(cube_r35, -0.6109F, 0, 0);
        cube_r35.cubeList.add(new ModelBox(cube_r35, 60, 105, -4, -0.4989F, -1.5F, 2, 1, 2, 0, false));
        cube_r35.cubeList.add(new ModelBox(cube_r35, 110, 76, -2.25F, -0.4999F, -1.5F, 2, 1, 2, 0, false));

        cube_r36 = new ModelRenderer(this);
        cube_r36.setRotationPoint(-1.5F, -37.5F, -2.5F);
        stock.addChild(cube_r36);
        setRotationAngle(cube_r36, -0.1745F, 0, 0);
        cube_r36.cubeList.add(new ModelBox(cube_r36, 0, 31, -2.001F, -0.5F, -5, 4, 1, 5, 0, false));

        cube_r37 = new ModelRenderer(this);
        cube_r37.setRotationPoint(-1.501F, -27.8224F, 13.5659F);
        stock.addChild(cube_r37);
        setRotationAngle(cube_r37, -0.2618F, 0, 0);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 112, 51, -1, -1.5F, -0.5F, 2, 2, 1, 0.001F, false));

        cube_r38 = new ModelRenderer(this);
        cube_r38.setRotationPoint(-1.501F, -29.0482F, 14.1175F);
        stock.addChild(cube_r38);
        setRotationAngle(cube_r38, 0.2182F, 0, 0);
        cube_r38.cubeList.add(new ModelBox(cube_r38, 115, 5, -1, -0.5F, -0.5F, 2, 1, 1, 0, false));

        cube_r39 = new ModelRenderer(this);
        cube_r39.setRotationPoint(-1.5F, -33.5747F, 15.459F);
        stock.addChild(cube_r39);
        setRotationAngle(cube_r39, -0.5672F, 0, 0);
        cube_r39.cubeList.add(new ModelBox(cube_r39, 113, 35, -1.001F, -1, -0.5F, 2, 2, 1, 0, false));

        cube_r40 = new ModelRenderer(this);
        cube_r40.setRotationPoint(-1.5F, -29, 17);
        stock.addChild(cube_r40);
        setRotationAngle(cube_r40, 0.1309F, 0, 0);
        cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 47, -2.001F, 0, -1.5F, 4, 9, 3, 0, false));

        cube_r41 = new ModelRenderer(this);
        cube_r41.setRotationPoint(-1.5F, -29, 17);
        stock.addChild(cube_r41);
        setRotationAngle(cube_r41, -0.0873F, 0, 0);
        cube_r41.cubeList.add(new ModelBox(cube_r41, 94, 56, -2.001F, -9.125F, 0.5F, 4, 9, 1, 0, false));

        cube_r42 = new ModelRenderer(this);
        cube_r42.setRotationPoint(-0.2071F, -40, -4);
        stock.addChild(cube_r42);
        setRotationAngle(cube_r42, 0, 0, 0.7854F);
        cube_r42.cubeList.add(new ModelBox(cube_r42, 113, 66, -0.5F, -0.5F, -8.5F, 1, 1, 2, 0, false));
        ...
        setRotationAngle(cube_r43, -0.1309F, 0, 0);
        cube_r43.cubeList.add(new ModelBox(cube_r43, 77, 39, -2.5F, -2, -0.5F, 5, 2, 2, 0, false));
        cube_r43.cubeList.add(new ModelBox(cube_r43, 72, 0, -2, -3, -1, 4, 5, 5, 0, false));
        ...
        cube_r44.cubeList.add(new ModelBox(cube_r44, 112, 21, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r45.cubeList.add(new ModelBox(cube_r45, 112, 15, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r46.cubeList.add(new ModelBox(cube_r46, 112, 39, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r47.cubeList.add(new ModelBox(cube_r47, 112, 45, 1, -3, 0.5F, 1, 5, 1, 0, false));

        cube_r48 = new ModelRenderer(this);
        cube_r48.setRotationPoint(-0.75F, 2.6119F, -4.7838F);
        mag.addChild(cube_r48);
        setRotationAngle(cube_r48, -0.1309F, 0, 0);
        cube_r48.cubeList.add(new ModelBox(cube_r48, 19, 91, -2, -3, -1.5F, 4, 5, 3, 0, false));

        mag2 = new ModelRenderer(this);
        mag2.setRotationPoint(0, 0, 0);
        mag.addChild(mag2);
        setRotationAngle(mag2, 0.0436F, 0, 0);


        cube_r49 = new ModelRenderer(this);
        cube_r49.setRotationPoint(-0.75F, -2.7046F, -0.567F);
        mag2.addChild(cube_r49);
        setRotationAngle(cube_r49, -0.1309F, 0, 0);
        cube_r49.cubeList.add(new ModelBox(cube_r49, 18, 0, -2, -3, -1, 4, 6, 5, 0.001F, false));
        ...
        cube_r50.cubeList.add(new ModelBox(cube_r50, 47, 82, 1, -3, 0.5F, 1, 6, 1, 0, false));
        ...
        cube_r51.cubeList.add(new ModelBox(cube_r51, 102, 76, 1, -3, 0.5F, 1, 6, 1, 0, false));
        ...
        cube_r52.cubeList.add(new ModelBox(cube_r52, 105, 4, 1, -3, 0.5F, 1, 6, 1, 0, false));
        ...
        cube_r53.cubeList.add(new ModelBox(cube_r53, 106, 46, 1, -3, 0.5F, 1, 6, 1, 0, false));

        cube_r54 = new ModelRenderer(this);
        cube_r54.setRotationPoint(-0.75F, -3.1615F, -4.0371F);
        mag2.addChild(cube_r54);
        setRotationAngle(cube_r54, -0.1309F, 0, 0);
        cube_r54.cubeList.add(new ModelBox(cube_r54, 53, 21, -2, -3, -1.5F, 4, 6, 3, 0.001F, false));

        mag3 = new ModelRenderer(this);
        mag3.setRotationPoint(0, 0, 0);
        mag.addChild(mag3);
        setRotationAngle(mag3, -0.0873F, 0, 0);


        cube_r55 = new ModelRenderer(this);
        cube_r55.setRotationPoint(-0.75F, 7.7094F, -1.4821F);
        mag3.addChild(cube_r55);
        setRotationAngle(cube_r55, -0.1309F, 0, 0);
        cube_r55.cubeList.add(new ModelBox(cube_r55, 71, 65, -2, -3, -1, 4, 5, 5, -0.001F, false));
        ...
        cube_r56.cubeList.add(new ModelBox(cube_r56, 111, 3, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r57.cubeList.add(new ModelBox(cube_r57, 111, 56, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r58.cubeList.add(new ModelBox(cube_r58, 111, 62, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r59.cubeList.add(new ModelBox(cube_r59, 13, 112, 1, -3, 0.5F, 1, 5, 1, 0, false));

        cube_r60 = new ModelRenderer(this);
        cube_r60.setRotationPoint(-0.75F, 7.2526F, -4.9521F);
        mag3.addChild(cube_r60);
        setRotationAngle(cube_r60, -0.1309F, 0, 0);
        cube_r60.cubeList.add(new ModelBox(cube_r60, 0, 91, -2, -3, -1.5F, 4, 5, 3, -0.001F, false));

        mag4 = new ModelRenderer(this);
        mag4.setRotationPoint(-0.75F, 6.7922F, -3.2605F);
        mag.addChild(mag4);
        setRotationAngle(mag4, -0.1745F, 0, 0);


        cube_r61 = new ModelRenderer(this);
        cube_r61.setRotationPoint(0, 8.2232F, 5.4171F);
        mag4.addChild(cube_r61);
        setRotationAngle(cube_r61, -0.1309F, 0, 0);
        cube_r61.cubeList.add(new ModelBox(cube_r61, 23, 79, -2.5001F, -0.4999F, -1.5F, 5, 1, 1, 0.001F, false));

        cube_r62 = new ModelRenderer(this);
        cube_r62.setRotationPoint(0, 7.5706F, 0.4599F);
        mag4.addChild(cube_r62);
        setRotationAngle(cube_r62, -0.1309F, 0, 0);
        cube_r62.cubeList.add(new ModelBox(cube_r62, 130, 15, -2.5F, -0.5F, -5, 5, 1, 9, 0, false));

        cube_r63 = new ModelRenderer(this);
        cube_r63.setRotationPoint(0, 5.0919F, 0.7862F);
        mag4.addChild(cube_r63);
        setRotationAngle(cube_r63, -0.1309F, 0, 0);
        cube_r63.cubeList.add(new ModelBox(cube_r63, 76, 82, -2.5F, -2, -0.5F, 5, 2, 2, 0, false));
        cube_r63.cubeList.add(new ModelBox(cube_r63, 25, 47, -2, -3, -1, 4, 5, 5, 0.001F, false));
        ...
        cube_r64.cubeList.add(new ModelBox(cube_r64, 0, 83, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r65.cubeList.add(new ModelBox(cube_r65, 84, 10, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r66.cubeList.add(new ModelBox(cube_r66, 84, 47, 1, -3, 0.5F, 1, 5, 1, 0, false));
        ...
        cube_r67.cubeList.add(new ModelBox(cube_r67, 106, 96, 1, -3, 0.5F, 1, 5, 1, 0, false));

        cube_r68 = new ModelRenderer(this);
        cube_r68.setRotationPoint(0, 4.6351F, -2.6839F);
        mag4.addChild(cube_r68);
        setRotationAngle(cube_r68, -0.1309F, 0, 0);
        cube_r68.cubeList.add(new ModelBox(cube_r68, 47, 73, -2, -3, -1.5F, 4, 5, 3, 0.001F, false));

        handguard = new ModelRenderer(this);
        handguard.setRotationPoint(0, 24, 0);
        handguard.cubeList.add(new ModelBox(handguard, 64, 21, 0.25F, -40.999F, -41.751F, 1, 2, 1, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 19, 109, -3.5F, -41, -41.5F, 4, 4, 1, 0.001F, false));
        handguard.cubeList.add(new ModelBox(handguard, 93, 39, -1.7071F, -41, -44.4571F, 2, 1, 3, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 81, 127, -2, -37.25F, -59.7F, 1, 1, 33, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 116, 110, -1.2929F, -36.5429F, -59.7F, 1, 1, 33, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 116, 76, -2.7071F, -36.5429F, -59.7F, 1, 1, 33, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 95, 0, -2, -35.8358F, -59.7F, 1, 1, 33, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 95, 0, -2, -39.25F, -54.95F, 1, 1, 14, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 62, 82, 0.75F, -36.5F, -42.75F, 1, 2, 2, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 57, 65, 0.75F, -36.5F, -54.75F, 1, 2, 2, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 79, 92, -2, -32.45F, -55.452F, 1, 1, 15, 0.3F, false));
        ...
        handguard.cubeList.add(new ModelBox(handguard, 53, 0, -4, -41, -43.75F, 5, 5, 3, 0.002F, false));
        handguard.cubeList.add(new ModelBox(handguard, 57, 59, -4.75F, -36.5F, -42.75F, 1, 2, 2, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 10, 59, -4.75F, -36.5F, -54.75F, 1, 2, 2, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 79, 86, -3.2929F, -41, -44.4571F, 2, 1, 3, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 38, 57, -4.25F, -40.999F, -41.751F, 1, 2, 1, 0, false));
        handguard.cubeList.add(new ModelBox(handguard, 79, 92, -2.5F, -37, -59.7F, 2, 2, 33, 0.01F, false));

        cube_r69 = new ModelRenderer(this);
        cube_r69.setRotationPoint(-2.2642F, -40.28F, -47.25F);
        handguard.addChild(cube_r69);
        setRotationAngle(cube_r69, 0, 0, -0.2182F);
        cube_r69.cubeList.add(new ModelBox(cube_r69, 95, 15, -1, -0.5F, -6.5F, 2, 1, 13, -0.001F, false));

        cube_r70 = new ModelRenderer(this);
        cube_r70.setRotationPoint(-2.4079F, -37.8251F, -30.4401F);
        handguard.addChild(cube_r70);
        setRotationAngle(cube_r70, 1.1345F, 0, 0.1745F);
        ...
        setRotationAngle(cube_r71, 0.5236F, 0, 0.1745F);
        cube_r71.cubeList.add(new ModelBox(cube_r71, 72, 10, -0.5001F, -2.75F, -0.25F, 1, 5, 1, 0.001F, false));

        cube_r72 = new ModelRenderer(this);
        cube_r72.setRotationPoint(-3.7245F, -35.5409F, -30);
        handguard.addChild(cube_r72);
        setRotationAngle(cube_r72, 0, 0, 0.1745F);
        cube_r72.cubeList.add(new ModelBox(cube_r72, 5, 17, -0.5F, 0, 0.5F, 1, 2, 1, 0, false));
        cube_r72.cubeList.add(new ModelBox(cube_r72, 0, 31, -0.5F, -2, -0.5F, 1, 4, 1, 0, false));

        cube_r73 = new ModelRenderer(this);
        cube_r73.setRotationPoint(-3.6377F, -36.0333F, -35.5F);
        handguard.addChild(cube_r73);
        setRotationAngle(cube_r73, 0, 0, 0.1745F);
        cube_r73.cubeList.add(new ModelBox(cube_r73, 34, 130, -0.5F, -2.5F, -5, 1, 5, 10, 0, false));

        cube_r74 = new ModelRenderer(this);
        cube_r74.setRotationPoint(-3.5509F, -36.5257F, -50);
        handguard.addChild(cube_r74);
        setRotationAngle(cube_r74, 0, 0, 0.1745F);
        cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 33, -0.5F, -3, 0, 1, 1, 1, 0, false));
        cube_r74.cubeList.add(new ModelBox(cube_r74, 48, 109, -0.5F, -3, 4, 1, 1, 2, 0, false));
        cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 65, -0.5F, -3, -4, 1, 1, 1, 0, false));
        cube_r74.cubeList.add(new ModelBox(cube_r74, 16, 17, -0.5F, 1, -5.5F, 1, 2, 1, 0, false));
        cube_r74.cubeList.add(new ModelBox(cube_r74, 72, 47, -0.5F, -2, -4.5F, 1, 5, 1, 0, false));
        cube_r74.cubeList.add(new ModelBox(cube_r74, 0, 17, -0.5F, -2, -3.5F, 1, 5, 9, 0, false));

        cube_r75 = new ModelRenderer(this);
        cube_r75.setRotationPoint(-2.9697F, -39.8215F, -53.3206F);
        handguard.addChild(cube_r75);
        setRotationAngle(cube_r75, 0.3927F, 0, 0.1745F);
        cube_r75.cubeList.add(new ModelBox(cube_r75, 71, 67, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r76 = new ModelRenderer(this);
        cube_r76.setRotationPoint(-2.9431F, -39.9725F, -49);
        handguard.addChild(cube_r76);
        setRotationAngle(cube_r76, 0, 0, 0.1745F);
        cube_r76.cubeList.add(new ModelBox(cube_r76, 71, 21, -0.5F, -0.5F, -4.05F, 1, 1, 9, 0, false));

        cube_r77 = new ModelRenderer(this);
        cube_r77.setRotationPoint(-3.5235F, -36.6807F, -54.7011F);
        handguard.addChild(cube_r77);
        setRotationAngle(cube_r77, -0.3491F, 0, 0.1745F);
        ...
        setRotationAngle(cube_r78, 0.6545F, 0, 0.1745F);
        cube_r78.cubeList.add(new ModelBox(cube_r78, 72, 0, -0.5F, -0.5F, 0, 1, 1, 1, -0.001F, false));

        cube_r79 = new ModelRenderer(this);
        cube_r79.setRotationPoint(-3.464F, -37.0181F, -46.5F);
        handguard.addChild(cube_r79);
        setRotationAngle(cube_r79, 0, 0, 0.1745F);
        cube_r79.cubeList.add(new ModelBox(cube_r79, 79, 92, -0.5F, -3.5F, 2, 1, 7, 4, 0, false));

        cube_r80 = new ModelRenderer(this);
        cube_r80.setRotationPoint(-2.4135F, -32.7268F, -40);
        handguard.addChild(cube_r80);
        setRotationAngle(cube_r80, 0, 0, 0.3927F);
        ...
        setRotationAngle(cube_r85, 0, 0.7854F, 0);
        ...
        setRotationAngle(cube_r86, 0, 0.7854F, 0);
        cube_r86.cubeList.add(new ModelBox(cube_r86, 47, 59, -0.5F, -1, -0.5F, 1, 2, 1, -0.001F, false));

        cube_r87 = new ModelRenderer(this);
        cube_r87.setRotationPoint(-1.5784F, -37.5848F, -41.251F);
        handguard.addChild(cube_r87);
        setRotationAngle(cube_r87, 0, 0, -0.7854F);
        cube_r87.cubeList.add(new ModelBox(cube_r87, 117, 50, 2, 0, -0.5F, 1, 1, 1, -0.001F, false));

        cube_r88 = new ModelRenderer(this);
        cube_r88.setRotationPoint(0.8678F, -33.5353F, -55.875F);
        handguard.addChild(cube_r88);
        setRotationAngle(cube_r88, 0, 0, -0.9599F);
        cube_r88.cubeList.add(new ModelBox(cube_r88, 3, 118, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.001F, false));
        cube_r88.cubeList.add(new ModelBox(cube_r88, 121, 144, -0.5F, -0.5F, 0.375F, 1, 1, 28, 0, false));

        cube_r89 = new ModelRenderer(this);
        cube_r89.setRotationPoint(-0.0303F, -39.8215F, -53.3206F);
        handguard.addChild(cube_r89);
        setRotationAngle(cube_r89, 0.3927F, 0, -0.1745F);
        cube_r89.cubeList.add(new ModelBox(cube_r89, 12, 118, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r90 = new ModelRenderer(this);
        cube_r90.setRotationPoint(0.5509F, -36.5257F, -48.5F);
        handguard.addChild(cube_r90);
        setRotationAngle(cube_r90, 0, 0, -0.1745F);
        cube_r90.cubeList.add(new ModelBox(cube_r90, 65, 8, -0.5F, 1, -7, 1, 2, 1, 0, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 69, 113, -0.5F, -2, -6, 1, 5, 1, 0, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 114, 25, -0.5F, -3, 2.5F, 1, 1, 2, 0, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 30, 118, -0.5F, -3, -1.5F, 1, 1, 1, 0, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 34, 118, -0.5F, -3, -5.5F, 1, 1, 1, 0, false));
        cube_r90.cubeList.add(new ModelBox(cube_r90, 23, 65, -0.5F, -2, -5, 1, 5, 9, 0, false));

        cube_r91 = new ModelRenderer(this);
        cube_r91.setRotationPoint(0.5235F, -36.6807F, -54.7011F);
        handguard.addChild(cube_r91);
        setRotationAngle(cube_r91, -0.3491F, 0, -0.1745F);
        ...
        setRotationAngle(cube_r92, 0.6545F, 0, -0.1745F);
        cube_r92.cubeList.add(new ModelBox(cube_r92, 118, 24, -0.5F, -0.5F, 0, 1, 1, 1, -0.001F, false));

        cube_r93 = new ModelRenderer(this);
        cube_r93.setRotationPoint(-0.5865F, -32.7268F, -40);
        handguard.addChild(cube_r93);
        setRotationAngle(cube_r93, 0, 0, -0.3927F);
        cube_r93.cubeList.add(new ModelBox(cube_r93, 34, 130, -1.5F, -0.5F, -16.5F, 3, 1, 29, 0, false));

        cube_r94 = new ModelRenderer(this);
        cube_r94.setRotationPoint(0.7245F, -35.5409F, -30);
        handguard.addChild(cube_r94);
        setRotationAngle(cube_r94, 0, 0, -0.1745F);
        cube_r94.cubeList.add(new ModelBox(cube_r94, 13, 65, -0.5F, 0, 0.5F, 1, 2, 1, 0, false));
        cube_r94.cubeList.add(new ModelBox(cube_r94, 0, 39, -0.5F, -2, -0.5F, 1, 4, 1, 0, false));

        cube_r95 = new ModelRenderer(this);
        cube_r95.setRotationPoint(-0.5921F, -37.8251F, -30.4401F);
        handguard.addChild(cube_r95);
        setRotationAngle(cube_r95, 1.1345F, 0, -0.1745F);
        ...
        setRotationAngle(cube_r96, 0.5236F, 0, -0.1745F);
        cube_r96.cubeList.add(new ModelBox(cube_r96, 79, 113, -0.4999F, -2.75F, -0.25F, 1, 5, 1, 0.001F, false));

        cube_r97 = new ModelRenderer(this);
        cube_r97.setRotationPoint(-0.0569F, -39.9725F, -49);
        handguard.addChild(cube_r97);
        setRotationAngle(cube_r97, 0, 0, -0.1745F);
        cube_r97.cubeList.add(new ModelBox(cube_r97, 144, 63, -0.5F, -0.5F, -4.05F, 1, 1, 9, 0, false));

        cube_r98 = new ModelRenderer(this);
        cube_r98.setRotationPoint(0.6377F, -36.0333F, -35.5F);
        handguard.addChild(cube_r98);
        setRotationAngle(cube_r98, 0, 0, -0.1745F);
        cube_r98.cubeList.add(new ModelBox(cube_r98, 131, 34, -0.5F, -2.5F, -5, 1, 5, 10, 0, false));

        cube_r99 = new ModelRenderer(this);
        cube_r99.setRotationPoint(-0.7358F, -40.28F, -47.25F);
        handguard.addChild(cube_r99);
        setRotationAngle(cube_r99, 0, 0, 0.2182F);
        cube_r99.cubeList.add(new ModelBox(cube_r99, 79, 108, -1, -0.5F, -6.5F, 2, 1, 13, 0, false));

        cube_r100 = new ModelRenderer(this);
        cube_r100.setRotationPoint(0.464F, -37.0181F, -46.5F);
        handguard.addChild(cube_r100);
        setRotationAngle(cube_r100, 0, 0, -0.1745F);
        cube_r100.cubeList.add(new ModelBox(cube_r100, 94, 43, -0.5F, -3.5F, 2, 1, 7, 4, 0, false));
        ...
        setRotationAngle(DustCover6_r1, 0, 0, -1.1781F);
        ...
        teeth3.setRotationPoint(0, -3.014F, 20.334F);
        rail2.addChild(teeth3);
        teeth3.cubeList.add(new ModelBox(teeth3, 10, 106, -1, 3, -13.5F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 104, 72, -1, 3, -15.125F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 69, 100, -1, 3, -16.75F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 9, 99, -1, 3, -18.375F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 76, 86, -1, 3, -21.625F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 62, 86, -1, 3, -20, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 84, 79, -1, 3, -24.875F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 81, 43, -1, 3, -23.25F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 34, 72, -1, 3, -26.5F, 2, 1, 1, -0.1F, false));
        teeth3.cubeList.add(new ModelBox(teeth3, 71, 28, -1, 3, -28.125F, 2, 1, 1, -0.1F, false));
        ...
        carryhandle.setRotationPoint(0, 24, 0);
        carryhandle.cubeList.add(new ModelBox(carryhandle, 0, 17, -0.75F, -43, -18.5F, 1, 2, 20, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 47, 48, -1.75F, -44, -41.5F, 2, 1, 43, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 0, 47, -3.25F, -44, -41.5F, 2, 1, 43, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 96, 113, -0.749F, -42.55F, -30.5F, 1, 1, 2, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 42, 109, -0.749F, -43.55F, -31.5F, 1, 1, 4, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 83, 113, -0.75F, -43, -20, 1, 1, 2, -0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 62, 82, -3.5F, -44.3F, -4.5F, 4, 1, 6, 0.004F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 0, 39, -3, -44.6F, -3.6F, 3, 1, 5, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 81, 75, -1, -45.63F, -3.3F, 1, 1, 3, -0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 63, 39, -3, -45.63F, -3.3F, 1, 1, 3, -0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 11, 39, -2, -45.38F, -2.9F, 1, 1, 3, -0.001F, false));
        ...
        carryhandle.cubeList.add(new ModelBox(carryhandle, 95, 34, -2.75F, -42, -43, 3, 1, 3, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 95, 29, -2.75F, -43, -42.25F, 3, 1, 3, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 85, 92, -3.25F, -43, -42.25F, 1, 1, 3, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 101, 0, -3.25F, -42, -43, 1, 1, 3, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 151, 144, -3.25F, -43, -18.5F, 3, 2, 20, 0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 95, 8, -2.5F, -41.5F, 1.4F, 2, 1, 4, 0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 11, 109, -3.25F, -43, -20, 1, 1, 2, -0.001F, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 104, 29, -3.251F, -42.55F, -30.5F, 1, 1, 2, 0, false));
        carryhandle.cubeList.add(new ModelBox(carryhandle, 96, 108, -3.251F, -43.55F, -31.5F, 1, 1, 4, 0, false));

        cube_r101 = new ModelRenderer(this);
        cube_r101.setRotationPoint(-1.5F, -42, -1);
        carryhandle.addChild(cube_r101);
        setRotationAngle(cube_r101, -0.3927F, 0, 0);
        cube_r101.cubeList.add(new ModelBox(cube_r101, 27, 65, -2, -0.5F, -0.5F, 1, 1, 1, 0, false));
        cube_r101.cubeList.add(new ModelBox(cube_r101, 27, 117, 1, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r102 = new ModelRenderer(this);
        cube_r102.setRotationPoint(-1.5F, -42, -11);
        carryhandle.addChild(cube_r102);
        setRotationAngle(cube_r102, -0.3927F, 0, 0);
        cube_r102.cubeList.add(new ModelBox(cube_r102, 66, 0, -2, -0.5F, -0.5F, 1, 1, 1, 0, false));
        cube_r102.cubeList.add(new ModelBox(cube_r102, 117, 31, 1, -0.5F, -0.5F, 1, 1, 1, 0, false));

        cube_r103 = new ModelRenderer(this);
        cube_r103.setRotationPoint(-2.75F, -42.7776F, -27.5036F);
        carryhandle.addChild(cube_r103);
        setRotationAngle(cube_r103, 0.5672F, 0, 0);
        cube_r103.cubeList.add(new ModelBox(cube_r103, 102, 92, -0.499F, -0.5F, -1.5F, 1, 1, 3, 0, false));
        cube_r103.cubeList.add(new ModelBox(cube_r103, 0, 104, 1.999F, -0.5F, -1.5F, 1, 1, 3, 0, false));

        cube_r104 = new ModelRenderer(this);
        cube_r104.setRotationPoint(-2.75F, -36.4831F, -20.6854F);
        carryhandle.addChild(cube_r104);
        setRotationAngle(cube_r104, -0.5672F, 0, 0);
        cube_r104.cubeList.add(new ModelBox(cube_r104, 79, 103, -0.499F, 0, -14, 1, 1, 3, 0, false));
        cube_r104.cubeList.add(new ModelBox(cube_r104, 19, 104, 1.999F, 0, -14, 1, 1, 3, 0, false));

        cube_r105 = new ModelRenderer(this);
        cube_r105.setRotationPoint(-2.75F, -36.4704F, -9.5288F);
        carryhandle.addChild(cube_r105);
        setRotationAngle(cube_r105, -0.5672F, 0, 0);
        cube_r105.cubeList.add(new ModelBox(cube_r105, 0, 109, -0.5F, 0, -14, 1, 1, 4, -0.002F, false));
        cube_r105.cubeList.add(new ModelBox(cube_r105, 60, 109, 2, 0, -14, 1, 1, 4, -0.002F, false));

        cube_r106 = new ModelRenderer(this);
        cube_r106.setRotationPoint(-1.75F, -42.4944F, -39.4835F);
        carryhandle.addChild(cube_r106);
        setRotationAngle(cube_r106, -0.6545F, 0, 0);
        cube_r106.cubeList.add(new ModelBox(cube_r106, 41, 38, -1.499F, -1.5F, -0.5F, 1, 3, 1, 0, false));
        cube_r106.cubeList.add(new ModelBox(cube_r106, 66, 109, -1.001F, -1.5F, -0.5F, 3, 3, 1, 0, false));

        cube_r107 = new ModelRenderer(this);
        cube_r107.setRotationPoint(-2.25F, -41.575F, -42.55F);
        carryhandle.addChild(cube_r107);
        setRotationAngle(cube_r107, -0.6545F, 0, 0);
        cube_r107.cubeList.add(new ModelBox(cube_r107, 18, 0, -0.999F, -2.5F, -0.75F, 1, 4, 1, 0, false));
        ...
        setRotationAngle(cube_r108, -0.5585F, 0, 0);
        ...
        cube_r109.setRotationPoint(1, -44.6F, 1.4F);
        carryhandle.addChild(cube_r109);
        setRotationAngle(cube_r109, -0.5411F, 0, 0);
        cube_r109.cubeList.add(new ModelBox(cube_r109, 101, 15, -2, 0, -2, 1, 1, 2, 0, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 38, 60, -3, 0, -1.5F, 1, 1, 1, -0.001F, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 6, 65, -3, 0, -1, 1, 1, 1, 0, false));
        cube_r109.cubeList.add(new ModelBox(cube_r109, 5, 104, -4, 0, -2, 1, 1, 2, 0, false));
        ...
        rail.addChild(teeth);
        teeth.cubeList.add(new ModelBox(teeth, 116, 82, -1, -4, -13.5F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 79, -1, -4, -15.125F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 76, -1, -4, -16.75F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 72, -1, -4, -18.375F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 60, 116, -1, -4, -21.625F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 48, -1, -4, -20, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 48, 116, -1, -4, -24.875F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 46, -1, -4, -23.25F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 42, 116, -1, -4, -37.875F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 41, -1, -4, -36.25F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 39, -1, -4, -26.5F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 30, 116, -1, -4, -28.125F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 22, -1, -4, -29.75F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 17, -1, -4, -31.375F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 15, -1, -4, -34.625F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 116, 11, -1, -4, -33, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 63, -1, -4, -49.25F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 58, -1, -4, -39.5F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 56, -1, -4, -41.125F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 44, -1, -4, -42.75F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 20, -1, -4, -44.375F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 9, -1, -4, -47.625F, 2, 1, 1, -0.1F, false));
        teeth.cubeList.add(new ModelBox(teeth, 115, 7, -1, -4, -46, 2, 1, 1, -0.1F, false));
        ...
        setRotationAngle(DustCover8_r3, 0, 0, -0.7854F);
