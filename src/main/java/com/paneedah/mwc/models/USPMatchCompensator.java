...
public class USPMatchCompensator extends ModelBase {
    ...
    public USPMatchCompensator() {
        ...
        cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 29, -1, 0.0F, 0.0F, 2, 1, 4, 0.0F, false));
        ...
        cube_r8.cubeList.add(new ModelBox(cube_r8, 21, 13, -1, -1, -0.03F, 1, 1, 1, 0.0F, false));
        ...
        cube_r9.cubeList.add(new ModelBox(cube_r9, 21, 16, -1, -1, -0.03F, 1, 1, 1, 0.0F, false));
        ...
        cube_r10.cubeList.add(new ModelBox(cube_r10, 10, 24, -1, -1, -0.03F, 1, 1, 1, 0.0F, false));
        ...
        cube_r11.cubeList.add(new ModelBox(cube_r11, 52, 36, -1, -1, 0.0F, 1, 1, 14, 0.0F, false));
        ...
        cube_r12.cubeList.add(new ModelBox(cube_r12, 24, 4, 0.0F, -1, -0.04F, 1, 1, 1, 0.0F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 24, 17, 0.0F, -1, -0.04F, 1, 1, 1, 0.0F, false));
        ...
        cube_r14.cubeList.add(new ModelBox(cube_r14, 21, 25, 0.0F, -1, -0.04F, 1, 1, 1, 0.0F, false));
        ...
        cube_r15.cubeList.add(new ModelBox(cube_r15, 0, 55, 0.0F, -1, 0.0F, 1, 1, 14, 0.0F, false));
        ...
        cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 20, 0.0F, -1, -1, 1, 1, 8, 0.0F, false));
        ...
        cube_r17.cubeList.add(new ModelBox(cube_r17, 21, 21, -1, -1, -1, 1, 1, 8, 0.0F, false));
        ...
        cube_r18.cubeList.add(new ModelBox(cube_r18, 25, 25, -1, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 21, 21, -1, 0.0F, 0.0F, 1, 1, 19, 0.0F, false));
    }
