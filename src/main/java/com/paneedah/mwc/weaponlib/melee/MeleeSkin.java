...
import com.paneedah.mwc.weaponlib.model.FlatModel;
...
public class MeleeSkin extends ItemAttachment<ItemMelee> {
	...
	public MeleeSkin(AttachmentCategory category, ModelBase model, String textureName, String crosshair,
			com.paneedah.mwc.weaponlib.ItemAttachment.ApplyHandler<ItemMelee> apply,
			com.paneedah.mwc.weaponlib.ItemAttachment.ApplyHandler<ItemMelee> remove) {
