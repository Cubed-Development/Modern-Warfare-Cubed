...
/*
    	PanelUpper = new AttachmentBuilder<Weapon>()
                ...
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinPanelUpper(), "ninthsin.png")
                .withName("PanelUpper")
                .withRenderablePart()
    	...
    	PanelLower = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinPanelLower(), "ninthsin.png")
                .withName("PanelLower")
                .withRenderablePart()
                .build(MWC.modContext);
    	...
    	RegulatorUpper = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorUpper(), "ninthsin.png")
    	...
    	RegulatorLower = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorLower(), "ninthsin.png")
    	...
    	RegulatorRotator = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorRotator(), "ninthsin.png")
    	...
    	RegulatorActionUpper = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorActionUpper(), "ninthsin.png")
    	...
    	RegulatorActionLower = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorActionLower(), "ninthsin.png")
    	...
    	RegulatorAction = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinRegulatorAction(), "ninthsin.png")
    	...
    	CyclerFront = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinCycleFront(), "ninthsin.png")
    	...
    	CyclerBackLeft = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinCycleBackLeft(), "ninthsin.png")
    	...
    	CyclerBackRight = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinCycleBackRight(), "ninthsin.png")
    	...
    	Cycler = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new com.paneedah.mwc.models.weapons.NinthSinCycle(), "ninthsin.png")
                .withName("Cycler")
                .withRenderablePart()
                .build(MWC.modContext);
*/
        ChainB = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ChainsawChainB(), "chainsaw.png")
                .withName("ChainB")
                .withRenderablePart()
                .build();
        ...
        ChainA = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ChainsawChainA(), "chainsaw.png")
                .withName("ChainA")
                .withRenderablePart()
                .build();
        ...
        Chain = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ChainsawChain(), "chainsaw.png")
                .withName("Chain")
                .withRenderablePart()
                .build();
        ...
        G95IronSights = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new G95_frontsights(), "gun.png")
                .withModel(new G95_rearsights(), "gun.png")
        ...
        Origin12Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Origin12Action(), "origin12.png")
        ...
        P90Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new P90Action(), "p90.png")
                .withName("P90Action")
                .withRenderablePart()
                .build();
        ...
        M1CarbineAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1CarbineAction(), "gun.png")
        ...
        G11Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withRotationPoint(0.1452000024497508F, -0.805199984866377F, 1.229600028479095F)
                .withModel(new G11Action(), "gun.png")
                .withName("G11Action")
                .withRenderablePart()
                .build();
        ...
        AUGAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new AUGaction(), "aug.png")
                .withName("AUGAction")
                .withRenderablePart()
                .build();
        ...
        MAS21Slide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MAS21Slide(), "MAS21.png")
        ...
        MAS21Barrel = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MAS21Barrel(), "MAS21.png")
        ...
        MAS21Part = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MAS21Part(), "MAS21.png")
                .withName("MAS21Part")
                .withRenderablePart()
        ...
        M32Main1B = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M32Main1B(), "gun.png")
        ...
        BrowningAuto5Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new BrowningAuto5Action(), "gun.png").withName("BrowningAuto5Action")
                .withRenderablePart()
                .build();
        ...
        M1GarandAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1GarandAction(), "gun.png").withName("M1GarandAction")
                .withRenderablePart()
                .build();
        ...
        M1897Pump = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1897Pump(), "m1897.png").withName("M1897pump")
                .withRenderablePart()
                .build();
        ...
        Super90Pump = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Super90Pump(), "gun.png").withName("Super90Pump")
                .withRenderablePart()
                .build();
...
//                .withCategory(AttachmentCategory.EXTRA)
//                // .withCreativeTab(MWC.gunsTab)
//                .withModel(new com.paneedah.mwc.models.weapons.P226Slide(), "P226.png")
//                .withModel(new com.paneedah.mwc.models.weapons.P226rearsight(), "p226rearsight.png")
//                .withModel(new com.paneedah.mwc.models.weapons.P226frontsight(), "p226frontsight.png")
//                .withName("P226Slide")
//                .withRenderablePart()
//                .build(MWC.modContext);
        ...
        PythonChamber = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new PythonChamber(), "Python.png")
                .withName("PythonChamber")
                .withRotationPoint(-0.11759999474287039F, -0.9064000131249434F, -0.8943999600172051F)
                .withRenderablePart()
                .build();
        ...
        RevolverSpeedLoader = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new TaurusLoader(), "taurusraginghunter.png")
                .withName("RevolverSpeedloader")
                .withRotationPoint(-0.11759999474287039F, 0.07280001164674715F, 0.8548000601351243F)
                .withRenderablePart()
                .build();
        ...
        RevolverSpeedLoaderBullets = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new TaurusBullets(), "taurusraginghunter.png")
        ...
        MagnumChamber = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new TaurusRagingHunterChamber(), "taurusraginghunter.png")
        ...
        M1014Action = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA2)
                .withModel(new M1014action(), "m1014.png")
        ...
        ShotgunInsertion = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA3)
                .withModel(new ShotgunInsertion(), "ShotgunInsertion.png")
        ...
        SupernovaPump = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA3)
                .withModel(new SupernovaPump(), "supernova.png")
        ...
        ACRRails = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA5)
                ...
                .withModel(new AKRail4(), "acrrail.png")
                .withModel(new AKRail5(), "acrrail.png")
                .withName("ACRRails").withRenderablePart()
                .build();

        RPG7rocket = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                .withModel(new RPG7rocket(), "rpg7.png")
                .withRenderablePart()
                .withName("RPG7rocket")
                .build();
        ...
        M202rockets = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                .withModel(new M202Rockets(), "gun.png")
                .withRenderablePart()
        ...
        GL06Cartridge = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                .withModel(new GL06Cartridge(), "GL06.png")
                .withRenderablePart()
        ...
        M32Cartridge = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                .withModel(new M32Cartridge(), "gun.png")
                .withRenderablePart()
        ...
        MP43Edoublebarrel = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP43Edoublebarrel(), "MP43Edoublebarrel.png")
        ...
        HS12Barrels = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new HS12Barrels(), "gun.png")
        ...
        M1873action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1873action(), "M1873.png")
        ...
        F2000Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new F2000Action(), "f2000.png")
        ...
        G36CAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new G36CAction(), "g36c.png")
                .withName("G36CAction")
                .withRenderablePart()
        ...
        ARX160Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ARX160Action(), "gun.png")
        ...
        KedrAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KedrAction(), "kedr.png")
                .withName("KedrAction")
                .withRenderablePart()
        ...
        KedrStock = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KedrStock(), "kedr.png")
                .withName("KedrStock")
                .withRenderablePart()
        ...
        MP7Grip = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP7Grip(), "mp7.png")
                .withName("MP7Grip")
                .withRotationPoint(-0.12000000357627871F, -0.20000000596046452F, -1.6000000476837126F)
                .withRenderablePart()
        ...
        M1928ThompsonAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1928ThompsonAction(), "M1A1Thompson.png")
        ...
        M1A1Sight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1A1rearsight(), "gun.png")
        ...
        M1928Sight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M1928rearsight(), "gun.png")
                .withName("M1928Sight")
                .withRenderablePart()
        ...
        M82Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M82Action(), "m82.png")
                .withName("m82action")
                .withRenderablePart()
        ...
        MP5boltaction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP5boltaction(), "MP5.png")
                .withName("MP5boltaction")
                .withRotationPoint(-0.12000000357627871F, -1.1200000333786013F, -2.320000069141389F)
                .withRenderablePart()
        ...
        UMP45action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new UMP45Action(), "ump45.png")
        ...
        MP5action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP5action(), "MP5.png")
                .withName("MP5action")
                .withRenderablePart()
        ...
        MP7action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP7Action(), "MP7.png")
                .withName("MP7action")
                .withRenderablePart()
        ...
        G3Bolt = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new G3ChargingHandle(), "G3.png")
                .withName("G3Bolt")
                .withRotationPoint(0, -1.0800000321865084F, -4.120000122785571F)
                .withRenderablePart()
        ...
        MG42Belt = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MG42belt(), "mg42.png")
                .withName("mg42belt")
                .withRenderablePart()
        ...
        MG42latch = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MG42latch(), "mg42.png")
                .withName("mg42latch")
                .withRenderablePart()
        ...
        MG34latch = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MG34Latch(), "mg42.png")
                .withName("mg34latch")
                .withRenderablePart()
        ...
        JohnsonACTION = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new JohnsonLMGACTION(), "gun.png")
        ...
        JohnsonRifleACTION = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new JohnsonRifleAction(), "gun.png")
        ...
        JohnsonRifleSight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new JohnsonRifleSight(), "gun.png")
        ...
        StripperClip = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new LeeEnfieldClip(), "stripperclip.png")
        ...
        StripperClipBullets = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new LeeEnfieldClipBullets(), "stripperclip.png")
        ...
        NTW20Barrel = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new NTW20Barrel(), "gun.png")
        ...
        NTW20Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new NTW20ACTION(), "gun.png")
        ...
        M249Belt = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M249Belt(), "m249.png")
                .withName("M249Belt")
                .withRenderablePart()
        ...
        M249Hatch = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M249Hatch(), "m249.png")
                .withModel(new AKRail(), "akrail.png")
                .withModel(new M249RearSight(), "gun.png")
        ...
        MG42action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MG42action(), "mg42.png")
                .withName("mg42action")
                .withRenderablePart()
        ...
        ScarAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ScarAction(), "gun.png")
                .withName("ScarAction")
                .withRenderablePart()
        ...
        ScarHAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new ScarHAction(), "scarh.png")
        ...
        Mk14EBRaction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Mk14EBRaction(), "m14dmr.png")
        ...
        Mk14EBRsight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new m1garandrearsight(), "gun.png")
        ...
        STG44actionCover = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new STG44actioncover(), "gun.png")
        ...
        G43GewehrAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new G43GewehrAction(), "gun.png")
        ...
        SpringfieldRearSight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new SpringfieldRearSight(), "gun.png")
        ...
        Kar98Kaction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA7)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Kar98Kboltaction(), "gun.png")
        ...
        VP70slide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new VP70slide(), "vp70.png")
        ...
        APSslide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new APSslide(), "APS.png")
                .withModel(new makarovfrontsight(), "gun")
                .withModel(new APSrearsight(), "gun")
                .withName("APSslide")
                .withRenderablePart()
                .build();
        ...
        APShammer = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new APShammer(), "APS.png")
                .withName("APShammer")
                .withRenderablePart()
                .build();
        ...
        USP45hammer = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new USP45Hammer(), "usp45.png")
        ...
        P226hammer = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new P226Hammer(), "p226.png")
                .withName("P226hammer")
                .withRenderablePart()
                .build();
        ...
        M9A1hammer = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M9hammer(), "m9a1.png")
                .withName("M9A1hammer")
                .withRenderablePart()
                .build();
        ...
        MP443hammer = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MP443Hammer(), "mp443.png")
        ...
        M17_Slide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new M17Slide(), "m17.png")
                .withModel(new M1911FrontSight(), "m1911frontsight")
        ...
        Makarov_Slide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MakarovSlide(), "gun.png")
                .withModel(new makarovrearsight(), "gun.png")
        ...
        P12_Slide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new USP45Slide(), "usp45.png")
                .withModel(new M1911FrontSight(), "m1911frontsight")
                .withModel(new P2000rearsight(), "m1911frontsight.png")
                .withName("P12_Slide")
                .withRenderablePart()
                .build();
        ...
        BrowningHiPowerSlide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new BrowningHiPowerSlide(), "BrowningHiPower.png")
                .withModel(new M1911FrontSight(), "gun")
        ...
        VSSVintorezAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new VSSVintorezAction(), "vssvintorez.png")
        ...
        AKaction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new AK47Action(), "ak47.png")
                .withName("AKaction")
                .withRenderablePart()
                .build();
        ...
        DragunovAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new DragunovAction(), "dragunov.png")
        ...
        Malyukaction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new MalyukAction(), "malyuk.png")
        ...
        AK15action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new AK15Action(), "ak15.png")
                .withName("AK15action")
                .withRenderablePart()
                .build();
        ...
        KBP9A91action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KBP9A91Action(), "KBP9A91.png")
        ...
        FNFALActionLever = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new FNFALActionLever(), "FNFAL.png")
        ...
        FNFALAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new FNFALAction(), "FNFAL.png")
        ...
        FamasF1Action = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new FamasF1Action(), "famasf1.png")
        ...
        Albert01Rslide = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Albert01RSlide(), "Albert01R.png")
        ...
        UziIronSight = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new UziFrontSight(), "gun.png")
                .withModel(new UziRearSight(), "gun.png")
        ...
        P10frontsight = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new makarovfrontsight(), "gun.png")
//                .withModel(new com.paneedah.mwc.models.weapons.M9A1frontsight(), "M9A1frontsight")
//                .withModel(new com.paneedah.mwc.models.weapons.M9A1rearsight(), "M9A1rearsight")
        ...
        M40A6BoltAction = new AttachmentBuilder<Weapon>()
                ...
                .withModel(new GunwerksHAMRboltaction(), "gunwerkshamr")
        ...
        M40A6BoltActionPrime = new AttachmentBuilder<Weapon>()
                ...
                .withModel(new GunwerksHAMRboltactionPrime(), "gunwerkshamr")
        ...
        SSG08BoltAction1 = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new SSG08BoltAction1(), "SSG08_2")
        ...
        Remington700BoltAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new R700action(), "remington700")
        ...
        Remington700BoltActionMain = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new R700actionMain(), "remington700")
        ...
        L115Bolt1 = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new L96Action(), "L96Action.png").withName("L96Action")
                .withRenderablePart()
                .build();
        ...
        L115Bolt2 = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new L115Bolt2(), "gun.png").withName("LP115Bolt2")
                .withRenderablePart()
                .build();
        ...
        DSR1BoltAction = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new DSR1BoltAction(), "dsr1.png")
        ...
        DSR1BoltActionMain = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new DSR1BoltActionMain(), "dsr1.png")
        ...
        L115Mag = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new L115Mag(), "gun.png").withName("L115Mag")
                .withRenderablePart()
                .build();
        ...
        HESCSpump = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new HEShotgunPump(), "spas12")
                .withName("HESCSpump")
                .withRenderablePart()
                .build();
        ...
        KragAction1 = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA2)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KragJorgensenAction1(), "KragJorgensen")
        ...
        KragAction2 = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA3)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KragJorgensenAction2(), "KragJorgensen")
        ...
        KragChamber = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA4)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new KragJorgensenChamber(), "KragJorgensen")
        ...
        ShotgunShell = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Shotgun12Gauge(), "shotgun12gauge")
        ...
        ShotgunShellDouble = new AttachmentBuilder<Weapon>()
                ...
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Shotgun12Gauge(), "shotgun12gauge")
                .withModel(new Shotgun12Gauge2(), "shotgun12gauge")
        ...
        Shotgun4Gauge = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Shotgun12Gauge(), "Shotgun4Gauge")
        ...
        Bullet = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new BulletBig(), "bulletbig")
                .withName("Bullet")
                .withRenderablePart()
        ...
        BulletSmall = new AttachmentBuilder<Weapon>()
                .withCategory(AttachmentCategory.EXTRA)
                // .withCreativeTab(MWC.gunsTab)
                .withModel(new Bullet44(), "bulletsmall")
        ...
        M110EjectorAction = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA)
                .withModel(new M110Action(), "m110.png")
        ...
        BeowulfAction = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA)
                .withModel(new Beowulf50CalAction(), "beowulf50cal.png")
        ...
        S710TricunActionPully = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA2)
                .withModel(new S710TricunActionPully(), "s710tricun.png")
        ...
        S710TricunActionEjector = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.EXTRA3)
                .withModel(new S710TricunActionEjector(), "s710tricun.png")
        ...
        AR15Iron = new AttachmentBuilder<Weapon>().withCategory(AttachmentCategory.SCOPE)
                ...
                .withOnWeaponModel(new M4Iron2(), "AK12.png")
                .withOnWeaponModel(new FALIron(), "gun.png")
                .withRequiredAttachments(Attachments.M4Receiver, Attachments.VLTORReceiver, Attachments.HoneyBadgerReceiver, Attachments.HoneyBadgerReceiverBlack)
                .withName("AR15Iron")
                .build();
