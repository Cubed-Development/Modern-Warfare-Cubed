...
//      .withCapacity(CommonProxy.Remington870Mag)
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
                    if (model instanceof AKMiron1) {
                        ...
                        GL11.glTranslatef(-0.14F, -0.47F, -4.45F);
...
//            GL11.glTranslatef(0f, -0.43f, -0.5f);
                ...
                .withCompatibleBullet(BulletRegistry.getBullet("Bullet4440"), (model) -> {})
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioning((renderContext) -> {
                            ...
                            GL11.glTranslatef(-0.275000f, 0.300000f, -1.100000f);
                        })
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GL11.glRotatef(4F, 0f, 0f, 1f);
                            GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                            GL11.glTranslatef(-0.275000f, 0.300000f, -0.9f);
...
//              // Holo Zoom
                        ...
                        .withFirstPersonPositioningEjectSpentRound(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GL11.glTranslatef(0.18f, 0.625000f, -1.4f);
                                }, 230, 0),

                                new Transition((renderContext) -> { // Reload position
                                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                                    GL11.glRotatef(-3.000000f, 1f, 0f, 0f);
                                    GL11.glRotatef(18.000000f, 0f, 1f, 0f);
                                    GL11.glRotatef(80.000000f, 0f, 0f, 1f);
                                    GL11.glTranslatef(0.18f, 0.625000f, -1.3f);
                                }, 180, 20),
                        ...
                        .withFirstPersonPositioningEjectSpentRoundAimed(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                                    GL11.glTranslatef(0.250000f, 0.22f, -1f);
                                }, 180, 20),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                                    GL11.glTranslatef(0.250000f, 0.2f, -1.05f);
                                }, 150, 0)
