...
public class VSSVintorezFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withCompatibleAttachment(Attachments.VSSVintorezMilspecStock, (player, itemStack) -> {
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.PSO1, (player, itemStack) -> {
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GL11.glTranslatef(0.175F, -0.36F, 0.65F);

                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.PSO1))
                                GL11.glTranslatef(-0.01F, 0.28f, -0.25f);
                                ...
                                GL11.glTranslatef(0F, 0.36f, -0.1f);
                                ...
                                GL11.glTranslatef(0.003F, 0.25f, 0.2f);
