...
public class Entities {
    ...
    public static void init(CommonProxy commonProxy) {
        ...
        new EntityConfiguration.Builder()
                ...
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.BanditNew", "banditnew.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.BanditNew2", "banditnew2.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.BanditNew3", "banditnew3.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.BanditNew4", "banditnew4.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.BanditNew5", "banditnew5.png")
                .withHurtSound("hurt")
...
//      .withAiTask(7, e -> new EntityAIBreakDoor(e))
        ...
        new EntityConfiguration.Builder()
                ...
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.Soldier", "soldier.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.Soldier2", "soldier2.png")
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.SoldierSniper", "soldiersniper.png")
                .withHurtSound("hurt")
                .withAmbientSound("drawweapon")
//        .withStepSound("step")
                .withAiTask(1, e -> new EntityAISwimming(e))
...
//        .withMaxTolerableLightBrightness(1f)
                .withSpawnEgg(0x5A674F, 0x464039)
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.Turret", "turret.png")
...
//        .withMaxTolerableLightBrightness(1f)
                .withSpawnEgg(0x5A674F, 0x464039)
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.TurretBuff", "turretbuff.png")
                .withAmbientSound("turret_turn")
//        .withStepSound("step")
                .withMaxSpeed(0.0F) // 0.1-0.3 is normal speed
                .withAiTask(1, e -> new EntityAIAttackRangedWeapon((EntityCustomMob) e, 1.0D, 1, 50.0F))
...
//        .withMaxTolerableLightBrightness(1f)
                .withSpawnEgg(0x5A674F, 0x464039)
                .withTexturedModelVariant("com.paneedah.mwc.models.weapons.turretsilenced", "turretsilenced.png")
                .withAmbientSound("turret_turn")
//        .withStepSound("step")
                .withMaxSpeed(0.0F) // 0.1-0.3 is normal speed
                .withAiTask(1, e -> new EntityAIAttackRangedWeapon((EntityCustomMob) e, 1.0D, 1, 50.0F))
