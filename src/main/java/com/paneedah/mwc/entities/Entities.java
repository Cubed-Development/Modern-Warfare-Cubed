...
public class Entities {
    ...
    public static void init(CommonProxy commonProxy) {
        ...
        new EntityConfiguration.Builder()
                ...
                .withMaxHealth(40)
                .withEntityIdSupplier(() -> Integer.valueOf(10000))
...
//      .withAiTask(7, e -> new EntityAIBreakDoor(e))
        ...
        new EntityConfiguration.Builder()
                ...
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> Integer.valueOf(10011))
...
//        .withStepSound("step")
        ...
        new EntityConfiguration.Builder()
                ...
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> Integer.valueOf(10012))
...
//        .withStepSound("step")
        ...
        new EntityConfiguration.Builder()
                ...
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> Integer.valueOf(10013))
...
//        .withStepSound("step")
        ...
        new EntityConfiguration.Builder()
                ...
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> Integer.valueOf(10014))
