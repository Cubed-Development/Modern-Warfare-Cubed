...
@Mod(modid = ID, name = NAME, version = VERSION, dependencies = "required-after:mixinbooter@[8.6,);required-after:redcore@[0.5,)", guiFactory = "com.paneedah.weaponlib.config.ConfigGUIFactory", updateJSON = "https://forge.curseupdate.com/836353/mwc")
