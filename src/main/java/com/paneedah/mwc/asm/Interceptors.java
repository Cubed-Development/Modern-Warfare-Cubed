    	...
    	*/
        ...
        if (weaponInstance != null && weaponInstance.isAimed() && weaponInstance.getScope() != null && weaponInstance.getScope().isOptical()) {
        	...
        	*/
            ...
            ClientValueRepo.SCOPE_X_LERPED.add((yawDelta * (0.001 + scalar)));
            ClientValueRepo.SCOPE_Y_LERPED.add(pitchDelta * (0.001 + scalar));
    		...
    		*/
            ClientValueRepo.SCOPE_X_LERPED.add(yawDelta * (0.005));
            ClientValueRepo.SCOPE_Y_LERPED.add(pitchDelta * (0.005));
